...
const CInterfaceProxyVtbl * _BetaBrain_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISySalObjectProxyVtbl,
    0
};

const CInterfaceStubVtbl * _BetaBrain_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ISySalObjectStubVtbl,
    0
};

PCInterfaceName const _BetaBrain_InterfaceNamesList[] = 
{
    "ISySalObject",
    0
};
...
#define _BetaBrain_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _BetaBrain, pIID, n)

int __stdcall _BetaBrain_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_BetaBrain_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo BetaBrain_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _BetaBrain_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _BetaBrain_StubVtblList,
    (const PCInterfaceName * ) & _BetaBrain_InterfaceNamesList,
    0, // no delegation
    & _BetaBrain_IID_Lookup, 
    1,
    2,
