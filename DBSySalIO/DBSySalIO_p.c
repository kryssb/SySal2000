...
const CInterfaceProxyVtbl * _DBSySalIO_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _DBSySalIO_StubVtblList[] = 
{
...
PCInterfaceName const _DBSySalIO_InterfaceNamesList[] = 
{
    "ISySalObject",
    "ISySalDataIO",
    0
...
#define _DBSySalIO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _DBSySalIO, pIID, n)

int __stdcall _DBSySalIO_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _DBSySalIO, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _DBSySalIO, 2, *pIndex )
    
}

const ExtendedProxyFileInfo DBSySalIO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _DBSySalIO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _DBSySalIO_StubVtblList,
    (const PCInterfaceName * ) & _DBSySalIO_InterfaceNamesList,
    0, // no delegation
    & _DBSySalIO_IID_Lookup, 
    2,
    2,
