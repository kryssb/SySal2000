...
CINTERFACE_PROXY_VTABLE(6) _ISySalDataIOProxyVtbl = 
{
    ...
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *)-1 /* ISySalDataIO::Write */ ,
    (void *)-1 /* ISySalDataIO::Read */ ,
    (void *)-1 /* ISySalDataIO::GetStatus */
};
...
/* 560 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
/* 566 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
/* 600 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
#ifndef _ALPHA_
/* 620 */	NdrFcShort( 0x14 ),	/* x86, MIPS, PPC Stack size/offset = 20 */
#else
			NdrFcShort( 0x28 ),	/* Alpha Stack size/offset = 40 */
#endif
/* 622 */	0x8,		/* FC_LONG */
...
/* 640 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
const CInterfaceProxyVtbl * _DispatcherIO_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _DispatcherIO_StubVtblList[] = 
{
...
PCInterfaceName const _DispatcherIO_InterfaceNamesList[] = 
{
    "ISySalObject",
    "ISySalDataIO",
    0
...
#define _DispatcherIO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _DispatcherIO, pIID, n)

int __stdcall _DispatcherIO_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _DispatcherIO, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _DispatcherIO, 2, *pIndex )
    
}

const ExtendedProxyFileInfo DispatcherIO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _DispatcherIO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _DispatcherIO_StubVtblList,
    (const PCInterfaceName * ) & _DispatcherIO_InterfaceNamesList,
    0, // no delegation
    & _DispatcherIO_IID_Lookup, 
    2,
    2,
