...
const CInterfaceProxyVtbl * _EtaTracking_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISySalObjectProxyVtbl,
    0
};

const CInterfaceStubVtbl * _EtaTracking_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ISySalObjectStubVtbl,
    0
};

PCInterfaceName const _EtaTracking_InterfaceNamesList[] = 
{
    "ISySalObject",
    0
};
...
#define _EtaTracking_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _EtaTracking, pIID, n)

int __stdcall _EtaTracking_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_EtaTracking_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo EtaTracking_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _EtaTracking_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _EtaTracking_StubVtblList,
    (const PCInterfaceName * ) & _EtaTracking_InterfaceNamesList,
    0, // no delegation
    & _EtaTracking_IID_Lookup, 
    1,
    2,
