...
#define PROC_FORMAT_STRING_SIZE   843                               
...
const CInterfaceProxyVtbl * _FixedThresholdClustering_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _FixedThresholdClustering_StubVtblList[] = 
{
...
PCInterfaceName const _FixedThresholdClustering_InterfaceNamesList[] = 
{
    "IClusterFinder",
    "ISySalObject",
    0
...
#define _FixedThresholdClustering_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _FixedThresholdClustering, pIID, n)

int __stdcall _FixedThresholdClustering_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _FixedThresholdClustering, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _FixedThresholdClustering, 2, *pIndex )
    
}

const ExtendedProxyFileInfo FixedThresholdClustering_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _FixedThresholdClustering_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _FixedThresholdClustering_StubVtblList,
    (const PCInterfaceName * ) & _FixedThresholdClustering_InterfaceNamesList,
    0, // no delegation
    & _FixedThresholdClustering_IID_Lookup, 
    2,
    2,
