...
/* at Mon Feb 02 19:23:56 2004
 */
/* Compiler settings for D:\SySal2\FlexMap2\FlexMap2.idl:
...
const CInterfaceProxyVtbl * _FlexMap2_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _FlexMap2_StubVtblList[] = 
{
...
PCInterfaceName const _FlexMap2_InterfaceNamesList[] = 
{
    "ISheetMap",
    "ISySalObject",
    0
...
#define _FlexMap2_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _FlexMap2, pIID, n)

int __stdcall _FlexMap2_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _FlexMap2, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _FlexMap2, 2, *pIndex )
    
}

const ExtendedProxyFileInfo FlexMap2_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _FlexMap2_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _FlexMap2_StubVtblList,
    (const PCInterfaceName * ) & _FlexMap2_InterfaceNamesList,
    0, // no delegation
    & _FlexMap2_IID_Lookup, 
    2,
    2,
