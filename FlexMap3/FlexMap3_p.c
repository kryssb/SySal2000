...
/* at Wed Apr 18 12:46:47 2007
 */
/* Compiler settings for D:\SySal2\FlexMap3\FlexMap3.idl:
...
const CInterfaceProxyVtbl * _FlexMap3_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _FlexMap3_StubVtblList[] = 
{
...
PCInterfaceName const _FlexMap3_InterfaceNamesList[] = 
{
    "ISheetMap2",
    "ISheetMap",
    "ISySalObject",
...
#define _FlexMap3_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _FlexMap3, pIID, n)

int __stdcall _FlexMap3_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _FlexMap3, 3, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _FlexMap3, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _FlexMap3, 3, *pIndex )
    
}

const ExtendedProxyFileInfo FlexMap3_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _FlexMap3_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _FlexMap3_StubVtblList,
    (const PCInterfaceName * ) & _FlexMap3_InterfaceNamesList,
    0, // no delegation
    & _FlexMap3_IID_Lookup, 
    3,
    2,
