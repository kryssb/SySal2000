...
/* at Sat Dec 29 19:32:29 2001
 */
/* Compiler settings for K:\SySal2\FlexMap2\FlexMap.idl:
...
const CInterfaceProxyVtbl * _FlexMap_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _FlexMap_StubVtblList[] = 
{
...
PCInterfaceName const _FlexMap_InterfaceNamesList[] = 
{
    "ISheetMap",
    "ISySalObject",
    0
...
#define _FlexMap_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _FlexMap, pIID, n)

int __stdcall _FlexMap_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _FlexMap, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _FlexMap, 2, *pIndex )
    
}

const ExtendedProxyFileInfo FlexMap_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _FlexMap_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _FlexMap_StubVtblList,
    (const PCInterfaceName * ) & _FlexMap_InterfaceNamesList,
    0, // no delegation
    & _FlexMap_IID_Lookup, 
    2,
    2,
