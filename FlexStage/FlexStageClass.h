// FlexStage.h : Declaration of the CFlexStage
...
class ATL_NO_VTABLE CFlexStage : 
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CFlexStage, &CLSID_FlexStage>,
	public IStage,
	public ISySalObject
{
public:
...
DECLARE_NOT_AGGREGATABLE(CFlexStage)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CFlexStage)
