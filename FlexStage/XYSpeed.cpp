...
CXYSpeed::CXYSpeed(HANDLE *phmonitormutex, int *pspeedmult, float *pxmanspeed, float *pymanspeed, ConfigData *pc) 
	: pHMonitorMutex(phmonitormutex), pSpeedMult(pspeedmult), pXManSpeed(pxmanspeed), pYManSpeed(pymanspeed), pC(pc)
{
}
