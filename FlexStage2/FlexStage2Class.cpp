// FlexStage2.cpp : Implementation of CFlexStage2
#include "stdafx.h"
#include "FlexStage2.h"
#include "FlexStage2Class.h"
...
STDMETHODIMP CFlexStage2::SetName(ConnectionName name)
{
...
STDMETHODIMP CFlexStage2::GetName(ConnectionName name)
{
	// TODO: Add your implementation code here
	strncpy(name, Name, SYSAL_MAX_CONN_NAME_LEN);
	return S_OK;
...
STDMETHODIMP CFlexStage2::SetConfig(SySalConfig *pConfig)
{
	// TODO: Add your implementation code here
	int i;
...
STDMETHODIMP CFlexStage2::GetConfig(SySalConfig *pConfig)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStage2::EditConfig(SySalConfig *pConfig, HSySalHANDLE hWnd)
{
	// TODO: Add your implementation code here
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	ConfigData Temp;
...
STDMETHODIMP CFlexStage2::EnableMonitor(boolean bEnable)
{
	// TODO: Add your implementation code here
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::GetNumberOfConnections(int *pNumber)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStage2::SetConnection(int n, SySalConnection connection)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStage2::GetConnection(int n, SySalConnection *pConnection)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStage2::GetIcon(int n, HSySalHICON *pHICON)
{
	// TODO: Add your implementation code here
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::GetClassName(ConnectionName name)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStage2::SyncExec()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStage2::AsyncExec(HSySalHANDLE HNotifyStatusChangeEvent)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStage2::AsyncCheckStatus(long *pStatus)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStage2::AsyncWait()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStage2::AsyncPause()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStage2::AsyncStop()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStage2::AsyncResume()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStage2::IsReady(long *pWrongConn, long *pRetCode)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStage2::GetLight(int *pLightLevel)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::SetLight(int LightLevel)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::PosMove(int Axis, float Pos, float Speed, float Acc)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::SpeedMove(int Axis, float Speed, float Acc)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::Stop(int Axis)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::GetPos(int Axis, float *pPos)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::GetLimiter(int Axis, int *pLim)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::EnableManualControl(boolean bEnable)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::IsManualControlEnabled(boolean *pbEnable)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::Reset(int Axis)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
UINT CFlexStage2::RefreshThreadHook(void *pOwner)
{
	return ((CFlexStage2 *)pOwner)->RefreshThread();
}

UINT CFlexStage2::RefreshThread()
{
	HANDLE HEvs[2];
	HEvs[0] = HTerminate;
	HEvs[1] = HRun;
...
void CFlexStage2::Enabler(void *pContext, bool bEnable)
{
	CFlexStage2 *This = (CFlexStage2 *)pContext;
...
bool CFlexStage2::SetBoard(bool InitLight)
{
	WaitForSingleObject(HMonitorMutex, INFINITE);
	try
	{
...
int CFlexStage2::GetData(QueryDataInfo DataName, void *StartPosition, char *File, int N)
{  
	int Index;
...
STDMETHODIMP CFlexStage2::PrepareAsyncGoTo3DMotion(AsyncGoTo3DTrajectory *pAGT)
{
...
STDMETHODIMP CFlexStage2::PrepareAsyncZScanMotion(AsyncZScanTrajectory *pAST)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::StartAsyncMotion()
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::WaitForAsyncZScanZComplete(DWORD pfnAbortCallback, DWORD Context)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::WaitForAsyncMotionComplete(DWORD pfnAbortCallback, DWORD Context)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::FlushAsyncMotions()
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStage2::GetMaxZScanZSamples(int *pMaxZSamples)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CFlexStage2::ExecTestProfile()
{
...
bool CFlexStage2::AZSTest(DWORD Context, AsyncZScanTrajectory *pAZS, float *pSamples)
{	
	short Axis = (pAZS->NewPos.X != 0.0f) ? 2 : 4;
	CFlexStage2 *This = (CFlexStage2 *)Context;
