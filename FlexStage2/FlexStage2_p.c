...
#define PROC_FORMAT_STRING_SIZE   1001                              
...
/* 842 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
/* 872 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 874 */	NdrFcShort( 0x64 ),	/* Type Offset=100 */
...
/* 900 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 902 */	NdrFcShort( 0x86 ),	/* Type Offset=134 */
...
/* 932 */	0x33,		/* FC_AUTO_HANDLE */
			0x6c,		/* Old Flags:  object, Oi2 */
/* 934 */	NdrFcLong( 0x0 ),	/* 0 */
/* 938 */	NdrFcShort( 0x11 ),	/* 17 */
#ifndef _ALPHA_
/* 940 */	NdrFcShort( 0x10 ),	/* x86, MIPS, PPC Stack size/offset = 16 */
#else
			NdrFcShort( 0x20 ),	/* Alpha Stack size/offset = 32 */
#endif
...
const CInterfaceProxyVtbl * _FlexStage2_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _FlexStage2_StubVtblList[] = 
{
...
PCInterfaceName const _FlexStage2_InterfaceNamesList[] = 
{
    "IStage",
    "IStage2",
    "ISySalObject",
...
#define _FlexStage2_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _FlexStage2, pIID, n)

int __stdcall _FlexStage2_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _FlexStage2, 3, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _FlexStage2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _FlexStage2, 3, *pIndex )
    
}

const ExtendedProxyFileInfo FlexStage2_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _FlexStage2_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _FlexStage2_StubVtblList,
    (const PCInterfaceName * ) & _FlexStage2_InterfaceNamesList,
    0, // no delegation
    & _FlexStage2_IID_Lookup, 
    3,
    2,
