...
const CInterfaceProxyVtbl * _FlexStage3_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _FlexStage3_StubVtblList[] = 
{
...
PCInterfaceName const _FlexStage3_InterfaceNamesList[] = 
{
    "IStage",
    "IStage2",
    "ISySalObject",
...
#define _FlexStage3_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _FlexStage3, pIID, n)

int __stdcall _FlexStage3_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _FlexStage3, 3, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _FlexStage3, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _FlexStage3, 3, *pIndex )
    
}

const ExtendedProxyFileInfo FlexStage3_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _FlexStage3_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _FlexStage3_StubVtblList,
    (const PCInterfaceName * ) & _FlexStage3_InterfaceNamesList,
    0, // no delegation
    & _FlexStage3_IID_Lookup, 
    3,
    2,
