...
const CInterfaceProxyVtbl * _FlexStage_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _FlexStage_StubVtblList[] = 
{
...
PCInterfaceName const _FlexStage_InterfaceNamesList[] = 
{
    "IStage",
    "ISySalObject",
    0
...
#define _FlexStage_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _FlexStage, pIID, n)

int __stdcall _FlexStage_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _FlexStage, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _FlexStage, 2, *pIndex )
    
}

const ExtendedProxyFileInfo FlexStage_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _FlexStage_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _FlexStage_StubVtblList,
    (const PCInterfaceName * ) & _FlexStage_InterfaceNamesList,
    0, // no delegation
    & _FlexStage_IID_Lookup, 
    2,
    2,
