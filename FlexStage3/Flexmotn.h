...
//	must be read explicitly by a separate execution of the flex_read_rdb command.
...
/* WINDOWS PROJECTS	*/
 ...
 #ifdef WIN32	//WIN 32 bit projects
 ...
 #else	//WIN 16 bit projects

	//Function Prototypes For flexmotn.dll
	#define FLEXFUNC 		i16 FAR  PASCAL
	#define PCFUNC	 		i16 FAR PASCAL
	#define BOARD 			u8 boardID
	#define BOARDID			boardID
...
// Load PWM Duty Cycle
FLEXFUNC flex_load_pwm_duty (BOARD, u8 PWMOutput, u16 dutycycle, u8 inpvect);
...
FLEXFUNC flex_enable_1394_watchdog(BOARD, WORD enableOrDisable);
