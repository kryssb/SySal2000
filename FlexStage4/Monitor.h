...
public:
	...
	CMonitor(float *pxmanspeed, float *pymanspeed, float *pzmanspeed, WORD *plightlevel, ConfigData *pc, HANDLE *phmonitormutex, HANDLE *phrun, void *pctx, void (*penabler)(void *, bool), void (*presetlamptimeout)(void *, bool), void (*phome)(void *), CWnd* pParent = NULL);   // standard constructor
...
protected:	
	...
	unsigned MaskLDec;
	unsigned MaskLInc;
	unsigned MaskToggleAutoMan;
	unsigned MaskSpeedChange;
	unsigned LastToggleAutoMan;
	unsigned LastSpeedChange;
	int AnXCenter;
	float AnXInvRange;
	int AnYCenter;
	float AnYInvRange;
