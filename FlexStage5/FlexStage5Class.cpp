...
const int MachineConfigDataN = 31;
...
QueryDataInfo MachineConfigDataName[MachineConfigDataN] =
{
	...
	{"DigZDec",					"%d",	STRUCT_OFFSET(ConfigData, DigZDec),				"-1"},
	{"DigZInc",					"%d",	STRUCT_OFFSET(ConfigData, DigZInc),				"-1"},
	{"DigLDec",					"%d",	STRUCT_OFFSET(ConfigData, DigLDec),				"-1"},
	{"DigLInc",					"%d",	STRUCT_OFFSET(ConfigData, DigLInc),				"-1"},
	{"DigToggleAutoManual",		"%d",	STRUCT_OFFSET(ConfigData, DigToggleAutoManual),	"-1"},
	{"DigSpeedChange",			"%d",	STRUCT_OFFSET(ConfigData, DigSpeedChange),		"-1"},
	{"AxXAxis",					"%d",	STRUCT_OFFSET(ConfigData, AxXAxis),				"-1"},
	{"AxYAxis",					"%d",	STRUCT_OFFSET(ConfigData, AxYAxis),				"-1"},
	{"AxZAxis",					"%d",	STRUCT_OFFSET(ConfigData, AxZAxis),				"-1"},
	{"AxLAxis",					"%d",	STRUCT_OFFSET(ConfigData, AxLAxis),				"-1"}
};
...
STDMETHODIMP CFlexStage5::GetClassName(ConnectionName name)
{
	...
	strncpy(name, "Flex Stage Controller 5", SYSAL_MAX_CONN_NAME_LEN);
	return S_OK;
}
