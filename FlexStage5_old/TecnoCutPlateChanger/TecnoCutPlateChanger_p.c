...
extern const MIDL_STUBLESS_PROXY_INFO IPlateChanger_ProxyInfo;
...
CINTERFACE_PROXY_VTABLE(7) _IPlateChangerProxyVtbl = 
{
    ...
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* IPlateChanger::LoadPlate */ ,
    (void *) (INT_PTR) -1 /* IPlateChanger::UnloadPlate */ ,
    (void *) (INT_PTR) -1 /* IPlateChanger::EnableManualControl */ ,
    (void *) (INT_PTR) -1 /* IPlateChanger::IsManualControlEnabled */
};
