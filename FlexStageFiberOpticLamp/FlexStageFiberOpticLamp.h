...
#ifndef __FlexStageFiberOpticLamp_h__
#define __FlexStageFiberOpticLamp_h__
...
#ifndef __FlexStageFiberOpticLamp_FWD_DEFINED__
#define __FlexStageFiberOpticLamp_FWD_DEFINED__

#ifdef __cplusplus
typedef class FlexStageFiberOpticLamp FlexStageFiberOpticLamp;
#else
typedef struct FlexStageFiberOpticLamp FlexStageFiberOpticLamp;
#endif /* __cplusplus */

#endif 	/* __FlexStageFiberOpticLamp_FWD_DEFINED__ */
...
EXTERN_C const CLSID CLSID_FlexStageFiberOpticLamp;

#ifdef __cplusplus

class DECLSPEC_UUID("13efec72-9442-434b-9fa4-910973bfc93f")
FlexStageFiberOpticLamp;
#endif
