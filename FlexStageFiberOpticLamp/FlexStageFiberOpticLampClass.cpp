// FlexStageFiberOpticLamp.cpp : Implementation of CFlexStageFiberOpticLamp
#include "stdafx.h"
#include "FlexStageFiberOpticLamp.h"
#include "FlexStageFiberOpticLampClass.h"
...
CFlexStageFiberOpticLamp::CFlexStageFiberOpticLamp()
{
...
STDMETHODIMP CFlexStageFiberOpticLamp::SetName(ConnectionName name)
{
...
STDMETHODIMP CFlexStageFiberOpticLamp::GetName(ConnectionName name)
{
	// TODO: Add your implementation code here
	strncpy(name, Name, SYSAL_MAX_CONN_NAME_LEN);
	return S_OK;
...
STDMETHODIMP CFlexStageFiberOpticLamp::SetConfig(SySalConfig *pConfig)
{
	// TODO: Add your implementation code here
	int i;
...
STDMETHODIMP CFlexStageFiberOpticLamp::GetConfig(SySalConfig *pConfig)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStageFiberOpticLamp::EditConfig(SySalConfig *pConfig, HSySalHANDLE hWnd)
{
	// TODO: Add your implementation code here
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	ConfigData Temp;
...
STDMETHODIMP CFlexStageFiberOpticLamp::EnableMonitor(boolean bEnable)
{
	// TODO: Add your implementation code here
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStageFiberOpticLamp::GetNumberOfConnections(int *pNumber)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStageFiberOpticLamp::SetConnection(int n, SySalConnection connection)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStageFiberOpticLamp::GetConnection(int n, SySalConnection *pConnection)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStageFiberOpticLamp::GetIcon(int n, HSySalHICON *pHICON)
{
	// TODO: Add your implementation code here
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStageFiberOpticLamp::GetClassName(ConnectionName name)
{
	// TODO: Add your implementation code here
	
	strncpy(name, "Flex Stage Controller with Fiber Optic Lamp Control", SYSAL_MAX_CONN_NAME_LEN);
	return S_OK;
}

STDMETHODIMP CFlexStageFiberOpticLamp::SyncExec()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStageFiberOpticLamp::AsyncExec(HSySalHANDLE HNotifyStatusChangeEvent)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStageFiberOpticLamp::AsyncCheckStatus(long *pStatus)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStageFiberOpticLamp::AsyncWait()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStageFiberOpticLamp::AsyncPause()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStageFiberOpticLamp::AsyncStop()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStageFiberOpticLamp::AsyncResume()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStageFiberOpticLamp::IsReady(long *pWrongConn, long *pRetCode)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CFlexStageFiberOpticLamp::GetLight(int *pLightLevel)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStageFiberOpticLamp::SetLight(int LightLevel)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStageFiberOpticLamp::PosMove(int Axis, float Pos, float Speed, float Acc)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStageFiberOpticLamp::SpeedMove(int Axis, float Speed, float Acc)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStageFiberOpticLamp::Stop(int Axis)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStageFiberOpticLamp::GetPos(int Axis, float *pPos)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStageFiberOpticLamp::GetLimiter(int Axis, int *pLim)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStageFiberOpticLamp::EnableManualControl(boolean bEnable)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStageFiberOpticLamp::IsManualControlEnabled(boolean *pbEnable)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CFlexStageFiberOpticLamp::Reset(int Axis)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
UINT CFlexStageFiberOpticLamp::RefreshThreadHook(void *pOwner)
{
	return ((CFlexStageFiberOpticLamp *)pOwner)->RefreshThread();
}

UINT CFlexStageFiberOpticLamp::RefreshThread()
{
	HANDLE HEvs[2];
	HEvs[0] = HTerminate;
	HEvs[1] = HRun;
...
void CFlexStageFiberOpticLamp::Enabler(void *pContext, bool bEnable)
{
	CFlexStageFiberOpticLamp *This = (CFlexStageFiberOpticLamp *)pContext;
...
bool CFlexStageFiberOpticLamp::SetBoard(bool InitLight)
{
	WaitForSingleObject(HMonitorMutex, INFINITE);
	try
	{
...
int CFlexStageFiberOpticLamp::GetData(QueryDataInfo DataName, void *StartPosition, char *File, int N)
{  
	int Index;
