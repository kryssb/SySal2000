...
#define PROC_FORMAT_STRING_SIZE   827                               
...
const CInterfaceProxyVtbl * _FlexStageFiberOpticLamp_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _FlexStageFiberOpticLamp_StubVtblList[] = 
{
...
PCInterfaceName const _FlexStageFiberOpticLamp_InterfaceNamesList[] = 
{
    "IStage",
    "ISySalObject",
    0
...
#define _FlexStageFiberOpticLamp_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _FlexStageFiberOpticLamp, pIID, n)

int __stdcall _FlexStageFiberOpticLamp_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _FlexStageFiberOpticLamp, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _FlexStageFiberOpticLamp, 2, *pIndex )
    
}

const ExtendedProxyFileInfo FlexStageFiberOpticLamp_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _FlexStageFiberOpticLamp_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _FlexStageFiberOpticLamp_StubVtblList,
    (const PCInterfaceName * ) & _FlexStageFiberOpticLamp_InterfaceNamesList,
    0, // no delegation
    & _FlexStageFiberOpticLamp_IID_Lookup, 
    2,
    2,
