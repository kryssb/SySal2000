...
FLEXFUNC flex_enable_encs(BOARD, BYTE device, WORD encmap);
...
FLEXFUNC flex_enable_gear(BOARD, BYTE device, WORD axismap);

//ACQ_SAMPLES_CMD, Acquire Samples Command
FLEXFUNC flex_acq_traj_data(BOARD, BYTE device, WORD axismap, WORD numsamps, WORD timeperiod);

//READ_SAMPLE_CMD, Read Sample From Acquire Samples to RDB
FLEXFUNC flex_read_traj_data(BOARD, BYTE device, BYTE retvect);

//READ_SAMPLE_CMD, Read Sample From Acquire Samples
FLEXFUNC flex_read_traj_data_rtn(BOARD, BYTE device, long FAR *retdata);

//OBSOLETE
//READ_RUNST_CMD, Read Run/Stop Status
FLEXFUNC flex_read_rs_status(BOARD, BYTE device, BYTE retvect);

//OBSOLETE
//READ_RUNST_CMD, Read Run/Stop Status
FLEXFUNC flex_read_rs_status_rtn(BOARD, BYTE device, WORD FAR *status);

//READ_MOFF_CMD, Read Motor Off Status
FLEXFUNC flex_read_motoff_status(BOARD, BYTE device, BYTE retvect);

//READ_MOFF_CMD, Read Motor Off Status
FLEXFUNC flex_read_motoff_status_rtn(BOARD, BYTE device, WORD FAR *status);

//OBSOLETE 
//READ_DACLIM_CMD, Read DAC Limit Status
FLEXFUNC flex_read_dac_status(BOARD, BYTE device, BYTE retvect);

//OBSOLETE
//READ_DACLIM_CMD, Read DAC Limit Status
FLEXFUNC flex_read_dac_status_rtn(BOARD, BYTE device, WORD FAR *status);
