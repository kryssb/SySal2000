// Distorsion.h : header file
//

#if !defined(DISTORSIONDLG_H_FOG__INCLUDED_)
#define DISTORSIONDLG_H_FOG__INCLUDED_
...
class CDistorsionDlg : public CDialog
{
// Construction
public:
...
/*	int m_DeltaStep;
	...
	CDistorsionDlg(CGrainFinder * pGF,CWnd* pParent = NULL);	// standard constructor

// Dialog Data
	//{{AFX_DATA(CDistorsionDlg)
	enum { IDD = IDD_DLG_DISTORSION };
	CMyButton	m_BtnRing;
...
#endif // !defined(DISTORSIONDLG_H_FOG__INCLUDED_)
