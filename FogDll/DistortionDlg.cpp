 // CDistortionDlg.cpp : implementation file
//
...
CDistortionDlg::CDistortionDlg(CGrainFinder * pGF,CWnd* pParent /*=NULL*/)
	...
	m_Space(pGF->m_EmSpaceUp)
{
	...
	m_OldDistortion = m_Space.Distortion;
	m_NewDistortion = m_Space.Distortion;
	m_Radius = 0.0f;
	m_RingSize = 0.0f;
...
void CDistortionDlg::SetFloat(UINT IDC,float ToSet)
{
...
void CDistortionDlg::SetInteger(UINT IDC,int ToSet)
{
	CWnd * pWnd = GetDlgItem(IDC);
	CString temp;
	temp.Format("%d",ToSet);
...
void CDistortionDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CDistortionDlg::PlotHistogram(CDC * pCDC/*=NULL*/)
{
	CDC * pDC, * pDevC = pCDC;
	int PlotSize = 256;
	int PlotLength = 980;
...
//	CBrush * pOldBrush;
	...
	float CountFactor;
	double A = m_OldDistortion.A,B = m_OldDistortion.B,x0 = m_OldDistortion.xzero,y0 = m_OldDistortion.yzero;
...
HCURSOR CDistortionDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

void CDistortionDlg::OnDrawItem(int nIDCtl, LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
...
void CDistortionDlg::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
...
void CDistortionDlg::OnOK() 
{
	...
	if(GF.GFC.pContext)((CWnd *)(GF.GFC.pContext))->SetDlgItemInt(IDC_EDT_FOGMAIN_GRAINSUP,m_Space.NumGrains);
//	m_Space.Distortion = m_NewDistortion;
	CDialog::OnOK();
}

void CDistortionDlg::OnCancel() 
{
	GF.ChangeSet(0,0);
	GF.ApplyCorrection(m_Space,m_OldDistortion);
//	ShowGrains();
	CDialog::OnCancel();
}

void CDistortionDlg::RButtonDown(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnRBD(IDC_BTN_DIST_PLOT,flags,point);
}
void CDistortionDlg::RBDDelta(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnRBD(IDC_BTN_DIST_DELTA,flags,point);
}
void CDistortionDlg::RBDThreshold(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnRBD(IDC_BTN_DIST_THRESHOLD,flags,point);
}
void CDistortionDlg::RBDA(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnRBD(IDC_BTN_DIST_A,flags,point);
}
void CDistortionDlg::RBDB(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnRBD(IDC_BTN_DIST_B,flags,point);
}
void CDistortionDlg::RBDR(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnRBD(IDC_BTN_DIST_R,flags,point);
}
void CDistortionDlg::RBDX0(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnRBD(IDC_BTN_DIST_X0,flags,point);
}
void CDistortionDlg::RBDY0(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnRBD(IDC_BTN_DIST_Y0,flags,point);
}
void CDistortionDlg::RBDAX(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnRBD(IDC_BTN_DIST_AX,flags,point);
}
void CDistortionDlg::RBDBY(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnRBD(IDC_BTN_DIST_BY,flags,point);
}


void CDistortionDlg::LButtonDown(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnLBD(IDC_BTN_DIST_PLOT,flags,point);
}
void CDistortionDlg::LBDDelta(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnLBD(IDC_BTN_DIST_DELTA,flags,point);
}
void CDistortionDlg::LBDThreshold(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnLBD(IDC_BTN_DIST_THRESHOLD,flags,point);
}
void CDistortionDlg::LBDA(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnLBD(IDC_BTN_DIST_A,flags,point);
}
void CDistortionDlg::LBDB(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnLBD(IDC_BTN_DIST_B,flags,point);
}
void CDistortionDlg::LBDR(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnLBD(IDC_BTN_DIST_R,flags,point);
}
void CDistortionDlg::LBDX0(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnLBD(IDC_BTN_DIST_X0,flags,point);
}
void CDistortionDlg::LBDY0(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnLBD(IDC_BTN_DIST_Y0,flags,point);
}
void CDistortionDlg::LBDAX(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnLBD(IDC_BTN_DIST_AX,flags,point);
}
void CDistortionDlg::LBDBY(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnLBD(IDC_BTN_DIST_BY,flags,point);
}


void CDistortionDlg::OnMouseMove(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnOMM(IDC_BTN_DIST_PLOT,flags,point);
}
void CDistortionDlg::OMMDelta(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnOMM(IDC_BTN_DIST_DELTA,flags,point);
}
void CDistortionDlg::OMMThreshold(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnOMM(IDC_BTN_DIST_THRESHOLD,flags,point);
}
void CDistortionDlg::OMMA(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnOMM(IDC_BTN_DIST_A,flags,point);
}
void CDistortionDlg::OMMB(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnOMM(IDC_BTN_DIST_B,flags,point);
}
void CDistortionDlg::OMMR(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnOMM(IDC_BTN_DIST_R,flags,point);
}
void CDistortionDlg::OMMX0(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnOMM(IDC_BTN_DIST_X0,flags,point);
}
void CDistortionDlg::OMMY0(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnOMM(IDC_BTN_DIST_Y0,flags,point);
}
void CDistortionDlg::OMMAX(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnOMM(IDC_BTN_DIST_AX,flags,point);
}
void CDistortionDlg::OMMBY(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnOMM(IDC_BTN_DIST_BY,flags,point);
}
void CDistortionDlg::RBDRing(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnRBD(IDC_BTN_DIST_RING,flags,point);
}
void CDistortionDlg::LBDRing(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnLBD(IDC_BTN_DIST_RING,flags,point);
}
void CDistortionDlg::OMMRing(void *pContext, UINT flags, CPoint point)
{
	((CDistortionDlg*)pContext)->OnOMM(IDC_BTN_DIST_RING,flags,point);
}



void CDistortionDlg::OnRBD(UINT ID, UINT flags, CPoint point)
{
/*	static int Pippo = 0;
...
void CDistortionDlg::OnLBD(UINT ID, UINT flags, CPoint point)
{
...
void CDistortionDlg::OnOMM(UINT ID, UINT flags, CPoint point)
{
	if(m_MouseCaptured == ID && ( flags & MK_LBUTTON))
	{
		...
		case IDC_BTN_DIST_X0 :
			Parameter = 3;
			m_NewDistortion.xzero -= Jump*m_xzeroStep;
			break;
		case IDC_BTN_DIST_Y0 :
			Parameter = 4;
			m_NewDistortion.yzero -= Jump*m_yzeroStep;
			break;
		case IDC_BTN_DIST_A :
			Parameter = 5;
			m_NewDistortion.A -= Jump*m_AStep;
			break;
		case IDC_BTN_DIST_B :
			Parameter = 6;
			m_NewDistortion.B -= Jump*m_BStep;
			break;
		case IDC_BTN_DIST_R :
			Parameter = 7;
			m_NewDistortion.R -= Jump*m_RStep;
			break;
		...
		if(!PlotButton)
		{
			...
			{	GF.ChangeSet(m_CinDelta/5,m_CinThreshold/5,m_Radius,m_RingSize);
				SetDlgItemInt(IDC_EDT_DIST_GRANI,GF.m_EmSpaceUp.NumGrains);	}
			GF.ApplyCorrection(m_Space,m_NewDistortion);
			PlotHistogram(NULL);
//			ShowGrains();
			pBtn->m_OldPoint = point;
		}
...
float CDistortionDlg::GetFloat(UINT IDC)
{
	CString temp;
...
void CDistortionDlg::OnEnChangeStep()
{
...
void CDistortionDlg::UpdateValues()
{
	int Value;
	Value = m_CinDelta/5;
	...
	SetFloat(IDC_EDT_DIST_VALUE_X0,(float)m_NewDistortion.xzero);
	SetFloat(IDC_EDT_DIST_VALUE_Y0,(float)m_NewDistortion.yzero);
	SetFloat(IDC_EDT_DIST_VALUE_A,(float)(m_NewDistortion.A*100000));
	SetFloat(IDC_EDT_DIST_VALUE_B,(float)(m_NewDistortion.B*1.e9));
	SetFloat(IDC_EDT_DIST_VALUE_R,(float)(m_NewDistortion.R*1.e6));
	SetFloat(IDC_EDT_DIST_VALUE_AX,(float)(m_NewDistortion.a*1.e3));
	SetFloat(IDC_EDT_DIST_VALUE_BY,(float)(m_NewDistortion.b*1.e3));
}


void CDistortionDlg::OnStcDistValue() 
{
	m_NewDistortion = SDistortion(0,0,0,0,0);
	UpdateValues();
	GF.ApplyCorrection(m_Space,m_NewDistortion);
	PlotHistogram();
}

void CDistortionDlg::OnBtnDistReset() 
{
	m_NewDistortion = m_OldDistortion;
	UpdateValues();
	GF.ApplyCorrection(m_Space,m_NewDistortion);
	PlotHistogram();
}

void CDistortionDlg::OnBtnDistSetnew() 
{
	m_OldDistortion = m_NewDistortion;
}

void CDistortionDlg::OnBtnDistTrackdist() 
{
	m_NewDistortion = GF.GFC.pT->m_Distortion;
	UpdateValues();
	GF.ApplyCorrection(m_Space,m_NewDistortion);
	PlotHistogram();
}

void CDistortionDlg::OnStcDistA() 
{
	m_NewDistortion.A = 0;
	UpdateValues();
	GF.ApplyCorrection(m_Space,m_NewDistortion);
...
void CDistortionDlg::OnStcDistAx() 
{
	m_NewDistortion.a = 0;
	UpdateValues();
	GF.ApplyCorrection(m_Space,m_NewDistortion);
...
void CDistortionDlg::OnStcDistB() 
{
	m_NewDistortion.B = 0;
	UpdateValues();
	GF.ApplyCorrection(m_Space,m_NewDistortion);
...
void CDistortionDlg::OnStcDistBy() 
{
	m_NewDistortion.b = 0;
	UpdateValues();
	GF.ApplyCorrection(m_Space,m_NewDistortion);
...
void CDistortionDlg::OnStcDistDelta() 
{
	m_CinDelta = 0;
...
void CDistortionDlg::OnStcDistR() 
{
	m_NewDistortion.R = 0;
	UpdateValues();
	GF.ApplyCorrection(m_Space,m_NewDistortion);
...
void CDistortionDlg::OnStcDistThreshold() 
{
	m_CinThreshold = 0;
	GF.ChangeSet(m_CinDelta/5,m_CinThreshold/5);
	UpdateValues();
...
void CDistortionDlg::OnStcDistX0() 
{
	m_NewDistortion.xzero = 0;
	UpdateValues();
	GF.ApplyCorrection(m_Space,m_NewDistortion);
	PlotHistogram();
}

void CDistortionDlg::OnStcDistY0() 
{
	m_NewDistortion.yzero = 0;
	UpdateValues();
	GF.ApplyCorrection(m_Space,m_NewDistortion);
	PlotHistogram();
}

void CDistortionDlg::OnRadDistZetas() 
{
	PlotHistogram();	
}


void CDistortionDlg::OnChkRanges() 
{
	PlotHistogram();	
}

void CDistortionDlg::OnEnChangeCountPixels() 
{
	PlotHistogram();	
}
