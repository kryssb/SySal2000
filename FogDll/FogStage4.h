...
/* at Mon Jun 15 19:49:33 2009
 */
/* Compiler settings for C:\sysal2000\FogStage4\FogStage4.idl:
...
#ifndef __FogStage4_h__
#define __FogStage4_h__
...
#ifndef __FogStage4_FWD_DEFINED__
#define __FogStage4_FWD_DEFINED__

#ifdef __cplusplus
typedef class FogStage4 FogStage4;
#else
typedef struct FogStage4 FogStage4;
#endif /* __cplusplus */

#endif 	/* __FogStage4_FWD_DEFINED__ */
...
EXTERN_C const IID IID_IStage;
    ...
    public:
        ...
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE ZPrecisionMove( 
            int ActPos,
            float Speed,
            float Acc) = 0;
    ...
    typedef struct IStageVtbl
    {
        ...
        /* [helpstring] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *ZPrecisionMove )( 
            IStage __RPC_FAR * This,
            int ActPos,
            float Speed,
            float Acc);
...
#define IStage_ZPrecisionMove(This,ActPos,Speed,Acc)	\
    (This)->lpVtbl -> ZPrecisionMove(This,ActPos,Speed,Acc)
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IStage_ZPrecisionMove_Proxy( 
    IStage __RPC_FAR * This,
    int ActPos,
    float Speed,
    float Acc);
...
void __RPC_STUB IStage_ZPrecisionMove_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
#define IStage2_ZPrecisionMove(This,ActPos,Speed,Acc)	\
    (This)->lpVtbl -> ZPrecisionMove(This,ActPos,Speed,Acc)
...
#define IStage3_ZPrecisionMove(This,ActPos,Speed,Acc)	\
    (This)->lpVtbl -> ZPrecisionMove(This,ActPos,Speed,Acc)
...
#ifndef __FOGSTAGELib_LIBRARY_DEFINED__
#define __FOGSTAGELib_LIBRARY_DEFINED__

/* library FOGSTAGELib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_FOGSTAGELib;

EXTERN_C const CLSID CLSID_FogStage4;

#ifdef __cplusplus

class DECLSPEC_UUID("15475b87-c804-4b7f-bdb3-9a356ee3630d")
FogStage4;
#endif
#endif /* __FOGSTAGELib_LIBRARY_DEFINED__ */
