...
const CInterfaceProxyVtbl * _FragmentLinker_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IFragmentLinkerProxyVtbl,
    0
};

const CInterfaceStubVtbl * _FragmentLinker_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IFragmentLinkerStubVtbl,
    0
};

PCInterfaceName const _FragmentLinker_InterfaceNamesList[] = 
{
    "IFragmentLinker",
    0
};
...
#define _FragmentLinker_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _FragmentLinker, pIID, n)

int __stdcall _FragmentLinker_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_FragmentLinker_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo FragmentLinker_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _FragmentLinker_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _FragmentLinker_StubVtblList,
    (const PCInterfaceName * ) & _FragmentLinker_InterfaceNamesList,
    0, // no delegation
    & _FragmentLinker_IID_Lookup, 
    1,
    2,
