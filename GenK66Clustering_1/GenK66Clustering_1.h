...
#ifndef __GenK66Clustering_1_h__
#define __GenK66Clustering_1_h__
...
#ifndef __IBoundedClusterFinder_FWD_DEFINED__
#define __IBoundedClusterFinder_FWD_DEFINED__
typedef interface IBoundedClusterFinder IBoundedClusterFinder;
#endif 	/* __IBoundedClusterFinder_FWD_DEFINED__ */


#ifndef __GenK66_1_FWD_DEFINED__
#define __GenK66_1_FWD_DEFINED__

#ifdef __cplusplus
typedef class GenK66_1 GenK66_1;
#else
typedef struct GenK66_1 GenK66_1;
#endif /* __cplusplus */

#endif 	/* __GenK66_1_FWD_DEFINED__ */
...
#ifndef __IBoundedClusterFinder_INTERFACE_DEFINED__
#define __IBoundedClusterFinder_INTERFACE_DEFINED__

/* interface IBoundedClusterFinder */
/* [unique][helpstring][uuid][object] */ 


EXTERN_C const IID IID_IBoundedClusterFinder;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("57FB9192-0F6A-4263-87E4-D14B392644F0")
    IBoundedClusterFinder : public IUnknown
    {
    public:
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetBoundedClusters( 
            BYTE __RPC_FAR *pImage,
            BoundedCluster __RPC_FAR *pSpace,
            int __RPC_FAR *pMaxNumber,
            BYTE Threshold,
            BYTE __RPC_FAR *pBinaryImage) = 0;
    ...
    typedef struct IBoundedClusterFinderVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            IBoundedClusterFinder __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        /* [helpstring] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetBoundedClusters )( 
            IBoundedClusterFinder __RPC_FAR * This,
            BYTE __RPC_FAR *pImage,
            BoundedCluster __RPC_FAR *pSpace,
            int __RPC_FAR *pMaxNumber,
        ...
        END_INTERFACE
    } IBoundedClusterFinderVtbl;

    interface IBoundedClusterFinder
    {
        CONST_VTBL struct IBoundedClusterFinderVtbl __RPC_FAR *lpVtbl;
    };
...
#define IBoundedClusterFinder_QueryInterface(This,riid,ppvObject)	\
    (This)->lpVtbl -> QueryInterface(This,riid,ppvObject)

#define IBoundedClusterFinder_AddRef(This)	\
    (This)->lpVtbl -> AddRef(This)

#define IBoundedClusterFinder_Release(This)	\
    (This)->lpVtbl -> Release(This)


#define IBoundedClusterFinder_GetBoundedClusters(This,pImage,pSpace,pMaxNumber,Threshold,pBinaryImage)	\
    (This)->lpVtbl -> GetBoundedClusters(This,pImage,pSpace,pMaxNumber,Threshold,pBinaryImage)
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IBoundedClusterFinder_GetBoundedClusters_Proxy( 
    IBoundedClusterFinder __RPC_FAR * This,
    BYTE __RPC_FAR *pImage,
    BoundedCluster __RPC_FAR *pSpace,
    int __RPC_FAR *pMaxNumber,
...
void __RPC_STUB IBoundedClusterFinder_GetBoundedClusters_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
#endif 	/* __IBoundedClusterFinder_INTERFACE_DEFINED__ */



#ifndef __GENK66CLUSTERING_1Lib_LIBRARY_DEFINED__
#define __GENK66CLUSTERING_1Lib_LIBRARY_DEFINED__

/* library GENK66CLUSTERING_1Lib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_GENK66CLUSTERING_1Lib;

EXTERN_C const CLSID CLSID_GenK66_1;

#ifdef __cplusplus

class DECLSPEC_UUID("4AD314CE-A033-11D3-A47D-A9A77D89893C")
GenK66_1;
#endif
#endif /* __GENK66CLUSTERING_1Lib_LIBRARY_DEFINED__ */
