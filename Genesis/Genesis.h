...
#ifndef __Genesis_FWD_DEFINED__
#define __Genesis_FWD_DEFINED__

#ifdef __cplusplus
typedef class Genesis Genesis;
#else
typedef struct Genesis Genesis;
#endif /* __cplusplus */

#endif 	/* __Genesis_FWD_DEFINED__ */
...
#include "..\Common\FrameGrabberDefs.h"
...
EXTERN_C const IID IID_IFrameGrabber;
    ...
    public:
        ...
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE LoadCursor( 
            unsigned char __RPC_FAR *CursorFile) = 0;
    ...
    typedef struct IFrameGrabberVtbl
    {
        ...
        /* [helpstring] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *LoadCursor )( 
            IFrameGrabber __RPC_FAR * This,
            unsigned char __RPC_FAR *CursorFile);
...
EXTERN_C const CLSID CLSID_Genesis;

#ifdef __cplusplus

class DECLSPEC_UUID("DFFC86AF-7C46-11D3-A47C-C0B889FF7C20")
Genesis;
#endif
