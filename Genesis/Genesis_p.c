...
const CInterfaceProxyVtbl * _Genesis_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _Genesis_StubVtblList[] = 
{
...
PCInterfaceName const _Genesis_InterfaceNamesList[] = 
{
    "IGenesis",
    "ISySalObject",
    "IFrameGrabber",
...
#define _Genesis_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Genesis, pIID, n)

int __stdcall _Genesis_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _Genesis, 4, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _Genesis, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _Genesis, 4, *pIndex )
    
}

const ExtendedProxyFileInfo Genesis_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Genesis_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Genesis_StubVtblList,
    (const PCInterfaceName * ) & _Genesis_InterfaceNamesList,
    0, // no delegation
    & _Genesis_IID_Lookup, 
    4,
    2,
