 ...
 *                01/04/95   15:30:00
 *                Removed _MP_MVP_INTFLG_PKT_DONE from the interrupts
 *                serviced by _MP_MVP_INTFLGS_GENERAL.
 *
 * Notes:
 *
 *******************************************************************/
...
#define _MP_MVP_SEMA_OFFSET                     (0L)
#define _MP_PRIMARY_VIA_SEMA_OFFSET             (_MP_MVP_SEMA_OFFSET+_MP_MAX_SEMA_BY_SECTION)
 ...
 */
#define MP_MVP_INTLVL_FP_INVALID                (_MP_MVP_SEMA_OFFSET + 2L)       /* floating point invalid */
#define MP_MVP_INTLVL_FP_DIV0                   (_MP_MVP_SEMA_OFFSET + 3L)       /* floating point divide by 0 */
#define MP_MVP_INTLVL_INT_OVERFLOW              (_MP_MVP_SEMA_OFFSET + 4L)       /* integer overflow */
#define MP_MVP_INTLVL_FP_OVERFLOW               (_MP_MVP_SEMA_OFFSET + 5L)       /* floating point overflow */
#define MP_MVP_INTLVL_FP_UNDERFLOW              (_MP_MVP_SEMA_OFFSET + 6L)       /* floating point underflow */
#define MP_MVP_INTLVL_FP_INEXACT                (_MP_MVP_SEMA_OFFSET + 7L)       /* floating point inexact */
#define MP_MVP_INTLVL_FRAME_TIMER0              (_MP_MVP_SEMA_OFFSET + 8L)       /* frame timer 0 interrupt */
#define MP_MVP_INTLVL_FRAME_TIMER1              (_MP_MVP_SEMA_OFFSET + 9L)       /* frame timer 1 interrupt */
#define MP_MVP_INTLVL_CLOCK_TIMER               (_MP_MVP_SEMA_OFFSET + 10L)      /* clock timer interrupt */
#define MP_MVP_INTLVL_EXTERNAL1                 (_MP_MVP_SEMA_OFFSET + 11L)      /* external interrupt 1 */
#define MP_MVP_INTLVL_EXTERNAL2                 (_MP_MVP_SEMA_OFFSET + 12L)      /* external interrupt 2 */
#define MP_MVP_INTLVL_MEM_FAULT                 (_MP_MVP_SEMA_OFFSET + 14L)      /* memory fault */
#define MP_MVP_INTLVL_MSGINT_PP0                (_MP_MVP_SEMA_OFFSET + 16L)      /* message interrupt from PP0 */
#define MP_MVP_INTLVL_MSGINT_PP1                (_MP_MVP_SEMA_OFFSET + 17L)      /* message interrupt from PP1 */
#define MP_MVP_INTLVL_MSGINT_PP2                (_MP_MVP_SEMA_OFFSET + 18L)      /* message interrupt from PP2 */
#define MP_MVP_INTLVL_MSGINT_PP3                (_MP_MVP_SEMA_OFFSET + 19L)      /* message interrupt from PP3 */
#define MP_MVP_INTLVL_MSGINT_PP4                (_MP_MVP_SEMA_OFFSET + 20L)      /* message interrupt from PP4 */
#define MP_MVP_INTLVL_MSGINT_PP5                (_MP_MVP_SEMA_OFFSET + 21L)      /* message interrupt from PP5 */
#define MP_MVP_INTLVL_MSGINT_PP6                (_MP_MVP_SEMA_OFFSET + 22L)      /* message interrupt from PP6 */
#define MP_MVP_INTLVL_MSGINT_PP7                (_MP_MVP_SEMA_OFFSET + 23L)      /* message interrupt from PP7 */
#define MP_MVP_INTLVL_MSGINT_MP                 (_MP_MVP_SEMA_OFFSET + 25L)      /* message interrupt from MP */
#define MP_MVP_INTLVL_PKT_DONE                  (_MP_MVP_SEMA_OFFSET + 26L)      /* packet transfer completed */
#define MP_MVP_INTLVL_PKT_BUSY                  (_MP_MVP_SEMA_OFFSET + 27L)      /* packet transfer completed */
#define MP_MVP_INTLVL_PKT_BAD                   (_MP_MVP_SEMA_OFFSET + 28L)      /* bad packet transfer request */
#define MP_MVP_INTLVL_EXTERNAL3                 (_MP_MVP_SEMA_OFFSET + 29L)      /* external interrupt 3 */
#define MP_MVP_INTLVL_EXTERNAL4                 (_MP_MVP_SEMA_OFFSET + 30L)      /* external interrupt 4 */
#define MP_MVP_INTLVL_PPERROR                   (_MP_MVP_SEMA_OFFSET + 31L)      /* PP error interrupt */


/*
 * MP's INTPEN and IE registers -- bit masks for interrupt flags
 */
#define _MP_MVP_INTFLG_FP_INVALID               (1L<<(MP_MVP_INTLVL_FP_INVALID   - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_FP_DIV0                  (1L<<(MP_MVP_INTLVL_FP_DIV0      - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_INT_OVERFLOW             (1L<<(MP_MVP_INTLVL_INT_OVERFLOW - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_FP_OVERFLOW              (1L<<(MP_MVP_INTLVL_FP_OVERFLOW  - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_FP_UNDERFLOW             (1L<<(MP_MVP_INTLVL_FP_UNDERFLOW - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_FP_INEXACT               (1L<<(MP_MVP_INTLVL_FP_INEXACT   - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_FRAME_TIMER0             (1L<<(MP_MVP_INTLVL_FRAME_TIMER0 - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_FRAME_TIMER1             (1L<<(MP_MVP_INTLVL_FRAME_TIMER1 - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_CLOCK_TIMER              (1L<<(MP_MVP_INTLVL_CLOCK_TIMER  - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_EXTERNAL1                (1L<<(MP_MVP_INTLVL_EXTERNAL1    - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_EXTERNAL2                (1L<<(MP_MVP_INTLVL_EXTERNAL2    - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_MEM_FAULT                (1L<<(MP_MVP_INTLVL_MEM_FAULT    - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_MSGINT_PP0               (1L<<(MP_MVP_INTLVL_MSGINT_PP0   - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_MSGINT_PP1               (1L<<(MP_MVP_INTLVL_MSGINT_PP1   - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_MSGINT_PP2               (1L<<(MP_MVP_INTLVL_MSGINT_PP2   - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_MSGINT_PP3               (1L<<(MP_MVP_INTLVL_MSGINT_PP3   - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_MSGINT_PP4               (1L<<(MP_MVP_INTLVL_MSGINT_PP4   - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_MSGINT_PP5               (1L<<(MP_MVP_INTLVL_MSGINT_PP5   - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_MSGINT_PP6               (1L<<(MP_MVP_INTLVL_MSGINT_PP6   - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_MSGINT_PP7               (1L<<(MP_MVP_INTLVL_MSGINT_PP7   - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_MSGINT_MP                (1L<<(MP_MVP_INTLVL_MSGINT_MP    - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_PKT_DONE                 (1L<<(MP_MVP_INTLVL_PKT_DONE     - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_PKT_BUSY                 (1L<<(MP_MVP_INTLVL_PKT_BUSY     - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_PKT_BAD                  (1L<<(MP_MVP_INTLVL_PKT_BAD      - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_EXTERNAL3                (1L<<(MP_MVP_INTLVL_EXTERNAL3    - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_EXTERNAL4                (1L<<(MP_MVP_INTLVL_EXTERNAL4    - _MP_MVP_SEMA_OFFSET))
#define _MP_MVP_INTFLG_PPERROR                  (1L<<(MP_MVP_INTLVL_PPERROR      - _MP_MVP_SEMA_OFFSET))

#define _MP_MVP_INTFLGS_MSGINT_PPS              (_MP_MVP_INTFLG_MSGINT_PP0 | \
                                                 _MP_MVP_INTFLG_MSGINT_PP1 | \
                                                 _MP_MVP_INTFLG_MSGINT_PP2 | \
                                                 _MP_MVP_INTFLG_MSGINT_PP3 | \
                                                 _MP_MVP_INTFLG_MSGINT_PP4 | \
                                                 _MP_MVP_INTFLG_MSGINT_PP5 | \
                                                 _MP_MVP_INTFLG_MSGINT_PP6 | \
                                                 _MP_MVP_INTFLG_MSGINT_PP7)

#define _MP_MVP_INTFLGS_GENERAL                 (_MP_MVP_INTFLG_PPERROR     | \
                                                 _MP_MVP_INTFLG_PKT_BAD     | \
                                                 _MP_MVP_INTFLG_PKT_BUSY    | \
                                                 _MP_MVP_INTFLG_MSGINT_MP   | \
                                                 _MP_MVP_INTFLG_CLOCK_TIMER)

#define _MP_MVP_INTFLGS_EXTERNAL                (_MP_MVP_INTFLG_EXTERNAL4)     /* never use _MP_MVP_INTFLG_EXTERNAL3 */

#define _MP_MVP_INTFLGS_FPU                     (_MP_MVP_INTFLG_FP_INVALID   | \
                                                 _MP_MVP_INTFLG_FP_DIV0      | \
                                                 _MP_MVP_INTFLG_FP_OVERFLOW  | \
                                                 _MP_MVP_INTFLG_FP_UNDERFLOW)
...
#define MP_PVIA_INTLVL_INTHST_UNDEF_6              (_MP_PRIMARY_VIA_SEMA_OFFSET + 6L)
...
#define MP_PVIA_INTLVL_INTMVP_UNDEF_6              (_MP_PRIMARY_VIA_SEMA_OFFSET + 27L)
...
#define MP_DVIA_INTLVL_INTHST_UNDEF_6              (_MP_DISPLAY_VIA_SEMA_OFFSET + 6L)
...
/*
 * Levels assigned to grab module hardware interrupts
 */
