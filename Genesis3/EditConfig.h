...
// Construction
public:
	CEditConfig(CGenesis &g, CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	...
	UINT	m_WinHeight;
	UINT	m_WinWidth;
	float	m_AstygmatismCoefficient;
	BOOL	m_AstygmatismCompensation;
	UINT	m_AstygmatismXCenter;
	UINT	m_AstygmatismYCenter;
	//}}AFX_DATA
