...
OBJECT_ENTRY(CLSID_Genesis3, CGenesis)
END_OBJECT_MAP()
...
STDAPI DllRegisterServer(void)
{
	...
	try
	{
		...
		MyKey.Close();
		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\Genesis3", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_WRITE | KEY_READ) != ERROR_SUCCESS) throw 3;
		MyKey.Close();
		MyKey.Open(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\Genesis3", KEY_WRITE | KEY_READ);
		char CLSIDString[64];
		wsprintf(CLSIDString, "{%08X-%04X-%04X-%02X%02X-%02X%02X%02X%02X%02X%02X}", 
			CLSID_Genesis3.Data1, CLSID_Genesis3.Data2, CLSID_Genesis3.Data3, 
			CLSID_Genesis3.Data4[0], CLSID_Genesis3.Data4[1], CLSID_Genesis3.Data4[2], CLSID_Genesis3.Data4[3], 
			CLSID_Genesis3.Data4[4], CLSID_Genesis3.Data4[5], CLSID_Genesis3.Data4[6], CLSID_Genesis3.Data4[7]);
	...
	catch (...)
	{
		...
		MyKey.RecurseDeleteKey("Software\\SySal2\\Classes\\Genesis3");
		MyKey.Close();
		};
