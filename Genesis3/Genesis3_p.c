...
#define PROC_FORMAT_STRING_SIZE   2193                              
...
const CInterfaceProxyVtbl * _Genesis3_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _Genesis3_StubVtblList[] = 
{
...
PCInterfaceName const _Genesis3_InterfaceNamesList[] = 
{
    "IGenesis",
    "ISySalObject",
    "IFrameGrabber",
...
#define _Genesis3_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Genesis3, pIID, n)

int __stdcall _Genesis3_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _Genesis3, 5, 4 )
    IID_BS_LOOKUP_NEXT_TEST( _Genesis3, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _Genesis3, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _Genesis3, 5, *pIndex )
    
}

const ExtendedProxyFileInfo Genesis3_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Genesis3_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Genesis3_StubVtblList,
    (const PCInterfaceName * ) & _Genesis3_InterfaceNamesList,
    0, // no delegation
    & _Genesis3_IID_Lookup, 
    5,
    2,
