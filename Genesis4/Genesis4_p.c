...
#define PROC_FORMAT_STRING_SIZE   2321                              
...
#ifndef _ALPHA_
/* 2082 */	NdrFcShort( 0xc ),	/* x86, MIPS, PPC Stack size/offset = 12 */
#else
			NdrFcShort( 0x18 ),	/* Alpha Stack size/offset = 24 */
#endif
...
/* 2090 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
/* 2108 */	NdrFcShort( 0xb ),	/* 11 */
#ifndef _ALPHA_
/* 2110 */	NdrFcShort( 0xc ),	/* x86, MIPS, PPC Stack size/offset = 12 */
#else
			NdrFcShort( 0x18 ),	/* Alpha Stack size/offset = 24 */
#endif
/* 2112 */	NdrFcShort( 0x8 ),	/* 8 */
/* 2114 */	NdrFcShort( 0x8 ),	/* 8 */
/* 2116 */	0x4,		/* Oi2 Flags:  has return, */
			0x2,		/* 2 */
...
#ifndef _ALPHA_
/* 2120 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
#else
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 2122 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 2126 */	NdrFcShort( 0x8 ),	/* x86, MIPS, PPC Stack size/offset = 8 */
#else
			NdrFcShort( 0x10 ),	/* Alpha Stack size/offset = 16 */
#endif
/* 2128 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 2138 */	NdrFcShort( 0x10 ),	/* x86, MIPS, PPC Stack size/offset = 16 */
#else
			NdrFcShort( 0x20 ),	/* Alpha Stack size/offset = 32 */
#endif
/* 2140 */	NdrFcShort( 0x10 ),	/* 16 */
/* 2142 */	NdrFcShort( 0x8 ),	/* 8 */
/* 2144 */	0x4,		/* Oi2 Flags:  has return, */
			0x3,		/* 3 */
...
#ifndef _ALPHA_
/* 2148 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
#else
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 2150 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 2154 */	NdrFcShort( 0x8 ),	/* x86, MIPS, PPC Stack size/offset = 8 */
#else
			NdrFcShort( 0x10 ),	/* Alpha Stack size/offset = 16 */
#endif
/* 2156 */	0x8,		/* FC_LONG */
...
/* 2170 */	NdrFcShort( 0xd ),	/* 13 */
#ifndef _ALPHA_
/* 2172 */	NdrFcShort( 0xc ),	/* x86, MIPS, PPC Stack size/offset = 12 */
#else
			NdrFcShort( 0x18 ),	/* Alpha Stack size/offset = 24 */
#endif
/* 2174 */	NdrFcShort( 0x5 ),	/* 5 */
/* 2176 */	NdrFcShort( 0x8 ),	/* 8 */
/* 2178 */	0x4,		/* Oi2 Flags:  has return, */
			0x2,		/* 2 */

	/* Parameter pImage */

/* 2180 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
#ifndef _ALPHA_
/* 2222 */	NdrFcShort( 0x14 ),	/* x86, MIPS, PPC Stack size/offset = 20 */
#else
			NdrFcShort( 0x20 ),	/* Alpha Stack size/offset = 32 */
#endif
/* 2224 */	NdrFcShort( 0x8 ),	/* 8 */
/* 2226 */	NdrFcShort( 0x8 ),	/* 8 */
/* 2228 */	0x6,		/* Oi2 Flags:  clt must size, has return, */
			0x3,		/* 3 */
...
/* 2236 */	NdrFcShort( 0x8b ),	/* Flags:  must size, must free, in, by val, */
#ifndef _ALPHA_
/* 2238 */	NdrFcShort( 0x8 ),	/* x86, MIPS, PPC Stack size/offset = 8 */
#else
			NdrFcShort( 0x10 ),	/* Alpha Stack size/offset = 16 */
#endif
/* 2240 */	NdrFcShort( 0xdc ),	/* Type Offset=220 */

	/* Return value */

/* 2242 */	NdrFcShort( 0x70 ),	/* Flags:  out, return, base type, */
#ifndef _ALPHA_
/* 2244 */	NdrFcShort( 0x10 ),	/* x86, MIPS, PPC Stack size/offset = 16 */
#else
			NdrFcShort( 0x18 ),	/* Alpha Stack size/offset = 24 */
#endif
/* 2246 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 2278 */	NdrFcShort( 0x8 ),	/* x86, MIPS, PPC Stack size/offset = 8 */
#else
			NdrFcShort( 0x10 ),	/* Alpha Stack size/offset = 16 */
#endif
...
/* 2308 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
const CInterfaceProxyVtbl * _Genesis4_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _Genesis4_StubVtblList[] = 
{
...
PCInterfaceName const _Genesis4_InterfaceNamesList[] = 
{
...
#define _Genesis4_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Genesis4, pIID, n)

int __stdcall _Genesis4_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _Genesis4, 7, 4 )
    IID_BS_LOOKUP_NEXT_TEST( _Genesis4, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _Genesis4, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _Genesis4, 7, *pIndex )
    
}

const ExtendedProxyFileInfo Genesis4_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Genesis4_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Genesis4_StubVtblList,
    (const PCInterfaceName * ) & _Genesis4_InterfaceNamesList,
    0, // no delegation
    & _Genesis4_IID_Lookup, 
    7,
    2,
