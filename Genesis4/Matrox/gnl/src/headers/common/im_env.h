...
#if (defined(__IMAPI_H__) || defined(__IMAGE2_H__)) && !defined(_IM_HOST_OS_DOS) && !defined(_IM_HOST_OS_NT) && !defined(_IM_HOST_OS_QNX4) && !defined(_IM_HOST_OS_LINUX) && !defined(_IM_HOST_OS_NTO) && !defined(_IM_HOST_OS_NTO_DRIVER) && !defined(_IM_LOCAL_CODE) && !defined(_IM_HOST_OS_VPLUS)
...
#pragma pack( 1 )             /* pop is in imapi.h */
