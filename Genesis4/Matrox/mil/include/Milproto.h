...
MFTYPE32 long MFTYPE    MbufDiskInquire      (LPMILSTR FileName,
                                              long InquireType,
                                              void MPTYPE *ResultPtr);

MFTYPE32 void MFTYPE    MbufSave             (LPMILSTR FileName,
                                              MIL_ID BufId);

MFTYPE32 MIL_ID MFTYPE  MbufRestore          (LPMILSTR FileName,
                                              MIL_ID SystemId,
                                              MIL_ID MPTYPE *IdVarPtr);

MFTYPE32 void MFTYPE    MbufLoad             (LPMILSTR FileName,
                                              MIL_ID BufId);

MFTYPE32 MIL_ID MFTYPE  MbufImport           (LPMILSTR FileName,
                                              MIL_ID FileFormatId,
                                              long Operation,
                                              MIL_ID SystemId,
                                              MIL_ID MPTYPE *IdVarPtr);

MFTYPE32 void MFTYPE    MbufExport           (LPMILSTR FileName,
                                              MIL_ID FileFormatId,
                                              MIL_ID srcBufId);
...
MFTYPE32 void MFTYPE    MbufCompression      (MIL_ID SrcImageId,
                                              ...
                                              long ControlValue,
                                              long OperationFlag);
MFTYPE32 void MFTYPE    MbufExportSequence   (LPMILSTR FileName,
                                              MIL_ID FileFormatId,  
                                              MIL_ID *BufArrayPtr,
                                              long NumberOfFrames,
                                              double FrameRate,
                                              long ControlFlag);
MFTYPE32 void MFTYPE    MbufImportSequence   (LPMILSTR FileName,
                                              MIL_ID FileFormatId,
                                              long Operation,
                                              MIL_ID SystemId,  
                                              MIL_ID *BufArrayPtr,
...
/***************************************************************************/
MFTYPE32 MIL_ID MFTYPE MfuncAlloc(LPMILSTR FunctionName, long NumOfParam);
...
MFTYPE32 long MFTYPE MfuncErrorReport(MIL_ID FuncId,
                                      long ErrorCode,
                                      LPMILSTR ErrorString,
                                      LPMILSTR ErrorSubString1,
                                      LPMILSTR ErrorSubString2,
                                      LPMILSTR ErrorSubString3);
...
MFTYPE32 long  MFTYPE MfuncPrintMessage(long Mode, LPMILSTR Str1,
                                        LPMILSTR Str2 ,
                                        LPMILSTR Str3 ,
                                        LPMILSTR Str4 ,
                                        LPMILSTR Str5);
...
MFTYPE32 void MFTYPE    MimBayer             (MIL_ID SrcImageId, 
                                              MIL_ID DstImageId,
                                              long OverscanEnabled);
