...
#ifndef __FlexMap3_h__
#define __FlexMap3_h__
...
EXTERN_C const IID IID_ISheetMap2;
    ...
    typedef struct ISheetMap2Vtbl
    {
        ...
        /* [helpstring] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *ReadLabels )( 
            ISheetMap2 __RPC_FAR * This,
            BYTE __RPC_FAR *pData,
            HSySalHWND hWnd,
            HSySalHANDLE hNotifyStatusChangeEvent,
    ...
    interface ISheetMap2
    {
        CONST_VTBL struct ISheetMap2Vtbl __RPC_FAR *lpVtbl;
    };
...
class DECLSPEC_UUID("21f86780-9e04-4b5a-8ab0-be55324534d3")
FlexibleMap;
#endif
