...
protected:
	float CalculateAverageInCircle(BYTE *pImage,int W,int H,int iXC,int iYC, int Diam);
	IO_MarkMap * ReadMapFromString(char *str);
	IO_MarkMap * ReadMapExtFromString(char *str);
	IO_MarkMap * ReadMapLabExtFromString(char *str, char *labexts, int *Nlabels);
	ConnectionName Name;
