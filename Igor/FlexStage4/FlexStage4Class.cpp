...
// By I.Kreslo
		flex_configure_encoder_filter(C.BoardId, 1, 0);
		flex_configure_encoder_filter(C.BoardId, 2, 0);
		flex_configure_encoder_filter(C.BoardId, 3, 0);
...
//I.Kreslo:
	flex_config_mc_criteria(C.BoardId, 3, 21, /*0x11,*/ 20/*p.Traj.DeadBand.Z * C.ZMicronsToSteps*/, 0, 0);
	flex_config_mc_criteria(C.BoardId, 1, 21, /*0x11,*/ 20/*p.Traj.DeadBand.X * C.XYMicronsToSteps*/, 0, 0);
	flex_config_mc_criteria(C.BoardId, 2, 21, /*0x11,*/ 20/*p.Traj.DeadBand.Y * C.XYMicronsToSteps*/, 0, 0);
