...
const CInterfaceProxyVtbl * _LyonTracker_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _LyonTracker_StubVtblList[] = 
{
...
PCInterfaceName const _LyonTracker_InterfaceNamesList[] = 
{
    "ITracker2",
    "ITracker",
    "ITracker3",
...
#define _LyonTracker_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _LyonTracker, pIID, n)

int __stdcall _LyonTracker_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _LyonTracker, 4, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _LyonTracker, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _LyonTracker, 4, *pIndex )
    
}

const ExtendedProxyFileInfo LyonTracker_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _LyonTracker_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _LyonTracker_StubVtblList,
    (const PCInterfaceName * ) & _LyonTracker_InterfaceNamesList,
    0, // no delegation
    & _LyonTracker_IID_Lookup, 
    4,
    2,
