...
int CMeteorII::GetSegments(BYTE *ScanLine, unsigned Length, Segment *SegSpace, PrecompSegmentBlock *PrecData)
{
	/* 
		REGISTERS USAGE 
...
IntCluster *CMeteorII::ChainSegments(Segment *Line1, Segment *Line2, unsigned short SegNum1,
...
DWORD CMeteorII::GetClusters(BYTE *ImageBuffer, PrecompSegmentBlock *PrecompData, Cluster *pSpace, int *pMaxNumber, 
