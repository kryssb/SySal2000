...
/*********************************/
IM_EXTC void IM_FTYPE imAppCatchError(long Mode, void (*handler)(void *), void IM_PTYPE *HandlerParam) IM_LFTYPE;
IM_EXTC void IM_FTYPE imAppControl(long Item, double Value) IM_LFTYPE;
IM_EXTC long IM_FTYPE imAppGetError(long Item, void IM_PTYPE *ValuePtr) IM_LFTYPE;
IM_EXTC long IM_FTYPE imAppInquire(long Item, void IM_PTYPE *ValuePtr) IM_LFTYPE;

/*********************************/
/* Device allocation functions   */
/*********************************/

IM_EXTC void IM_FTYPE imDevAlloc(long System, long ProcessingNode, char *ShellFile, long Mode, long IM_PTYPE *DevPtr) IM_LFTYPE;
...
IM_EXTC long IM_FTYPE imDevInquire(long Dev, long Item, void IM_PTYPE *ValuePtr) IM_LFTYPE;

/*********************************/
/* Thread control functions      */
/*********************************/

IM_EXTC void IM_FTYPE imThrAlloc(long Dev, long Control, long IM_PTYPE *ThreadPtr) IM_LFTYPE;
...
IM_EXTC long IM_FTYPE imThrGetError(long Thread, long Item,void IM_PTYPE *ValuePtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imThrHalt(long Thread, long Mode) IM_LFTYPE;
IM_EXTC long IM_FTYPE imThrInquire(long Thread, long Item, void IM_PTYPE *ValuePtr) IM_LFTYPE;
...
IM_EXTC void IM_FTYPE imSyncAlloc(long Thread, long IM_PTYPE *OSBPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imSyncFree(long Thread, long OSB) IM_LFTYPE;
IM_EXTC long IM_FTYPE imSyncGetError(long Thread, long OSB, long Item,void IM_PTYPE *ValuePtr) IM_LFTYPE;
...
IM_EXTC void IM_FTYPE imBufAlloc(long Thread, long Xsize, long Ysize, long Nbands, long Type, long Location, long IM_PTYPE *BufPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufAlloc2d(long Thread, long Xsize, long Ysize, long Type, long Location, long IM_PTYPE *BufPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufAlloc1d(long Thread, long Xsize, long Type, long Location, long IM_PTYPE *BufPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufAllocControl(long Thread, long IM_PTYPE *BufPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufChild(long Thread, long Buf, long Xstart, long Ystart, long Xsize, long Ysize, long IM_PTYPE *ChildPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufChildBand(long Thread, long Buf, long BandNum, long IM_PTYPE *BandPtr) IM_LFTYPE;
...
IM_EXTC void IM_FTYPE imBufClone(long Thread, long Buf, long NewLocation, long IM_PTYPE *NewBufPtr) IM_LFTYPE;
...
IM_EXTC void IM_FTYPE imBufGet(long Thread, long Buf, void IM_PTYPE *Ptr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufGet1d(long Thread, long Buf, long Xstart, long Xsize, void IM_PTYPE *Ptr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufGet2d(long Thread, long Buf, long Xstart, long Ystart, long Xsize, long Ysize, void IM_PTYPE *Ptr) IM_LFTYPE;
IM_EXTC long IM_FTYPE imBufGetField(long Thread, long Buf, long Tag, long IM_PTYPE *ValuePtr) IM_LFTYPE;
IM_EXTC long IM_FTYPE imBufGetFieldDouble(long Thread, long Buf, long Tag, double IM_PTYPE *ValuePtr) IM_LFTYPE;
IM_EXTC long IM_FTYPE imBufGetNextField(long Thread, long Buf, long IM_PTYPE *ContextPtr, long IM_PTYPE *TagPtr, double IM_PTYPE *ValuePtr) IM_LFTYPE;
IM_EXTC long IM_FTYPE imBufInquire(long Thread, long Buf, long Item,void IM_PTYPE *ValuePtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufLoad(long Thread, char IM_PTYPE *FileName, long Format, long Buf) IM_LFTYPE;
IM_EXTC long IM_FTYPE imBufMap(long Thread, long Buf,long Band,long Ystart, void IM_PTYPE **AddrPtr, long IM_PTYPE *PitchPtr, long IM_PTYPE *NlinesPtr) IM_LFTYPE; 
...
IM_EXTC void IM_FTYPE imBufPut(long Thread, long Buf, void IM_PTYPE *Ptr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufPut1d(long Thread, long Buf, long Xstart, long Xsize, void IM_PTYPE *Ptr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufPut2d(long Thread, long Buf, long Xstart, long Ystart, long Xsize, long Ysize, void IM_PTYPE *Ptr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufPutField(long Thread, long Buf, long Tag, double Value) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufPutFormatted(long Thread, long Buf, long Control, void IM_PTYPE *Ptr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufRemoveField(long Thread, long Buf, long Tag) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufSave(long Thread, char IM_PTYPE *FileName, long Format, long Buf) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBufRestore(long Thread, char IM_PTYPE *FileName, long Format, long Location, long IM_PTYPE *BufPtr) IM_LFTYPE;
...
IM_EXTC void IM_FTYPE imCamAlloc(long Thread, char IM_PTYPE *CamFile,long Mode, long IM_PTYPE *CameraPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imCamClone(long Thread,long Camera,long Mode,long IM_PTYPE *NewCamPtr) IM_LFTYPE;
...
IM_EXTC long IM_FTYPE imCamInquire(long Thread, long Camera, long Item, void IM_PTYPE *ValuePtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imCamSave(long Thread, char IM_PTYPE *CamFile, long Camera) IM_LFTYPE;
IM_EXTC void IM_FTYPE imDigAlloc(long Thread, long System,long Digitizer,long Mode,long IM_PTYPE *DigPtr) IM_LFTYPE;
...
IM_EXTC long IM_FTYPE imDigInquire(long Thread,long Dig, long Item, void IM_PTYPE *ValuePtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imDigFree(long Thread,long Dig) IM_LFTYPE;
IM_EXTC void IM_FTYPE imDigConvert(long Thread, long Src, long Dst, long Type, long Control, long Osb) IM_LFTYPE;
...
IM_EXTC void IM_FTYPE imDispAlloc(long Thread, long System, long Display, char IM_PTYPE *DispFile, long Mode,long IM_PTYPE *DispPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imDispControl(long Thread, long Disp,long Control,long Mode) IM_LFTYPE;
IM_EXTC long IM_FTYPE imDispInquire(long Thread,long Disp,long Item,void IM_PTYPE *ValuePtr) IM_LFTYPE;
...
/********************************/
IM_EXTC void IM_FTYPE imGen1d(long Thread, long Buf, long Func, long Start, long End, long NumCoeffs, double IM_PTYPE *Coeffs, long OSB) IM_LFTYPE;
...
IM_EXTC void IM_FTYPE imGraText(long Thread,long Context,long Buf, long Xstart,long Ystart,char IM_PTYPE *String) IM_LFTYPE;

/*******************************/
/* JPEG functions              */
/*******************************/
IM_EXTC void IM_FTYPE imJpegAlloc(long Thread,long Control,long IM_PTYPE *JpegPtr) IM_LFTYPE;
...
IM_EXTC void IM_FTYPE imJpegPutTable(long Thread,long Jpeg,long TableType,long TableNum,long TableSize,void IM_PTYPE *TablePtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imJpegWrite(long Thread,FILE *FileHandle,long Jpeg) IM_LFTYPE;
IM_EXTC void IM_FTYPE imJpegSave(long Thread,char IM_PTYPE *FileName,long Jpeg) IM_LFTYPE;
IM_EXTC void IM_FTYPE imJpegDecode(long Thread,long Buf,long Jpeg,long OSB) IM_LFTYPE;
IM_EXTC long IM_FTYPE imJpegInquire(long Thread,long Jpeg,long Item,void IM_PTYPE *ValuePtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imJpegRead(long Thread,FILE *FileHandle,long Jpeg) IM_LFTYPE;
IM_EXTC void IM_FTYPE imJpegRestore(long Thread,char IM_PTYPE *FileName,long IM_PTYPE *JpegPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imJpegGetTable(long Thread,long Jpeg,long TableType,long TableNum,long *TableSize,void IM_PTYPE *TablePtr) IM_LFTYPE;
...
/*******************************/
IM_EXTC void IM_FTYPE imPatAllocAutoModel(long Thread, long SrcBuf, long XSize, long YSize, long XUncert, long YUncert, long Type, long Mode, long IM_PTYPE *ModelPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imPatAllocModel(long Thread, long SrcBuf, long XOff, long YOff, long XSize, long YSize, long Type, long IM_PTYPE *ModelPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imPatAllocResult(long Thread, long NumEntries, long IM_PTYPE *ResultPtr) IM_LFTYPE;
...
/* IM_EXTC void IM_FTYPE imPatFindMultipleModel(long Thread, long SrcBuf, long IM_PTYPE *Model, long IM_PTYPE *Result, long NumModels, long Mode, long OSB) IM_LFTYPE; */
IM_EXTC void IM_FTYPE imPatFree(long Thread, long ModelOrResult) IM_LFTYPE;
IM_EXTC long IM_FTYPE imPatGetNumber(long Thread, long Result, long IM_PTYPE *NumPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imPatGetResult(long Thread, long Result, long Type, void IM_PTYPE *Ptr) IM_LFTYPE;
IM_EXTC long IM_FTYPE imPatInquire(long Thread, long ModelOrResult, long Item, void IM_PTYPE *ValuePtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imPatPreprocModel(long Thread, long Buf, long Model, long Mode, long OSB) IM_LFTYPE;
IM_EXTC void IM_FTYPE imPatRead(long Thread, FILE IM_PTYPE *FileHandle, long IM_PTYPE *ModelPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imPatRestore(long Thread, char IM_PTYPE *FileName, long IM_PTYPE *ModelPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imPatSave(long Thread, char IM_PTYPE *FileName, long Model) IM_LFTYPE;
...
IM_EXTC void IM_FTYPE imPatWrite(long Thread, FILE IM_PTYPE *FileHandle, long Model) IM_LFTYPE;

/****************************/
/* Blob Analysis Module     */
/****************************/
IM_EXTC void IM_FTYPE imBlobAllocFeatureList(long Thread, long IM_PTYPE *FeatListPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBlobAllocResult(long Thread, long IM_PTYPE *ResultPtr) IM_LFTYPE;
...
IM_EXTC long IM_FTYPE imBlobGetLabel(long Thread, long Result, long XPos, long YPos, long IM_PTYPE *LabelPtr) IM_LFTYPE;
IM_EXTC long IM_FTYPE imBlobGetNumber(long Thread, long Result, long IM_PTYPE *NumPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBlobGetResult(long Thread, long Result, long Feature, long Mode, void IM_PTYPE *ArrayPtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBlobGetResultSingle(long Thread, long Result, long Label, long Feature, long Mode, void IM_PTYPE *ValuePtr) IM_LFTYPE;
IM_EXTC void IM_FTYPE imBlobGetRuns(long Thread, long Result, long Label, long Type, void IM_PTYPE *XPtr, void IM_PTYPE *YPtr, void IM_PTYPE *LenPtr) IM_LFTYPE;
IM_EXTC long IM_FTYPE imBlobInquire(long Thread, long Result, long Item, void IM_PTYPE *ValuePtr) IM_LFTYPE;
...
IM_EXTC long IM_FTYPE   imSysInquire(long System,long Item,void IM_PTYPE *ValuePtr) IM_LFTYPE;
IM_EXTC double IM_FTYPE imSysClock(long Thread,double Offset) IM_LFTYPE;
IM_EXTC long IM_FTYPE   imSysGetMemoryMap(long Thread,long item, long * result) IM_LFTYPE;
...
/*******************************/
IM_EXTC void IM_FTYPE imMilPpcComm(long Thread, long DatagramSize, void IM_PTYPE *DatagramPtr, long IsAsynchrone) IM_LFTYPE;
