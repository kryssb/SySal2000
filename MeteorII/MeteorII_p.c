...
const CInterfaceProxyVtbl * _MeteorII_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _MeteorII_StubVtblList[] = 
{
...
PCInterfaceName const _MeteorII_InterfaceNamesList[] = 
{
    "ISySalObject",
    "IFrameGrabber",
    "IVisionProcessor",
...
#define _MeteorII_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _MeteorII, pIID, n)

int __stdcall _MeteorII_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _MeteorII, 4, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _MeteorII, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _MeteorII, 4, *pIndex )
    
}

const ExtendedProxyFileInfo MeteorII_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _MeteorII_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _MeteorII_StubVtblList,
    (const PCInterfaceName * ) & _MeteorII_InterfaceNamesList,
    0, // no delegation
    & _MeteorII_IID_Lookup, 
    4,
    2,
