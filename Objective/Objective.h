...
#ifndef __Objective_FWD_DEFINED__
#define __Objective_FWD_DEFINED__

#ifdef __cplusplus
typedef class Objective Objective;
#else
typedef struct Objective Objective;
#endif /* __cplusplus */

#endif 	/* __Objective_FWD_DEFINED__ */
...
#ifndef __OBJECTIVELib_LIBRARY_DEFINED__
#define __OBJECTIVELib_LIBRARY_DEFINED__

/* library OBJECTIVELib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_OBJECTIVELib;

EXTERN_C const CLSID CLSID_Objective;

#ifdef __cplusplus

class DECLSPEC_UUID("E056524E-7CFD-11D3-A47C-AC71B6A41C20")
Objective;
#endif
#endif /* __OBJECTIVELib_LIBRARY_DEFINED__ */
