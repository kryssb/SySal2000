...
#ifndef __Odyssey2_h__
#define __Odyssey2_h__
...
EXTERN_C const IID IID_IVisionProcessor4;
    ...
    public:
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE VPWaitForProcessingCompleteAndExtractImages( 
            BYTE __RPC_FAR *__RPC_FAR *ppImages) = 0;
    ...
    typedef struct IVisionProcessor4Vtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            IVisionProcessor4 __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        /* [helpstring] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *VPWaitForProcessingCompleteAndExtractImages )( 
            IVisionProcessor4 __RPC_FAR * This,
            BYTE __RPC_FAR *__RPC_FAR *ppImages);
    ...
    interface IVisionProcessor4
    {
        CONST_VTBL struct IVisionProcessor4Vtbl __RPC_FAR *lpVtbl;
    };
...
class DECLSPEC_UUID("a834807a-ea6c-428f-b234-9a12c44b0a31")
Odyssey;
#endif
