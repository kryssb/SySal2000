...
#define PROC_FORMAT_STRING_SIZE   2293                              
...
CINTERFACE_PROXY_VTABLE(4) _IAutomaticLightControlProxyVtbl = 
{
    ...
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *)-1 /* IAutomaticLightControl::SetLightLevel */
};
...
CINTERFACE_PROXY_VTABLE(19) _IVisionProcessor3ProxyVtbl = 
{
    ...
    (void *)-1 /* IVisionProcessor2::VPLock2 */ ,
    (void *)-1 /* IVisionProcessor2::VPGetPrimaryImage */ ,
    (void *)-1 /* IVisionProcessor3::VPPrepareAsyncProcessing */ ,
    (void *)-1 /* IVisionProcessor3::VPStartAsyncProcessing */ ,
    (void *)-1 /* IVisionProcessor3::VPWaitForProcessingComplete */ ,
    (void *)-1 /* IVisionProcessor3::VPGetCurrentImageSequenceDelay */ ,
    (void *)-1 /* IVisionProcessor3::VPWaitForClusters */
};
...
CINTERFACE_PROXY_VTABLE(20) _IVisionProcessor4ProxyVtbl = 
{
    ...
    (void *)-1 /* IVisionProcessor3::VPGetCurrentImageSequenceDelay */ ,
    (void *)-1 /* IVisionProcessor3::VPWaitForClusters */ ,
    (void *)-1 /* IVisionProcessor4::VPWaitForProcessingCompleteAndExtractImages */
};
...
#ifndef _ALPHA_
/* 1804 */	NdrFcShort( 0x30 ),	/* x86, MIPS, PPC Stack size/offset = 48 */
#else
			NdrFcShort( 0x60 ),	/* Alpha Stack size/offset = 96 */
#endif
/* 1806 */	NdrFcShort( 0x50 ),	/* 80 */
...
#ifndef _ALPHA_
/* 1832 */	NdrFcShort( 0x10 ),	/* x86, MIPS, PPC Stack size/offset = 16 */
#else
			NdrFcShort( 0x20 ),	/* Alpha Stack size/offset = 32 */
#endif
/* 1834 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 1838 */	NdrFcShort( 0x14 ),	/* x86, MIPS, PPC Stack size/offset = 20 */
#else
			NdrFcShort( 0x28 ),	/* Alpha Stack size/offset = 40 */
#endif
/* 1840 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 1844 */	NdrFcShort( 0x18 ),	/* x86, MIPS, PPC Stack size/offset = 24 */
#else
			NdrFcShort( 0x30 ),	/* Alpha Stack size/offset = 48 */
#endif
/* 1846 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 1850 */	NdrFcShort( 0x1c ),	/* x86, MIPS, PPC Stack size/offset = 28 */
#else
			NdrFcShort( 0x38 ),	/* Alpha Stack size/offset = 56 */
#endif
/* 1852 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 1856 */	NdrFcShort( 0x20 ),	/* x86, MIPS, PPC Stack size/offset = 32 */
#else
			NdrFcShort( 0x40 ),	/* Alpha Stack size/offset = 64 */
#endif
/* 1858 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 1862 */	NdrFcShort( 0x24 ),	/* x86, MIPS, PPC Stack size/offset = 36 */
#else
			NdrFcShort( 0x48 ),	/* Alpha Stack size/offset = 72 */
#endif
/* 1864 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 1868 */	NdrFcShort( 0x28 ),	/* x86, MIPS, PPC Stack size/offset = 40 */
#else
...
#ifndef _ALPHA_
/* 1874 */	NdrFcShort( 0x2c ),	/* x86, MIPS, PPC Stack size/offset = 44 */
#else
			NdrFcShort( 0x58 ),	/* Alpha Stack size/offset = 88 */
#endif
/* 1876 */	0x8,		/* FC_LONG */
...
/* 1936 */	0x6,		/* Oi2 Flags:  clt must size, has return, */
			0x3,		/* 3 */
...
/* 1940 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 1942 */	NdrFcShort( 0xb4 ),	/* Type Offset=180 */

	/* Parameter pMaxClusters */

/* 1944 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
/* 1970 */	0x6,		/* Oi2 Flags:  clt must size, has return, */
			0x3,		/* 3 */
...
/* 1974 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 1976 */	NdrFcShort( 0xb4 ),	/* Type Offset=180 */

	/* Parameter pMaxClusters */

/* 1978 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
/* 2004 */	0x4,		/* Oi2 Flags:  has return, */
			0x2,		/* 2 */

	/* Parameter pDelay */

/* 2006 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
#ifndef _ALPHA_
/* 2082 */	NdrFcShort( 0x10 ),	/* x86, MIPS, PPC Stack size/offset = 16 */
#else
			NdrFcShort( 0x20 ),	/* Alpha Stack size/offset = 32 */
#endif
...
#ifndef _ALPHA_
/* 2092 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
#else
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 2094 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 2098 */	NdrFcShort( 0x8 ),	/* x86, MIPS, PPC Stack size/offset = 8 */
#else
			NdrFcShort( 0x10 ),	/* Alpha Stack size/offset = 16 */
#endif
/* 2100 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 2104 */	NdrFcShort( 0xc ),	/* x86, MIPS, PPC Stack size/offset = 12 */
#else
			NdrFcShort( 0x18 ),	/* Alpha Stack size/offset = 24 */
#endif
/* 2106 */	0x8,		/* FC_LONG */
...
/* 2164 */	NdrFcShort( 0xe ),	/* 14 */
#ifndef _ALPHA_
/* 2166 */	NdrFcShort( 0x24 ),	/* x86, MIPS, PPC Stack size/offset = 36 */
#else
			NdrFcShort( 0x30 ),	/* Alpha Stack size/offset = 48 */
#endif
...
#ifndef _ALPHA_
/* 2176 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
#else
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 2178 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 2182 */	NdrFcShort( 0x8 ),	/* x86, MIPS, PPC Stack size/offset = 8 */
#else
			NdrFcShort( 0x10 ),	/* Alpha Stack size/offset = 16 */
#endif
/* 2184 */	NdrFcShort( 0xdc ),	/* Type Offset=220 */

	/* Return value */

/* 2186 */	NdrFcShort( 0x70 ),	/* Flags:  out, return, base type, */
#ifndef _ALPHA_
/* 2188 */	NdrFcShort( 0x20 ),	/* x86, MIPS, PPC Stack size/offset = 32 */
#else
			NdrFcShort( 0x28 ),	/* Alpha Stack size/offset = 40 */
#endif
/* 2190 */	0x8,		/* FC_LONG */
...
/* 2250 */	0x4,		/* Oi2 Flags:  has return, */
			0x2,		/* 2 */

	/* Parameter pDelay */

/* 2252 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
/* 2280 */	NdrFcShort( 0x200a ),	/* Flags:  must free, in, srv alloc size=8 */
#ifndef _ALPHA_
/* 2282 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
#else
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 2284 */	NdrFcShort( 0x9c ),	/* Type Offset=156 */
...
/* 210 */	0x12, 0x0,	/* FC_UP */
/* 212 */	NdrFcShort( 0xffffffe0 ),	/* Offset= -32 (180) */
/* 214 */	
			0x5b,		/* FC_END */
...
/* 232 */	0x12, 0x0,	/* FC_UP */
/* 234 */	NdrFcShort( 0xffffffdc ),	/* Offset= -36 (198) */
/* 236 */	
			0x5b,		/* FC_END */
...
const CInterfaceProxyVtbl * _Odyssey2_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _Odyssey2_StubVtblList[] = 
{
...
PCInterfaceName const _Odyssey2_InterfaceNamesList[] = 
{
...
#define _Odyssey2_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Odyssey2, pIID, n)

int __stdcall _Odyssey2_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _Odyssey2, 7, 4 )
    IID_BS_LOOKUP_NEXT_TEST( _Odyssey2, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _Odyssey2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _Odyssey2, 7, *pIndex )
    
}

const ExtendedProxyFileInfo Odyssey2_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Odyssey2_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Odyssey2_StubVtblList,
    (const PCInterfaceName * ) & _Odyssey2_InterfaceNamesList,
    0, // no delegation
    & _Odyssey2_IID_Lookup, 
    7,
    2,
