...
/* TEMPORARY!!! */
			Programs[Count].LastThreshold = Programs[Count].Threshold;
/* End TEMPORARY */
			};
		}
	catch (...)
...
static const int GeneralSettingsDataN = 3;
...
static QueryDataInfo GeneralDataQDI[LightControlDataN] =
{
	...
	{"ProcessingStartDelayPerFrame",ST_FLOAT,	STRUCT_OFFSET(t_GeneralSettings, ProcessingStartDelayPerFrame),	"0"}
};
