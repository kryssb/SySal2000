...
#define MAX_FRAMES_PER_NODE 512
#define MAX_OPTIMIZABLE_FRAMES_PER_NODE 512
...
{	
	...
	int MaxFramesPerNode;
	int MaxOptimizableFramesPerNode;
	...
	long XopSrcBuffs[MAX_FRAMES_PER_NODE][MAX_XOP_BUFFERS];
	long XopDestBuffs[MAX_FRAMES_PER_NODE][MAX_XOP_BUFFERS];
	...
	long SeqOSB;
	long SeqMainBuff;
	long SeqChildBuffs[MAX_FRAMES_PER_NODE];
	long SeqCtlBuff;
