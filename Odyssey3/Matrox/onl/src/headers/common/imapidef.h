...
#define IM_SYS_SHELL_HEADER               8
#define IM_SYS_SHELL_VERSION              9
#define IM_SYS_PRODUCT_LIST_NO_WARNING    10    // Similar to IM_SYS_PRODUCT_LIST but no warning if no board

/* Device inquiries and control */
#define IM_DEV_CPU                        1
#define IM_DEV_CPU_SPEED                  2
#define IM_DEV_VIA_PRIMARY                3
#define IM_DEV_VIA_DISPLAY                4
#define IM_DEV_ACCELERATOR                5
#define IM_DEV_PROC_FPGA                  6
#define IM_DEV_MEM_PROC                   7
#define IM_DEV_MEM_DISP                   8
#define IM_DEV_MEM_OVERLAY                9
#define IM_DEV_MEM_HOST                   10
#define IM_DEV_MEM_FPGA                   11
#define IM_DEV_OWNER_SYSTEM               12
#define IM_DEV_OWNER_NODE                 13
#define IM_DEV_MSG_TOTAL                  14
#define IM_DEV_MSG_FREE                   15
#define IM_DEV_FREE_MEM_PROC              16
#define IM_DEV_FREE_MEM_DISP              17
#define IM_DEV_FREE_MEM_HOST              18
#define IM_DEV_FREE_MEM_PROC_FAST         19
#define IM_DEV_FREE_MEM_PROC_SHARED       20
#define IM_DEV_FREE_MEM_PROC_EXTENDED     IM_DEV_FREE_MEM_PROC   // for legacy code
#define IM_DEV_FREE_MEM_FPGA              22
#define IM_DEV_FREE_HEAP                  23
#define IM_DEV_PRODUCT_ID                 24
#define IM_DEV_PRODUCT_CLASS              25
#define IM_DEV_CUSTOMER_PRODUCT_ID        26
#define IM_DEV_PRODUCT_SERIAL_NUMBER      27
#define IM_DEV_CPU_TYPE                   28
#define IM_DEV_PITCH_GRANULARITY          29
#define IM_DEV_HEAP_SIZE                  30
#define IM_DEV_NUM_OF_STREAMS             31    /* Internal use */
#define IM_DEV_PERCENT_UTILIZATION        32
#define IM_DEV_RAMDISK                    33
#define IM_DEV_TRACING                    34
#define IM_DEV_SET_MEMORY_CALIBRATION     35
#define IM_DEV_HOST_WATCHDOG_TIMEOUT      36
#define IM_DEV_HOST_WATCHDOG_RESET        37
#define IM_DEV_HOST_WATCHDOG_SUSPEND      38
#define IM_DEV_HOST_WATCHDOG_STATE        39
#define IM_DEV_LOCAL_WATCHDOG_TIMEOUT     40
#define IM_DEV_LOCAL_WATCHDOG_RESET       41
#define IM_DEV_LOCAL_WATCHDOG_SUSPEND     42
#define IM_DEV_LOCAL_WATCHDOG_STATE       43
#define IM_DEV_LOCAL_WATCHDOG_ACTION      44
#define IM_DEV_LAST_PROCESS_INT_TO_LOCAL  45
#define IM_DEV_MIN_HEAP_SIZE              46

#define IM_DEV_NONE                       0
#define IM_DEV_PPC                        1

#define IM_SOFT_RESET                     0
#define IM_HARD_RESET                     1
#define IM_MACHINE_CHECK                  2
...
#define IM_DEV_ODYSSEY_PLUS               (IM_DEV_ODYSSEY_CLASS | 12)
...
/* Display control */
#define IM_KEY_OFF                        0
#define IM_KEY_ALWAYS                     71
#define IM_KEY_IN_RANGE                   72
#define IM_KEY_OUT_RANGE                  73
#define IM_KEY_ON_COLOR                   74
#define IM_KEY_ON_BACKGROUND              75

/* VGA Mode */
#define IM_SINGLE_SCREEN                  0
#define IM_DUAL_SCREEN                    1
#define IM_DUAL_HEAD                      2 /* Deprecated  (I think? ) AF*/
#define IM_WINDOWED                       3
#define IM_NO_DISPLAY                     4
#define IM_NO_DISPLAY_AT_ALL              5
#define IM_DESKTOP                        IM_SINGLE_SCREEN
#define IM_AUXILIARY                      IM_DUAL_SCREEN

/* Display attribute */
#define IM_NO_SHOW                        0x01000
#define IM_SHOW                           0x02000
#define IM_DIRECT_COPY                    0x04000
#define IM_NO_DIRECT_COPY                 0x08000
#define IM_NO_TEARING                     0x10000
...
#define IM_LINE_COUNT                     0x2000000
...
#define IM_PROC_EXTENDED            IM_PROC   // for legacy code
#define IM_PROC_FAST                      7
#define IM_PROC_SHARED                    8
#define IM_PROC_FPGA                      9
#define IM_LOCAL                          10  // This case is for imBufCreate when we pass local address
...
#define IM_RGB_TO_RGB10                   0x52
#define IM_RGB_TO_BGR10                   0x53
...
#define IM_BLOB_MAX_BLOBS                 20
#define IM_BLOB_TOO_MANY                  21
...
#define IM_FPGA_LINK_0                    (IM_BUF_PREDEFINED | 0x08)
#define IM_FPGA_LINK_1                    (IM_BUF_PREDEFINED | 0x09)
...
#define _IM_BUF_MASK_PREDEFINED           (~IM_BUF_PREDEFINED & ~_IM_BUF_BUFFER_NODE)


/*******************************************************************
 * Default thread macro to pass/get the priority
 *******************************************************************/
#define _IM_IS_A_DEFAULT_THREAD(p)        (((p) & ~0xf) == _IM_DEFAULT_THREAD)
#define _IM_DEFAULT_THREAD_GET_PRIO(p)    ((p) & 0xF)
#define _IM_DEFAULT_THREAD_PRIO(p)        (_IM_DEFAULT_THREAD | _IM_DEFAULT_THREAD_GET_PRIO(p))
...
#define IM_CTL_LINE_COUNT                 10040
#define IM_CTL_REGULATION                 10041
#define IM_CTL_COMPONENTS                 10042
...
#define IM_RES_NUM_PIXEL                  IM_RES_NUM_PIXELS
...
#define IM_DISP_ZOOM_X                    13016
#define IM_DISP_KEY_COLOR                 13017
#define IM_DISP_WINDOW                    13018
#define IM_DISP_SIZE_X                    13019
#define IM_DISP_SIZE_Y                    13020
#define IM_DISP_WINDOW_START_X            13021
#define IM_DISP_WINDOW_START_Y            13022
#define IM_DISP_POSITION_X                IM_DISP_WINDOW_START_X
#define IM_DISP_POSITION_Y                IM_DISP_WINDOW_START_Y
#define IM_DISP_SIZE_BIT                  13023
#define IM_DISP_NUM_BANDS                 13024
#define IM_DISP_WINDOW_SIZE_X             13025
#define IM_DISP_WINDOW_SIZE_Y             13026
#define IM_DISP_NO_TEARING                13027
#define IM_DISP_NUM_AUXILIARY             13028
#define IM_DISP_NUM_DESKTOP               13029
#define IM_DISP_CRTC_NUM                  13030
#define IM_DISP_WINDOW_UPDATE             13031
...
#define IM_THR_STACK_USED                 15010
#define IM_THR_SHOW_STACK_USED            15011
#define IM_THR_PROC_FPGA                  15012
#define IM_THR_AUTO_FLUSH                 15013
...
#define IM_DIG_EVENT_QUADT                30089
#define IM_DIG_EVENT_BUFOVR               30090
#define IM_DIG_EVENT_UART                 30091
#define IM_DIG_EVENT_SONDF                30092
#define IM_DIG_EVENT_SENDF                30093
#define IM_DIG_EVENT_PFO                  30094
#define IM_DIG_EVENT_USRIN                30095

#define IM_DIG_ENCODER                    30096
#define IM_DIG_ENCODER_EOG                30097
#define IM_DIG_ENC_TCOUNT                 30098

// Number of channels present on a digitizer
#define IM_DIG_NUM_CHANNELS               30099

// Support of new I/O functionnalities
#define IM_DIG_TRIG_FORMAT                30100
#define IM_DIG_EXP_FORMAT                 30101
#define IM_DIG_USER_IN_BITS               30102
#define IM_DIG_USER_OUT_BITS              30103
#define IM_DIG_CC_FORMAT                  30104

#define IM_DIG_MODULE_TYPE                30105
#define IM_DIG_OWNER_NODE                 30106

#define IM_UART_FLUSH                     30107
#define IM_UART_NUM_BYTES                 30108

#define IM_DIG_PLL_MODE                   30109

#define IM_DIG_EVENT_GRBSTP               30110

#define IM_DIG_WAIT_TIMER_LOW             30111
#define IM_DIG_WAIT_TIMER_HIGH            30112
#define IM_DIG_WAIT_USRIN_LOW             30113
#define IM_DIG_WAIT_USRIN_HIGH            30114

#define IM_DIG_USER_CLOCK                 30115

/* Digitizer identification */
#define IM_DIG_NUMBER                     30116

#define IM_DIG_MAX_FREQUENCY              30117
#define IM_DIG_MIN_FREQUENCY              30118
...
#define IM_DIG_LAST_CONTROL               30118
...
#define IM_UART_TIMEOUT_ERROR             0x0001
#define IM_UART_FRAMING_ERROR             0x0002   // do not change, same as Win32
#define IM_UART_OVERRUN_ERROR             0x0008   // do not change, same as Win32
#define IM_UART_PARITY_ERROR              0x0010   // do not change, same as Win32

#define IM_UART_ABORT_READ                0x0001
#define IM_UART_PURGE_READ_BUFFER         0x0002
#define IM_UART_ABORT_WRITE               0x0004
#define IM_UART_PURGE_WRITE_BUFFER        0x0008
...
#define IM_BIT0                           0x01000000  /* Bits can be combined*/
#define IM_BIT1                           0x02000000  /* with channels and with*/
#define IM_BIT2                           0x04000000  /* formats*/
...
#define IM_PCLOCK                         8L
#define IM_OTHER_CHANNEL                  9L          /* Specifies that a timer's trig source is the same timer's output from another AC*/ 
#define IM_TIMER1                         0x01000000  /* Timers can be combined*/
#define IM_TIMER2                         0x02000000  /* with channels */
#define IM_TIMER3                         0x04000000
#define IM_TIMER4                         0x08000000
#define IM_ALL_TIMERS                     (IM_TIMER1|IM_TIMER2|IM_TIMER3|IM_TIMER4)
#define IM_TRIGGER1                       0x00100000  /* Triggers can be combined*/
#define IM_TRIGGER2                       0x00200000  /* with channels */
...
#define IM_TTL                            0x00100000  /* Formats can be combined*/
#define IM_RS422                          0x00200000  /* with bits */
#define IM_OPTO                           0x00400000
