...
IM_EXTC void IM_FTYPE imBufUnmap(long Thread, long Buf, long Mode) IM_LFTYPE;
...
IM_EXTC long   IM_FTYPE imSysGetFpgaCaps(long Thread, long *result1, long *result2) IM_LFTYPE;
...
IM_EXTC void IM_FTYPE imStreamAlloc(long Thread, long Src, long Dst, long Mode, long *StreamPtr);
IM_EXTC void IM_FTYPE imStreamFree(long Thread, long Stream);
IM_EXTC void IM_FTYPE imStreamWait(long Thread, long Stream);
