...
/* Semaphore signals for all Odyssey sources                      */
/* -------------------------------------------------------------- */
/* 64 (  0 to  63) are for the control                            */
/* 64 ( 64 to 127) are for the start of frame                     */
/* 64 (128 to 191) are for the line interrupt                     */
/* 64 (192 to 255) are for the end of window                      */
/* 64 (256 to 319) are for the end of frame                       */
/* 64 (320 to 383) are general purpose                            */

#define _IM_MAX_GENERAL_SIGNALS                 (64)
#define _IM_MAX_VALID_INTERRUPT_SOURCES         (6 * _IM_MAX_GENERAL_SIGNALS)         /* see intlevel.h also */

// WARNING:  _MP_SECTION_SHIFT is not the actual number of sections
//          even though there is actually 6 valid sections
#define _MP_SECTION_SHIFT                    6                             // 2^6 = 64 bits/section
#define _MP_MAX_SEMA_BY_SECTION              (1<<_MP_SECTION_SHIFT)        // 2^_MP_SECTION_SHIFT
#define _MP_INTLVL_MASK                      (_MP_MAX_SEMA_BY_SECTION-1)

/* Each section use _MP_MAX_SEMA_BY_SECTION semaphores */
...
#define MP_OASIS_INTLVL_DISPLAYHOST          MP_OASIS_INTLVL_GPR(1)  /* display interrupt to the host */
#define MP_OASIS_INTFLG_DISPLAYHOST          MP_OASIS_INTFLG_GPR(1)
#define MP_OASIS_INTLVL_UARTPPC              MP_OASIS_INTLVL_GPR(2)  /* Communication interrupt to the local */
#define MP_OASIS_INTFLG_UARTPPC              MP_OASIS_INTFLG_GPR(2)
#define MP_OASIS_INTLVL_UARTHOST             MP_OASIS_INTLVL_GPR(3)  /* Communication interrupt to the host */
#define MP_OASIS_INTFLG_UARTHOST             MP_OASIS_INTFLG_GPR(3)
#define MP_OASIS_INTLVL_DISPLAYPPC           MP_OASIS_INTLVL_GPR(4)  /* display interrupt to the local */
#define MP_OASIS_INTFLG_DISPLAYPPC           MP_OASIS_INTFLG_GPR(4)
#define MP_OASIS_INTLVL_LAST_PROCESS         MP_OASIS_INTLVL_GPR(5)
#define MP_OASIS_INTFLG_LAST_PROCESS         MP_OASIS_INTFLG_GPR(5)

// PUT & GET uses all available GP Interrupt
// Please change MP_OASIS_FIRST_INT_AVAILABLE & MP_OASIS_LAST_INT_AVAILABLE
// if you want an other GP Interrupt
#define MP_OASIS_FIRST_INT_AVAILABLE                    6
...
// Please change MP_OASIS_FIRST_INT_AVAILABLE & MP_OASIS_LAST_INT_AVAILABLE
// if you want an other GP Interrupt
#define MP_OASIS_LAST_INT_AVAILABLE          57
