...
protected:
	...
	void Scan();
	static void WINAPI ScanHook(void *powner);
	...
	afx_msg void OnKillFocusXSamplingFactor();
	afx_msg void OnKillFocusYSamplingFactor();
	afx_msg void OnKillFocusXWaves();
	afx_msg void OnKillFocusYWaves();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
