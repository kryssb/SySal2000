...
OBJECT_ENTRY(CLSID_Odyssey, COdyssey)
END_OBJECT_MAP()
...
STDAPI DllRegisterServer(void)
{
	...
	try
	{
		...
		MyKey.Close();
		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\Odyssey3", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_WRITE | KEY_READ) != ERROR_SUCCESS) throw 3;
		MyKey.Close();
		MyKey.Open(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\Odyssey3", KEY_WRITE | KEY_READ);
		char CLSIDString[64];
		wsprintf(CLSIDString, "{%08X-%04X-%04X-%02X%02X-%02X%02X%02X%02X%02X%02X}", 
			CLSID_Odyssey.Data1, CLSID_Odyssey.Data2, CLSID_Odyssey.Data3, 
			CLSID_Odyssey.Data4[0], CLSID_Odyssey.Data4[1], CLSID_Odyssey.Data4[2], CLSID_Odyssey.Data4[3], 
			CLSID_Odyssey.Data4[4], CLSID_Odyssey.Data4[5], CLSID_Odyssey.Data4[6], CLSID_Odyssey.Data4[7]);
	...
	catch (...)
	{
		...
		MyKey.RecurseDeleteKey("Software\\SySal2\\Classes\\Odyssey3");
		MyKey.Close();
		};
