...
#define PROC_FORMAT_STRING_SIZE   2265                              
...
const CInterfaceProxyVtbl * _Odyssey1_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _Odyssey1_StubVtblList[] = 
{
...
PCInterfaceName const _Odyssey1_InterfaceNamesList[] = 
{
...
#define _Odyssey1_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Odyssey1, pIID, n)

int __stdcall _Odyssey1_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _Odyssey1, 6, 4 )
    IID_BS_LOOKUP_NEXT_TEST( _Odyssey1, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _Odyssey1, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _Odyssey1, 6, *pIndex )
    
}

const ExtendedProxyFileInfo Odyssey1_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Odyssey1_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Odyssey1_StubVtblList,
    (const PCInterfaceName * ) & _Odyssey1_InterfaceNamesList,
    0, // no delegation
    & _Odyssey1_IID_Lookup, 
    6,
    2,
