...
/* at Tue Sep 19 09:20:05 2006
 */
/* Compiler settings for D:\SySal2\PlateChangerSerial\PlateChanger.idl:
...
const CInterfaceProxyVtbl * _PlateChanger_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _PlateChanger_StubVtblList[] = 
{
...
PCInterfaceName const _PlateChanger_InterfaceNamesList[] = 
{
    "IPlateChanger",
    "ISySalObject",
    0
...
#define _PlateChanger_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _PlateChanger, pIID, n)

int __stdcall _PlateChanger_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _PlateChanger, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _PlateChanger, 2, *pIndex )
    
}

const ExtendedProxyFileInfo PlateChanger_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _PlateChanger_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _PlateChanger_StubVtblList,
    (const PCInterfaceName * ) & _PlateChanger_InterfaceNamesList,
    0, // no delegation
    & _PlateChanger_IID_Lookup, 
    2,
    2,
