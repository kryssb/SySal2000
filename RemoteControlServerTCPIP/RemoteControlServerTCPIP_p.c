...
/* Object interface: IRemoteControlServer, ver. 0.0,
   GUID={0x09AFBFFE,0xBBA9,0x4A5A,{0x91,0x66,0x35,0x2A,0x73,0xCF,0xCA,0x32}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IRemoteControlServer_ServerInfo;
...
static const unsigned short IRemoteControlServer_FormatStringOffsetTable[] = 
    {
    532,
    560,
    582,
...
static const MIDL_SERVER_INFO IRemoteControlServer_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IRemoteControlServer_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IRemoteControlServer_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IRemoteControlServer_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(7) _IRemoteControlServerProxyVtbl = 
{
    &IRemoteControlServer_ProxyInfo,
    &IID_IRemoteControlServer,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *)-1 /* IRemoteControlServer::Connect */ ,
    (void *)-1 /* IRemoteControlServer::Disconnect */ ,
    (void *)-1 /* IRemoteControlServer::IsConnected */ ,
    (void *)-1 /* IRemoteControlServer::SendMessage */
};

const CInterfaceStubVtbl _IRemoteControlServerStubVtbl =
{
    &IID_IRemoteControlServer,
    &IRemoteControlServer_ServerInfo,
    7,
    0, /* pure interpreted */
    CStdStubBuffer_METHODS
};
...
const CInterfaceProxyVtbl * _RemoteControlServerTCPIP_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISySalObjectProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IRemoteControlServerProxyVtbl,
    0
};

const CInterfaceStubVtbl * _RemoteControlServerTCPIP_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ISySalObjectStubVtbl,
    ( CInterfaceStubVtbl *) &_IRemoteControlServerStubVtbl,
    0
};

PCInterfaceName const _RemoteControlServerTCPIP_InterfaceNamesList[] = 
{
    "ISySalObject",
...
#define _RemoteControlServerTCPIP_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _RemoteControlServerTCPIP, pIID, n)

int __stdcall _RemoteControlServerTCPIP_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _RemoteControlServerTCPIP, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _RemoteControlServerTCPIP, 2, *pIndex )
    
}

const ExtendedProxyFileInfo RemoteControlServerTCPIP_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _RemoteControlServerTCPIP_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _RemoteControlServerTCPIP_StubVtblList,
    (const PCInterfaceName * ) & _RemoteControlServerTCPIP_InterfaceNamesList,
    0, // no delegation
    & _RemoteControlServerTCPIP_IID_Lookup, 
    2,
    2,
