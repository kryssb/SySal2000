...
const CInterfaceProxyVtbl * _RemoteStage_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _RemoteStage_StubVtblList[] = 
{
...
PCInterfaceName const _RemoteStage_InterfaceNamesList[] = 
{
    "IStage",
    "ISySalObject",
    0
...
#define _RemoteStage_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _RemoteStage, pIID, n)

int __stdcall _RemoteStage_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _RemoteStage, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _RemoteStage, 2, *pIndex )
    
}

const ExtendedProxyFileInfo RemoteStage_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _RemoteStage_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _RemoteStage_StubVtblList,
    (const PCInterfaceName * ) & _RemoteStage_InterfaceNamesList,
    0, // no delegation
    & _RemoteStage_IID_Lookup, 
    2,
    2,
