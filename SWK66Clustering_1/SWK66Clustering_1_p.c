...
const CInterfaceProxyVtbl * _SWK66Clustering_1_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _SWK66Clustering_1_StubVtblList[] = 
{
...
PCInterfaceName const _SWK66Clustering_1_InterfaceNamesList[] = 
{
    "IClusterFinder",
    "ISySalObject",
    0
...
#define _SWK66Clustering_1_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SWK66Clustering_1, pIID, n)

int __stdcall _SWK66Clustering_1_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _SWK66Clustering_1, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _SWK66Clustering_1, 2, *pIndex )
    
}

const ExtendedProxyFileInfo SWK66Clustering_1_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SWK66Clustering_1_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SWK66Clustering_1_StubVtblList,
    (const PCInterfaceName * ) & _SWK66Clustering_1_InterfaceNamesList,
    0, // no delegation
    & _SWK66Clustering_1_IID_Lookup, 
    2,
    2,
