...
MIDL_DEFINE_GUID(IID, LIBID_ScanServerMessageRouter,0x6a5af626,0xadb1,0x474e,0x89,0xae,0xad,0x13,0xb3,0x37,0xef,0xfd);


MIDL_DEFINE_GUID(CLSID, CLSID_ScanServerMessageRouter,0x117CB81A,0x6E7D,0x40A5,0x8F,0x6B,0xD0,0xA8,0x2F,0xD0,0x5D,0x38);
