...
#define PROC_FORMAT_STRING_SIZE   853                               
...
extern const MIDL_SERVER_INFO IScanServerMessageRouter_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IScanServerMessageRouter_ProxyInfo;
...
static const MIDL_PROC_FORMAT_STRING __MIDL_ProcFormatString =
	...
	/* Procedure SetMessageRoutingMap */
...
/* 64 */	NdrFcShort( 0x10 ),	/* Type Offset=16 */
...
/* 100 */	NdrFcShort( 0x10 ),	/* Type Offset=16 */
...
/* 208 */	NdrFcShort( 0x1a ),	/* Type Offset=26 */
...
/* 282 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
...
/* 302 */	NdrFcShort( 0x54 ),	/* x86 Stack size/offset = 84 */
...
/* 332 */	NdrFcShort( 0x50 ),	/* x86 Stack size/offset = 80 */
/* 334 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* 370 */	NdrFcShort( 0x48 ),	/* Type Offset=72 */
...
/* 444 */	NdrFcShort( 0xa ),	/* Flags:  must free, in, */
/* 446 */	NdrFcShort( 0x4 ),	/* x86 Stack size/offset = 4 */
/* 448 */	NdrFcShort( 0x10 ),	/* Type Offset=16 */
...
/* 804 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
...
/* 840 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
...
/* 32 */	
			0x46,		/* FC_NO_REPEAT */
			0x5c,		/* FC_PAD */
/* 34 */	NdrFcShort( 0x44 ),	/* 68 */
/* 36 */	NdrFcShort( 0x44 ),	/* 68 */
...
/* 44 */	0x0,		/* 0 */
			NdrFcShort( 0xffe3 ),	/* Offset= -29 (16) */
			0x8,		/* FC_LONG */
/* 48 */	0x8,		/* FC_LONG */
			0x5b,		/* FC_END */
/* 50 */	
...
/* 76 */	NdrFcShort( 0x0 ),	/* 0 */
/* 78 */	NdrFcShort( 0xc ),	/* Offset= 12 (90) */
/* 80 */	0x8,		/* FC_LONG */
			0x4c,		/* FC_EMBEDDED_COMPLEX */
/* 82 */	0x0,		/* 0 */
			NdrFcShort( 0xffbd ),	/* Offset= -67 (16) */
			0x4c,		/* FC_EMBEDDED_COMPLEX */
/* 86 */	0x0,		/* 0 */
			NdrFcShort( 0xffdf ),	/* Offset= -33 (54) */
			0x5b,		/* FC_END */
/* 90 */	
			0x11, 0x0,	/* FC_RP */
...
/* Object interface: IScanServerMessageRouter, ver. 0.0,
   GUID={0xCE7FD743,0x3049,0x4661,{0xB1,0x58,0xF7,0x50,0x6B,0x11,0x14,0x5D}} */

#pragma code_seg(".orpc")
static const unsigned short IScanServerMessageRouter_FormatStringOffsetTable[] =
    {
    0
    };

static const MIDL_STUBLESS_PROXY_INFO IScanServerMessageRouter_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IScanServerMessageRouter_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IScanServerMessageRouter_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(4) _IScanServerMessageRouterProxyVtbl = 
{
    &IScanServerMessageRouter_ProxyInfo,
    &IID_IScanServerMessageRouter,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* IScanServerMessageRouter::SetMessageRoutingMap */
};

const CInterfaceStubVtbl _IScanServerMessageRouterStubVtbl =
{
    &IID_IScanServerMessageRouter,
    &IScanServerMessageRouter_ServerInfo,
    4,
    0, /* pure interpreted */
...
const CInterfaceProxyVtbl * _ScanServerMessageRouter_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IScanServerMessageRouterProxyVtbl,
    ( CInterfaceProxyVtbl *) &_ISySalObjectProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IScanServerProxyVtbl,
    0
};

const CInterfaceStubVtbl * _ScanServerMessageRouter_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IScanServerMessageRouterStubVtbl,
    ( CInterfaceStubVtbl *) &_ISySalObjectStubVtbl,
    ( CInterfaceStubVtbl *) &_IScanServerStubVtbl,
    0
};

PCInterfaceName const _ScanServerMessageRouter_InterfaceNamesList[] = 
{
...
#define _ScanServerMessageRouter_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _ScanServerMessageRouter, pIID, n)

int __stdcall _ScanServerMessageRouter_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _ScanServerMessageRouter, 3, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _ScanServerMessageRouter, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _ScanServerMessageRouter, 3, *pIndex )
    
}

const ExtendedProxyFileInfo ScanServerMessageRouter_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _ScanServerMessageRouter_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _ScanServerMessageRouter_StubVtblList,
    (const PCInterfaceName * ) & _ScanServerMessageRouter_InterfaceNamesList,
    0, // no delegation
    & _ScanServerMessageRouter_IID_Lookup, 
    3,
    2,
