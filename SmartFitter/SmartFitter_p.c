...
const CInterfaceProxyVtbl * _SmartFitter_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _SmartFitter_StubVtblList[] = 
{
...
PCInterfaceName const _SmartFitter_InterfaceNamesList[] = 
{
    "ITrackFitter2",
    "ITrackFitter",
    "ISySalObject",
...
#define _SmartFitter_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SmartFitter, pIID, n)

int __stdcall _SmartFitter_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _SmartFitter, 4, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _SmartFitter, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _SmartFitter, 4, *pIndex )
    
}

const ExtendedProxyFileInfo SmartFitter_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SmartFitter_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SmartFitter_StubVtblList,
    (const PCInterfaceName * ) & _SmartFitter_InterfaceNamesList,
    0, // no delegation
    & _SmartFitter_IID_Lookup, 
    4,
    2,
