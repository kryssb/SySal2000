	TITLE	D:\SySal2\SmartTracker4\SmartTracker4.cpp
	.386P
include listing.inc
if @Version gt 510
.model FLAT
...
_DATA	SEGMENT DWORD USE32 PUBLIC 'DATA'
_DATA	ENDS
;	COMDAT ??_C@_0CG@POPE@Software?2SySal2?2Classes?2SmartTra@
_DATA	SEGMENT DWORD USE32 PUBLIC 'DATA'
_DATA	ENDS
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker4@@3U_GUID@@B@ATL@@SGPBDXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker4@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
PUBLIC	?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker4@@3U_GUID@@B@ATL@@SGPBDXZ ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker4>::GetObjectDescription
PUBLIC	?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker4@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker4>::GetCategoryMap
...
_IID_ITracker3 DD 07a9e779cH
	...
	DB	062H
	DB	0b7H
_LIBID_SMARTTRACKERLib DD 0848597caH
	DW	0b128H
	DW	04697H
	DB	0b1H
	DB	042H
	...
	DB	055H
	DB	0bbH
_CLSID_SmartTracker4 DD 07d18182cH
	DW	09e17H
	DW	04addH
	DB	0b6H
	DB	0d2H
...
CONST	ENDS
_DATA	SEGMENT
_ObjectMap DD	FLAT:_CLSID_SmartTracker4
	...
	DD	00H
	DD	00H
	DD	FLAT:?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker4@@3U_GUID@@B@ATL@@SGPBDXZ
	DD	FLAT:?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker4@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ
...
; 183  : DECLARE_REGISTRY_RESOURCEID(IDR_SMARTTRACKER)
...
; 54   : 	CSmartTrackerClass::pHelpPath = new char[strlen(m_pszHelpFilePath) + 1];
...
; 55   : 	strcpy(CSmartTrackerClass::pHelpPath, m_pszHelpFilePath);
...
; 56   : 	strcpy(CSmartTrackerClass::pHelpPath + strlen(CSmartTrackerClass::pHelpPath) - 3, "chm");
...
; 63   : 	delete [] CSmartTrackerClass::pHelpPath;
...
PUBLIC	??_C@_0CG@POPE@Software?2SySal2?2Classes?2SmartTra@ ; `string'
...
;	COMDAT ??_C@_0CG@POPE@Software?2SySal2?2Classes?2SmartTra@
_DATA	SEGMENT
??_C@_0CG@POPE@Software?2SySal2?2Classes?2SmartTra@ DB 'Software\SySal2\C'
	DB	'lasses\SmartTracker4', 00H			; `string'
_DATA	ENDS
;	COMDAT ??_C@_0DD@BIAF@?$HL?$CF08X?9?$CF04X?9?$CF04X?9?$CF02X?$CF02X?9?$CF02X?$CF02@
_DATA	SEGMENT
...
; 91   : 	try
; 92   : 	{
; 93   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 0;

	lea	eax, DWORD PTR _dw$73627[ebp]
	lea	ecx, DWORD PTR _hKey$73628[ebp]
	push	eax
...
; 95   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 1;

	lea	eax, DWORD PTR _dw$73641[ebp]
	lea	ecx, DWORD PTR _hKey$73642[ebp]
	push	eax
	push	ecx
	push	esi
	push	131103					; 0002001fH
	...
	push	-2147483646				; 80000002H
	mov	DWORD PTR _hKey$73642[ebp], esi
	call	edi
	cmp	eax, esi
	jne	SHORT $L73716
	lea	ecx, DWORD PTR _MyKey$[ebp]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73642[ebp]
	cmp	eax, esi
	mov	DWORD PTR _MyKey$[ebp], ecx
	je	SHORT $L73011
$L73716:
	lea	edx, DWORD PTR $T73615[ebp]
	push	OFFSET FLAT:__TI1H
	push	edx
	mov	DWORD PTR $T73615[ebp], 1
	call	__CxxThrowException@8
$L73011:
...
; 97   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 2;

	lea	eax, DWORD PTR _dw$73655[ebp]
	lea	ecx, DWORD PTR _hKey$73656[ebp]
	push	eax
	push	ecx
	push	esi
	push	131103					; 0002001fH
	...
	push	-2147483646				; 80000002H
	mov	DWORD PTR _hKey$73656[ebp], esi
	call	edi
	cmp	eax, esi
	jne	SHORT $L73717
	lea	ecx, DWORD PTR _MyKey$[ebp]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73656[ebp]
	cmp	eax, esi
	mov	DWORD PTR _MyKey$[ebp], ecx
	je	SHORT $L73015
$L73717:
	lea	edx, DWORD PTR $T73616[ebp]
	push	OFFSET FLAT:__TI1H
	push	edx
	mov	DWORD PTR $T73616[ebp], 2
	call	__CxxThrowException@8
$L73015:
...
; 99   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\SmartTracker4", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 3;

	lea	eax, DWORD PTR _dw$73669[ebp]
	lea	ecx, DWORD PTR _hKey$73670[ebp]
	push	eax
	push	ecx
	push	esi
	push	131103					; 0002001fH
	...
	push	esi
	push	esi
	push	OFFSET FLAT:??_C@_0CG@POPE@Software?2SySal2?2Classes?2SmartTra@ ; `string'
	push	-2147483646				; 80000002H
	mov	DWORD PTR _hKey$73670[ebp], esi
	call	edi
	cmp	eax, esi
	jne	SHORT $L73718
	lea	ecx, DWORD PTR _MyKey$[ebp]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73670[ebp]
	cmp	eax, esi
	mov	DWORD PTR _MyKey$[ebp], ecx
	je	SHORT $L73019
$L73718:
	lea	edx, DWORD PTR $T73617[ebp]
	push	OFFSET FLAT:__TI1H
	push	edx
	mov	DWORD PTR $T73617[ebp], 3
	call	__CxxThrowException@8
$L73019:
...
; 101  : 		MyKey.Open(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\SmartTracker4", KEY_READ | KEY_WRITE);

	lea	eax, DWORD PTR _hKey$73683[ebp]
	mov	DWORD PTR _hKey$73683[ebp], esi
	push	eax
	push	131103					; 0002001fH
	push	esi
	push	OFFSET FLAT:??_C@_0CG@POPE@Software?2SySal2?2Classes?2SmartTra@ ; `string'
	...
	lea	ecx, DWORD PTR _MyKey$[ebp]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73683[ebp]
	mov	DWORD PTR _MyKey$[ebp], ecx
$L73685:

; 102  : 		char CLSIDString[64];
; 103  : 		wsprintf(CLSIDString, "{%08X-%04X-%04X-%02X%02X-%02X%02X%02X%02X%02X%02X}", 
; 104  : 			CLSID_SmartTracker4.Data1, CLSID_SmartTracker4.Data2, CLSID_SmartTracker4.Data3, 
; 105  : 			CLSID_SmartTracker4.Data4[0], CLSID_SmartTracker4.Data4[1], CLSID_SmartTracker4.Data4[2], CLSID_SmartTracker4.Data4[3], 
; 106  : 			CLSID_SmartTracker4.Data4[4], CLSID_SmartTracker4.Data4[5], CLSID_SmartTracker4.Data4[6], CLSID_SmartTracker4.Data4[7]);

	xor	edx, edx
	xor	eax, eax
	mov	dl, BYTE PTR _CLSID_SmartTracker4+15
	mov	al, BYTE PTR _CLSID_SmartTracker4+14
	push	edx
	push	eax
	mov	eax, DWORD PTR _CLSID_SmartTracker4+12
	xor	ecx, ecx
	mov	cl, ah
	...
	xor	edx, edx
	xor	eax, eax
	mov	dl, BYTE PTR _CLSID_SmartTracker4+11
	mov	al, BYTE PTR _CLSID_SmartTracker4+10
	push	edx
	push	eax
	mov	eax, DWORD PTR _CLSID_SmartTracker4+8
	xor	ecx, ecx
	mov	cl, ah
	and	eax, 255				; 000000ffH
	push	ecx
	mov	ecx, DWORD PTR _CLSID_SmartTracker4
	push	eax
	mov	eax, DWORD PTR _CLSID_SmartTracker4+4
	xor	edx, edx
	and	eax, 65535				; 0000ffffH
	mov	dx, WORD PTR _CLSID_SmartTracker4+6
	push	edx
	push	eax
	push	ecx
	lea	edx, DWORD PTR _CLSIDString$73023[ebp]
	push	OFFSET FLAT:??_C@_0DD@BIAF@?$HL?$CF08X?9?$CF04X?9?$CF04X?9?$CF02X?$CF02X?9?$CF02X?$CF02@ ; `string'
	push	edx
	call	DWORD PTR __imp__wsprintfA
	add	esp, 52					; 00000034H

; 107  : 		MyKey.SetValue(CLSIDString, "CLSID");

	lea	eax, DWORD PTR _CLSIDString$73023[ebp]
	push	eax
	call	DWORD PTR __imp__lstrlenA@4
	mov	edx, DWORD PTR _MyKey$[ebp]
	inc	eax
	lea	ecx, DWORD PTR _CLSIDString$73023[ebp]
	push	eax
	push	ecx
	push	1
	push	esi
...
; 113  : 		MyKey.Open(HKEY_LOCAL_MACHINE, "", KEY_READ | KEY_WRITE);
...
; 114  : 		MyKey.RecurseDeleteKey("Software\\SySal2\\Classes\\SmartTracker4");
...
; 117  :     return _Module.RegisterServer(FALSE/*TRUE*/);
...
; 125  : 	CRegKey MyKey;
; 126  : 	MyKey.Open(HKEY_LOCAL_MACHINE, "", KEY_READ | KEY_WRITE);

	lea	eax, DWORD PTR _hKey$73749[esp+284]
	push	edi
	...
	test	eax, eax
	jne	SHORT $L73751
	mov	esi, DWORD PTR _hKey$73749[esp+288]
$L73751:

; 127  : 	MyKey.RecurseDeleteKey("Software\\SySal2\\Classes\\SmartTracker4");

	lea	ecx, DWORD PTR _hKey$73791[esp+288]
	mov	DWORD PTR _key$73807[esp+288], ebx
	push	ecx
	push	131103					; 0002001fH
	push	ebx
	push	OFFSET FLAT:??_C@_0CG@POPE@Software?2SySal2?2Classes?2SmartTra@ ; `string'
	push	esi
	mov	DWORD PTR _hKey$73791[esp+308], ebx
	call	edi
	cmp	eax, ebx
	jne	$L73837
	lea	ecx, DWORD PTR _key$73807[esp+288]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73791[esp+288]
	cmp	eax, ebx
	mov	DWORD PTR _key$73807[esp+288], ecx
	jne	SHORT $L73837
	lea	edx, DWORD PTR _time$73810[esp+288]
	mov	edi, DWORD PTR __imp__RegEnumKeyExA@32
	push	edx
	push	ebx
	push	ebx
	lea	eax, DWORD PTR _dwSize$73811[esp+300]
	push	ebx
	lea	edx, DWORD PTR _szBuffer$73812[esp+304]
	push	eax
	push	edx
	push	ebx
	push	ecx
	mov	DWORD PTR _dwSize$73811[esp+320], 256	; 00000100H
	call	edi
	test	eax, eax
	jne	SHORT $L73814
$L73813:
	lea	eax, DWORD PTR _szBuffer$73812[esp+288]
	lea	ecx, DWORD PTR _key$73807[esp+288]
	push	eax
	call	?RecurseDeleteKey@CRegKey@ATL@@QAEJPBD@Z ; ATL::CRegKey::RecurseDeleteKey
	test	eax, eax
	jne	SHORT $L73837
	lea	ecx, DWORD PTR _time$73810[esp+288]
	lea	edx, DWORD PTR _dwSize$73811[esp+288]
	push	ecx
	mov	ecx, DWORD PTR _key$73807[esp+292]
	push	ebx
	push	ebx
	push	ebx
	lea	eax, DWORD PTR _szBuffer$73812[esp+304]
	push	edx
	push	eax
	push	ebx
	push	ecx
	...
	je	SHORT $L73813
$L73814:
	mov	eax, DWORD PTR _key$73807[esp+288]
	cmp	eax, ebx
	je	SHORT $L73801
	push	eax
	call	DWORD PTR __imp__RegCloseKey@4
...
;	COMDAT ?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker4@@3U_GUID@@B@ATL@@SGPBDXZ
_TEXT	SEGMENT
?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker4@@3U_GUID@@B@ATL@@SGPBDXZ PROC NEAR ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker4>::GetObjectDescription, COMDAT

; 3127 : 	static LPCTSTR WINAPI GetObjectDescription() {return NULL;}

	xor	eax, eax
	ret	0
?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker4@@3U_GUID@@B@ATL@@SGPBDXZ ENDP ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker4>::GetObjectDescription
_TEXT	ENDS
;	COMDAT ?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker4@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ
_TEXT	SEGMENT
?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker4@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ PROC NEAR ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker4>::GetCategoryMap, COMDAT

; 3128 : 	static const struct _ATL_CATMAP_ENTRY* GetCategoryMap() {return NULL;};

	xor	eax, eax
	ret	0
?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker4@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ ENDP ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker4>::GetCategoryMap
_TEXT	ENDS
...
text$x	SEGMENT
$L73859:
	mov	eax, DWORD PTR $T73850[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
$L73975:
	mov	eax, OFFSET FLAT:$T73971
	jmp	___CxxFrameHandler
text$x	ENDS
...
text$x	SEGMENT
$L74118:
	mov	eax, DWORD PTR $T74109[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
$L74176:
	mov	eax, OFFSET FLAT:$T74172
	jmp	___CxxFrameHandler
text$x	ENDS
...
xdata$x	SEGMENT
$T74236	DD	019930520H
	DD	02H
	DD	FLAT:$T74241
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T74241	DD	0ffffffffH
	DD	FLAT:$L74183
	DD	00H
	DD	FLAT:$L74184
xdata$x	ENDS
...
; 125  : 		Name[0] = 0;
; 126  : 		HStatusChangeEvent = 0;
; 127  : 		CamSpec.Width = CamSpec.Height = 0;
; 128  : 		CamSpec.WinWidth = CamSpec.WinHeight = 0;
; 129  : 		CamSpec.OffX = CamSpec.OffY = 0;
; 130  : 		CamSpec.PixelToMicronX = CamSpec.PixelToMicronY = 1.f;
...
; 132  : 		int i;
; 133  : 		HStart = CreateEvent(NULL, TRUE, FALSE, NULL);
...
; 134  : 		HReset = CreateEvent(NULL, TRUE, FALSE, NULL);
...
; 135  : 		HTerminate = CreateEvent(NULL, TRUE, FALSE, NULL);
...
; 136  : 		for (i = 0; i < MAX_PROCESSORS; i++)
; 137  : 		{
; 138  : 			ThreadInfo[i].HFinished = 0;

	mov	DWORD PTR [eax+20], ebx

; 139  : 			ThreadInfo[i].pThis = this;

	mov	DWORD PTR [eax], esi

; 140  : 			ThreadInfo[i].HThread = 0;
...
; File D:\Program Files\Microsoft Visual Studio\VC98\ATL\INCLUDE\atlbase.h
xdata$x	SEGMENT
$T74350	DD	019930520H
	DD	01H
	DD	FLAT:$T74354
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T74354	DD	0ffffffffH
	DD	FLAT:$L74315
xdata$x	ENDS
;	COMDAT ??1?$CComObject@VCSmartTrackerClass@@@ATL@@UAE@XZ
_TEXT	SEGMENT
...
$L74338:
	...
	push	eax
	call	edi
	mov	DWORD PTR [esi+912], ebp
$L74339:
	mov	eax, DWORD PTR __ctlState$74330[esp+48]
	mov	ecx, DWORD PTR __ctlState$74330[esp+44]
	neg	esi
	mov	DWORD PTR [eax+4], ecx
...
$L74315:
	...
	add	eax, 8
	mov	DWORD PTR $T74328[ebp], eax
	jmp	$L74314
$L74313:
	mov	DWORD PTR $T74328[ebp], 0
$L74314:
	mov	ecx, DWORD PTR $T74328[ebp]
	jmp	??1?$CComObjectRootEx@VCComMultiThreadModel@ATL@@@ATL@@QAE@XZ ; ATL::CComObjectRootEx<ATL::CComMultiThreadModel>::~CComObjectRootEx<ATL::CComMultiThreadModel>
$L74353:
	mov	eax, OFFSET FLAT:$T74350
	jmp	___CxxFrameHandler
text$x	ENDS
...
; File D:\Program Files\Microsoft Visual Studio\VC98\ATL\INCLUDE\atlbase.h
xdata$x	SEGMENT
$T74456	DD	019930520H
	DD	01H
	DD	FLAT:$T74466
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T74466	DD	0ffffffffH
	DD	FLAT:$L74391
xdata$x	ENDS
;	COMDAT ?RecurseDeleteKey@CRegKey@ATL@@QAEJPBD@Z
_TEXT	SEGMENT
...
; 4893 : 	LONG lRes = key.Open(m_hKey, lpszKey, KEY_READ | KEY_WRITE);
	...
	lea	ecx, DWORD PTR _hKey$74402[esp+304]
	...
	push	edx
	push	eax
	mov	DWORD PTR _hKey$74402[esp+324], edi
	call	DWORD PTR __imp__RegOpenKeyExA@20
	mov	esi, eax
	cmp	esi, edi
	jne	SHORT $L74461
	...
	call	DWORD PTR __imp__RegCloseKey@4
$L74408:
	mov	ecx, DWORD PTR _hKey$74402[esp+304]
