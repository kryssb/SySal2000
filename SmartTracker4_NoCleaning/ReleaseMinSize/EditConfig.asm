	TITLE	D:\SySal2\SmartTracker4\EditConfig.cpp
	.386P
include listing.inc
if @Version gt 510
.model FLAT
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T78750	DD	019930520H
	DD	03H
	DD	FLAT:$T78753
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T78753	DD	0ffffffffH
	DD	FLAT:$L78739
	DD	00H
	DD	FLAT:$L78740
	DD	01H
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T78782	DD	019930520H
	DD	02H
	DD	FLAT:$T78784
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T78784	DD	0ffffffffH
	DD	FLAT:$L78778
	DD	00H
	DD	FLAT:$L78779
xdata$x	ENDS
...
; 76   : BEGIN_MESSAGE_MAP(CEditConfig, CDialog)
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T78813	DD	019930520H
	DD	02H
	DD	FLAT:$T78821
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T78821	DD	0ffffffffH
	DD	FLAT:$L78799
	DD	00H
	DD	FLAT:$L78800
xdata$x	ENDS
...
; 95   : 	{
; 96   : 		MessageBox("Too many trials", "Trial Error");
...
; 98   : 		};
; 99   : 	if (m_BottomLayer <= m_TopLayer)

	mov	ecx, DWORD PTR [ebp+924]
	mov	edx, DWORD PTR [ebp+928]
	cmp	edx, ecx
	ja	SHORT $L78328

; 100  : 	{
; 101  : 		MessageBox("Bottom layer must be higher than Top layer", "Trial Error");
...
; 103  : 		};
; 104  : 	C.Trials[C.TrialCount].TopLayer = m_TopLayer;

	lea	edx, DWORD PTR [eax+eax*4+15]
	lea	eax, DWORD PTR [eax+edx*2+3]
	mov	DWORD PTR [ebp+eax*4], ecx

; 105  : 	C.Trials[C.TrialCount].BottomLayer = m_BottomLayer;
...
; 109  : 	strcpy(tempstr, m_Triggers);

	mov	edi, DWORD PTR [ebp+932]
	or	ecx, -1
	xor	eax, eax
...
; 111  : 	int i;
; 112  : 	for (i = 0; i < MAX_TRIGGERS && str; i++)
...
; 113  : 	{
; 114  : 		if (sscanf(str, "%d", &C.Trials[C.TrialCount].Triggers[i]) != 1)
...
; 120  : 			}
; 121  : 		tsub.Format("%d", C.Trials[C.TrialCount].Triggers[i]);
...
; 125  : 		}
; 126  : 	C.Trials[C.TrialCount].TriggerCount = i;

	mov	eax, DWORD PTR [ebp+128]

; 127  : 	sprintf(tempstr, "%d", C.Trials[C.TrialCount].TopLayer);
...
; 128  : 	m_TrialList.InsertItem(C.TrialCount, tempstr);

	mov	eax, DWORD PTR [ebp+128]
	add	esp, 12					; 0000000cH
	lea	edx, DWORD PTR _tempstr$[esp+292]
	lea	esi, DWORD PTR [ebp+860]
	push	0
	push	0
	push	0
	push	0
...
; 129  : 	sprintf(tempstr, "%d", C.Trials[C.TrialCount].BottomLayer);
...
; 130  : 	m_TrialList.SetItemText(C.TrialCount, 1, tempstr);
...
; 131  : 	m_TrialList.SetItemText(C.TrialCount, 2, sub);
...
; 115  : 		{
; 116  : 			MessageBox("Triggers must be comma-separated integers", "Trial Error");
...
; 117  : 			for (i = 0; i < MAX_TRIGGERS; i++)

	xor	ecx, ecx
$L78342:

; 118  : 				C.Trials[C.TrialCount].Triggers[i] = -1;
...
; 138  : 	int index = m_TrialList.GetSelectionMark();
...
; 140  : 	{
; 141  : 		int i, j;
; 142  : 		for (i = index + 1; i < C.TrialCount + 1; i++)
...
; 144  : 		for (j = 0; j < MAX_TRIGGERS; j++)

	lea	edx, DWORD PTR [eax+eax*4]

; 145  : 			C.Trials[i].Triggers[j] = -1;

	mov	ecx, 8

; 146  : 		C.TrialCount--;
; 147  : 		m_TrialList.DeleteItem(index);
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T78855	DD	019930520H
	DD	02H
	DD	FLAT:$T78863
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T78863	DD	0ffffffffH
	DD	FLAT:$L78839
	DD	00H
	DD	FLAT:$L78840
xdata$x	ENDS
...
; 156  : 	m_TrialList.InsertColumn(0, "Top", LVCFMT_RIGHT, 60, 0);

	xor	ebp, ebp
	lea	ebx, DWORD PTR [esi+860]
	push	ebp
	push	60					; 0000003cH
	push	1
...
; 157  : 	m_TrialList.InsertColumn(1, "Bottom", LVCFMT_RIGHT, 60, 1);
...
; 158  : 	m_TrialList.InsertColumn(2, "Trigger", LVCFMT_RIGHT, 80, 2);
...
; 159  : 	ListView_SetExtendedListViewStyle(m_TrialList.m_hWnd, (LVS_EX_FULLROWSELECT | LVS_EX_GRIDLINES) | ListView_GetExtendedListViewStyle(m_TrialList.m_hWnd));
...
; 164  : 	{
; 165  : 		str.Format("%d", C.Trials[i].TopLayer);
...
; 166  : 		m_TrialList.InsertItem(i, str);
...
; 167  : 		str.Format("%d", C.Trials[i].BottomLayer);
...
; 168  : 		m_TrialList.SetItemText(i, 1, str);
...
; 170  : 		for (j = 0; j < C.Trials[i].TriggerCount; j++)
...
; 173  : 			temp.Format("%d", C.Trials[i].Triggers[j]);
...
; 175  : 			}
; 176  : 		m_TrialList.SetItemText(i, 2, str);
...
;	COMDAT xdata$x
; File D:\SySal2\SmartTracker4\EditConfig.cpp
xdata$x	SEGMENT
$T78876	DD	019930520H
	DD	03H
	DD	FLAT:$T78878
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T78878	DD	0ffffffffH
	DD	FLAT:$L78868
	DD	0ffffffffH
	DD	FLAT:$L78870
	DD	01H
...
; 186  : 
; 187  : 	SySalConfig OldC, NewC;
; 188  : 	OldC.Name[0] = NewC.Name[0] = 0;
; 189  : 	OldC.CountOfItems = NewC.CountOfItems = 0;
; 190  : 	OldC.pItems = NewC.pItems = 0;
; 191  : 
; 192  : 	pTk->GetConfig(&OldC);
...
; 193  : 
; 194  : 	CSmartTrackerClass::PutData(&NewC, &C);
...
; 200  : 
; 201  : 	pTk->SetConfig(&OldC);

	mov	esi, DWORD PTR [esi+936]
	lea	edx, DWORD PTR _OldC$[esp+288]
	push	edx
...
; 202  : 
; 203  : 	if (OldC.pItems) CoTaskMemFree(OldC.pItems);
...
; 204  : 	if (NewC.pItems) CoTaskMemFree(NewC.pItems);
...
$L78871:
	...
	jmp	??1CString@@QAE@XZ			; CString::~CString
$L78877:
	mov	eax, OFFSET FLAT:$T78876
	jmp	___CxxFrameHandler
text$x	ENDS
?OnTest@CEditConfig@@IAEXXZ ENDP			; CEditConfig::OnTest
;	COMDAT xdata$x
xdata$x	SEGMENT
$T78887	DD	019930520H
	DD	02H
	DD	FLAT:$T78889
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T78889	DD	0ffffffffH
	DD	FLAT:$L78883
	DD	00H
	DD	FLAT:$L78884
xdata$x	ENDS
...
; 210  : 	HtmlHelp(this->m_hWnd, CSmartTrackerClass::pHelpPath, HH_DISPLAY_TOPIC, (DWORD)"HelpConfig.htm");	
