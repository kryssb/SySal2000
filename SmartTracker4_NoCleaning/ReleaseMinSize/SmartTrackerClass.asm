	TITLE	D:\SySal2\SmartTracker4_NoCleaning\SmartTrackerClass.cpp
	.386P
include listing.inc
if @Version gt 510
.model FLAT
...
xdata$x	SEGMENT
$T80001	DD	019930520H
	DD	07H
	DD	FLAT:$T80004
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T80004	DD	0ffffffffH
	DD	FLAT:$L79977
	DD	00H
	DD	FLAT:$L79978
	DD	01H
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T80016	DD	019930520H
	DD	02H
	DD	FLAT:$T80018
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T80018	DD	0ffffffffH
	DD	FLAT:$L80012
	DD	00H
	DD	FLAT:$L80013
xdata$x	ENDS
...
; File D:\Program Files\Microsoft Visual Studio\VC98\MFC\INCLUDE\afxwin1.inl
xdata$x	SEGMENT
$T80049	DD	019930520H
	DD	01H
	DD	FLAT:$T80052
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T80052	DD	0ffffffffH
	DD	FLAT:$L80033
xdata$x	ENDS
;	COMDAT ?GetIcon@CSmartTrackerClass@@UAGJHPAJ@Z
_TEXT	SEGMENT
...
;	COMDAT ??_C@_0BA@OJLB@Smart?5Tracker?54?$AA@
; File D:\SySal2\SmartTracker4_NoCleaning\SmartTrackerClass.cpp
_DATA	SEGMENT
...
; 540  : 			Icell = GetCell(PClus->X *= PixelToMicronX, PClus->Y *= PixelToMicronY);
	...
	fst	DWORD PTR [ebp]
	fstp	DWORD PTR $T80096[esp+52]
	fld	DWORD PTR _PixelToMicronX$[esp+56]
	fmul	DWORD PTR [ebx]
	fst	DWORD PTR [ebx]
	fst	DWORD PTR $T80095[esp+52]
	fcomp	DWORD PTR [esi+920]
	fnstsw	ax
	test	ah, 1
	jne	$L78849
	fld	DWORD PTR $T80095[esp+52]
	fcomp	DWORD PTR [esi+924]
	fnstsw	ax
	test	ah, 1
	je	$L78849
	fld	DWORD PTR $T80096[esp+52]
...
; 792  : 				if (ccount >= MaxNumber) throw ccount;
	...
	cmp	ebx, edx
	jl	SHORT $L79021
	lea	eax, DWORD PTR $T80192[ebp]
	push	OFFSET FLAT:__TI1H
	push	eax
	mov	DWORD PTR $T80192[ebp], ebx
...
; 1179 : 	for (p = 0; p < T.Processors; p++)
	...
	lea	edi, DWORD PTR _HEvs$[esp+60]
	lea	ecx, DWORD PTR [ecx+ecx*4]
	shl	ecx, 2
	mov	DWORD PTR -40+[esp+60], ecx
...
; 1184 : 		ThreadInfo[p].StartLayer = StartLayer;
	...
	mov	ebp, DWORD PTR _StartLayer$[esp+56]
	mov	DWORD PTR [ecx+8], ebp

; 1185 : 		ThreadInfo[p].EndLayer = EndLayer;

	mov	ebp, DWORD PTR _EndLayer$[esp+56]
	mov	DWORD PTR [ecx+12], ebp
	mov	ebp, DWORD PTR -40+[esp+60]

; 1186 : 		ThreadInfo[p].MaxTracks = maxtracksperthread;

	mov	DWORD PTR [ecx-8], eax
	add	edx, ebp
	mov	ebp, DWORD PTR [esi+896]
	add	edi, 4
...
; 1198 : 	for (p = 1; p < T.Processors; p++)
	...
	cmp	eax, ebx
	mov	DWORD PTR _p$[esp+60], ebx
	jle	$L79335
	lea	ebx, DWORD PTR [esi+1028]
	mov	DWORD PTR -40+[esp+60], ebx
$L79333:
...
; 1206 : 				pTemp = pSpace[k].pGrains;
	...
	mov	DWORD PTR _pTemp$[esp+60], ebp
...
; 1208 : 				pSpace[k - 1].pGrains = pTemp;
	...
	mov	ebp, DWORD PTR _pTemp$[esp+60]
...
; 1218 : 	*pMaxNumber = found;
	...
	mov	ebx, DWORD PTR _pMaxNumber$[esp+56]
...
; 1341 : 	for (i = 0; i < Layers; i++)
	...
	mov	ebp, DWORD PTR _Layers$[esp+4]
	xor	edx, edx
	push	esi
	push	edi
	test	ebp, ebp
	jle	SHORT $L79435
	mov	esi, DWORD PTR _pTempGrains$[esp+12]
$L79433:
...
; 1342 : 		if (pTempGrains[i] && pTempGrains[i]->TrackLength >= SequenceLength) return;
	...
	test	eax, eax
	je	SHORT $L79434
	mov	edi, DWORD PTR _SequenceLength$[esp+12]
...
; 1356 : */	Track2 &N = pTracks[NTracks++];
	...
	mov	esi, DWORD PTR _NTracks$[esp+12]
	mov	edi, DWORD PTR _pTracks$[esp+12]
	mov	eax, DWORD PTR [esi]
...
; 1358 : 		if (pTempGrains[i])
	...
	mov	eax, DWORD PTR _pTempGrains$[esp+12]
...
; 1367 : 	N.Grains = SequenceLength;
	...
	mov	ecx, DWORD PTR _SequenceLength$[esp+12]
...
;	COMDAT ??_C@_02MECO@?$CFd?$AA@
; File D:\SySal2\SmartTracker4_NoCleaning\..\Common\Config2.cpp
_DATA	SEGMENT
