...
OBJECT_ENTRY(CLSID_SmartTracker4, CSmartTrackerClass)
END_OBJECT_MAP()
...
STDAPI DllRegisterServer(void)
{
	...
	try
	{
		...
		MyKey.Close();
		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\SmartTracker4", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 3;
		MyKey.Close();
		MyKey.Open(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\SmartTracker4", KEY_READ | KEY_WRITE);
		char CLSIDString[64];
		wsprintf(CLSIDString, "{%08X-%04X-%04X-%02X%02X-%02X%02X%02X%02X%02X%02X}", 
			CLSID_SmartTracker4.Data1, CLSID_SmartTracker4.Data2, CLSID_SmartTracker4.Data3, 
			CLSID_SmartTracker4.Data4[0], CLSID_SmartTracker4.Data4[1], CLSID_SmartTracker4.Data4[2], CLSID_SmartTracker4.Data4[3], 
			CLSID_SmartTracker4.Data4[4], CLSID_SmartTracker4.Data4[5], CLSID_SmartTracker4.Data4[6], CLSID_SmartTracker4.Data4[7]);
	...
	catch (...)
	{
		...
		MyKey.RecurseDeleteKey("Software\\SySal2\\Classes\\SmartTracker4");
		MyKey.Close();
		};
