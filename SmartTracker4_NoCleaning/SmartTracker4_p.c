...
const CInterfaceProxyVtbl * _SmartTracker4_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _SmartTracker4_StubVtblList[] = 
{
...
PCInterfaceName const _SmartTracker4_InterfaceNamesList[] = 
{
    "ITracker2",
    "ITracker",
    "ITracker3",
...
#define _SmartTracker4_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SmartTracker4, pIID, n)

int __stdcall _SmartTracker4_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _SmartTracker4, 4, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _SmartTracker4, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _SmartTracker4, 4, *pIndex )
    
}

const ExtendedProxyFileInfo SmartTracker4_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SmartTracker4_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SmartTracker4_StubVtblList,
    (const PCInterfaceName * ) & _SmartTracker4_InterfaceNamesList,
    0, // no delegation
    & _SmartTracker4_IID_Lookup, 
    4,
    2,
