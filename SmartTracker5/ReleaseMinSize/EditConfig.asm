	TITLE	D:\SySal2\SmartTracker5\EditConfig.cpp
	.386P
include listing.inc
if @Version gt 510
.model FLAT
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T78758	DD	019930520H
	DD	03H
	DD	FLAT:$T78761
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T78761	DD	0ffffffffH
	DD	FLAT:$L78747
	DD	00H
	DD	FLAT:$L78748
	DD	01H
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T78790	DD	019930520H
	DD	02H
	DD	FLAT:$T78792
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T78792	DD	0ffffffffH
	DD	FLAT:$L78786
	DD	00H
	DD	FLAT:$L78787
xdata$x	ENDS
...
; 87   : BEGIN_MESSAGE_MAP(CEditConfig, CDialog)
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T78821	DD	019930520H
	DD	02H
	DD	FLAT:$T78829
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T78829	DD	0ffffffffH
	DD	FLAT:$L78807
	DD	00H
	DD	FLAT:$L78808
xdata$x	ENDS
...
; 105  : 	if (C.TrialCount >= MAX_TRIALS)
...
; 106  : 	{
; 107  : 		MessageBox("Too many trials", "Trial Error");
...
; 109  : 		};
; 110  : 	if (m_BottomLayer <= m_TopLayer)
...
; 111  : 	{
; 112  : 		MessageBox("Bottom layer must be higher than Top layer", "Trial Error");
...
; 114  : 		};
; 115  : 	C.Trials[C.TrialCount].TopLayer = m_TopLayer;

	lea	edx, DWORD PTR [eax+eax*4+15]
	lea	eax, DWORD PTR [eax+edx*2+3]
	mov	DWORD PTR [ebp+eax*4], ecx

; 116  : 	C.Trials[C.TrialCount].BottomLayer = m_BottomLayer;
...
; 120  : 	strcpy(tempstr, m_Triggers);

	mov	edi, DWORD PTR [ebp+952]
	or	ecx, -1
	xor	eax, eax
...
; 122  : 	int i;
; 123  : 	for (i = 0; i < MAX_TRIGGERS && str; i++)
...
; 124  : 	{
; 125  : 		if (sscanf(str, "%d", &C.Trials[C.TrialCount].Triggers[i]) != 1)
...
; 131  : 			}
; 132  : 		tsub.Format("%d", C.Trials[C.TrialCount].Triggers[i]);
...
; 136  : 		}
; 137  : 	C.Trials[C.TrialCount].TriggerCount = i;

	mov	eax, DWORD PTR [ebp+128]

; 138  : 	sprintf(tempstr, "%d", C.Trials[C.TrialCount].TopLayer);
...
; 139  : 	m_TrialList.InsertItem(C.TrialCount, tempstr);

	mov	eax, DWORD PTR [ebp+128]
	add	esp, 12					; 0000000cH
	lea	edx, DWORD PTR _tempstr$[esp+292]
	lea	esi, DWORD PTR [ebp+880]
	push	0
	push	0
	push	0
	push	0
...
; 140  : 	sprintf(tempstr, "%d", C.Trials[C.TrialCount].BottomLayer);
...
; 141  : 	m_TrialList.SetItemText(C.TrialCount, 1, tempstr);
...
; 142  : 	m_TrialList.SetItemText(C.TrialCount, 2, sub);
...
; 126  : 		{
; 127  : 			MessageBox("Triggers must be comma-separated integers", "Trial Error");
...
; 128  : 			for (i = 0; i < MAX_TRIGGERS; i++)

	xor	ecx, ecx
$L78350:

; 129  : 				C.Trials[C.TrialCount].Triggers[i] = -1;
...
; 149  : 	int index = m_TrialList.GetSelectionMark();
...
; 151  : 	{
; 152  : 		int i, j;
; 153  : 		for (i = index + 1; i < C.TrialCount + 1; i++)
...
; 155  : 		for (j = 0; j < MAX_TRIGGERS; j++)

	lea	edx, DWORD PTR [eax+eax*4]

; 156  : 			C.Trials[i].Triggers[j] = -1;

	mov	ecx, 8

; 157  : 		C.TrialCount--;
; 158  : 		m_TrialList.DeleteItem(index);
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T78863	DD	019930520H
	DD	02H
	DD	FLAT:$T78871
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T78871	DD	0ffffffffH
	DD	FLAT:$L78847
	DD	00H
	DD	FLAT:$L78848
xdata$x	ENDS
...
; 167  : 	m_TrialList.InsertColumn(0, "Top", LVCFMT_RIGHT, 60, 0);

	xor	ebp, ebp
	lea	ebx, DWORD PTR [esi+880]
	push	ebp
	push	60					; 0000003cH
	push	1
...
; 168  : 	m_TrialList.InsertColumn(1, "Bottom", LVCFMT_RIGHT, 60, 1);
...
; 169  : 	m_TrialList.InsertColumn(2, "Trigger", LVCFMT_RIGHT, 80, 2);
...
; 170  : 	ListView_SetExtendedListViewStyle(m_TrialList.m_hWnd, (LVS_EX_FULLROWSELECT | LVS_EX_GRIDLINES) | ListView_GetExtendedListViewStyle(m_TrialList.m_hWnd));
...
; 175  : 	{
; 176  : 		str.Format("%d", C.Trials[i].TopLayer);
...
; 177  : 		m_TrialList.InsertItem(i, str);
...
; 178  : 		str.Format("%d", C.Trials[i].BottomLayer);
...
; 179  : 		m_TrialList.SetItemText(i, 1, str);
...
; 181  : 		for (j = 0; j < C.Trials[i].TriggerCount; j++)
...
; 184  : 			temp.Format("%d", C.Trials[i].Triggers[j]);
...
; 186  : 			}
; 187  : 		m_TrialList.SetItemText(i, 2, str);
...
;	COMDAT xdata$x
; File D:\SySal2\SmartTracker5\EditConfig.cpp
xdata$x	SEGMENT
$T78884	DD	019930520H
	DD	03H
	DD	FLAT:$T78886
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T78886	DD	0ffffffffH
	DD	FLAT:$L78876
	DD	0ffffffffH
	DD	FLAT:$L78878
	DD	01H
...
; 197  : 
; 198  : 	SySalConfig OldC, NewC;
; 199  : 	OldC.Name[0] = NewC.Name[0] = 0;
; 200  : 	OldC.CountOfItems = NewC.CountOfItems = 0;
; 201  : 	OldC.pItems = NewC.pItems = 0;
; 202  : 
; 203  : 	pTk->GetConfig(&OldC);
...
; 204  : 
; 205  : 	CSmartTrackerClass::PutData(&NewC, &C);
...
; 211  : 
; 212  : 	pTk->SetConfig(&OldC);

	mov	esi, DWORD PTR [esi+956]
	lea	edx, DWORD PTR _OldC$[esp+288]
	push	edx
...
; 213  : 
; 214  : 	if (OldC.pItems) CoTaskMemFree(OldC.pItems);
...
; 215  : 	if (NewC.pItems) CoTaskMemFree(NewC.pItems);
...
; 221  : 	HtmlHelp(this->m_hWnd, CSmartTrackerClass::pHelpPath, HH_DISPLAY_TOPIC, (DWORD)"HelpConfig.htm");	
