	TITLE	D:\SySal2\SmartTracker5\SmartTracker5.cpp
	.386P
include listing.inc
if @Version gt 510
.model FLAT
...
_DATA	SEGMENT DWORD USE32 PUBLIC 'DATA'
_DATA	ENDS
;	COMDAT ??_C@_0CG@FEGD@Software?2SySal2?2Classes?2SmartTra@
_DATA	SEGMENT DWORD USE32 PUBLIC 'DATA'
_DATA	ENDS
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker5@@3U_GUID@@B@ATL@@SGPBDXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker5@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
PUBLIC	?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker5@@3U_GUID@@B@ATL@@SGPBDXZ ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker5>::GetObjectDescription
PUBLIC	?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker5@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker5>::GetCategoryMap
...
_IID_ITracker3 DD 07a9e779cH
	...
	DB	062H
	DB	0b7H
_LIBID_SMARTTRACKERLib DD 095384718H
	DW	06edbH
	DW	04bcaH
	DB	095H
	DB	0faH
	...
	DB	059H
	DB	06cH
_CLSID_SmartTracker5 DD 032744ad4H
	DW	0d177H
	DW	04a00H
	DB	087H
	DB	09eH
...
CONST	ENDS
_DATA	SEGMENT
_ObjectMap DD	FLAT:_CLSID_SmartTracker5
	...
	DD	00H
	DD	00H
	DD	FLAT:?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker5@@3U_GUID@@B@ATL@@SGPBDXZ
	DD	FLAT:?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker5@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ
...
; 185  : DECLARE_REGISTRY_RESOURCEID(IDR_SMARTTRACKER)
...
PUBLIC	??_C@_0CG@FEGD@Software?2SySal2?2Classes?2SmartTra@ ; `string'
...
;	COMDAT ??_C@_0CG@FEGD@Software?2SySal2?2Classes?2SmartTra@
_DATA	SEGMENT
??_C@_0CG@FEGD@Software?2SySal2?2Classes?2SmartTra@ DB 'Software\SySal2\C'
	DB	'lasses\SmartTracker5', 00H			; `string'
_DATA	ENDS
;	COMDAT ??_C@_0DD@BIAF@?$HL?$CF08X?9?$CF04X?9?$CF04X?9?$CF02X?$CF02X?9?$CF02X?$CF02@
_DATA	SEGMENT
...
; 92   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 0;
	...
	lea	eax, DWORD PTR _dw$73635[ebp]
	lea	ecx, DWORD PTR _hKey$73636[ebp]
	push	eax
...
; 94   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 1;
	...
	lea	eax, DWORD PTR _dw$73649[ebp]
	lea	ecx, DWORD PTR _hKey$73650[ebp]
	push	eax
	push	ecx
	push	esi
	push	131103					; 0002001fH
	...
	push	-2147483646				; 80000002H
	mov	DWORD PTR _hKey$73650[ebp], esi
	call	edi
	cmp	eax, esi
	jne	SHORT $L73724
	lea	ecx, DWORD PTR _MyKey$[ebp]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73650[ebp]
	cmp	eax, esi
	mov	DWORD PTR _MyKey$[ebp], ecx
	je	SHORT $L73019
$L73724:
	lea	edx, DWORD PTR $T73623[ebp]
	push	OFFSET FLAT:__TI1H
	push	edx
	mov	DWORD PTR $T73623[ebp], 1
	call	__CxxThrowException@8
$L73019:
...
; 96   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 2;
	...
	lea	eax, DWORD PTR _dw$73663[ebp]
	lea	ecx, DWORD PTR _hKey$73664[ebp]
	push	eax
	push	ecx
	push	esi
	push	131103					; 0002001fH
	...
	push	-2147483646				; 80000002H
	mov	DWORD PTR _hKey$73664[ebp], esi
	call	edi
	cmp	eax, esi
	jne	SHORT $L73725
	lea	ecx, DWORD PTR _MyKey$[ebp]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73664[ebp]
	cmp	eax, esi
	mov	DWORD PTR _MyKey$[ebp], ecx
	je	SHORT $L73023
$L73725:
...
; 98   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\SmartTracker5", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 3;

	lea	eax, DWORD PTR _dw$73677[ebp]
	lea	ecx, DWORD PTR _hKey$73678[ebp]
	push	eax
	push	ecx
	push	esi
	push	131103					; 0002001fH
	...
	push	esi
	push	esi
	push	OFFSET FLAT:??_C@_0CG@FEGD@Software?2SySal2?2Classes?2SmartTra@ ; `string'
	push	-2147483646				; 80000002H
	mov	DWORD PTR _hKey$73678[ebp], esi
	call	edi
	cmp	eax, esi
	jne	SHORT $L73726
	lea	ecx, DWORD PTR _MyKey$[ebp]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73678[ebp]
	cmp	eax, esi
	mov	DWORD PTR _MyKey$[ebp], ecx
	je	SHORT $L73027
$L73726:
	lea	edx, DWORD PTR $T73625[ebp]
	push	OFFSET FLAT:__TI1H
	push	edx
	mov	DWORD PTR $T73625[ebp], 3
	call	__CxxThrowException@8
$L73027:
...
; 100  : 		MyKey.Open(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\SmartTracker5", KEY_READ | KEY_WRITE);

	lea	eax, DWORD PTR _hKey$73691[ebp]
	mov	DWORD PTR _hKey$73691[ebp], esi
	push	eax
	push	131103					; 0002001fH
	push	esi
	push	OFFSET FLAT:??_C@_0CG@FEGD@Software?2SySal2?2Classes?2SmartTra@ ; `string'
	...
	lea	ecx, DWORD PTR _MyKey$[ebp]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73691[ebp]
	mov	DWORD PTR _MyKey$[ebp], ecx
$L73693:

; 101  : 		char CLSIDString[64];
; 102  : 		wsprintf(CLSIDString, "{%08X-%04X-%04X-%02X%02X-%02X%02X%02X%02X%02X%02X}", 
; 103  : 			CLSID_SmartTracker5.Data1, CLSID_SmartTracker5.Data2, CLSID_SmartTracker5.Data3, 
; 104  : 			CLSID_SmartTracker5.Data4[0], CLSID_SmartTracker5.Data4[1], CLSID_SmartTracker5.Data4[2], CLSID_SmartTracker5.Data4[3], 
; 105  : 			CLSID_SmartTracker5.Data4[4], CLSID_SmartTracker5.Data4[5], CLSID_SmartTracker5.Data4[6], CLSID_SmartTracker5.Data4[7]);

	xor	edx, edx
	xor	eax, eax
	mov	dl, BYTE PTR _CLSID_SmartTracker5+15
	mov	al, BYTE PTR _CLSID_SmartTracker5+14
	push	edx
	push	eax
	mov	eax, DWORD PTR _CLSID_SmartTracker5+12
	xor	ecx, ecx
	mov	cl, ah
	...
	xor	edx, edx
	xor	eax, eax
	mov	dl, BYTE PTR _CLSID_SmartTracker5+11
	mov	al, BYTE PTR _CLSID_SmartTracker5+10
	push	edx
	push	eax
	mov	eax, DWORD PTR _CLSID_SmartTracker5+8
	xor	ecx, ecx
	mov	cl, ah
	and	eax, 255				; 000000ffH
	push	ecx
	mov	ecx, DWORD PTR _CLSID_SmartTracker5
	push	eax
	mov	eax, DWORD PTR _CLSID_SmartTracker5+4
	xor	edx, edx
	and	eax, 65535				; 0000ffffH
	mov	dx, WORD PTR _CLSID_SmartTracker5+6
	push	edx
	push	eax
	push	ecx
	lea	edx, DWORD PTR _CLSIDString$73031[ebp]
...
; 106  : 		MyKey.SetValue(CLSIDString, "CLSID");
	...
	lea	eax, DWORD PTR _CLSIDString$73031[ebp]
	push	eax
	call	DWORD PTR __imp__lstrlenA@4
	mov	edx, DWORD PTR _MyKey$[ebp]
	inc	eax
	lea	ecx, DWORD PTR _CLSIDString$73031[ebp]
	push	eax
	push	ecx
	push	1
	push	esi
...
; 113  : 		MyKey.RecurseDeleteKey("Software\\SySal2\\Classes\\SmartTracker5");
...
; 125  : 	MyKey.Open(HKEY_LOCAL_MACHINE, "", KEY_READ | KEY_WRITE);
	...
	lea	eax, DWORD PTR _hKey$73757[esp+284]
	push	edi
	...
	push	-2147483646				; 80000002H
	xor	esi, esi
	mov	DWORD PTR _hKey$73757[esp+308], ebx
	call	edi
	test	eax, eax
	jne	SHORT $L73759
	mov	esi, DWORD PTR _hKey$73757[esp+288]
$L73759:

; 126  : 	MyKey.RecurseDeleteKey("Software\\SySal2\\Classes\\SmartTracker5");

	lea	ecx, DWORD PTR _hKey$73799[esp+288]
	mov	DWORD PTR _key$73815[esp+288], ebx
	push	ecx
	push	131103					; 0002001fH
	push	ebx
	push	OFFSET FLAT:??_C@_0CG@FEGD@Software?2SySal2?2Classes?2SmartTra@ ; `string'
	push	esi
	mov	DWORD PTR _hKey$73799[esp+308], ebx
	call	edi
	cmp	eax, ebx
	jne	$L73845
	lea	ecx, DWORD PTR _key$73815[esp+288]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73799[esp+288]
	cmp	eax, ebx
	mov	DWORD PTR _key$73815[esp+288], ecx
	jne	SHORT $L73845
	lea	edx, DWORD PTR _time$73818[esp+288]
	mov	edi, DWORD PTR __imp__RegEnumKeyExA@32
	push	edx
	push	ebx
	push	ebx
	lea	eax, DWORD PTR _dwSize$73819[esp+300]
	push	ebx
	lea	edx, DWORD PTR _szBuffer$73820[esp+304]
	push	eax
	push	edx
	push	ebx
	push	ecx
	mov	DWORD PTR _dwSize$73819[esp+320], 256	; 00000100H
	call	edi
	test	eax, eax
	jne	SHORT $L73822
$L73821:
	lea	eax, DWORD PTR _szBuffer$73820[esp+288]
	lea	ecx, DWORD PTR _key$73815[esp+288]
	push	eax
	call	?RecurseDeleteKey@CRegKey@ATL@@QAEJPBD@Z ; ATL::CRegKey::RecurseDeleteKey
	test	eax, eax
	jne	SHORT $L73845
	lea	ecx, DWORD PTR _time$73818[esp+288]
	lea	edx, DWORD PTR _dwSize$73819[esp+288]
	push	ecx
	mov	ecx, DWORD PTR _key$73815[esp+292]
	push	ebx
	push	ebx
	push	ebx
	lea	eax, DWORD PTR _szBuffer$73820[esp+304]
	push	edx
	push	eax
	push	ebx
	push	ecx
	...
	je	SHORT $L73821
$L73822:
	mov	eax, DWORD PTR _key$73815[esp+288]
	cmp	eax, ebx
	je	SHORT $L73809
	push	eax
	call	DWORD PTR __imp__RegCloseKey@4
...
;	COMDAT ?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker5@@3U_GUID@@B@ATL@@SGPBDXZ
_TEXT	SEGMENT
?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker5@@3U_GUID@@B@ATL@@SGPBDXZ PROC NEAR ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker5>::GetObjectDescription, COMDAT

; 3127 : 	static LPCTSTR WINAPI GetObjectDescription() {return NULL;}

	xor	eax, eax
	ret	0
?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker5@@3U_GUID@@B@ATL@@SGPBDXZ ENDP ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker5>::GetObjectDescription
_TEXT	ENDS
;	COMDAT ?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker5@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ
_TEXT	SEGMENT
?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker5@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ PROC NEAR ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker5>::GetCategoryMap, COMDAT

; 3128 : 	static const struct _ATL_CATMAP_ENTRY* GetCategoryMap() {return NULL;};

	xor	eax, eax
	ret	0
?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker5@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ ENDP ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker5>::GetCategoryMap
_TEXT	ENDS
...
text$x	SEGMENT
$L73867:
	mov	eax, DWORD PTR $T73858[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
$L73983:
	mov	eax, OFFSET FLAT:$T73979
	jmp	___CxxFrameHandler
text$x	ENDS
...
text$x	SEGMENT
$L74126:
	mov	eax, DWORD PTR $T74117[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
$L74184:
	mov	eax, OFFSET FLAT:$T74180
	jmp	___CxxFrameHandler
text$x	ENDS
...
xdata$x	SEGMENT
$T74244	DD	019930520H
	DD	02H
	DD	FLAT:$T74249
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T74249	DD	0ffffffffH
	DD	FLAT:$L74191
	DD	00H
	DD	FLAT:$L74192
xdata$x	ENDS
...
; 127  : 		Name[0] = 0;
; 128  : 		HStatusChangeEvent = 0;
; 129  : 		CamSpec.Width = CamSpec.Height = 0;
; 130  : 		CamSpec.WinWidth = CamSpec.WinHeight = 0;
; 131  : 		CamSpec.OffX = CamSpec.OffY = 0;
; 132  : 		CamSpec.PixelToMicronX = CamSpec.PixelToMicronY = 1.f;
...
; 134  : 		int i;
; 135  : 		HStart = CreateEvent(NULL, TRUE, FALSE, NULL);
...
; 136  : 		HReset = CreateEvent(NULL, TRUE, FALSE, NULL);
...
; 137  : 		HTerminate = CreateEvent(NULL, TRUE, FALSE, NULL);

	push	ebx
	push	ebx
	push	1
	push	ebx
	mov	DWORD PTR [esi+1000], eax
	call	edi
	mov	DWORD PTR [esi+996], eax
	lea	eax, DWORD PTR [esi+1004]
	mov	ecx, 8
$L72834:

; 138  : 		for (i = 0; i < MAX_PROCESSORS; i++)
; 139  : 		{
; 140  : 			ThreadInfo[i].HFinished = 0;

	mov	DWORD PTR [eax+20], ebx

; 141  : 			ThreadInfo[i].pThis = this;

	mov	DWORD PTR [eax], esi

; 142  : 			ThreadInfo[i].HThread = 0;
...
; File D:\Program Files\Microsoft Visual Studio\VC98\ATL\INCLUDE\atlbase.h
xdata$x	SEGMENT
$T74358	DD	019930520H
	DD	01H
	DD	FLAT:$T74362
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T74362	DD	0ffffffffH
	DD	FLAT:$L74323
xdata$x	ENDS
;	COMDAT ??1?$CComObject@VCSmartTrackerClass@@@ATL@@UAE@XZ
_TEXT	SEGMENT
...
$L74341:
	...
	push	eax
	call	ebx
	mov	ecx, DWORD PTR [esi+1000]
	push	ecx
	call	ebx
	mov	edx, DWORD PTR [esi+996]
	push	edx
	call	ebx
...
$L74347:
	mov	eax, DWORD PTR __ctlState$74338[esp+48]
	mov	ecx, DWORD PTR __ctlState$74338[esp+44]
	neg	esi
	mov	DWORD PTR [eax+4], ecx
...
$L74323:
	...
	add	eax, 8
	mov	DWORD PTR $T74336[ebp], eax
	jmp	$L74322
$L74321:
	mov	DWORD PTR $T74336[ebp], 0
$L74322:
	mov	ecx, DWORD PTR $T74336[ebp]
	jmp	??1?$CComObjectRootEx@VCComMultiThreadModel@ATL@@@ATL@@QAE@XZ ; ATL::CComObjectRootEx<ATL::CComMultiThreadModel>::~CComObjectRootEx<ATL::CComMultiThreadModel>
$L74361:
	mov	eax, OFFSET FLAT:$T74358
	jmp	___CxxFrameHandler
text$x	ENDS
...
; File D:\Program Files\Microsoft Visual Studio\VC98\ATL\INCLUDE\atlbase.h
xdata$x	SEGMENT
$T74464	DD	019930520H
	DD	01H
	DD	FLAT:$T74474
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T74474	DD	0ffffffffH
	DD	FLAT:$L74399
xdata$x	ENDS
;	COMDAT ?RecurseDeleteKey@CRegKey@ATL@@QAEJPBD@Z
_TEXT	SEGMENT
...
; 4893 : 	LONG lRes = key.Open(m_hKey, lpszKey, KEY_READ | KEY_WRITE);
	...
	lea	ecx, DWORD PTR _hKey$74410[esp+304]
	...
	push	edx
	push	eax
	mov	DWORD PTR _hKey$74410[esp+324], edi
	call	DWORD PTR __imp__RegOpenKeyExA@20
	mov	esi, eax
	cmp	esi, edi
	jne	SHORT $L74469
	...
	call	DWORD PTR __imp__RegCloseKey@4
$L74416:
	mov	ecx, DWORD PTR _hKey$74410[esp+304]
