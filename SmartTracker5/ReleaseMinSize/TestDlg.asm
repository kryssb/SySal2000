	TITLE	D:\SySal2\SmartTracker5\TestDlg.cpp
	.386P
include listing.inc
if @Version gt 510
.model FLAT
...
;	COMDAT ??_C@_00A@?$AA@
; File D:\SySal2\SmartTracker5\TestDlg.cpp
_BSS	SEGMENT
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T76074	DD	019930520H
	DD	03H
	DD	FLAT:$T76077
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T76077	DD	0ffffffffH
	DD	FLAT:$L76068
	DD	00H
	DD	FLAT:$L76069
	DD	01H
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T76094	DD	019930520H
	DD	02H
	DD	FLAT:$T76096
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T76096	DD	0ffffffffH
	DD	FLAT:$L76090
	DD	00H
	DD	FLAT:$L76091
xdata$x	ENDS
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T76158	DD	019930520H
	DD	03H
	DD	FLAT:$T76160
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T76160	DD	0ffffffffH
	DD	FLAT:$L76140
	DD	00H
	DD	FLAT:$L76141
	DD	0ffffffffH
...
; 121  : 		m_DataFile = MyDlg.GetPathName();
	...
	lea	eax, DWORD PTR $T76139[esp+532]
	lea	ecx, DWORD PTR _MyDlg$[esp+532]
	push	eax
	...
	lea	ecx, DWORD PTR $T76139[esp+532]
...
$L76141:
	lea	ecx, DWORD PTR $T76139[ebp]
	jmp	??1CString@@QAE@XZ			; CString::~CString
$L76147:
	lea	ecx, DWORD PTR _MyDlg$[ebp]
	jmp	??1CCommonDialog@@UAE@XZ		; CCommonDialog::~CCommonDialog
$L76159:
	mov	eax, OFFSET FLAT:$T76158
	jmp	___CxxFrameHandler
text$x	ENDS
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T76175	DD	019930520H
	DD	01H
	DD	FLAT:$T76177
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T76177	DD	0ffffffffH
	DD	FLAT:$L76168
xdata$x	ENDS
;	COMDAT ??1CFileDialog@@UAE@XZ
_TEXT	SEGMENT
