...
const CInterfaceProxyVtbl * _SmartTracker5_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _SmartTracker5_StubVtblList[] = 
{
...
PCInterfaceName const _SmartTracker5_InterfaceNamesList[] = 
{
    "ITracker2",
    "ITracker",
    "ITracker3",
...
#define _SmartTracker5_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SmartTracker5, pIID, n)

int __stdcall _SmartTracker5_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _SmartTracker5, 4, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _SmartTracker5, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _SmartTracker5, 4, *pIndex )
    
}

const ExtendedProxyFileInfo SmartTracker5_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SmartTracker5_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SmartTracker5_StubVtblList,
    (const PCInterfaceName * ) & _SmartTracker5_InterfaceNamesList,
    0, // no delegation
    & _SmartTracker5_IID_Lookup, 
    4,
    2,
