	TITLE	D:\SySal2\SmartTracker6\TestDlg.cpp
	.386P
include listing.inc
if @Version gt 510
.model FLAT
...
;	COMDAT ??_C@_00A@?$AA@
; File D:\SySal2\SmartTracker6\TestDlg.cpp
_BSS	SEGMENT
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T76100	DD	019930520H
	DD	03H
	DD	FLAT:$T76103
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T76103	DD	0ffffffffH
	DD	FLAT:$L76094
	DD	00H
	DD	FLAT:$L76095
	DD	01H
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T76120	DD	019930520H
	DD	02H
	DD	FLAT:$T76122
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T76122	DD	0ffffffffH
	DD	FLAT:$L76116
	DD	00H
	DD	FLAT:$L76117
xdata$x	ENDS
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T76184	DD	019930520H
	DD	03H
	DD	FLAT:$T76186
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T76186	DD	0ffffffffH
	DD	FLAT:$L76166
	DD	00H
	DD	FLAT:$L76167
	DD	0ffffffffH
...
; 121  : 		m_DataFile = MyDlg.GetPathName();
	...
	lea	eax, DWORD PTR $T76165[esp+532]
	lea	ecx, DWORD PTR _MyDlg$[esp+532]
	push	eax
	...
	lea	ecx, DWORD PTR $T76165[esp+532]
...
$L76167:
	lea	ecx, DWORD PTR $T76165[ebp]
	jmp	??1CString@@QAE@XZ			; CString::~CString
$L76173:
	lea	ecx, DWORD PTR _MyDlg$[ebp]
	jmp	??1CCommonDialog@@UAE@XZ		; CCommonDialog::~CCommonDialog
$L76185:
	mov	eax, OFFSET FLAT:$T76184
	jmp	___CxxFrameHandler
text$x	ENDS
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T76201	DD	019930520H
	DD	01H
	DD	FLAT:$T76203
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T76203	DD	0ffffffffH
	DD	FLAT:$L76194
xdata$x	ENDS
;	COMDAT ??1CFileDialog@@UAE@XZ
_TEXT	SEGMENT
