...
/* at Mon Mar 22 12:44:00 2004
 */
/* Compiler settings for D:\SySal2\SmartTracker6\SmartTracker6.idl:
...
const CInterfaceProxyVtbl * _SmartTracker6_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _SmartTracker6_StubVtblList[] = 
{
...
PCInterfaceName const _SmartTracker6_InterfaceNamesList[] = 
{
    "ITracker2",
    "ITracker",
    "ITracker3",
...
#define _SmartTracker6_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SmartTracker6, pIID, n)

int __stdcall _SmartTracker6_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _SmartTracker6, 4, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _SmartTracker6, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _SmartTracker6, 4, *pIndex )
    
}

const ExtendedProxyFileInfo SmartTracker6_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SmartTracker6_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SmartTracker6_StubVtblList,
    (const PCInterfaceName * ) & _SmartTracker6_InterfaceNamesList,
    0, // no delegation
    & _SmartTracker6_IID_Lookup, 
    4,
    2,
