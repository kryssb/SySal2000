	TITLE	D:\SySal2\SmartTracker7\SmartTracker7.cpp
	.386P
include listing.inc
if @Version gt 510
.model FLAT
...
_DATA	SEGMENT DWORD USE32 PUBLIC 'DATA'
_DATA	ENDS
;	COMDAT ??_C@_0CG@BEN@Software?2SySal2?2Classes?2SmartTra@
_DATA	SEGMENT DWORD USE32 PUBLIC 'DATA'
_DATA	ENDS
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker7@@3U_GUID@@B@ATL@@SGPBDXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker7@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
PUBLIC	?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker7@@3U_GUID@@B@ATL@@SGPBDXZ ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker7>::GetObjectDescription
PUBLIC	?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker7@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker7>::GetCategoryMap
...
_IID_ITracker3 DD 07a9e779cH
	...
	DB	062H
	DB	0b7H
_LIBID_SMARTTRACKERLib DD 0cbb17c05H
	DW	0285cH
	DW	0423dH
	DB	087H
	DB	0e4H
	...
	DB	07fH
	DB	02bH
_CLSID_SmartTracker7 DD 0a6876062H
	DW	0a5c3H
	DW	04971H
	DB	089H
	DB	035H
...
CONST	ENDS
_DATA	SEGMENT
_ObjectMap DD	FLAT:_CLSID_SmartTracker7
	...
	DD	00H
	DD	00H
	DD	FLAT:?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker7@@3U_GUID@@B@ATL@@SGPBDXZ
	DD	FLAT:?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker7@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ
...
; 198  : DECLARE_REGISTRY_RESOURCEID(IDR_SMARTTRACKER)
...
PUBLIC	??_C@_0CG@BEN@Software?2SySal2?2Classes?2SmartTra@ ; `string'
...
;	COMDAT ??_C@_0CG@BEN@Software?2SySal2?2Classes?2SmartTra@
_DATA	SEGMENT
??_C@_0CG@BEN@Software?2SySal2?2Classes?2SmartTra@ DB 'Software\SySal2\Cl'
	DB	'asses\SmartTracker7', 00H			; `string'
_DATA	ENDS
;	COMDAT ??_C@_0DD@BIAF@?$HL?$CF08X?9?$CF04X?9?$CF04X?9?$CF02X?$CF02X?9?$CF02X?$CF02@
_DATA	SEGMENT
...
; 92   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 0;
	...
	lea	eax, DWORD PTR _dw$73664[ebp]
	lea	ecx, DWORD PTR _hKey$73665[ebp]
	push	eax
...
; 94   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 1;
	...
	lea	eax, DWORD PTR _dw$73678[ebp]
	lea	ecx, DWORD PTR _hKey$73679[ebp]
	push	eax
	push	ecx
	push	esi
	push	131103					; 0002001fH
	...
	push	-2147483646				; 80000002H
	mov	DWORD PTR _hKey$73679[ebp], esi
	call	edi
	cmp	eax, esi
	jne	SHORT $L73753
	lea	ecx, DWORD PTR _MyKey$[ebp]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73679[ebp]
	cmp	eax, esi
	mov	DWORD PTR _MyKey$[ebp], ecx
	je	SHORT $L73048
$L73753:
	lea	edx, DWORD PTR $T73652[ebp]
	push	OFFSET FLAT:__TI1H
	push	edx
	mov	DWORD PTR $T73652[ebp], 1
	call	__CxxThrowException@8
$L73048:
...
; 96   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 2;
	...
	lea	eax, DWORD PTR _dw$73692[ebp]
	lea	ecx, DWORD PTR _hKey$73693[ebp]
	push	eax
	push	ecx
	push	esi
	push	131103					; 0002001fH
	...
	push	-2147483646				; 80000002H
	mov	DWORD PTR _hKey$73693[ebp], esi
	call	edi
	cmp	eax, esi
	jne	SHORT $L73754
	lea	ecx, DWORD PTR _MyKey$[ebp]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73693[ebp]
	cmp	eax, esi
	mov	DWORD PTR _MyKey$[ebp], ecx
	je	SHORT $L73052
$L73754:
	lea	edx, DWORD PTR $T73653[ebp]
	push	OFFSET FLAT:__TI1H
	push	edx
	mov	DWORD PTR $T73653[ebp], 2
	call	__CxxThrowException@8
$L73052:
...
; 98   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\SmartTracker7", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 3;

	lea	eax, DWORD PTR _dw$73706[ebp]
	lea	ecx, DWORD PTR _hKey$73707[ebp]
	push	eax
	push	ecx
	push	esi
	push	131103					; 0002001fH
	...
	push	esi
	push	esi
	push	OFFSET FLAT:??_C@_0CG@BEN@Software?2SySal2?2Classes?2SmartTra@ ; `string'
	push	-2147483646				; 80000002H
	mov	DWORD PTR _hKey$73707[ebp], esi
	call	edi
	cmp	eax, esi
	jne	SHORT $L73755
	lea	ecx, DWORD PTR _MyKey$[ebp]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73707[ebp]
	cmp	eax, esi
	mov	DWORD PTR _MyKey$[ebp], ecx
	je	SHORT $L73056
$L73755:
	lea	edx, DWORD PTR $T73654[ebp]
	push	OFFSET FLAT:__TI1H
	push	edx
	mov	DWORD PTR $T73654[ebp], 3
	call	__CxxThrowException@8
$L73056:
...
; 100  : 		MyKey.Open(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\SmartTracker7", KEY_READ | KEY_WRITE);

	lea	eax, DWORD PTR _hKey$73720[ebp]
	mov	DWORD PTR _hKey$73720[ebp], esi
	push	eax
	push	131103					; 0002001fH
	push	esi
	push	OFFSET FLAT:??_C@_0CG@BEN@Software?2SySal2?2Classes?2SmartTra@ ; `string'
	...
	lea	ecx, DWORD PTR _MyKey$[ebp]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73720[ebp]
	mov	DWORD PTR _MyKey$[ebp], ecx
$L73722:

; 101  : 		char CLSIDString[64];
; 102  : 		wsprintf(CLSIDString, "{%08X-%04X-%04X-%02X%02X-%02X%02X%02X%02X%02X%02X}", 
; 103  : 			CLSID_SmartTracker7.Data1, CLSID_SmartTracker7.Data2, CLSID_SmartTracker7.Data3, 
; 104  : 			CLSID_SmartTracker7.Data4[0], CLSID_SmartTracker7.Data4[1], CLSID_SmartTracker7.Data4[2], CLSID_SmartTracker7.Data4[3], 
; 105  : 			CLSID_SmartTracker7.Data4[4], CLSID_SmartTracker7.Data4[5], CLSID_SmartTracker7.Data4[6], CLSID_SmartTracker7.Data4[7]);

	xor	edx, edx
	xor	eax, eax
	mov	dl, BYTE PTR _CLSID_SmartTracker7+15
	mov	al, BYTE PTR _CLSID_SmartTracker7+14
	push	edx
	push	eax
	mov	eax, DWORD PTR _CLSID_SmartTracker7+12
	xor	ecx, ecx
	mov	cl, ah
	...
	xor	edx, edx
	xor	eax, eax
	mov	dl, BYTE PTR _CLSID_SmartTracker7+11
	mov	al, BYTE PTR _CLSID_SmartTracker7+10
	push	edx
	push	eax
	mov	eax, DWORD PTR _CLSID_SmartTracker7+8
	xor	ecx, ecx
	mov	cl, ah
	and	eax, 255				; 000000ffH
	push	ecx
	mov	ecx, DWORD PTR _CLSID_SmartTracker7
	push	eax
	mov	eax, DWORD PTR _CLSID_SmartTracker7+4
	xor	edx, edx
	and	eax, 65535				; 0000ffffH
	mov	dx, WORD PTR _CLSID_SmartTracker7+6
	push	edx
	push	eax
	push	ecx
	lea	edx, DWORD PTR _CLSIDString$73060[ebp]
...
; 106  : 		MyKey.SetValue(CLSIDString, "CLSID");
	...
	lea	eax, DWORD PTR _CLSIDString$73060[ebp]
	push	eax
	call	DWORD PTR __imp__lstrlenA@4
	mov	edx, DWORD PTR _MyKey$[ebp]
	inc	eax
	lea	ecx, DWORD PTR _CLSIDString$73060[ebp]
	push	eax
	push	ecx
	push	1
	push	esi
...
; 113  : 		MyKey.RecurseDeleteKey("Software\\SySal2\\Classes\\SmartTracker7");
...
; 125  : 	MyKey.Open(HKEY_LOCAL_MACHINE, "", KEY_READ | KEY_WRITE);
	...
	lea	eax, DWORD PTR _hKey$73786[esp+284]
	push	edi
	...
	push	-2147483646				; 80000002H
	xor	esi, esi
	mov	DWORD PTR _hKey$73786[esp+308], ebx
	call	edi
	test	eax, eax
	jne	SHORT $L73788
	mov	esi, DWORD PTR _hKey$73786[esp+288]
$L73788:

; 126  : 	MyKey.RecurseDeleteKey("Software\\SySal2\\Classes\\SmartTracker7");

	lea	ecx, DWORD PTR _hKey$73828[esp+288]
	mov	DWORD PTR _key$73844[esp+288], ebx
	push	ecx
	push	131103					; 0002001fH
	push	ebx
	push	OFFSET FLAT:??_C@_0CG@BEN@Software?2SySal2?2Classes?2SmartTra@ ; `string'
	push	esi
	mov	DWORD PTR _hKey$73828[esp+308], ebx
	call	edi
	cmp	eax, ebx
	jne	$L73874
	lea	ecx, DWORD PTR _key$73844[esp+288]
	call	?Close@CRegKey@ATL@@QAEJXZ		; ATL::CRegKey::Close
	mov	ecx, DWORD PTR _hKey$73828[esp+288]
	cmp	eax, ebx
	mov	DWORD PTR _key$73844[esp+288], ecx
	jne	SHORT $L73874
	lea	edx, DWORD PTR _time$73847[esp+288]
	mov	edi, DWORD PTR __imp__RegEnumKeyExA@32
	push	edx
	push	ebx
	push	ebx
	lea	eax, DWORD PTR _dwSize$73848[esp+300]
	push	ebx
	lea	edx, DWORD PTR _szBuffer$73849[esp+304]
	push	eax
	push	edx
	push	ebx
	push	ecx
	mov	DWORD PTR _dwSize$73848[esp+320], 256	; 00000100H
	call	edi
	test	eax, eax
	jne	SHORT $L73851
$L73850:
	lea	eax, DWORD PTR _szBuffer$73849[esp+288]
	lea	ecx, DWORD PTR _key$73844[esp+288]
	push	eax
	call	?RecurseDeleteKey@CRegKey@ATL@@QAEJPBD@Z ; ATL::CRegKey::RecurseDeleteKey
	test	eax, eax
	jne	SHORT $L73874
	lea	ecx, DWORD PTR _time$73847[esp+288]
	lea	edx, DWORD PTR _dwSize$73848[esp+288]
	push	ecx
	mov	ecx, DWORD PTR _key$73844[esp+292]
	push	ebx
	push	ebx
	push	ebx
	lea	eax, DWORD PTR _szBuffer$73849[esp+304]
	push	edx
	push	eax
	push	ebx
	push	ecx
	...
	je	SHORT $L73850
$L73851:
	mov	eax, DWORD PTR _key$73844[esp+288]
	cmp	eax, ebx
	je	SHORT $L73838
	push	eax
	call	DWORD PTR __imp__RegCloseKey@4
...
;	COMDAT ?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker7@@3U_GUID@@B@ATL@@SGPBDXZ
_TEXT	SEGMENT
?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker7@@3U_GUID@@B@ATL@@SGPBDXZ PROC NEAR ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker7>::GetObjectDescription, COMDAT

; 3127 : 	static LPCTSTR WINAPI GetObjectDescription() {return NULL;}

	xor	eax, eax
	ret	0
?GetObjectDescription@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker7@@3U_GUID@@B@ATL@@SGPBDXZ ENDP ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker7>::GetObjectDescription
_TEXT	ENDS
;	COMDAT ?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker7@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ
_TEXT	SEGMENT
?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker7@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ PROC NEAR ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker7>::GetCategoryMap, COMDAT

; 3128 : 	static const struct _ATL_CATMAP_ENTRY* GetCategoryMap() {return NULL;};

	xor	eax, eax
	ret	0
?GetCategoryMap@?$CComCoClass@VCSmartTrackerClass@@$1?CLSID_SmartTracker7@@3U_GUID@@B@ATL@@SAPBU_ATL_CATMAP_ENTRY@2@XZ ENDP ; ATL::CComCoClass<CSmartTrackerClass,&CLSID_SmartTracker7>::GetCategoryMap
_TEXT	ENDS
...
text$x	SEGMENT
$L73896:
	mov	eax, DWORD PTR $T73887[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
$L74012:
	mov	eax, OFFSET FLAT:$T74008
	jmp	___CxxFrameHandler
text$x	ENDS
...
xdata$x	SEGMENT
$T74273	DD	019930520H
	DD	02H
	DD	FLAT:$T74278
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T74278	DD	0ffffffffH
	DD	FLAT:$L74220
	DD	00H
	DD	FLAT:$L74221
xdata$x	ENDS
...
; 136  : 		Name[0] = 0;
; 137  : 		HStatusChangeEvent = 0;
; 138  : 		CamSpec.Width = CamSpec.Height = 0;
; 139  : 		CamSpec.WinWidth = CamSpec.WinHeight = 0;
; 140  : 		CamSpec.OffX = CamSpec.OffY = 0;
; 141  : 		CamSpec.PixelToMicronX = CamSpec.PixelToMicronY = 1.f;
...
; 143  : 		int i;
; 144  : 		HStart = CreateEvent(NULL, TRUE, FALSE, NULL);
...
; 145  : 		HReset = CreateEvent(NULL, TRUE, FALSE, NULL);
...
; 146  : 		HTerminate = CreateEvent(NULL, TRUE, FALSE, NULL);
...
; 147  : 		for (i = 0; i < MAX_PROCESSORS; i++)
; 148  : 		{
; 149  : 			ThreadInfo[i].HFinished = 0;

	mov	DWORD PTR [eax+20], ebx

; 150  : 			ThreadInfo[i].pThis = this;

	mov	DWORD PTR [eax], esi

; 151  : 			ThreadInfo[i].HThread = 0;
...
; File D:\Program Files\Microsoft Visual Studio\VC98\ATL\INCLUDE\atlbase.h
xdata$x	SEGMENT
$T74388	DD	019930520H
	DD	01H
	DD	FLAT:$T74392
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T74392	DD	0ffffffffH
	DD	FLAT:$L74352
xdata$x	ENDS
;	COMDAT ??1?$CComObject@VCSmartTrackerClass@@@ATL@@UAE@XZ
_TEXT	SEGMENT
...
; 2411 : 	}
	...
	call	?AfxGetStaticModuleState@@YGPAVAFX_MODULE_STATE@@XZ ; AfxGetStaticModuleState
	push	eax
	lea	ecx, DWORD PTR __ctlState$74367[esp+48]
	call	??0AFX_MAINTAIN_STATE2@@QAE@PAVAFX_MODULE_STATE@@@Z ; AFX_MAINTAIN_STATE2::AFX_MAINTAIN_STATE2
...
$L74377:
	mov	eax, DWORD PTR __ctlState$74367[esp+48]
	mov	ecx, DWORD PTR __ctlState$74367[esp+44]
	neg	esi
	mov	DWORD PTR [eax+4], ecx
...
$L74352:
	...
	add	eax, 8
	mov	DWORD PTR $T74365[ebp], eax
	jmp	$L74351
$L74350:
	mov	DWORD PTR $T74365[ebp], 0
$L74351:
	mov	ecx, DWORD PTR $T74365[ebp]
	jmp	??1?$CComObjectRootEx@VCComMultiThreadModel@ATL@@@ATL@@QAE@XZ ; ATL::CComObjectRootEx<ATL::CComMultiThreadModel>::~CComObjectRootEx<ATL::CComMultiThreadModel>
$L74391:
	mov	eax, OFFSET FLAT:$T74388
	jmp	___CxxFrameHandler
text$x	ENDS
...
; File D:\Program Files\Microsoft Visual Studio\VC98\ATL\INCLUDE\atlbase.h
xdata$x	SEGMENT
$T74494	DD	019930520H
	DD	01H
	DD	FLAT:$T74504
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T74504	DD	0ffffffffH
	DD	FLAT:$L74429
xdata$x	ENDS
;	COMDAT ?RecurseDeleteKey@CRegKey@ATL@@QAEJPBD@Z
_TEXT	SEGMENT
...
; 4893 : 	LONG lRes = key.Open(m_hKey, lpszKey, KEY_READ | KEY_WRITE);
	...
	lea	ecx, DWORD PTR _hKey$74440[esp+304]
	...
	push	edx
	push	eax
	mov	DWORD PTR _hKey$74440[esp+324], edi
	call	DWORD PTR __imp__RegOpenKeyExA@20
	mov	esi, eax
	cmp	esi, edi
	jne	SHORT $L74499
	...
	call	DWORD PTR __imp__RegCloseKey@4
$L74446:
	mov	ecx, DWORD PTR _hKey$74440[esp+304]
