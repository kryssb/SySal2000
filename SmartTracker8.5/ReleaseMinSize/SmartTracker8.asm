; Listing generated by Microsoft (R) Optimizing Compiler Version 14.00.50727.762 
	...
	TITLE	d:\SySal2\SmartTracker8.5\SmartTracker8.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_IID_ITracker4 DD 04e5187bH
	...
	DB	0a9H
	DB	0d0H
_LIBID_SMARTTRACKERLib DD 0c7529081H
	DW	02014H
	DW	04fb6H
	DB	0a5H
	DB	068H
	...
	DB	01fH
	DB	0eH
_CLSID_SmartTracker8 DD 070ad22dcH
	DW	078c6H
	DW	049faH
	DB	0b1H
	DB	0f0H
...
; File d:\sysal2\smarttracker8.5\smarttracker8.cpp
CONST	SEGMENT
...
; 5676 : 	LONG lRes = key.Open(m_hKey, lpszKey, KEY_READ | KEY_WRITE);
	...
	lea	ecx, DWORD PTR _hKey$125781[esp+296]
	push	ecx
...
; 5697 : 	return DeleteSubKey(lpszKey);
	...
	mov	DWORD PTR _hKey$125781[esp+316], 0
	call	DWORD PTR __imp__RegOpenKeyExA@20
...
; 5677 : 	if (lRes != ERROR_SUCCESS)
	...
	test	eax, eax
	mov	ecx, DWORD PTR _hKey$125781[esp+296]
	mov	esi, eax
...
__ehfuncinfo$??1CSmartTrackerClass@@UAE@XZ DD 019930522H
	...
	DD	01H
; Function compile flags: /Ogtpy
; File d:\sysal2\smarttracker8.5\smarttrackerclass.h
xdata$x	ENDS
...
; 221  : 		{
; 222  : 			GlobalFree(T.pDeltaHisto2d);
...
__unwindfunclet$??1CSmartTrackerClass@@UAE@XZ$0:
	...
	add	eax, 8
	mov	DWORD PTR $T126031[ebp], eax
	jmp	$LN16@CSmartTrac
$LN15@CSmartTrac:
	mov	DWORD PTR $T126031[ebp], 0
$LN16@CSmartTrac:
	mov	ecx, DWORD PTR $T126031[ebp]
...
PUBLIC	??_C@_0CI@MCFFJPP@Software?2SySal2?2Classes?2SmartTra@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0CI@MCFFJPP@Software?2SySal2?2Classes?2SmartTra@
CONST	SEGMENT
??_C@_0CI@MCFFJPP@Software?2SySal2?2Classes?2SmartTra@ DB 'Software\SySal'
	DB	'2\Classes\SmartTracker8.5', 00H		; `string'
CONST	ENDS
...
$T126094 = -104						; size = 4
$T126096 = -100						; size = 4
_dw$126186 = -96					; size = 4
_dw$126164 = -96					; size = 4
_dw$126142 = -96					; size = 4
_dw$126120 = -96					; size = 4
_hKey$126187 = -92					; size = 4
_hKey$126165 = -92					; size = 4
_hKey$126143 = -92					; size = 4
_hKey$126121 = -92					; size = 4
_MyKey$ = -88						; size = 4
_CLSIDString$124563 = -84				; size = 64
...
; 92   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 0;
	...
	lea	eax, DWORD PTR _dw$126120[ebp]
	push	eax
	lea	ecx, DWORD PTR _hKey$126121[ebp]
	push	ecx
	push	edi
	push	131103					; 0002001fH
	push	edi
	...
	mov	DWORD PTR _hKey$126121[ebp], edi
	call	DWORD PTR __imp__RegCreateKeyExA@36
	cmp	eax, edi
	jne	SHORT $LN79@DllRegiste
	mov	esi, DWORD PTR _hKey$126121[ebp]
...
; 94   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 1;
	...
	lea	eax, DWORD PTR _dw$126142[ebp]
	push	eax
	lea	ecx, DWORD PTR _hKey$126143[ebp]
	push	ecx
	push	edi
	push	131103					; 0002001fH
	push	edi
	...
	push	-2147483646				; 80000002H
	mov	DWORD PTR _hKey$126143[ebp], edi
	call	DWORD PTR __imp__RegCreateKeyExA@36
	cmp	eax, edi
...
$LN29@DllRegiste:
	cmp	eax, edi
	mov	esi, DWORD PTR _hKey$126143[ebp]
	mov	DWORD PTR _MyKey$[ebp], esi
	je	SHORT $LN3@DllRegiste
$LN78@DllRegiste:
	push	OFFSET __TI1H
	lea	edx, DWORD PTR $T126096[ebp]
	push	edx
	mov	DWORD PTR $T126096[ebp], 1
...
; 92   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 0;
	...
	push	OFFSET __TI1H
	lea	edx, DWORD PTR $T126094[ebp]
	push	edx
	mov	DWORD PTR $T126094[ebp], edi
	call	__CxxThrowException@8
$LN3@DllRegiste:
...
; 96   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 2;
	...
	lea	eax, DWORD PTR _dw$126164[ebp]
	push	eax
	lea	ecx, DWORD PTR _hKey$126165[ebp]
	push	ecx
	push	edi
	push	131103					; 0002001fH
	push	edi
	...
	push	-2147483646				; 80000002H
	mov	DWORD PTR _hKey$126165[ebp], edi
	call	DWORD PTR __imp__RegCreateKeyExA@36
	cmp	eax, edi
...
$LN39@DllRegiste:
	cmp	eax, edi
	mov	esi, DWORD PTR _hKey$126165[ebp]
	mov	DWORD PTR _MyKey$[ebp], esi
...
; 98   : 		if (MyKey.Create(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\SmartTracker8.5", REG_NONE, REG_OPTION_NON_VOLATILE, KEY_READ | KEY_WRITE) != ERROR_SUCCESS) throw 3;

	lea	eax, DWORD PTR _dw$126186[ebp]
	push	eax
	lea	ecx, DWORD PTR _hKey$126187[ebp]
	push	ecx
	push	edi
	push	131103					; 0002001fH
	push	edi
	push	edi
	push	edi
	push	OFFSET ??_C@_0CI@MCFFJPP@Software?2SySal2?2Classes?2SmartTra@
	push	-2147483646				; 80000002H
	mov	DWORD PTR _hKey$126187[ebp], edi
	call	DWORD PTR __imp__RegCreateKeyExA@36
	cmp	eax, edi
...
$LN49@DllRegiste:
	cmp	eax, edi
	mov	ecx, DWORD PTR _hKey$126187[ebp]
...
; 100  : 		MyKey.Open(HKEY_LOCAL_MACHINE, "Software\\SySal2\\Classes\\SmartTracker8.5", KEY_READ | KEY_WRITE);
...
; 105  : 			CLSID_SmartTracker8.Data4[4], CLSID_SmartTracker8.Data4[5], CLSID_SmartTracker8.Data4[6], CLSID_SmartTracker8.Data4[7]);
	...
	push	240					; 000000f0H
	push	177					; 000000b1H
	push	18938					; 000049faH
	push	30918					; 000078c6H
	push	1890394844				; 70ad22dcH
	lea	eax, DWORD PTR _CLSIDString$124563[ebp]
...
; 106  : 		MyKey.SetValue(CLSIDString, "CLSID");
	...
	lea	ecx, DWORD PTR _CLSIDString$124563[ebp]
	push	ecx
	call	DWORD PTR __imp__lstrlenA@4
	mov	esi, DWORD PTR _MyKey$[ebp]
	add	eax, 1
	push	eax
	lea	edx, DWORD PTR _CLSIDString$124563[ebp]
	push	edx
	push	1
	push	edi
...
; 113  : 		MyKey.RecurseDeleteKey("Software\\SySal2\\Classes\\SmartTracker8.5");
...
; 125  : 	MyKey.Open(HKEY_LOCAL_MACHINE, "", KEY_READ | KEY_WRITE);
	...
	lea	eax, DWORD PTR _hKey$126262[esp+8]
	push	eax
	push	131103					; 0002001fH
	push	0
	push	OFFSET ??_C@_00CNPNBAHC@?$AA@
	...
	mov	DWORD PTR _hKey$126262[esp+28], 0
	call	DWORD PTR __imp__RegOpenKeyExA@20
	test	eax, eax
	jne	SHORT $LN5@DllUnregis
	mov	ecx, DWORD PTR _hKey$126262[esp+8]
...
; 126  : 	MyKey.RecurseDeleteKey("Software\\SySal2\\Classes\\SmartTracker8.5");
...
; 1799 : 		ATLTRY(p = new T1(pv))
	...
	mov	ecx, DWORD PTR _e$124636[ebp]
...
; 1799 : 		ATLTRY(p = new T1(pv))
	...
	mov	ecx, DWORD PTR _e$124738[ebp]
	call	?Delete@CException@@QAEXXZ		; CException::Delete
