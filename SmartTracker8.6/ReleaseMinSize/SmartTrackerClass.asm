; Listing generated by Microsoft (R) Optimizing Compiler Version 14.00.50727.762 
	...
	TITLE	d:\SySal2\SmartTracker8.6\SmartTrackerClass.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; Function compile flags: /Ogtpy
; File d:\sysal2\smarttracker8.6\smarttrackerclass.cpp
...
; 252  : 	strncpy(name, Name, SYSAL_MAX_CONN_NAME_LEN);
...
; 348  : 	// TODO: Add your implementation code here
; 349  : 
; 350  : 	return (bEnable) ? S_FALSE : S_OK;
...
; 355  : 	// TODO: Add your implementation code here
; 356  : 
; 357  : 	*pNumber = 0;
...
; 363  : 	// TODO: Add your implementation code here
; 364  : 
...
; 370  : 	// TODO: Add your implementation code here
; 371  : 
...
_TEXT	ENDS
PUBLIC	??_C@_0BC@GBNFBLOK@Smart?5Tracker?58?46?$AA@	; `string'
PUBLIC	?GetClassNameA@CSmartTrackerClass@@UAGJQAD@Z	; CSmartTrackerClass::GetClassNameA
;	COMDAT ??_C@_0BC@GBNFBLOK@Smart?5Tracker?58?46?$AA@
CONST	SEGMENT
??_C@_0BC@GBNFBLOK@Smart?5Tracker?58?46?$AA@ DB 'Smart Tracker 8.6', 00H ; `string'
; Function compile flags: /Ogtpy
CONST	ENDS
...
; 398  : 	
; 399  : 	strncpy(name, "Smart Tracker 8.6", SYSAL_MAX_CONN_NAME_LEN);

	mov	eax, DWORD PTR _name$[esp-4]
	push	64					; 00000040H
	push	OFFSET ??_C@_0BC@GBNFBLOK@Smart?5Tracker?58?46?$AA@
	push	eax
	call	DWORD PTR __imp__strncpy
	add	esp, 12					; 0000000cH
...
; 413  : 
; 414  : 	HStatusChangeEvent = (HANDLE)HNotifyStatusChangeEvent;

	mov	eax, DWORD PTR _HNotifyStatusChangeEvent$[esp-4]

; 415  : 	if (HStatusChangeEvent) SetEvent(HStatusChangeEvent);
...
; 422  : 	
; 423  : 	*pStatus = SYSAL_ASYNC_STATUS_IDLE;
...
; 436  : 	// TODO: Add your implementation code here
; 437  : 
; 438  : 	if (HStatusChangeEvent) SetEvent(HStatusChangeEvent);
...
; 444  : 	// TODO: Add your implementation code here
; 445  : 
; 446  : 	if (HStatusChangeEvent) 
...
; 447  : 	{
; 448  : 		SetEvent(HStatusChangeEvent);

	push	eax
	call	DWORD PTR __imp__SetEvent@4

; 449  : 		HStatusChangeEvent = 0;
...
; 457  : 
; 458  : 	if (HStatusChangeEvent) SetEvent(HStatusChangeEvent);
...
; 464  : 	// TODO: Add your implementation code here
; 465  : 
; 466  : 	*pWrongConn = -1;

	mov	eax, DWORD PTR _pWrongConn$[esp-4]

; 467  : 	*pRetCode = SYSAL_READYSTATUS_READY;
...
; 479  : 	*pCLSID = CLSID_SmartTracker8;
...
; 488  : 	if (!OkToRun) return S_FALSE;

	mov	eax, DWORD PTR _this$[esp-4]
	xor	ecx, ecx
	cmp	BYTE PTR [eax+1116], cl
...
; 492  : 	T.ShadowSigmaMeasures = 0;

	mov	DWORD PTR [eax+1048], ecx

; 493  : 	T.ShadowSigmaXAccumulator = T.ShadowSigmaYAccumulator = 0.0f;

	fst	DWORD PTR [eax+1036]
...
; 495  : 	T.TotalLX = T.TotalLY = 0.0f;

	fst	DWORD PTR [eax+1112]
...
; 545  : 
; 546  : 	// TODO: Add your implementation code here
; 547  : 	*pSpec = CamSpec;
...
; 904  : 	int CellsInLayer = T.CellsInLayer;

	mov	eax, DWORD PTR [ecx+980]
	push	ebp

; 905  : 	Cell *CellSpace = T.CellSpace;
; 906  : 	Cell *pCell, *pCellBase, *pCellEnd;
; 907  : 	IntGrain *pG, *pGE, *pC, *pNC;	
; 908  : 	int lay, n;	
; 909  : 	float DX, DY;
; 910  : 	for ((lay = T.Layer - 1), (pCellBase = CellSpace + lay * CellsInLayer), (pCellEnd = pCellBase + CellsInLayer); lay >= 0; (lay--), (pCellEnd = pCellBase), (pCellBase -= CellsInLayer))	

	mov	ebp, DWORD PTR [ecx+1020]
...
; 911  : 		for (pCell = pCellBase; pCell < pCellEnd; pCell++)
...
; 913  : 				for ((pG = pCell->FirstG), (pGE = pG + pCell->Free); pG < pGE; pG++)
...
; 919  : 						pC = pG->pChainHead;
; 920  : 						while (pC)
; 921  : 						{
; 922  : 							DX += (pC->Xcm - pC->Xunc);
...
; 923  : 							DY += (pC->Ycm - pC->Yunc);

	fld	DWORD PTR [eax+4]
	fsub	DWORD PTR [eax+24]

; 924  : 							pC = pC->pChainHead;
...
; 1127 : 	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
; 1128 : 
; 1129 : 	// TODO: Add your implementation code here	
; 1130 : 	if (!OkToRun) return S_FALSE;	

	mov	esi, DWORD PTR _this$[ebp]
	cmp	BYTE PTR [esi+1116], 0
...
; 1131 : 	if (Layer < 0 || Layer >= T.LayerNum) return E_INVALIDARG;
...
; 1132 : 	int MaxNumber = *pMaxNumber;

	mov	edx, DWORD PTR _pMaxNumber$[ebp]
	mov	ebx, DWORD PTR [edx]

; 1133 : 	*pZ = T.ZLayer[Layer];
...
; 1134 : 	int i, j, ccount = 0;
; 1135 : 	Cell *pCells = T.CellSpace;

	mov	edx, DWORD PTR [esi+976]

; 1136 : 	try
; 1137 : 	{
; 1138 : 		for (i = 0; i < T.CellsInLayer; i++)
...
$LN7@GetCluster:
	cmp	ecx, DWORD PTR [esi+980]
	jge	$LN25@GetCluster

; 1139 : 		{
; 1140 : 			Cell TCell = pCells[i];

	mov	esi, DWORD PTR [edx+ecx*8]
	mov	ecx, DWORD PTR [edx+ecx*8+4]
	mov	DWORD PTR _TCell$131164[ebp+4], ecx

; 1141 : 			for (j = 0; j < TCell.Free; j++)

	xor	edx, edx
$LN4@GetCluster:
	cmp	edx, DWORD PTR _TCell$131164[ebp+4]
	jge	SHORT $LN6@GetCluster

; 1142 : 			{
; 1143 : 				pSpace->X = TCell.FirstG[j].Xcm;
...
; 1144 : 				pSpace->Y = TCell.FirstG[j].Ycm;
; 1145 : 				pSpace->Area = 0;
; 1146 : 				pSpace->GrayLevel = 0;
; 1147 : 				pSpace->Inertia.IXX = pSpace->Inertia.IYY = pSpace->Inertia.IXY = 0;
; 1148 : 				pSpace++;

	add	eax, 40					; 00000028H

; 1149 : 				if (ccount >= MaxNumber) throw ccount;
	...
	push	OFFSET __TI1H
	fstp	ST(0)
	lea	edx, DWORD PTR $T132880[ebp]
	fstp	ST(0)
	push	edx
	mov	DWORD PTR $T132880[ebp], edi
...
; 1161 : 
; 1162 : 	// TODO: Add your implementation code here
; 1163 : 	T.PresetSlopeX = SX;

	mov	eax, DWORD PTR _this$[esp-4]
	fld	DWORD PTR _SX$[esp-4]
	fstp	DWORD PTR [eax+948]

; 1164 : 	T.PresetSlopeY = SY;

	fld	DWORD PTR _SY$[esp-4]
	fstp	DWORD PTR [eax+952]

; 1165 : 	T.PresetSlopeAccX = AccX;

	fld	DWORD PTR _AccX$[esp-4]
	fstp	DWORD PTR [eax+956]

; 1166 : 	T.PresetSlopeAccY = AccY;

	fld	DWORD PTR _AccY$[esp-4]
	fstp	DWORD PTR [eax+960]
...
; 1173 : 
; 1174 : 	// TODO: Add your implementation code here
; 1175 : 	T.PresetSlope = SlPresEnable;

	cmp	BYTE PTR _SlPresEnable$[esp-4], 0
	mov	ecx, DWORD PTR _this$[esp-4]
	setne	al
	mov	BYTE PTR [ecx+944], al
...
; 1182 : 
; 1183 : 	// TODO: Add your implementation code here
; 1184 : 	*pSlPresEnable = T.PresetSlope;

	mov	eax, DWORD PTR _this$[esp-4]
	mov	cl, BYTE PTR [eax+944]
...
; 1206 : 	float slope2 = (float)hypot(SlopeX, SlopeY);
...
; 1217 : 		*pdirtol = T.AlignTol + avgdz * slope2;
...
; 1213 : 	else
; 1214 : 	{
; 1215 : 		*pDirX = SlopeX / slope2;

	fld	DWORD PTR _SlopeX$[esp+4]
	fdiv	ST(0), ST(1)
	fstp	DWORD PTR [eax]

; 1216 : 		*pDirY = SlopeY / slope2;
...
; 1938 : 	*pMaxGrains = T.LayerNum * T.InitialMultiplicity;
...
; 1944 : 	//if (Side < 0 || Side > 1) return E_INVALIDARG;
; 1945 : 	HRESULT HRes = StartFilling();
...
; 1971 : 	int Icl;
; 1972 : 	if ((Xp < T.Win.Xmin) || (Xp >= T.Win.Xmax) ||
; 1973 : 		(Yp < T.Win.Ymin) || (Yp >= T.Win.Ymax)) return -1;
...
; 1974 : 	Icl = ((int)((Yp - T.Win.Ymin) / T.DyCell)) * T.CellNumX +
; 1975 : 		(int)((Xp - T.Win.Xmin) / T.DxCell);

	fsub	DWORD PTR [esi+992]
	push	edi
	fdiv	DWORD PTR [esi+1004]
	call	__ftol2_sse
	fsub	DWORD PTR [esi+984]
	mov	edi, eax
...
; 1976 : 	if ((Icl >= 0) && (Icl < T.CellsInLayer)) return Icl;

	js	SHORT $LN1@GetCell
	cmp	edi, DWORD PTR [esi+980]
...
; 2058 : 		if (pTempGrains[i] && pTempGrains[i]->TrackLength >= SequenceLength) return;
...
; 2060 : 		if (pTempGrains[i] && pTempGrains[i]->pTrack)
...
; 2061 : 		{
; 2062 : 			Track &N = *pTempGrains[i]->pTrack;
...
; 2064 : 			{
; 2065 : 				IntGrain *pG = ((IntTrackVector *)N.pPoints)[j].T.pG;

	mov	eax, DWORD PTR [edx+8]
	mov	eax, DWORD PTR [edi+eax]
	add	esi, 1

; 2066 : 				pG->TrackLength = 0;
...
; 2075 : 		{
; 2076 : 			IntTrackVector *pIG = ((IntTrackVector *)N.pPoints) + j++;

	mov	esi, DWORD PTR [eax+8]

; 2077 : 			pIG->T.pG = pTempGrains[i];

	mov	DWORD PTR [esi+edx], ecx
	add	esi, edx

; 2078 : 			pIG->T.pG->pTrack = &N;

	mov	DWORD PTR [ecx+16], eax

; 2079 : 			pIG->T.pG->TrackLength = SequenceLength;

	mov	ecx, DWORD PTR [esi]
	mov	DWORD PTR [ecx+12], ebp

; 2080 : 			pIG->T.Z = T.ZLayer[i];
...
; 2090 : 		if (pTempGrains[i] && pTempGrains[i]->TrackLength >= SequenceLength) return;
...
; 2092 : 		if (pTempGrains[i] && pTempGrains[i]->pTrack2)
...
; 2093 : 		{
; 2094 : 			Track2 &N = *pTempGrains[i]->pTrack2;
...
; 2096 : 			{
; 2097 : 				IntGrain *pG = ((IntTrackGrain *)N.pGrains)[j].T.pG;

	mov	eax, DWORD PTR [edx+12]
	mov	eax, DWORD PTR [edi+eax]
	add	esi, 1

; 2098 : 				pG->TrackLength = 0;
...
; 2107 : 		{
; 2108 : 			IntTrackGrain *pIG = ((IntTrackGrain *)N.pGrains) + j++;

	mov	esi, DWORD PTR [eax+12]

; 2109 : 			pIG->T.pG = pTempGrains[i];

	mov	DWORD PTR [esi+edx], ecx
	add	esi, edx

; 2110 : 			pIG->T.pG->pTrack2 = &N;

	mov	DWORD PTR [ecx+16], eax

; 2111 : 			pIG->T.pG->TrackLength = SequenceLength;

	mov	ecx, DWORD PTR [esi]
	mov	DWORD PTR [ecx+12], ebp

; 2112 : 			pIG->T.Z = T.ZLayer[i];
...
; 2122 : 		if (pspace[i].Valid)

	cmp	BYTE PTR [ebp], 0
	je	SHORT $LN6@FinalizeTr

; 2125 : 			Track &N = pspace[j++];
; 2126 : 			N.PointsN = O.PointsN;
...
; 2130 : 			{
; 2131 : 				IntGrain *pG = ((IntTrackVector *)O.pPoints)[k].T.pG;

	mov	eax, DWORD PTR [ebp-68]
	mov	edi, DWORD PTR [eax+edx]

; 2132 : 				N.pPoints[k].Z = ((IntTrackVector *)O.pPoints)[k].T.Z;
...
; 2142 : 	float avglx = T.TotalLX / T.Layer;

	mov	eax, DWORD PTR [ecx+1020]

; 2143 : 	float avgly = T.TotalLY / T.Layer;
; 2144 : 	int i, j, k, a, ta;
; 2145 : 	float dsx, dsy;
; 2146 : 	if (T.Layer > 1)
...
; 2153 : 		if (pspace[i].Valid)

	cmp	BYTE PTR [ecx], bl
	je	$LN8@FinalizeTr@2

; 2156 : 			Track2 &N = pspace[j++];
; 2157 : 			N.Grains = O.Grains;
...
; 2154 : 		{
; 2155 : 			Track2 &O = pspace[i];

	xor	esi, esi
$LN19@FinalizeTr@2:

; 2162 : 			{
; 2163 : 				IntGrain *pG = ((IntTrackGrain *)O.pGrains)[k].T.pG;

	mov	eax, DWORD PTR [ecx-44]
	mov	edi, DWORD PTR [esi+eax]

; 2164 : 				a += (ta = pG->Area);
; 2165 : 				float dz = (N.pGrains[k].Z = ((IntTrackGrain *)O.pGrains)[k].T.Z) - T.ZLayer[0];
...
; 2166 : 				if (T.Side == 0)
	...
	mov	eax, DWORD PTR _this$[esp+40]
	cmp	DWORD PTR [eax+1104], 0
	fstp	DWORD PTR _dz$131855[esp+36]

; 2167 : 				{
; 2168 : 					N.pGrains[k].X = pG->Xcm + dsx * dz - avglx;

	fld	DWORD PTR _dz$131855[esp+36]
	fld	ST(0)
	fmul	ST(0), ST(3)
	fadd	DWORD PTR [edi]
...
; 2169 : 					N.pGrains[k].Y = pG->Ycm + dsy * dz - avgly;
...
; 2173 : 				{
; 2174 : 					N.pGrains[k].X = pG->Xcm + dsx * dz;

	fstp	DWORD PTR [ebx+4]

; 2175 : 					N.pGrains[k].Y = pG->Ycm + dsy * dz;				
...
; 71   : 	for (; C.CountOfItems < (QueryDataCount + OldCount); C.CountOfItems++)
	...
	add	esp, 12					; 0000000cH
	cmp	eax, edi
	mov	DWORD PTR $T133060[esp+12], edi
	jge	$LN7@PutDataPre
	mov	edi, DWORD PTR _pC$[esp+12]
...
; 89   : 		strncpy(C.pItems + C.CountOfItems * (SYSAL_MAXCONFIG_ENTRY_NAME_LEN + SYSAL_MAXCONFIG_ENTRY_VALUE_LEN), pQDI[C.CountOfItems - OldCount].Name, SYSAL_MAXCONFIG_ENTRY_NAME_LEN);
	...
	push	eax
	call	DWORD PTR __imp__strncpy
	mov	edx, DWORD PTR $T133060[esp+24]
	add	DWORD PTR [esi+64], 1
	add	esp, 12					; 0000000cH
	cmp	DWORD PTR [esi+64], edx
	jl	$LL9@PutDataPre
...
; 319  : 	// TODO: Add your implementation code here
; 320  : 	ConfigData C = T;

	mov	eax, DWORD PTR _this$[ebp]

; 321  : 	C.Processors = ConfigMaxProcessors_backup;
; 322  : 	if (::PutData(*pConfig, ConfigDataN, ConfigDataQDI, &C) != ConfigDataN) return S_FALSE;
	...
	lea	edi, DWORD PTR _C$[esp+816]
	rep movsd
	lea	ecx, DWORD PTR _C$[esp+816]
	push	ecx
	push	OFFSET ?ConfigDataQDI@@3PAUQueryDataInfo@@A ; ConfigDataQDI
	push	201					; 000000c9H
	push	edx
	mov	DWORD PTR _C$[esp+1592], eax
...
_TEXT	SEGMENT
__ctlState$ = -1132					; size = 16
_Owner$ = -1116						; size = 84
_MyDlg$ = -1032						; size = 1020
__$EHRec$ = -12						; size = 12
_this$ = 8						; size = 4
_pConfig$ = 12						; size = 4
_hWnd$ = 16						; size = 4
...
; 327  : {
	...
	xor	eax, esp
	push	eax
	lea	eax, DWORD PTR __$EHRec$[esp+1140]
	mov	DWORD PTR fs:0, eax

; 328  : 	// TODO: Add your implementation code here
; 329  : 	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	...
	push	eax
	lea	ecx, DWORD PTR __ctlState$[esp+1144]
...
; 330  : 	CWnd Owner;
	...
	mov	DWORD PTR __$EHRec$[esp+1148], 0
	call	??0CWnd@@QAE@XZ				; CWnd::CWnd

; 331  : 	Owner.Attach((HWND)hWnd);

	mov	eax, DWORD PTR _hWnd$[esp+1136]
	push	eax
	lea	ecx, DWORD PTR _Owner$[esp+1144]
	mov	BYTE PTR __$EHRec$[esp+1152], 1
	call	?Attach@CWnd@@QAEHPAUHWND__@@@Z		; CWnd::Attach

; 332  : 	CEditConfig MyDlg(this, &Owner);

	mov	edx, DWORD PTR _this$[esp+1136]
	lea	ecx, DWORD PTR _Owner$[esp+1140]
	push	ecx
	add	edx, -4					; fffffffcH
	push	edx
	lea	ecx, DWORD PTR _MyDlg$[esp+1148]
	call	??0CEditConfig@@QAE@PAVCSmartTrackerClass@@PAVCWnd@@@Z ; CEditConfig::CEditConfig

; 333  : 
; 334  : 	GetData(*pConfig, ConfigDataN, ConfigDataQDI, &MyDlg.C, true);

	mov	esi, DWORD PTR _pConfig$[esp+1136]
	push	1
	lea	eax, DWORD PTR _MyDlg$[esp+1260]
	push	eax
	push	OFFSET ?ConfigDataQDI@@3PAUQueryDataInfo@@A ; ConfigDataQDI
	push	201					; 000000c9H
	push	esi
	mov	BYTE PTR __$EHRec$[esp+1168], 2
	call	?GetData@@YAHAAUSySalConfig@@HPAUQueryDataInfo@@PAX_N@Z ; GetData
	add	esp, 20					; 00000014H

; 335  : 
; 336  : 	if (MyDlg.DoModal() == IDOK)

	lea	ecx, DWORD PTR _MyDlg$[esp+1140]
	call	?DoModal@CDialog@@UAEHXZ		; CDialog::DoModal
	cmp	eax, 1
	jne	SHORT $LN1@EditConfig

; 337  : 	{
; 338  : 		::PutData(*pConfig, ConfigDataN, ConfigDataQDI, &MyDlg.C);

	lea	ecx, DWORD PTR _MyDlg$[esp+1256]
	push	ecx
	push	OFFSET ?ConfigDataQDI@@3PAUQueryDataInfo@@A ; ConfigDataQDI
	push	201					; 000000c9H
	push	esi
...
; 340  : 		return S_OK;
	...
	lea	ecx, DWORD PTR _Owner$[esp+1140]
	mov	BYTE PTR __$EHRec$[esp+1148], 0
	call	??1CWnd@@UAE@XZ				; CWnd::~CWnd
	mov	eax, DWORD PTR __ctlState$[esp+1144]
	test	eax, eax
	mov	DWORD PTR __$EHRec$[esp+1148], -1
	je	SHORT $LN8@EditConfig
	mov	edx, DWORD PTR __ctlState$[esp+1140]
	mov	DWORD PTR [eax+4], edx
$LN8@EditConfig:
	cmp	DWORD PTR __ctlState$[esp+1152], 0
	je	SHORT $LN7@EditConfig
	mov	eax, DWORD PTR __ctlState$[esp+1148]
	push	eax
	push	0
	call	?AfxDeactivateActCtx@@YGHKK@Z		; AfxDeactivateActCtx
$LN7@EditConfig:
...
; 343  : 	return S_FALSE;
	...
	mov	ecx, DWORD PTR __ctlState$[esp+1140]
	mov	DWORD PTR [eax+4], ecx
$LN12@EditConfig:
	cmp	DWORD PTR __ctlState$[esp+1152], 0
	je	SHORT $LN11@EditConfig
	mov	edx, DWORD PTR __ctlState$[esp+1148]
	push	edx
	push	0
	call	?AfxDeactivateActCtx@@YGHKK@Z		; AfxDeactivateActCtx
$LN11@EditConfig:
...
; 344  : }
	...
	mov	ecx, DWORD PTR __$EHRec$[esp+1140]
	mov	DWORD PTR fs:0, ecx
	pop	ecx
	pop	esi
...
; 377  : 	// TODO: Add your implementation code here
...
; 388  : 
; 389  : 		default:	return E_INVALIDARG;
...
; 384  : 					break;
; 385  : 
; 386  : 		case 1:		HTemp = LoadImage(AfxGetResourceHandle(), MAKEINTRESOURCE(IDI_ICON64), IMAGE_ICON, 64, 64, LR_SHARED);
...
; 382  : 	{
; 383  : 		case 0:		HTemp = LoadImage(AfxGetResourceHandle(), MAKEINTRESOURCE(IDI_ICON32), IMAGE_ICON, 32, 32, LR_SHARED);
...
tv3154 = -164						; size = 4
tv2289 = -164						; size = 4
_rv$130912 = -164					; size = 4
_W$130924 = -160					; size = 8
...
; 553  : 	//AFX_MANAGE_STATE(AfxGetStaticModuleState())
; 554  : 
; 555  : 	// TODO: Add your implementation code here
; 556  : 	int Nc;
; 557  : 	int Icell;
; 558  : 	IntCluster *PClus;
; 559  : 	Cell *PCell;
; 560  : 	IntGrain *PGrain, *PGrainEnd;
; 561  : 	int PixMin = T.PixMin;

	mov	esi, DWORD PTR _this$[ebp]

; 562  : 	int PixMax = T.PixMax;
; 563  : 	float PixelToMicronX = T.PixelToMicronX;
...
; 564  : 	float PixelToMicronY = T.PixelToMicronY;

	fld	DWORD PTR [esi+1012]
	push	edi

; 565  : 	float PixelToMicronXY = fabs(PixelToMicronX * PixelToMicronY);
; 566  : 	float PixelToMicronX3Y = PixelToMicronXY * PixelToMicronX * PixelToMicronX;
; 567  : 	float PixelToMicronY3X = PixelToMicronXY * PixelToMicronY * PixelToMicronY;
; 568  : 	float PixelToMicronX2Y2 = PixelToMicronXY * PixelToMicronXY;
; 569  : 	int CellsInLayer = T.CellsInLayer;
; 570  : 	Cell *CellSpace = T.CellSpace;
; 571  : 	int Layer = T.Layer;
; 572  : 	int CellOverflow = T.CellOverflow;

	mov	edi, DWORD PTR [esi+148]
	fstp	DWORD PTR _PixelToMicronY$[esp+256]

; 573  : 	int CurrentGCounter = T.NumGrains;
; 574  : 	int MaxGrains = T.MaxGrains;
; 575  : 	float CurrDispX = 0.0f;
; 576  : 	float CurrDispY = 0.0f;
; 577  : 	float CurrDispSigmaX = 0.0f;
; 578  : 	float CurrDispSigmaY = 0.0f;
; 579  : 	float DispX = T.DispX;
; 580  : 	float DispY = T.DispY;
; 581  : 	float CX, CY, DX, DY;
; 582  : 	double L0X = 0.0, L1X = 0.0, L0Y = 0.0, L1Y = 0.0;

	fldz
	mov	edx, DWORD PTR [esi+1020]

; 583  : 	double AvgLX = 0.0, AvgLY = 0.0;
; 584  : 	float *pX = T.pX;
; 585  : 	float *pY = T.pY;
; 586  : 	float *pDX = T.pDX;
; 587  : 	float *pDY = T.pDY;
; 588  : 	IntCluster **pReplicas = T.pReplicas;
; 589  : 	int ReplicaCount = 0;
; 590  : 	int ReplicaDivider = T.ReplicaSampleDivider;

	mov	ebx, DWORD PTR [esi+912]
	fst	QWORD PTR _L0X$[esp+256]
	mov	DWORD PTR _CellOverflow$[esp+256], edi
	fst	QWORD PTR _L1X$[esp+256]
	mov	edi, DWORD PTR [esi+1016]
...
; 591  : 	int DividerCount;
; 592  : 	float ReplicaRadius = T.ReplicaRadius;
...
; 595  : 
; 596  : 	if (Layer >= T.LayerNum) return S_FALSE;

	cmp	edx, DWORD PTR [esi+144]
	jge	SHORT $LN305@PutCluster

; 597  : 	T.ZLayer[Layer] = Z;
; 598  : 	for (Icell = 0; Icell < CellsInLayer; Icell++)

	cmp	ecx, edi
	fld	DWORD PTR _Z$[ebp]
	mov	ebx, DWORD PTR [esi+968]
...
; 599  : 	{	((Cell *)CellSpace)[Layer*CellsInLayer+Icell].FirstC = 0;

	mov	DWORD PTR [eax], edi

; 600  : 		((Cell *)CellSpace)[Layer*CellsInLayer+Icell].Free = 0;
...
; 601  : 		};
; 602  : 
; 603  : 	static int run = 0;
; 604  : 	run++;
; 605  : 
; 606  : 	int DeltaBins = T.DeltaBinsX * T.DeltaBinsY;

	mov	ecx, DWORD PTR [esi+1060]
	imul	ecx, DWORD PTR [esi+1064]
	add	DWORD PTR ?run@?7??PutClusters@CSmartTrackerClass@@UAGJPAUCluster@@HM@Z@4HA, 1

; 607  : 	int MaxHisto, MaxBin;
; 608  : 	for (Nc = 0; Nc < DeltaBins; T.pDeltaHisto2d[Nc++] = 0);
...
; 609  : 
; 610  : /*	FILE *fsmtg = fopen("c:\\acq\\smt8g.txt", "a+t");
; 611  : 	FILE *fsmtd = fopen("c:\\acq\\smt8d.txt", "a+t");
; 612  : */
; 613  : 
; 614  : 	if (T.ReplicaRadius > 0.0f && Layer > 0)
...
; 615  : 	{
; 616  : 		for (Nc = DividerCount = 0; (Nc < CountOfClusters) && (CurrentGCounter < MaxGrains); Nc++)
...
; 629  : 					if (++DividerCount == ReplicaDivider)
...
; 630  : 					{
; 631  : 						DividerCount = 0;
; 632  : 						PCell -= CellsInLayer;

	mov	ecx, DWORD PTR _CellsInLayer$[esp+256]

; 633  : 						CX = PClus->X/* + DispX*/;

	fld	DWORD PTR [ebx]
	neg	ecx
	fstp	DWORD PTR _CX$[esp+256]

; 634  : 						CY = PClus->Y/* + DispY*/;

	fld	DWORD PTR [edx]
	lea	eax, DWORD PTR [eax+ecx*8]

; 635  : 						IntGrain *pRep = PCell->FirstG;

	mov	ecx, DWORD PTR [eax]
	fstp	DWORD PTR _CY$[esp+256]

; 636  : 						IntGrain *pEnd = pRep + PCell->Free;
...
; 638  : 						{
; 639  : 							if (fabs(DX = (pRep->Xcm - CX)) < ReplicaRadius && fabs(DY = (pRep->Ycm - CY)) < ReplicaRadius) 
...
; 640  : 							{
; 641  : 								*(IntGrain **)(void *)&PClus->Inertia.IYY = pRep;
; 642  : 								pX[ReplicaCount] = CX;
; 643  : 								pY[ReplicaCount] = CY;
; 644  : 								pDX[ReplicaCount] = DX;

	mov	edx, DWORD PTR tv3201[esp+256]
	fstp	ST(2)

; 645  : 								pDY[ReplicaCount] = DY;
...
; 646  : 								pReplicas[ReplicaCount] = PClus;
...
; 647  : 
; 648  : 								CurrDispX += DX;
; 649  : 								CurrDispSigmaX += DX * DX;
; 650  : 								CurrDispY += DY;
; 651  : 								CurrDispSigmaY += DY * DY;
; 652  : 
; 653  : 								T.pDeltaHisto2d[((int)floor(DY / T.DeltaDY + 0.5) + T.DeltaBinsY / 2) * T.DeltaBinsX + ((int)floor(DX / T.DeltaDX + 0.5) + T.DeltaBinsX / 2)]++;

	sub	esp, 8
	fxch	ST(1)
	fstp	DWORD PTR [edx+edi]
	fst	DWORD PTR [eax+edi]
	mov	ebx, DWORD PTR [esi+1060]
	fdiv	DWORD PTR [esi+1056]
...
; 664  : 				};
; 665  : 			};
; 666  : 		MaxBin = DeltaBins / 2 + T.DeltaBinsX / 2;
; 667  : 		for (Nc = MaxHisto = MaxBin = 0; Nc < DeltaBins; Nc++)
	...
	mov	edi, DWORD PTR [esi+1068]
	mov	ebx, DWORD PTR _DeltaBins$[esp+256]
$LN50@PutCluster:

; 668  : 			if (T.pDeltaHisto2d[Nc] > MaxHisto)
...
; 669  : 			{
; 670  : 				MaxHisto = T.pDeltaHisto2d[Nc];
...
; 675  : 			if ((MaxHisto = T.pDeltaHisto2d[MaxBin] + T.pDeltaHisto2d[MaxBin + 1] + T.pDeltaHisto2d[MaxBin - 1] + 
; 676  : 				T.pDeltaHisto2d[MaxBin + T.DeltaBinsX] + T.pDeltaHisto2d[MaxBin + 1 + T.DeltaBinsX] + T.pDeltaHisto2d[MaxBin - 1 + T.DeltaBinsX] + 
; 677  : 				T.pDeltaHisto2d[MaxBin - T.DeltaBinsX] + T.pDeltaHisto2d[MaxBin + 1 - T.DeltaBinsX] + T.pDeltaHisto2d[MaxBin - 1 - T.DeltaBinsX]) >= T.MinReplicas)

	mov	edi, DWORD PTR [esi+1060]
...
; 678  : 		{
; 679  : 			DX = ((MaxBin % T.DeltaBinsX) - T.DeltaBinsX / 2) * T.DeltaDX;

	mov	eax, edx
	fstp	ST(1)
	cdq
	fstp	ST(0)
	idiv	DWORD PTR [esi+1060]
...
; 680  : 			DY = ((MaxBin / T.DeltaBinsX) - T.DeltaBinsY / 2) * T.DeltaDY;
...
; 681  : 			CurrDispX = (DX * (T.pDeltaHisto2d[MaxBin] + T.pDeltaHisto2d[MaxBin + T.DeltaBinsX] + T.pDeltaHisto2d[MaxBin - T.DeltaBinsX]) + 
; 682  : 				(DX + T.DeltaDX) * (T.pDeltaHisto2d[MaxBin + 1] + T.pDeltaHisto2d[MaxBin + T.DeltaBinsX + 1] + T.pDeltaHisto2d[MaxBin - T.DeltaBinsX + 1]) + 
; 683  : 				(DX - T.DeltaDX) * (T.pDeltaHisto2d[MaxBin - 1] + T.pDeltaHisto2d[MaxBin + T.DeltaBinsX - 1] + T.pDeltaHisto2d[MaxBin - T.DeltaBinsX - 1])) / MaxHisto;
...
; 684  : 
; 685  : 			CurrDispY = (DY * (T.pDeltaHisto2d[MaxBin] + T.pDeltaHisto2d[MaxBin + 1] + T.pDeltaHisto2d[MaxBin - 1]) + 
; 686  : 				(DY + T.DeltaDY) * (T.pDeltaHisto2d[MaxBin + T.DeltaBinsX] + T.pDeltaHisto2d[MaxBin + T.DeltaBinsX + 1] + T.pDeltaHisto2d[MaxBin + T.DeltaBinsX - 1]) + 
; 687  : 				(DY - T.DeltaDY) * (T.pDeltaHisto2d[MaxBin - T.DeltaBinsX] + T.pDeltaHisto2d[MaxBin - T.DeltaBinsX + 1] + T.pDeltaHisto2d[MaxBin - T.DeltaBinsX - 1])) / MaxHisto;
...
; 688  : 
; 689  : 			int rsp, rv;
; 690  : 			double SumPx = 0.0, SumX = 0.0, SumX2 = 0.0, SumXPx = 0.0, DenX = 0.0;
; 691  : 			double SumPy = 0.0, SumY = 0.0, SumY2 = 0.0, SumYPy = 0.0, DenY = 0.0;
; 692  : 			double V, W;
; 693  : 			for (rsp = rv = 0; rsp < ReplicaCount; rsp++)

	xor	ebx, ebx
	fmulp	ST(1), ST(0)
	mov	DWORD PTR _rsp$130911[esp+256], ebx
	fild	DWORD PTR tv4592[esp+256]
	mov	DWORD PTR tv4590[esp+256], edi
	xor	edi, edi
	cmp	DWORD PTR _ReplicaCount$[esp+256], 4
	fmul	ST(0), ST(2)
	mov	DWORD PTR _rv$130912[esp+256], edi
	faddp	ST(1), ST(0)
	...
	fld	ST(3)
	fxch	ST(4)
	fst	QWORD PTR _SumPy$130918[esp+256]
	fld	ST(0)
	fld	ST(1)
	fxch	ST(2)
	fstp	QWORD PTR _SumYPy$130921[esp+256]
	jl	$LC117@PutCluster
	...
	mov	ebx, DWORD PTR _rsp$130911[esp+256]
	mov	DWORD PTR tv3197[esp+256], edi
	mov	edi, DWORD PTR _rv$130912[esp+256]
$LN122@PutCluster:

; 694  : 			{
; 695  : 				if (fabs(pDX[rsp] - CurrDispX) < T.DeltaDX && fabs(pDY[rsp] - CurrDispY) < T.DeltaDY)
...
; 704  : 					V = pY[rsp];
	...
	fld	DWORD PTR [ecx-4]
	add	edi, 1
	fstp	QWORD PTR _W$130924[esp+256]
	fld	ST(0)
	faddp	ST(5), ST(0)
	fld	ST(0)
	fmul	ST(0), ST(1)
	faddp	ST(4), ST(0)
	fld	QWORD PTR _W$130924[esp+256]
	faddp	ST(6), ST(0)
	fmul	QWORD PTR _W$130924[esp+256]
	faddp	ST(6), ST(0)
	fld	DWORD PTR [eax-12]
	fst	QWORD PTR _V$130923[esp+256]
...
; 708  : 					SumPy += W;
	...
	fld	QWORD PTR _W$130924[esp+256]
	fadd	QWORD PTR _SumPy$130918[esp+256]
	fstp	QWORD PTR _SumPy$130918[esp+256]

; 709  : 					SumYPy += V * W;

	fld	QWORD PTR _W$130924[esp+256]
	fmul	QWORD PTR _V$130923[esp+256]
	fadd	QWORD PTR _SumYPy$130921[esp+256]
	fstp	QWORD PTR _SumYPy$130921[esp+256]
$LN118@PutCluster:
	fld	DWORD PTR [ecx]
	fsub	DWORD PTR _CurrDispX$[esp+256]
...
; 710  : 					}
; 711  : 				}
; 712  : 			DenX = 1. / (rv * SumX2 - SumX * SumX);
; 713  : 			L0X = (SumPx * SumX2 - SumX * SumXPx) * DenX;
; 714  : 			L1X = (rv * SumXPx - SumX * SumPx) * DenX;
; 715  : 			DenY = 1. / (rv * SumY2 - SumY * SumY);
; 716  : 			L0Y = (SumPy * SumY2 - SumY * SumYPy) * DenY;
; 717  : 			L1Y = (rv * SumYPy - SumY * SumPy) * DenY;
; 718  : 
; 719  : 			SumPx = 0.0; SumX = 0.0; SumX2 = 0.0; SumXPx = 0.0; DenX = 0.0;
; 720  : 			SumPy = 0.0; SumY = 0.0; SumY2 = 0.0; SumYPy = 0.0; DenY = 0.0;
; 721  : 			for (rsp = rv = 0; rsp < ReplicaCount; rsp++)

	cmp	DWORD PTR _ReplicaCount$[esp+256], 0
	fild	DWORD PTR _rv$130912[esp+256]
	mov	DWORD PTR _rv$130912[esp+256], 0
	...
	fld	ST(0)
	fdivrp	ST(2), ST(0)
	fld	QWORD PTR _SumPy$130918[esp+256]
	fmul	ST(4), ST(0)
	fld	QWORD PTR _SumYPy$130921[esp+256]
	fld	ST(0)
	fmul	ST(0), ST(7)
	fsubp	ST(6), ST(0)
	fxch	ST(5)
	...
	fld	ST(0)
	fxch	ST(1)
	fst	QWORD PTR _SumY2$130920[esp+256]
	fstp	QWORD PTR _SumYPy$130921[esp+256]
	jle	$LN38@PutCluster
...
; 722  : 			{
; 723  : 				if (fabs(pDX[rsp] - (pX[rsp] * L1X + L0X)) < T.DeltaDX && fabs(pDY[rsp] - (pY[rsp] * L1Y + L0Y)) < T.DeltaDY)
; 724  : 				{
; 725  : 					rv++;
; 726  : 					V = pX[rsp];
; 727  : 					W = pDX[rsp];
...
$LN40@PutCluster:
	...
	fld	DWORD PTR [ecx+ebx]
	add	DWORD PTR _rv$130912[esp+256], 1
	fld	DWORD PTR [ecx]
	fld	ST(1)
	faddp	ST(4), ST(0)
	fld	ST(1)
	...
	fld	ST(0)
	fmul	ST(0), ST(1)
	fadd	QWORD PTR _SumY2$130920[esp+256]
	fstp	QWORD PTR _SumY2$130920[esp+256]
	fld	QWORD PTR _W$130924[esp+256]
	fadd	QWORD PTR _SumPy$130918[esp+256]
	fstp	QWORD PTR _SumPy$130918[esp+256]
	fmul	QWORD PTR _W$130924[esp+256]
...
; 740  : 				}
; 741  : 			DenX = 1. / (rv * SumX2 - SumX * SumX);

	fild	DWORD PTR _rv$130912[esp+256]

; 742  : 			L0X = (SumPx * SumX2 - SumX * SumXPx) * DenX;
; 743  : 			L1X = (rv * SumXPx - SumX * SumPx) * DenX;
; 744  : 			DenY = 1. / (rv * SumY2 - SumY * SumY);
; 745  : 			L0Y = (SumPy * SumY2 - SumY * SumYPy) * DenY;
; 746  : 			L1Y = (rv * SumYPy - SumY * SumPy) * DenY;
; 747  : 			AvgLX = L0X + L1X * T.ViewCenterX;
; 748  : 			AvgLY = L0Y + L1Y * T.ViewCenterY;
; 749  : 			L1X += 1.0;
; 750  : 			L1Y += 1.0;
; 751  : 			T.TotalLX += AvgLX;
; 752  : 			T.TotalLY += AvgLY;
; 753  : 			for (rsp = 0; rsp < ReplicaCount; rsp++)
	...
	fmulp	ST(2), ST(0)
	fld	ST(0)
	fld	QWORD PTR _SumY2$130920[esp+256]
	fmul	ST(1), ST(0)
	fld	ST(4)
	fmul	ST(0), ST(5)
	fsubp	ST(2), ST(0)
	...
	fst	QWORD PTR _L0Y$[esp+256]
	fxch	ST(3)
	fmul	QWORD PTR _SumYPy$130921[esp+256]
	fxch	ST(5)
	fmulp	ST(1), ST(0)
	fsubp	ST(4), ST(0)
	fmulp	ST(3), ST(0)
...
; 754  : 				if (pReplicas[rsp]) 

	cmp	DWORD PTR [edx+eax*4], 0
	je	SHORT $LN34@PutCluster

; 755  : 					pReplicas[rsp]->Area = -pReplicas[rsp]->Area;
...
; 756  : /*
; 757  : 			T.DispX = (DispX += CurrDispX);
; 758  : 			T.DispY = (DispY += CurrDispY);
; 759  : */
; 760  : /*
; 761  : 			fprintf(fsmtd, "%d %d %f %f %d %d %f %f %f %f\n", run, Layer, CurrDispX, CurrDispY, MaxHisto, MaxBin, DX, DY, T.DeltaDX, T.DeltaDY);
; 762  : */				
; 763  : /*
; 764  : 			fprintf(fsmtd, "%d %d %f %f %f %d %d %f %f %f %f\n", run, Layer, Z - T.ZLayer[Layer - 1], CurrDispX, CurrDispY, MaxHisto, MaxBin, L0X, L1X, L0Y, L1Y);
; 765  : */				
; 766  : 
; 767  : 			CurrDispSigmaX = T.DeltaDX * 0.5f;
; 768  : 			CurrDispSigmaY = T.DeltaDY * 0.5f;
; 769  : 			T.ShadowSigmaMeasures++;
; 770  : 			T.ShadowSigmaXAccumulator += CurrDispSigmaX;

	fld	DWORD PTR [esi+1052]
	add	DWORD PTR [esi+1048], 1
...
; 771  : 			T.ShadowSigmaYAccumulator += CurrDispSigmaY;

	fmul	DWORD PTR [esi+1056]
	fstp	DWORD PTR tv4323[esp+256]
	fld	DWORD PTR tv4323[esp+256]
	fadd	DWORD PTR [esi+1036]
	fstp	DWORD PTR [esi+1036]
$LN302@PutCluster:
...
; 774  : 	else
; 775  : 	{
; 776  : 		for (Nc = 0; (Nc < CountOfClusters) && (CurrentGCounter < MaxGrains); Nc++)
...
; 795  : 	fclose(fsmtd);
; 796  : */
; 797  : 	T.LayerGrains[Layer] = PGrain = T.GrainSpace + T.NumGrains;

	mov	eax, DWORD PTR [esi+1016]

; 798  : 	PGrainEnd = T.GrainSpace + MaxGrains;
; 799  : 	IntCluster *NextFree;
; 800  : 
; 801  : 	float pcx, pcy;
; 802  : 	IntGrain *pig;
; 803  : 	if (T.ReplicaRadius > 0.0f && Layer > 0)
...
; 804  : 	{
; 805  : 		for (Icell = 0; (Icell < CellsInLayer) && (PGrain < PGrainEnd); Icell ++)
...
; 777  : 		{	
; 778  : 			PClus = (IntCluster *)(pClusters + Nc);
; 779  : 			if ((PClus->Area >= PixMin) && (PClus->Area <= PixMax))
...
; 780  : 			{	
; 781  : 				Icell = GetCell(PClus->X *= PixelToMicronX, PClus->Y *= PixelToMicronY);
...
; 783  : 				{	
; 784  : 					PCell = (Cell *)(CellSpace+(Layer*CellsInLayer+Icell));
...
; 787  : 					PClus->NextFree = PCell->FirstC;

	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR [edi+8], ecx

; 788  : 					PCell->FirstC = PClus;
...
; 806  : 		{	
; 807  : 			PCell = (Cell *)(CellSpace+(Layer*CellsInLayer+Icell));
...
; 809  : 			{	
; 810  : 				if (PCell->Free < CellOverflow)

	cmp	eax, DWORD PTR _CellOverflow$[esp+256]
	jge	$LN20@PutCluster

; 811  : 				{	
; 812  : 					PClus = PCell->FirstC;

	mov	eax, DWORD PTR [ebx]

; 813  : 					PCell->FirstG = PGrain;
...
; 814  : 					do
; 815  : 					{	
; 816  : //						PGrain->Xcm = PClus->X + DispX;
; 817  : //						PGrain->Ycm = PClus->Y + DispY;
; 818  : 						NextFree = PClus->NextFree;
; 819  : 						if (PClus->Area < 0)
...
; 820  : 						{							
; 821  : 							PGrain->Xcm = (pcx = PClus->X) * L1X + L0X;
...
; 822  : 							PGrain->Ycm = (pcy = PClus->Y) * L1Y + L0Y;
...
; 823  : 							pig = *((IntGrain **)(void *)(&PClus->Inertia.IYY));

	mov	edx, DWORD PTR [eax+28]

; 824  : 							PGrain->Area = -PClus->Area;

	mov	eax, DWORD PTR [eax+8]

; 825  : 							PGrain->Xunc = pcx + AvgLX; 

	fxch	ST(1)
	fadd	ST(0), ST(5)
	neg	eax

; 826  : 							PGrain->Yunc = pcy + AvgLY;
; 827  : 							PGrain->ChainLinkNumber = 1 + (PGrain->pChainHead = pig)->ChainLinkNumber;
...
; 830  : 						{
; 831  : 							PGrain->Xcm = PClus->X + AvgLX;

	fld	DWORD PTR [eax]
	fadd	ST(0), ST(4)
	fstp	DWORD PTR [ecx]

; 832  : 							PGrain->Ycm = PClus->Y + AvgLY;

	fld	DWORD PTR [eax+4]
	fadd	ST(0), ST(5)
	fstp	DWORD PTR [ecx+4]

; 833  : 							PGrain->Area = PClus->Area;							

	mov	eax, DWORD PTR [eax+8]

; 834  : 							PGrain->ChainLinkNumber = 0;
; 835  : 							PGrain->pChainHead = 0;
; 836  : 							PGrain->Xunc = PGrain->Xcm;
...
; 838  : 							}
; 839  : 						//PClus = PClus->NextFree;
; 840  : 						PClus = NextFree;
; 841  : 						}
; 842  : 					while (((++PGrain) < PGrainEnd) && (PClus));
...
; 848  : 					};
; 849  : 				};
; 850  : 			T.NumGrains += PCell->Free;

	mov	eax, DWORD PTR [ebx+4]
	add	DWORD PTR [esi+1016], eax
...
; 854  : 	{
; 855  : 		for (Icell = 0; (Icell < CellsInLayer) && (PGrain < PGrainEnd); Icell ++)
...
; 856  : 		{	
; 857  : 			PCell = (Cell *)(CellSpace+(Layer*CellsInLayer+Icell));
...
; 859  : 			{	
; 860  : 				if (PCell->Free < CellOverflow)

	cmp	eax, DWORD PTR _CellOverflow$[esp+256]
	jge	SHORT $LN7@PutCluster

; 861  : 				{	
; 862  : 					PClus = PCell->FirstC;

	mov	eax, DWORD PTR [edx]

; 863  : 					PCell->FirstG = PGrain;
...
; 864  : 					do
; 865  : 					{	
; 866  : 						PGrain->Xcm = PClus->X;

	fld	DWORD PTR [eax]

; 867  : 						PGrain->Ycm = PClus->Y;
; 868  : 						PGrain->Area = PClus->Area;
; 869  : 						NextFree = PClus->NextFree;
; 870  : /*						if (PGrain->Area <= 0)
; 871  : 						{
; 872  : 							::MessageBox(0, "Here - Invalid grain area!", "Debug Info", MB_OK);
; 873  : 							volatile int uy = 0;
; 874  : 							uy = 1;
; 875  : 							}*/
; 876  : 						//PClus = PClus->NextFree;
; 877  : 						PClus = NextFree;
; 878  : 						}
; 879  : 					while (((++PGrain) < PGrainEnd) && (PClus));
...
; 885  : 					};
; 886  : 				};
; 887  : 			T.NumGrains += PCell->Free;

	mov	edx, DWORD PTR [edx+4]
	mov	eax, DWORD PTR _CellsInLayer$[esp+256]
	add	DWORD PTR [esi+1016], edx
	add	edi, 1
	cmp	edi, eax
...
; 890  : /*
; 891  : 	{
; 892  : 		FILE *f = fopen("c:\\acq\\tk.txt", "at");
; 893  : 		fprintf(f, "%d %f %f %d %f %f\n", T.Layer, T.DispX, T.DispY, ReplicaCount, CurrDispSigmaX, CurrDispSigmaY);
; 894  : 		fclose(f);
; 895  : 		}
; 896  : */
; 897  : 	if (PGrain >= PGrainEnd) return S_FALSE;
...
; 1955 : 	GetData(Temp, ConfigDataN, ConfigDataQDI, &T, true);
...
; 1956 : 
; 1957 : 	T.PresetSlope = false;
; 1958 : 	T.PresetSlopeAccX = T.PresetSlopeAccY = T.PresetSlopeX = T.PresetSlopeY = 0.0f;

	fldz

; 1959 : 	T.GrainSpace = 0;
; 1960 : 	T.ZLayer = 0;
; 1961 : 	T.LayerGrains = 0;
; 1962 : 	T.CellSpace = 0;
; 1963 : 	T.pDeltaHisto2d = 0;
; 1964 : 	T.pDeltaData = 0;
; 1965 : 	T.pX = T.pY = T.pDX = T.pDY = 0;
; 1966 : 	T.pReplicas = 0;
; 1967 : }

	mov	ecx, DWORD PTR __$ArrayPad$[esp+116]
	fst	DWORD PTR [esi+952]
	fst	DWORD PTR [esi+948]
	add	esp, 32					; 00000020H
	fst	DWORD PTR [esi+960]
	mov	BYTE PTR [esi+944], bl
	mov	DWORD PTR [esi+964], ebx
	fstp	DWORD PTR [esi+956]
...
; 1983 : 	float normdist;
; 1984 : 	float dx, dy;
; 1985 : 	IntGrain *pStart = FirstG;
; 1986 : 	IntGrain *pEnd = FirstG + Free;

	mov	eax, DWORD PTR [ecx]

; 1987 : 	float reddirtol = dirtol * 1.5f;
...
; 1988 : 	for (IntGrain *pScan = pStart; pScan < pEnd; pScan++)

	mov	edx, eax
	fstp	DWORD PTR _reddirtol$[esp+12]
	cmp	edx, ecx
	mov	DWORD PTR _pEnd$[esp+12], ecx
	mov	DWORD PTR _pScan$131670[esp+12], eax
	jae	$LN12@FindGrains
...
; 1989 : 		if (fabs(dx = (pScan->Xcm - x)) <= reddirtol)
...
; 1990 : 			if (fabs(dy = (pScan->Ycm - y)) <= reddirtol)
...
; 1991 : 				if ((normdist = fabs(dy * dirx - dx * diry)) < normtol)
...
; 1992 : 					if (fabs(dx * dirx + dy * diry) < dirtol)
...
; 1993 : 					{
; 1994 : 						for (i = 0; i < maxmult && pDist[i] <= normdist; i++);
...
; 1995 : 						if (i == maxmult) continue;

	cmp	edi, esi
$LN102@FindGrains:
	je	$LN80@FindGrains

; 1996 : 						for (j = maxmult - 1; j > i; j--)
...
; 1999 : 							pDest[j] = pDest[j - 1];
	...
	mov	edx, DWORD PTR _pScan$131670[esp+28]
...
; 1988 : 	for (IntGrain *pScan = pStart; pScan < pEnd; pScan++)
	...
	mov	DWORD PTR _pScan$131670[esp+28], edx
	jb	$LN48@FindGrains
	pop	edi
	fstp	ST(1)
	pop	esi
...
; 2008 : 	IntGrain *pBest = 0;
; 2009 : 	int i;
; 2010 : 	float bestnormdist, normdist;
; 2011 : 	float dx, dy;
; 2012 : 	IntGrain *pStart = FirstG;
; 2013 : 	IntGrain *pEnd = FirstG + Free;

	mov	eax, DWORD PTR [ecx]

; 2014 : 	float reddirtol = dirtol * 1.5f;
...
; 2015 : 	for (IntGrain *pScan = pStart; pScan < pEnd; pScan++)
...
; 2016 : 		if (fabs(dx = (pScan->Xcm - x)) <= reddirtol)
...
; 2017 : 			if (fabs(dy = (pScan->Ycm - y)) <= reddirtol)
...
; 2018 : 				if ((normdist = fabs(dy * dirx - dx * diry)) < normtol)
...
; 2019 : 					if (!pBest || normdist < bestnormdist)
...
; 2020 : 						if (fabs(dx * dirx + dy * diry) < dirtol)
...
; 2030 : 	IntGrain *pBest = 0;
; 2031 : 	int i;
; 2032 : 	float bestnormdist = normtol, normdist;

	fld	DWORD PTR _normtol$[esp]
	mov	eax, ecx

; 2033 : 	float dx, dy;
; 2034 : 	IntGrain *pStart = FirstG;
; 2035 : 	IntGrain *pEnd = FirstG + Free;

	mov	ecx, DWORD PTR [eax]
	fstp	DWORD PTR _bestnormdist$[esp]
	mov	eax, DWORD PTR [eax+4]

; 2036 : 	float reddirtol = dirtol * 1.5f;
...
; 2037 : 	for (IntGrain *pScan = pStart; pScan < pEnd; pScan++)
...
; 2038 : 		if (fabs(dx = (pScan->Xcm - x)) <= reddirtol)
...
; 2039 : 			if (fabs(dy = (pScan->Ycm - y)) <= reddirtol)
...
; 2040 : 				if ((normdist = fabs(dy * dirx - dx * diry)) < bestnormdist)
...
; 2041 : 				{
; 2042 : 					if (pTopShadow && fabs(pTopShadow->Xcm - pScan->Xcm) < xshadowtol && fabs(pTopShadow->Ycm - pScan->Ycm) < yshadowtol) continue;
...
; 2043 : 					if (pBottomShadow && fabs(pBottomShadow->Xcm - pScan->Xcm) < xshadowtol && fabs(pBottomShadow->Ycm - pScan->Ycm) < yshadowtol) continue;
...
; 2045 : 						if (fabs(dx * dirx + dy * diry) < dirtol)
...
; 2187 : 	if (T.pDeltaHisto2d) CoTaskMemFree(T.pDeltaHisto2d);
...
; 2188 : 	T.pDeltaHisto2d = 0;
; 2189 : 	T.DeltaDX = fabs(T.PixelToMicronX);
; 2190 : 	T.DeltaDY = fabs(T.PixelToMicronY);
; 2191 : 	T.DeltaBinsX = (int)floor(T.ReplicaRadius / T.DeltaDX + 1) * 2 + 5;
...
; 2192 : 	T.DeltaBinsY = (int)floor(T.ReplicaRadius / T.DeltaDY + 1) * 2 + 5;
...
; 2193 : 	return T.pDeltaHisto2d = (int *)CoTaskMemAlloc( sizeof(int) * T.DeltaBinsX * T.DeltaBinsY);
...
; 2202 : 	::PutData(*pConfig, ConfigDataN, ConfigDataQDI, pC);
...
; 506  : 	if (Spec.PixelToMicronX != 0.f && Spec.PixelToMicronY != 0.f &&
; 507  : 		Spec.Height > 0 && Spec.Width > 0 && Spec.WinHeight > 0 && Spec.WinWidth > 0)
...
; 510  : 		T.PixelToMicronX = Spec.PixelToMicronX;

	fxch	ST(1)
	fst	DWORD PTR [edx+1008]
	push	esi

; 511  : 		T.PixelToMicronY = Spec.PixelToMicronY;

	fxch	ST(1)
	push	edi
	fst	DWORD PTR [edx+1012]
	lea	edi, DWORD PTR [edx+108]

; 512  : 		if (T.PixelToMicronX > 0)
...
; 514  : 			T.Win.Xmax = Spec.OffX + Spec.WinWidth;
...
; 518  : 			T.Win.Xmin = Spec.OffX + Spec.WinWidth;
...
; 522  : 			T.Win.Ymax = Spec.OffY + Spec.WinHeight;
...
; 526  : 			T.Win.Ymin = Spec.OffY + Spec.WinHeight;
...
; 527  : 			};
; 528  : 		T.Win.Xmin *= T.PixelToMicronX;

	fld	DWORD PTR [edx+984]

; 529  : 		T.Win.Xmax *= T.PixelToMicronX;
; 530  : 		T.Win.Ymin *= T.PixelToMicronY;
; 531  : 		T.Win.Ymax *= T.PixelToMicronY;
; 532  : 		T.DxCell = ((T.Win.Xmax - T.Win.Xmin)/(float)(T.CellNumX));
; 533  : 		T.DyCell = ((T.Win.Ymax - T.Win.Ymin)/(float)(T.CellNumY));
; 534  : 		T.ViewCenterX = Spec.Width * Spec.PixelToMicronX * 0.5;
	...
	fstp	DWORD PTR [edx+1004]
	fild	DWORD PTR _Spec$[esp+4]
	jge	SHORT $LN43@SetCameraS
	fadd	DWORD PTR __real@4f800000
$LN43@SetCameraS:

; 535  : 		T.ViewCenterY = Spec.Height * Spec.PixelToMicronY * 0.5;
...
; 536  : 		if (!ResetDeltaHisto()) return S_FALSE;

	mov	ecx, edx
	fmulp	ST(1), ST(0)
	fstp	DWORD PTR [edx+1100]
...
; 1241 : 	float fix, fiy;
; 1242 : 	int eix = (int)(fix = ((expx - T.Win.Xmin) / T.DxCell));
...
; 1243 : 	if (eix < 0 || eix >= T.CellNumX) return 0;
...
; 1244 : 	int eiy = (int)(fiy = ((expy - T.Win.Ymin) / T.DyCell));
...
; 1246 : 	{
; 1247 : 		IntGrain *pNew = pCellLayer[eiy * T.CellNumX + eix].FindGrainNoShadow(expx, expy, dirx, diry, dirtol, T.AlignTol, pTopShadow, pBottomShadow, xshadowtol, yshadowtol);
...
; 1254 : 				return pCellLayer[eiy * T.CellNumX + eix - 1].FindGrainNoShadow(expx, expy, dirx, diry, dirtol, T.AlignTol, pTopShadow, pBottomShadow, xshadowtol, yshadowtol);
...
; 1261 : 				return pCellLayer[(eiy - 1) * T.CellNumX + eix].FindGrainNoShadow(expx, expy, dirx, diry, dirtol, T.AlignTol, pTopShadow, pBottomShadow, xshadowtol, yshadowtol);
...
; 1255 : 			else if (fix > 0.0f && eix < (T.CellNumX - 1))
...
; 1256 : 				return pCellLayer[eiy * T.CellNumX + eix + 1].FindGrainNoShadow(expx, expy, dirx, diry, dirtol, T.AlignTol, pTopShadow, pBottomShadow, xshadowtol, yshadowtol);
...
; 1262 : 			else if (fiy > 0.0f && eiy < (T.CellNumX - 1))
...
; 1263 : 				return pCellLayer[(eiy + 1) * T.CellNumX + eix].FindGrainNoShadow(expx, expy, dirx, diry, dirtol, T.AlignTol, pTopShadow, pBottomShadow, xshadowtol, yshadowtol);
...
; 1271 : 
; 1272 : #define MAXMULT 16
; 1273 : 
; 1274 : 	IntGrain *pOut[MAXMULT];
; 1275 : 	float Dist[MAXMULT];
; 1276 : 	if (maxmult > MAXMULT) maxmult = MAXMULT;
...
; 1277 : 	int i;
; 1278 : 	for (i = 0; i < maxmult; Dist[i++] = T.AlignTol);
...
; 1279 : 	float fix, fiy;
; 1280 : 	int eix = (int)(fix = ((expx - T.Win.Xmin) / T.DxCell));
...
; 1281 : 	if (eix < 0 || eix >= T.CellNumX) return 0;
...
; 1282 : 	int eiy = (int)(fiy = ((expy - T.Win.Ymin) / T.DyCell));
...
; 1284 : 	{
; 1285 : 		pCellLayer[eiy * T.CellNumX + eix].FindGrains(expx, expy, dirx, diry, dirtol, T.AlignTol, pOut, Dist, maxmult);
...
; 1291 : 				pCellLayer[eiy * T.CellNumX + eix - 1].FindGrains(expx, expy, dirx, diry, dirtol, T.AlignTol, pOut, Dist, maxmult);
...
; 1292 : 			else if (fix > 0.0f && eix < (T.CellNumX - 1))
...
; 1293 : 				pCellLayer[eiy * T.CellNumX + eix + 1].FindGrains(expx, expy, dirx, diry, dirtol, T.AlignTol, pOut, Dist, maxmult);
...
; 1298 : 				pCellLayer[(eiy - 1) * T.CellNumX + eix].FindGrains(expx, expy, dirx, diry, dirtol, T.AlignTol, pOut, Dist, maxmult);
...
; 1299 : 			else if (fiy > 0.0f && eiy < (T.CellNumY - 1))
...
; 1300 : 				pCellLayer[(eiy + 1) * T.CellNumX + eix].FindGrains(expx, expy, dirx, diry, dirtol, T.AlignTol, pOut, Dist, maxmult);
...
; 1301 : 			}
; 1302 : 		}
; 1303 : 	for (i = 0; i < maxmult && Dist[i] < T.AlignTol; i++) pGrainDest[i] = pOut[i];
...
tv2475 = -352						; size = 4
tv2257 = -352						; size = 4
_j$131532 = -352					; size = 4
_seqlength$131522 = -352				; size = 4
_dz$131444 = -352					; size = 4
_ExpX$ = -352						; size = 4
_cdz$131438 = -352					; size = 4
_ldz$131437 = -352					; size = 4
tv2426 = -348						; size = 4
tv2415 = -348						; size = 4
tv2396 = -348						; size = 4
tv2343 = -348						; size = 4
tv2342 = -348						; size = 4
tv2255 = -348						; size = 4
_dz$131521 = -348					; size = 4
_cdz$131515 = -348					; size = 4
_ldz$131514 = -348					; size = 4
_pBE$131417 = -348					; size = 4
_j$131455 = -344					; size = 4
_seqlength$131445 = -344				; size = 4
_ExpY$ = -344						; size = 4
_Slope2$ = -344						; size = 4
...
_itr$ = -220						; size = 4
tv2928 = -216						; size = 4
_pT$131403 = -216					; size = 4
_ix$ = -212						; size = 4
tv2761 = -208						; size = 4
tv1541 = -208						; size = 4
_pTE$131483 = -204					; size = 4
_pB$131416 = -204					; size = 4
tv2602 = -200						; size = 4
_pB$131495 = -200					; size = 4
...
_bp$131470 = -168					; size = 4
_pTE$131404 = -168					; size = 4
tv1543 = -164						; size = 4
_CellsInLayer$ = -160					; size = 4
tv1579 = -156						; size = 4
_pBE$131496 = -152					; size = 4
_bp$131391 = -152					; size = 4
_ISlopeS$ = -148					; size = 4
...
_gt$131487 = -116					; size = 36
_gt$131408 = -116					; size = 36
_gb$131502 = -80					; size = 36
_gb$131423 = -80					; size = 36
_tr$131466 = -44					; size = 44
_tr$131387 = -44					; size = 44
_AR$ = 8						; size = 4
...
; 1309 : 	int countIterations = 0, countSlopeX = 0, countSlopeY = 0, countTrials = 0, countFindGrains = 0, countPossible = 0, countAccepted = 0;
; 1310 : 	int nx, ny, bx, wx;
; 1311 : 	int lay;
; 1312 : 	int itr, ibr;
; 1313 : 	int NTracks = 0;
; 1314 : 	float *ZLayer = T.ZLayer;
; 1315 : 	float tz;
; 1316 : 	int CellsInLayer = T.CellsInLayer;

	mov	ecx, DWORD PTR [ebp+980]

; 1317 : 	Cell *CellSpace = T.CellSpace;
; 1318 : 	float MaxSlope = T.MaxSlope;
...
; 1319 : 	float MinSlope = T.MinSlope;
; 1320 : 	float MaxSlope2 = MaxSlope * MaxSlope;
...
; 1321 : 	float aligntol2 = T.AlignTol * T.AlignTol;
; 1322 : 	int TimeLimit = AR.TimeLimit;
...
; 1323 : 
; 1324 : 	int ix, iy, iix, iiy, eix, eiy;
; 1325 : 	int minix, maxix, miniy, maxiy;
; 1326 : 	float Slope2, SlopeS, ISlopeS;
; 1327 : 	float SlopeX, SlopeY, ExpX, ExpY, DirX, DirY;
; 1328 : 	float ShadowXTol, ShadowYTol;
; 1329 : 	float CurrDeltaX, CurrDeltaY;
; 1330 : 	float avgds2;
; 1331 : 	float dirtol;
; 1332 : 	int it, ib, ir, ifound;
; 1333 : 	float idz;
; 1334 : 
; 1335 : 	ShadowXTol = T.DiscardShadowSigma * T.ShadowSigmaX;
; 1336 : 	ShadowYTol = T.DiscardShadowSigma * T.ShadowSigmaY;
; 1337 : 
; 1338 : 	bx = T.CellNumX / T.Processors * AR.ThreadIndex;
...
; 1339 : 	nx = T.CellNumX;
; 1340 : 	wx = (AR.ThreadIndex == T.Processors - 1) ? T.CellNumX : (T.CellNumX / T.Processors * (AR.ThreadIndex + 1));
...
; 1341 : 	ny = T.CellNumY;
; 1342 : 
; 1343 : 	for (lay = 0; lay < T.Layer; lay++)

	cmp	DWORD PTR [ebp+1020], edi
	...
	mov	DWORD PTR tv2356[esp+368], eax
	npad	9
$LL113@PartialGet:

; 1346 : 		for (iy = 0; iy < ny; iy++)

	cmp	DWORD PTR _ny$[esp+368], 0
	mov	edi, DWORD PTR tv2356[esp+368]
	jle	SHORT $LN112@PartialGet

; 1344 : 	{		
; 1345 : 		Cell *pCellsL = CellSpace + lay * CellsInLayer;
...
; 1347 : 		{
; 1348 : 			Cell *pCellsR = pCellsL + bx;

	mov	eax, DWORD PTR _bx$[esp+368]

; 1349 : 			for (ix = bx; ix < wx; ix++)
...
; 1350 : 			{
; 1351 : 				IntGrain *pG = pCellsR->FirstG;
; 1352 : 				IntGrain *pGEnd = pG + pCellsR->Free;
...
; 1343 : 	for (lay = 0; lay < T.Layer; lay++)
	...
	add	ecx, ecx
	add	ecx, ecx
	add	DWORD PTR tv2356[esp+368], ecx
	add	eax, 1
	cmp	eax, DWORD PTR [ebp+1020]
...
; 1366 : 	if (AR.MaxTracks <= 0) return S_OK;
...
; 1367 : 
; 1368 : 	int EndLayer = AR.EndLayer;

	mov	esi, DWORD PTR [eax+32]

; 1369 : 	int StartLayer = AR.StartLayer;

	mov	edi, DWORD PTR [eax+28]

; 1370 : 	if (EndLayer >= T.Layer) EndLayer = T.Layer - 1;
...
; 1371 : 
; 1372 : 	IntGrain **pTempGrains = (IntGrain **)malloc(sizeof(IntGrain *) * (EndLayer + 1) * T.InitialMultiplicity);
...
; 1373 : 
; 1374 : 	float avgdz = (ZLayer[StartLayer] - ZLayer[EndLayer]) / (EndLayer - StartLayer);
...
; 1375 : 	float avgdz2 = avgdz * avgdz;
; 1376 : 			
; 1377 : 	float tsl = (T.NptMin01 == T.NptMinH) ? 0.0 : (10.0f * (T.NptMinV - T.NptMin01) / (T.NptMin01 - T.NptMinH));
...
; 1378 : 	float tinf = (float)(T.NptMinH);
; 1379 : 	float td = (float)(T.NptMinV - T.NptMinH);
; 1380 : 
; 1381 : 	if (T.PresetSlope)
; 1382 : 	{
; 1383 : 
; 1384 : 		for (itr = 0; itr < T.TrialCount; itr++)

	xor	eax, eax
	cmp	BYTE PTR [ebp+944], al
	fld	DWORD PTR [ebp+884]
	...
	mov	DWORD PTR tv2614[esp+368], eax
	lea	eax, DWORD PTR [ebp+176]
	mov	DWORD PTR tv2643[esp+368], eax
	npad	15
$LL99@PartialGet:

; 1385 : 		{
; 1386 : 			Trial tr = T.Trials[itr];

	mov	esi, DWORD PTR tv2643[esp+368]
	mov	ecx, 11					; 0000000bH
	lea	edi, DWORD PTR _tr$131387[esp+368]
	rep movsd

; 1387 : 			if (tr.TopLayer < StartLayer || tr.BottomLayer > EndLayer) continue;

	mov	eax, DWORD PTR _tr$131387[esp+368]
	cmp	eax, DWORD PTR _StartLayer$[esp+368]
	jl	$LN98@PartialGet
	mov	ecx, DWORD PTR _tr$131387[esp+372]
	cmp	ecx, DWORD PTR _EndLayer$[esp+368]
	jg	$LN98@PartialGet

; 1388 : 			Cell *tp = CellsInLayer * tr.TopLayer + CellSpace;
...
; 1389 : 			Cell *bp = CellsInLayer * tr.BottomLayer + CellSpace;

	mov	edi, ecx
	imul	edi, esi

; 1390 : 			tz = ZLayer[tr.TopLayer];
; 1391 : 			idz = 1.0f / (tz - ZLayer[tr.BottomLayer]);
; 1392 : 	
; 1393 : 			for (ix = bx; ix < wx; ix++)

	cmp	ebx, DWORD PTR _wx$[esp+368]
	mov	esi, DWORD PTR _CellSpace$[esp+368]
	lea	esi, DWORD PTR [esi+edi*8]
	mov	DWORD PTR _bp$131391[esp+368], esi
	...
	mov	DWORD PTR tv2602[esp+368], ebx
$LL236@PartialGet:
	xor	esi, esi
...
; 1394 : 			{
; 1395 : 				ifound = 0;
; 1396 : 				minix = ix - 1; if (minix < 0) minix = 0;
...
; 1397 : 				maxix = ix + 1; if (maxix >= nx) maxix = nx - 1;
...
; 1398 : 				for (iy = 0; iy < ny; iy++)
	...
	mov	DWORD PTR tv2546[esp+368], ebx
	npad	6
$LL235@PartialGet:
...
; 1399 : 				{
; 1400 : 					miniy = iy - 1; if (miniy < 0) miniy = 0;
...
; 1401 : 					maxiy = iy + 1; if (maxiy >= ny) maxiy = ny - 1;
...
; 1402 : 					Cell &ct = tp[iy * nx + ix];
; 1403 : 					IntGrain *pT = ct.FirstG;

	mov	ecx, DWORD PTR tv2546[esp+368]
	mov	ebx, DWORD PTR [ecx]

; 1404 : 					IntGrain *pTE = ct.FirstG + ct.Free;
...
; 1405 : 					for (;pT < pTE; pT++)
	...
	cmp	ebx, eax
	mov	DWORD PTR _pT$131403[esp+368], ebx
	mov	DWORD PTR _pTE$131404[esp+368], eax
	jae	$LN88@PartialGet
$LL84@PartialGet:

; 1406 : 					{
; 1407 : 						IntGrain gt = *pT;
; 1408 : 						for (iix = minix; iix <= maxix; iix++)

	mov	eax, DWORD PTR _minix$[esp+368]
	mov	ecx, 9
	mov	esi, ebx
	lea	edi, DWORD PTR _gt$131408[esp+368]
	rep movsd
...
; 1409 : 							for (iiy = miniy; iiy <= maxiy; iiy++)
	...
	add	edx, eax
	mov	eax, DWORD PTR _bp$131391[esp+368]
	lea	ecx, DWORD PTR [eax+edx*8]
	mov	DWORD PTR tv2470[esp+368], ecx
	jmp	SHORT $LN78@PartialGet
	npad	8
$LL231@PartialGet:
	mov	ecx, DWORD PTR tv2470[esp+368]
$LN78@PartialGet:

; 1410 : 							{
; 1411 : 								Cell &cb = bp[iiy * nx + iix];
; 1412 : 								IntGrain *pB = cb.FirstG;

	mov	eax, DWORD PTR [ecx]

; 1413 : 								IntGrain *pBE = cb.FirstG + cb.Free;
...
; 1414 : 								for (;pB < pBE; pB++)
	...
	cmp	eax, ecx
	mov	DWORD PTR _pB$131416[esp+368], eax
	mov	DWORD PTR _pBE$131417[esp+368], ecx
	jae	$LN77@PartialGet
	mov	esi, eax
$LL228@PartialGet:
	mov	ebx, 1
...
; 1415 : 								{
; 1416 : 									countIterations++;

	add	DWORD PTR _countIterations$[esp+368], ebx

; 1417 : 									if (GetTickCount() > TimeLimit)
...
; 1421 : 										}
; 1422 : 									IntGrain gb = *pB;
; 1423 : 									SlopeX = idz * (gt.Xcm - gb.Xcm);

	fld	DWORD PTR _gt$131408[esp+368]
	mov	ecx, 9
	lea	edi, DWORD PTR _gb$131423[esp+368]
	rep movsd
	fsub	DWORD PTR _gb$131423[esp+368]
...
; 1424 : 									if (fabs(SlopeX) >= MaxSlope || fabs(SlopeX - T.PresetSlopeX) > T.PresetSlopeAccX) continue;									

	fld	DWORD PTR _SlopeX$[esp+368]
	fld	ST(0)
	fabs
	fstp	DWORD PTR tv2583[esp+368]
	fld	DWORD PTR tv2583[esp+368]
	...
	fstp	DWORD PTR tv2576[esp+368]
	fld	DWORD PTR tv2576[esp+368]
	fabs
	fstp	DWORD PTR tv2572[esp+368]
	fld	DWORD PTR tv2572[esp+368]
...
; 1425 : 									countSlopeX++;
; 1426 : 									SlopeY = idz * (gt.Ycm - gb.Ycm);

	fld	DWORD PTR _gt$131408[esp+372]
	add	DWORD PTR _countSlopeX$[esp+368], ebx
	fsub	DWORD PTR _gb$131423[esp+372]
	fmulp	ST(3), ST(0)
	fxch	ST(2)
	fstp	DWORD PTR _SlopeY$[esp+368]

; 1427 : 									if (fabs(SlopeY) >= MaxSlope || fabs(SlopeY - T.PresetSlopeY) > T.PresetSlopeAccY) continue;

	fld	DWORD PTR _SlopeY$[esp+368]
	fld	ST(0)
	fabs
	fstp	DWORD PTR tv2561[esp+368]
	fld	DWORD PTR tv2561[esp+368]
	fcomp	ST(3)
	fnstsw	ax
	fstp	ST(2)
	test	ah, bl
	je	$LN252@PartialGet
	fld	ST(1)
	fsub	DWORD PTR [ebp+952]
	fstp	DWORD PTR tv2554[esp+368]
	fld	DWORD PTR tv2554[esp+368]
	fabs
	fstp	DWORD PTR tv2549[esp+368]
	fld	DWORD PTR tv2549[esp+368]
	fld	DWORD PTR [ebp+960]
	fcompp
	fnstsw	ax
	test	ah, 5
	jnp	$LN252@PartialGet

; 1428 : 									Slope2 = SlopeX * SlopeX + SlopeY * SlopeY;
; 1429 : 									countSlopeY++;
...
; 1434 : 										SlopeS = sqrt(Slope2);

	call	__CIsqrt
	fstp	DWORD PTR tv2527[esp+368]
	fld	DWORD PTR tv2527[esp+368]
	fstp	DWORD PTR _SlopeS$[esp+368]

; 1435 : 										if (SlopeS > 0.0f) ISlopeS = 1.0f / SlopeS;
...
; 1436 : 										avgds2 = avgdz2 * Slope2;
; 1437 : 										fastGetDirAndTol(SlopeS, ISlopeS, DirX, DirY, dirtol/*, aligntol2, avgds2*/);
...
$LN261@PartialGet:
	...
	fmul	DWORD PTR [ebp+936]
	fadd	DWORD PTR [ebp+168]
$LN279@PartialGet:

; 1438 : 										//GetDirAndTol(SlopeX, SlopeY, avgdz, &DirX, &DirY, &dirtol);
; 1439 : 	
; 1440 : 										for (ir = 0; ir < tr.TriggerCount; ir++)

	cmp	DWORD PTR _tr$131387[esp+376], 0
...
; 1441 : 										{
; 1442 : 											int TriggerLayer = tr.Triggers[ir];

	mov	edx, DWORD PTR _ir$[esp+368]

; 1443 : 											float ldz = (tz - ZLayer[TriggerLayer]) * idz;

	fld	DWORD PTR _tz$[esp+368]
	mov	esi, DWORD PTR _tr$131387[esp+edx*4+380]
	fsub	DWORD PTR [ebx+esi*4]

; 1444 : 											float cdz = 1.0f - ldz;
; 1445 : 											ExpX = ldz * gb.Xcm + cdz * gt.Xcm;
; 1446 : 											ExpY = ldz * gb.Ycm + cdz * gt.Ycm;
; 1447 : 											eix = (int)((ExpX - T.Win.Xmin) / T.DxCell);
; 1448 : 											eiy = (int)((ExpY - T.Win.Ymin) / T.DyCell);
; 1449 : 											IntGrain *pTrg = CellSpace[(TriggerLayer * ny + eiy) * nx + eix].FindGrain(ExpX, ExpY, DirX, DirY, dirtol, T.AlignTol);

	sub	esp, 24					; 00000018H
	fmul	DWORD PTR _idz$[esp+392]
	fstp	DWORD PTR _ldz$131437[esp+392]
	fld	DWORD PTR _ldz$131437[esp+392]
	fld	ST(0)
	fld1
	fsubrp	ST(1), ST(0)
	fstp	DWORD PTR _cdz$131438[esp+392]
	fld	ST(0)
	fmul	DWORD PTR _gb$131423[esp+392]
	fld	DWORD PTR _cdz$131438[esp+392]
	fld	ST(0)
	fmul	DWORD PTR _gt$131408[esp+392]
	faddp	ST(2), ST(0)
	fxch	ST(1)
	fstp	DWORD PTR _ExpX$[esp+392]
	fld	DWORD PTR _gb$131423[esp+396]
	fmulp	ST(2), ST(0)
	fmul	DWORD PTR _gt$131408[esp+396]
	faddp	ST(1), ST(0)
...
; 1450 : 											if (pTrg)
	...
	fld	DWORD PTR [ebp+992]
	fsubp	ST(2), ST(0)
	fld	DWORD PTR [ebp+1004]
	fdivp	ST(2), ST(0)
	fxch	ST(1)
	call	__ftol2_sse
	fsub	DWORD PTR [ebp+984]
	imul	esi, DWORD PTR _ny$[esp+392]
	fdiv	DWORD PTR [ebp+1000]
	add	eax, esi
	imul	eax, DWORD PTR tv1493[esp+392]
	mov	DWORD PTR tv2257[esp+392], eax
	call	__ftol2_sse
	mov	ecx, DWORD PTR tv2257[esp+392]
	add	ecx, eax
...
; 1451 : 											{
; 1452 : 												memset(pTempGrains, 0, T.Layer * sizeof(Grain *) * T.InitialMultiplicity);

	mov	ecx, DWORD PTR [ebp+932]
	imul	ecx, DWORD PTR [ebp+1020]
	add	ecx, ecx
	add	ecx, ecx
	push	ecx
	push	0
...
; 1453 : 												float dz;
; 1454 : 												int seqlength = 0;
; 1455 : 												//int seqlength = 3;
; 1456 : /*	
; 1457 : 												pTempGrains[tr.TopLayer] = pT;
; 1458 : 												pTempGrains[tr.BottomLayer] = pB;
; 1459 : 												pTempGrains[TriggerLayer] = pTrg;
; 1460 : */	
; 1461 : 												CurrDeltaX = fabs(avgdz * SlopeX);
; 1462 : 												CurrDeltaY = fabs(avgdz * SlopeY);
; 1463 : /*	
; 1464 : 												for (lay = tr.TopLayer; lay <= tr.BottomLayer; lay++)
; 1465 : 												{
; 1466 : 													dz = ZLayer[lay] - tz;
; 1467 : 													ExpX = dz * SlopeX + gt.Xcm;
; 1468 : 													ExpY = dz * SlopeY + gt.Ycm;
; 1469 : 													if (FindGrains(ExpX, ExpY, CellSpace + lay * T.CellsInLayer, DirX, DirY, dirtol, pTempGrains + lay * T.InitialMultiplicity, T.InitialMultiplicity)) seqlength++;												
; 1470 : 													};
; 1471 : 	
; 1472 : 												Vector topv, bottomv;
; 1473 : 												topv.X = pT->Xcm;
; 1474 : 												topv.Y = pT->Ycm;
; 1475 : 												topv.Z = tz;
; 1476 : 												bottomv.X = pB->Xcm;
; 1477 : 												bottomv.Y = pB->Ycm;
; 1478 : 												bottomv.Z = ZLayer[tr.BottomLayer];
; 1479 : 												for (lay = (int)tr.TopLayer - 1; lay >= 0; lay--)
; 1480 : 												{
; 1481 : 													dz = (bottomv.Z - topv.Z);
; 1482 : 													float diz = 1.0f / dz;
; 1483 : 													dz = ZLayer[lay] - topv.Z;
; 1484 : 													ExpX = dz * SlopeX + topv.X;
; 1485 : 													ExpY = dz * SlopeY + topv.Y;
; 1486 : 													if (pTempGrains[lay] = FindGrain(ExpX, ExpY, CellSpace + lay * T.CellsInLayer, DirX, DirY, dirtol, 0, DiscardShadows ? pTempGrains[lay + 1] : 0, ShadowXTol, ShadowYTol))
; 1487 : 													{
; 1488 : 														seqlength++;
; 1489 : 														}
; 1490 : 													else if (--availablevoids <= 0) break;
; 1491 : 													};
; 1492 : 												if (availablevoids <= 0) continue;
; 1493 : 												for (lay = (int)tr.BottomLayer + 1; lay <= EndLayer; lay++)
; 1494 : 												{
; 1495 : 													dz = (bottomv.Z - topv.Z);
; 1496 : 													float diz = 1.0f / dz;
; 1497 : 													dz = ZLayer[lay] - topv.Z;
; 1498 : 													ExpX = dz * SlopeX + topv.X;
; 1499 : 													ExpY = dz * SlopeY + topv.Y;
; 1500 : 													if (pTempGrains[lay] = FindGrain(ExpX, ExpY, CellSpace + lay * T.CellsInLayer, DirX, DirY, dirtol, DiscardShadows ? pTempGrains[lay - 1] : 0, 0, ShadowXTol, ShadowYTol))
; 1501 : 													{
; 1502 : 														seqlength++;
; 1503 : 														}
; 1504 : 													else if (--availablevoids <= 0) break;
; 1505 : 													};
; 1506 : */	
; 1507 : 												for (lay = StartLayer; lay <= EndLayer; lay++)

	mov	esi, DWORD PTR _StartLayer$[esp+380]
	mov	edx, DWORD PTR _EndLayer$[esp+380]
	add	esp, 12					; 0000000cH
	cmp	esi, edx
	mov	DWORD PTR _seqlength$131445[esp+368], 0
	jg	$LN57@PartialGet
...
; 1508 : 												{
; 1509 : 													dz = ZLayer[lay] - tz;
; 1510 : 													ExpX = dz * SlopeX + gt.Xcm;
; 1511 : 													ExpY = dz * SlopeY + gt.Ycm;
; 1512 : 													countFindGrains++;
; 1513 : 													if (FindGrains(ExpX, ExpY, CellSpace + lay * T.CellsInLayer, DirX, DirY, dirtol, pTempGrains + lay * T.InitialMultiplicity, T.InitialMultiplicity)) seqlength++;
	...
	imul	eax, esi
	imul	ecx, esi
	fstp	DWORD PTR _dz$131444[esp+372]
	...
	fstp	DWORD PTR [esp]
	push	eax
	fld	DWORD PTR _dz$131444[esp+392]
	sub	esp, 8
	fld	ST(0)
	fmul	DWORD PTR _SlopeY$[esp+400]
	fadd	DWORD PTR _gt$131408[esp+404]
	fstp	DWORD PTR tv2476[esp+400]
	fld	DWORD PTR tv2476[esp+400]
	fstp	DWORD PTR [esp+4]
	fmul	DWORD PTR _SlopeX$[esp+400]
	fadd	DWORD PTR _gt$131408[esp+400]
	fstp	DWORD PTR tv2475[esp+400]
	fld	DWORD PTR tv2475[esp+400]
	fstp	DWORD PTR [esp]
	...
	add	DWORD PTR _seqlength$131445[esp+368], 1
$LN58@PartialGet:
...
; 1514 : 													};											
; 1515 : 												
; 1516 : 												if ((float)seqlength > (tinf + td / (1.0f + tsl * SlopeS)))

	fild	DWORD PTR _seqlength$131445[esp+368]
...
; 1440 : 										for (ir = 0; ir < tr.TriggerCount; ir++)
	...
	add	eax, 1
	cmp	eax, DWORD PTR _tr$131387[esp+376]
	mov	DWORD PTR _ir$[esp+368], eax
	jl	$LL221@PartialGet

; 1586 : 									if (GetTickCount() > TimeLimit)
...
; 1522 : 														Track2 &N = AR.pSpace[AR.Found++];
...
; 1523 : 														int i, j;
; 1524 : 														for (i = j = 0; i <= EndLayer * T.InitialMultiplicity; i++)
	...
	xor	esi, esi
	test	eax, eax
	mov	DWORD PTR _j$131455[esp+368], esi
...
; 1526 : 															{
; 1527 : 																IntTrackGrain *pIG = ((IntTrackGrain *)N.pGrains) + j++;

	add	DWORD PTR _j$131455[esp+368], 1
	add	ecx, ebx

; 1528 : 																pIG->T.pG = pTempGrains[i];

	mov	DWORD PTR [ecx], eax

; 1529 : 																pIG->T.Z = ZLayer[i / T.InitialMultiplicity];
...
; 1530 : 																}														
; 1531 : 														N.Field = (itr << 24) + (ix << 16) + ifound;

	mov	ecx, DWORD PTR tv2614[esp+368]
...
; 1532 : 														N.Valid = true;
; 1533 : 														N.Grains = j;//seqlength;

	mov	ecx, DWORD PTR _j$131455[esp+368]
...
; 1414 : 								for (;pB < pBE; pB++)
	...
	mov	esi, DWORD PTR _pB$131416[esp+368]
	add	esi, 36					; 00000024H
	cmp	esi, DWORD PTR _pBE$131417[esp+368]
	mov	DWORD PTR _pB$131416[esp+368], esi
	jb	$LL228@PartialGet
$LN77@PartialGet:
...
; 1405 : 					for (;pT < pTE; pT++)
	...
	cmp	ebx, DWORD PTR _pTE$131404[esp+368]
	mov	DWORD PTR _pT$131403[esp+368], ebx
	jb	$LL84@PartialGet
	mov	ecx, DWORD PTR tv2546[esp+368]
$LN88@PartialGet:
...
; 1398 : 				for (iy = 0; iy < ny; iy++)
	...
	mov	DWORD PTR tv2546[esp+368], ecx
	jl	$LL235@PartialGet
...
; 1393 : 			for (ix = bx; ix < wx; ix++)
	...
	mov	ebx, DWORD PTR tv2602[esp+368]
	mov	eax, ecx
	add	ebx, 8
	cmp	eax, DWORD PTR _wx$[esp+368]
	mov	DWORD PTR _ix$[esp+368], eax
...
; 1384 : 		for (itr = 0; itr < T.TrialCount; itr++)
	...
	add	DWORD PTR tv2643[esp+368], 44		; 0000002cH
	add	DWORD PTR tv2614[esp+368], 256		; 00000100H
	add	eax, 1
...
; 1721 : /*
; 1722 : 	char fname[256];
; 1723 : 	sprintf(fname, "c:\\acq\\smt8c_%d.txt", AR.ThreadIndex);
; 1724 : 	FILE *f;
; 1725 : 	if (!(f = fopen(fname, "r+t")))
; 1726 : 	{
; 1727 : 		f = fopen(fname, "w+t");
; 1728 : 		fprintf(f, "Iters\tSlopeX\tSlopeY\tTrials\tFindGrn\tPoss\tAcc");
; 1729 : 		}
; 1730 : 	else
; 1731 : 	{
; 1732 : 		fclose(f);
; 1733 : 		f = fopen(fname, "a+t");
; 1734 : 		}
...
; 1551 : 	{
; 1552 : 
; 1553 : 		for (itr = 0; itr < T.TrialCount; itr++)

	cmp	DWORD PTR [ebp+172], eax
	jle	SHORT $LN46@PartialGet
	mov	ebx, DWORD PTR _ny$[esp+368]
	lea	esi, DWORD PTR [ebp+176]
	mov	DWORD PTR tv2900[esp+368], eax
	mov	DWORD PTR tv2928[esp+368], esi
	npad	12
$LL48@PartialGet:

; 1554 : 		{
; 1555 : 			Trial tr = T.Trials[itr];

	mov	ecx, 11					; 0000000bH
	lea	edi, DWORD PTR _tr$131466[esp+368]
	rep movsd

; 1556 : 			if (tr.TopLayer < StartLayer || tr.BottomLayer > EndLayer) continue;

	mov	eax, DWORD PTR _tr$131466[esp+368]
	cmp	eax, DWORD PTR _StartLayer$[esp+368]
	jl	$LN47@PartialGet
	mov	ecx, DWORD PTR _tr$131466[esp+372]
	cmp	ecx, DWORD PTR _EndLayer$[esp+368]
	jg	$LN47@PartialGet

; 1557 : 			Cell *tp = CellsInLayer * tr.TopLayer + CellSpace;
...
; 1558 : 			Cell *bp = CellsInLayer * tr.BottomLayer + CellSpace;

	mov	edi, ecx
	imul	edi, esi
	mov	esi, DWORD PTR _CellSpace$[esp+368]
	lea	esi, DWORD PTR [esi+edi*8]
	mov	DWORD PTR _bp$131470[esp+368], esi

; 1559 : 			tz = ZLayer[tr.TopLayer];

	mov	esi, DWORD PTR _ZLayer$[esp+368]
	fld	DWORD PTR [esi+eax*4]

; 1560 : 			idz = 1.0f / (tz - ZLayer[tr.BottomLayer]);
; 1561 : 	
; 1562 : 			for (ix = bx; ix < wx; ix++)
	...
	mov	DWORD PTR tv2888[esp+368], edx
$LL237@PartialGet:
...
; 1565 : 				minix = ix - 1; if (minix < 0) minix = 0;
...
; 1566 : 				maxix = ix + 1; if (maxix >= nx) maxix = nx - 1;
...
; 1567 : 				for (iy = 0; iy < ny; iy++)

	xor	eax, eax
	cmp	ebx, edi
	jle	$LN42@PartialGet
	mov	esi, DWORD PTR tv2888[esp+368]
	mov	DWORD PTR tv2834[esp+368], esi
	jmp	SHORT $LN38@PartialGet
	npad	7
$LL238@PartialGet:
	mov	esi, DWORD PTR tv2834[esp+368]
	xor	edi, edi
$LN38@PartialGet:
	lea	ecx, DWORD PTR [eax-1]

; 1568 : 				{
; 1569 : 					miniy = iy - 1; if (miniy < 0) miniy = 0;
...
; 1570 : 					maxiy = iy + 1; if (maxiy >= ny) maxiy = ny - 1;
...
; 1571 : 					Cell &ct = tp[iy * nx + ix];
; 1572 : 					IntGrain *pT = ct.FirstG;

	mov	ecx, DWORD PTR [esi]

; 1573 : 					IntGrain *pTE = ct.FirstG + ct.Free;
...
; 1574 : 					for (;pT < pTE; pT++)
	...
	cmp	ecx, eax
	mov	DWORD PTR _pT$131482[esp+368], ecx
	mov	DWORD PTR _pTE$131483[esp+368], eax
	jae	$LN37@PartialGet
	npad	2
$LL33@PartialGet:
...
; 1575 : 					{
; 1576 : 						IntGrain gt = *pT;
; 1577 : 						for (iix = minix; iix <= maxix; iix++)

	mov	eax, DWORD PTR _minix$[esp+368]
	cmp	eax, DWORD PTR _maxix$[esp+368]
	mov	esi, DWORD PTR _pT$131482[esp+368]
	mov	ecx, 9
	lea	edi, DWORD PTR _gt$131487[esp+368]
	rep movsd
	mov	ecx, eax
	mov	DWORD PTR _iix$[esp+368], eax
	jg	$LN32@PartialGet
...
; 1578 : 							for (iiy = miniy; iiy <= maxiy; iiy++)
	...
	add	eax, ecx
	mov	ecx, DWORD PTR _bp$131470[esp+368]
	lea	eax, DWORD PTR [ecx+eax*8]
	mov	DWORD PTR tv2761[esp+368], eax
	npad	5
$LL27@PartialGet:

; 1579 : 							{
; 1580 : 								Cell &cb = bp[iiy * nx + iix];
; 1581 : 								IntGrain *pB = cb.FirstG;

	mov	esi, DWORD PTR [eax]

; 1582 : 								IntGrain *pBE = cb.FirstG + cb.Free;
...
; 1583 : 								for (;pB < pBE; pB++)
	...
	cmp	esi, ecx
	mov	DWORD PTR _pB$131495[esp+368], esi
	mov	DWORD PTR _pBE$131496[esp+368], ecx
	jae	$LN26@PartialGet
$LL229@PartialGet:
	mov	ebx, 1

; 1584 : 								{
; 1585 : 									countIterations++;
...
; 1590 : 										}
; 1591 : 									IntGrain gb = *pB;
; 1592 : 									SlopeX = idz * (gt.Xcm - gb.Xcm);

	fld	DWORD PTR _gt$131487[esp+368]
	mov	ecx, 9
	lea	edi, DWORD PTR _gb$131502[esp+368]
	rep movsd
	fsub	DWORD PTR _gb$131502[esp+368]
	fld	DWORD PTR _idz$[esp+368]
	fld	ST(0)
	fmulp	ST(2), ST(0)
	fxch	ST(1)
...
; 1593 : 									if (fabs(SlopeX) >= MaxSlope) continue;

	fld	DWORD PTR _SlopeX$[esp+368]
	fld	ST(0)
	fabs
	fstp	DWORD PTR tv2426[esp+368]
	fld	DWORD PTR tv2426[esp+368]
	fld	DWORD PTR _MaxSlope$[esp+368]
	fcom	ST(1)
	fnstsw	ax
	fstp	ST(1)
...
; 1594 : 									countSlopeX++;
; 1595 : 									SlopeY = idz * (gt.Ycm - gb.Ycm);

	fld	DWORD PTR _gt$131487[esp+372]
	add	DWORD PTR _countSlopeX$[esp+368], ebx
	fsub	DWORD PTR _gb$131502[esp+372]
	fmulp	ST(3), ST(0)
	fxch	ST(2)
	fstp	DWORD PTR _SlopeY$[esp+368]

; 1596 : 									if (fabs(SlopeY) >= MaxSlope) continue;

	fld	DWORD PTR _SlopeY$[esp+368]
	fld	ST(0)
	fabs
	fstp	DWORD PTR tv2415[esp+368]
	fld	DWORD PTR tv2415[esp+368]
	fcomp	ST(3)
	fnstsw	ax
	fstp	ST(2)
	test	ah, bl
...
; 1597 : 									Slope2 = SlopeX * SlopeX + SlopeY * SlopeY;
; 1598 : 									countSlopeY++;

	add	DWORD PTR _countSlopeY$[esp+368], ebx
	fmul	ST(0), ST(0)
	fld	ST(1)
$restartpreset$131505:
	fmulp	ST(2), ST(0)
	faddp	ST(1), ST(0)
	fstp	DWORD PTR _Slope2$[esp+368]

; 1599 : restartpreset:	
; 1600 : 									if (Slope2 < MaxSlope2)
...
; 1603 : 										SlopeS = sqrt(Slope2);

	call	__CIsqrt
	fstp	DWORD PTR tv2396[esp+368]
	fld	DWORD PTR tv2396[esp+368]
	fstp	DWORD PTR _SlopeS$[esp+368]

; 1604 : 										if (SlopeS > 0.0f) ISlopeS = 1.0f / SlopeS;
...
; 1605 : 										avgds2 = avgdz2 * Slope2;
; 1606 : 										fastGetDirAndTol(SlopeS, ISlopeS, DirX, DirY, dirtol/*, aligntol2, avgds2*/);
...
; 1607 : 										//GetDirAndTol(SlopeX, SlopeY, avgdz, &DirX, &DirY, &dirtol);
; 1608 : 	
; 1609 : 										for (ir = 0; ir < tr.TriggerCount; ir++)

	cmp	DWORD PTR _tr$131466[esp+376], 0
	fstp	DWORD PTR _dirtol$[esp+368]
	mov	DWORD PTR _ir$[esp+368], 0
	jle	$LN23@PartialGet
	mov	edi, DWORD PTR _pTempGrains$[esp+368]
...
; 1610 : 										{
; 1611 : 											int TriggerLayer = tr.Triggers[ir];

	mov	edx, DWORD PTR _ir$[esp+368]

; 1612 : 											float ldz = (tz - ZLayer[TriggerLayer]) * idz;

	fld	DWORD PTR _tz$[esp+368]
	mov	esi, DWORD PTR _tr$131466[esp+edx*4+380]
	fsub	DWORD PTR [ebx+esi*4]

; 1613 : 											float cdz = 1.0f - ldz;
; 1614 : 											ExpX = ldz * gb.Xcm + cdz * gt.Xcm;
; 1615 : 											ExpY = ldz * gb.Ycm + cdz * gt.Ycm;
; 1616 : 											eix = (int)((ExpX - T.Win.Xmin) / T.DxCell);
; 1617 : 											eiy = (int)((ExpY - T.Win.Ymin) / T.DyCell);
; 1618 : 											IntGrain *pTrg = CellSpace[(TriggerLayer * ny + eiy) * nx + eix].FindGrain(ExpX, ExpY, DirX, DirY, dirtol, T.AlignTol);

	sub	esp, 24					; 00000018H
	fmul	DWORD PTR _idz$[esp+392]
	fstp	DWORD PTR _ldz$131514[esp+392]
	fld	DWORD PTR _ldz$131514[esp+392]
	fld	ST(0)
	fld1
	fsubrp	ST(1), ST(0)
	fstp	DWORD PTR _cdz$131515[esp+392]
	fld	ST(0)
	fmul	DWORD PTR _gb$131502[esp+392]
	fld	DWORD PTR _cdz$131515[esp+392]
	fld	ST(0)
	fmul	DWORD PTR _gt$131487[esp+392]
	faddp	ST(2), ST(0)
	fxch	ST(1)
	fstp	DWORD PTR _ExpX$[esp+392]
	fld	DWORD PTR _gb$131502[esp+396]
	fmulp	ST(2), ST(0)
	fmul	DWORD PTR _gt$131487[esp+396]
	faddp	ST(1), ST(0)
	fstp	DWORD PTR _ExpY$[esp+392]
	fld	DWORD PTR [ebp+168]
	fstp	DWORD PTR [esp+20]
...
; 1619 : 											if (pTrg)
	...
	add	eax, esi
	imul	eax, DWORD PTR tv1493[esp+392]
	mov	DWORD PTR tv2255[esp+392], eax
	call	__ftol2_sse
	mov	ecx, DWORD PTR tv2255[esp+392]
	add	ecx, eax
	mov	eax, DWORD PTR _CellSpace$[esp+392]
	lea	ecx, DWORD PTR [eax+ecx*8]
	call	?FindGrain@Cell@@QAEPAUIntGrain@@MMMMMM@Z ; Cell::FindGrain
...
; 1620 : 											{
; 1621 : 												memset(pTempGrains, 0, T.Layer * sizeof(Grain *) * T.InitialMultiplicity);
...
; 1622 : 												float dz;
; 1623 : 												int seqlength = 0;
; 1624 : 												//int seqlength = 3;
; 1625 : /*	
; 1626 : 												pTempGrains[tr.TopLayer] = pT;
; 1627 : 												pTempGrains[tr.BottomLayer] = pB;
; 1628 : 												pTempGrains[TriggerLayer] = pTrg;
; 1629 : */	
; 1630 : 												CurrDeltaX = fabs(avgdz * SlopeX);
; 1631 : 												CurrDeltaY = fabs(avgdz * SlopeY);
; 1632 : /*	
; 1633 : 												for (lay = tr.TopLayer; lay <= tr.BottomLayer; lay++)
; 1634 : 												{
; 1635 : 													dz = ZLayer[lay] - tz;
; 1636 : 													ExpX = dz * SlopeX + gt.Xcm;
; 1637 : 													ExpY = dz * SlopeY + gt.Ycm;
; 1638 : 													if (FindGrains(ExpX, ExpY, CellSpace + lay * T.CellsInLayer, DirX, DirY, dirtol, pTempGrains + lay * T.InitialMultiplicity, T.InitialMultiplicity)) seqlength++;												
; 1639 : 													};
; 1640 : 	
; 1641 : 												Vector topv, bottomv;
; 1642 : 												topv.X = pT->Xcm;
; 1643 : 												topv.Y = pT->Ycm;
; 1644 : 												topv.Z = tz;
; 1645 : 												bottomv.X = pB->Xcm;
; 1646 : 												bottomv.Y = pB->Ycm;
; 1647 : 												bottomv.Z = ZLayer[tr.BottomLayer];
; 1648 : 												for (lay = (int)tr.TopLayer - 1; lay >= 0; lay--)
; 1649 : 												{
; 1650 : 													dz = (bottomv.Z - topv.Z);
; 1651 : 													float diz = 1.0f / dz;
; 1652 : 													dz = ZLayer[lay] - topv.Z;
; 1653 : 													ExpX = dz * SlopeX + topv.X;
; 1654 : 													ExpY = dz * SlopeY + topv.Y;
; 1655 : 													if (pTempGrains[lay] = FindGrain(ExpX, ExpY, CellSpace + lay * T.CellsInLayer, DirX, DirY, dirtol, 0, DiscardShadows ? pTempGrains[lay + 1] : 0, ShadowXTol, ShadowYTol))
; 1656 : 													{
; 1657 : 														seqlength++;
; 1658 : 														}
; 1659 : 													else if (--availablevoids <= 0) break;
; 1660 : 													};
; 1661 : 												if (availablevoids <= 0) continue;
; 1662 : 												for (lay = (int)tr.BottomLayer + 1; lay <= EndLayer; lay++)
; 1663 : 												{
; 1664 : 													dz = (bottomv.Z - topv.Z);
; 1665 : 													float diz = 1.0f / dz;
; 1666 : 													dz = ZLayer[lay] - topv.Z;
; 1667 : 													ExpX = dz * SlopeX + topv.X;
; 1668 : 													ExpY = dz * SlopeY + topv.Y;
; 1669 : 													if (pTempGrains[lay] = FindGrain(ExpX, ExpY, CellSpace + lay * T.CellsInLayer, DirX, DirY, dirtol, DiscardShadows ? pTempGrains[lay - 1] : 0, 0, ShadowXTol, ShadowYTol))
; 1670 : 													{
; 1671 : 														seqlength++;
; 1672 : 														}
; 1673 : 													else if (--availablevoids <= 0) break;
; 1674 : 													};
; 1675 : */	
; 1676 : 												for (lay = StartLayer; lay <= EndLayer; lay++)

	mov	esi, DWORD PTR _StartLayer$[esp+380]
	mov	edx, DWORD PTR _EndLayer$[esp+380]
	add	esp, 12					; 0000000cH
	cmp	esi, edx
	mov	DWORD PTR _seqlength$131522[esp+368], 0
	jg	$LN8@PartialGet
	mov	eax, DWORD PTR _countFindGrains$[esp+368]
	mov	ecx, DWORD PTR tv1579[esp+368]
	lea	edx, DWORD PTR [eax+ecx+1]
...
; 1677 : 												{
; 1678 : 													dz = ZLayer[lay] - tz;
; 1679 : 													ExpX = dz * SlopeX + gt.Xcm;
; 1680 : 													ExpY = dz * SlopeY + gt.Ycm;
; 1681 : 													countFindGrains++;
; 1682 : 													if (FindGrains(ExpX, ExpY, CellSpace + lay * T.CellsInLayer, DirX, DirY, dirtol, pTempGrains + lay * T.InitialMultiplicity, T.InitialMultiplicity)) seqlength++;
	...
	imul	eax, esi
	imul	ecx, esi
	fstp	DWORD PTR _dz$131521[esp+372]
	fld	DWORD PTR _dirtol$[esp+372]
	mov	edx, DWORD PTR _CellSpace$[esp+372]
	lea	eax, DWORD PTR [edi+eax*4]
	push	eax
	...
	fstp	DWORD PTR [esp]
	push	eax
	fld	DWORD PTR _dz$131521[esp+392]
	sub	esp, 8
	fld	ST(0)
	fmul	DWORD PTR _SlopeY$[esp+400]
	fadd	DWORD PTR _gt$131487[esp+404]
	fstp	DWORD PTR tv2343[esp+400]
	fld	DWORD PTR tv2343[esp+400]
	fstp	DWORD PTR [esp+4]
	fmul	DWORD PTR _SlopeX$[esp+400]
	fadd	DWORD PTR _gt$131487[esp+400]
	fstp	DWORD PTR tv2342[esp+400]
	fld	DWORD PTR tv2342[esp+400]
	fstp	DWORD PTR [esp]
	call	?FindGrains@CSmartTrackerClass@@IAEHMMPAUCell@@MMMPAPAUIntGrain@@H@Z ; CSmartTrackerClass::FindGrains
	test	eax, eax
	je	SHORT $LN9@PartialGet
	add	DWORD PTR _seqlength$131522[esp+368], 1
$LN9@PartialGet:
...
; 1683 : 													};											
; 1684 : 												
; 1685 : 												if ((float)seqlength > (tinf + td / (1.0f + tsl * SlopeS)))

	fild	DWORD PTR _seqlength$131522[esp+368]
	fld	DWORD PTR _td$[esp+368]
	fld	DWORD PTR _SlopeS$[esp+368]
	fmul	DWORD PTR _tsl$[esp+368]
	fadd	QWORD PTR __real@3ff0000000000000
...
; 1609 : 										for (ir = 0; ir < tr.TriggerCount; ir++)
	...
	mov	eax, DWORD PTR _ir$[esp+368]
	add	eax, 1
	cmp	eax, DWORD PTR _tr$131466[esp+376]
	mov	DWORD PTR _ir$[esp+368], eax
	jl	$LL225@PartialGet
...
; 1691 : 														Track2 &N = AR.pSpace[AR.Found++];
...
; 1692 : 														int i, j;
; 1693 : 														for (i = j = 0; i <= EndLayer * T.InitialMultiplicity; i++)
	...
	xor	esi, esi
	test	eax, eax
	mov	DWORD PTR _j$131532[esp+368], esi
...
; 1695 : 															{
; 1696 : 																IntTrackGrain *pIG = ((IntTrackGrain *)N.pGrains) + j++;

	add	DWORD PTR _j$131532[esp+368], 1
	add	ecx, ebx

; 1697 : 																pIG->T.pG = pTempGrains[i];

	mov	DWORD PTR [ecx], eax

; 1698 : 																pIG->T.Z = ZLayer[i / T.InitialMultiplicity];
...
; 1699 : 																}														
; 1700 : 														N.Field = (itr << 24) + (ix << 16) + ifound;

	mov	ecx, DWORD PTR tv2900[esp+368]
	mov	edx, DWORD PTR _ix$[esp+368]
	mov	eax, DWORD PTR _ifound$[esp+368]
	add	ecx, edx
	shl	ecx, 16					; 00000010H
...
; 1701 : 														N.Valid = true;
; 1702 : 														N.Grains = j;//seqlength;

	mov	ecx, DWORD PTR _j$131532[esp+368]
...
; 1583 : 								for (;pB < pBE; pB++)
	...
	mov	esi, DWORD PTR _pB$131495[esp+368]
	add	esi, 36					; 00000024H
	cmp	esi, DWORD PTR _pBE$131496[esp+368]
	mov	DWORD PTR _pB$131495[esp+368], esi
	jb	$LL229@PartialGet
	mov	eax, DWORD PTR tv2761[esp+368]
...
; 1574 : 					for (;pT < pTE; pT++)
	...
	mov	eax, DWORD PTR _pT$131482[esp+368]
	add	eax, 36					; 00000024H
	cmp	eax, DWORD PTR _pTE$131483[esp+368]
	mov	DWORD PTR _pT$131482[esp+368], eax
	jb	$LL33@PartialGet
$LN37@PartialGet:
...
; 1567 : 				for (iy = 0; iy < ny; iy++)
	...
	add	ecx, ecx
	add	ecx, ecx
	add	DWORD PTR tv2834[esp+368], ecx
	cmp	eax, ebx
	jl	$LL238@PartialGet
	mov	ecx, DWORD PTR tv1539[esp+368]
$LN42@PartialGet:
...
; 1562 : 			for (ix = bx; ix < wx; ix++)
	...
	add	DWORD PTR tv2888[esp+368], 8
	mov	eax, ecx
	cmp	eax, DWORD PTR _wx$[esp+368]
	mov	DWORD PTR _ix$[esp+368], eax
	jl	$LL237@PartialGet
...
; 1553 : 		for (itr = 0; itr < T.TrialCount; itr++)
	...
	mov	eax, DWORD PTR _itr$[esp+368]
	mov	esi, DWORD PTR tv2928[esp+368]
	add	DWORD PTR tv2900[esp+368], 256		; 00000100H
	add	eax, 1
...
; 1744 : 	ActivationRecord *pAR = (ActivationRecord *)Context;
; 1745 : 	HANDLE HEvsStart[2], HEvsReset[2];
; 1746 : 	HEvsStart[0] = HEvsReset[0] = pAR->pThis->HTerminate;
...
; 1747 : 	HEvsStart[1] = pAR->pThis->HStart;
; 1748 : 	HEvsReset[1] = pAR->pThis->HReset;
; 1749 : 	while (WaitForMultipleObjects(2, HEvsStart, FALSE, INFINITE) != WAIT_OBJECT_0)
...
; 1750 : 	{
; 1751 : 		pAR->pThis->PartialGetTracks2(*pAR);

	mov	ecx, DWORD PTR [esi]
	push	esi
	call	?PartialGetTracks2@CSmartTrackerClass@@IAEIAAUActivationRecord@1@@Z ; CSmartTrackerClass::PartialGetTracks2

; 1752 : 		SetEvent(pAR->HFinished);

	mov	ecx, DWORD PTR [esi+20]
	push	ecx
	call	ebx

; 1753 : 		if (WaitForMultipleObjects(2, HEvsReset, FALSE, INFINITE) == WAIT_OBJECT_0) break;
...
; 1764 : 
; 1765 : 	// TODO: Add your implementation code here
; 1766 : 
; 1767 : 	//CorrectChains();
; 1768 : 
; 1769 : 	int starttime = GetTickCount();

	mov	esi, DWORD PTR __imp__GetTickCount@0
	push	edi
	call	esi

; 1770 : 	char fdumpname[256];
; 1771 : 	
; 1772 : 	int p, i, j, k, maxtracksperthread = *pMaxNumber / T.Processors;

	mov	eax, DWORD PTR _pMaxNumber$[esp+32]
	mov	eax, DWORD PTR [eax]
	mov	edi, DWORD PTR _this$[esp+32]
	cdq
	idiv	DWORD PTR [edi+900]
	mov	ebp, eax

; 1773 : 	int found, seqlength;
; 1774 : 	Grain *pTemp;
; 1775 : 	int TempF, TempG;
; 1776 : 	bool TempV;
; 1777 : 
; 1778 : 	if (T.ShadowSigmaMeasures > 0)

	mov	eax, DWORD PTR [edi+1048]
	test	eax, eax
	mov	DWORD PTR _maxtracksperthread$[esp+36], ebp
	mov	DWORD PTR tv488[esp+32], eax
	jle	SHORT $LN34@GetTracks2

; 1779 : 	{
; 1780 : 		T.ShadowSigmaX = T.ShadowSigmaXAccumulator / T.ShadowSigmaMeasures;

	fild	DWORD PTR tv488[esp+32]
	fstp	DWORD PTR tv494[esp+32]
	fld	DWORD PTR [edi+1032]
	fld	DWORD PTR tv494[esp+32]
	fld	ST(0)
	fdivp	ST(2), ST(0)
	fxch	ST(1)
	fstp	DWORD PTR [edi+1040]

; 1781 : 		T.ShadowSigmaY = T.ShadowSigmaYAccumulator / T.ShadowSigmaMeasures;

	fdivr	DWORD PTR [edi+1036]
	fstp	DWORD PTR [edi+1044]

; 1782 : 		}
; 1783 : 	else	

	jmp	SHORT $LN33@GetTracks2
$LN34@GetTracks2:

; 1784 : 		T.ShadowSigmaX = T.ShadowSigmaY = 0.0f;

	fldz
	fst	DWORD PTR [edi+1044]
	fstp	DWORD PTR [edi+1040]
$LN33@GetTracks2:

; 1785 : 	
; 1786 : 	int TimeLimit = GetTickCount() + T.MaxTrackingTime;

	call	esi
	add	eax, DWORD PTR [edi+904]

; 1787 : 	for (p = 0; p < T.Processors; p++)

	xor	edx, edx
	cmp	DWORD PTR [edi+900], edx
	mov	DWORD PTR _TimeLimit$[esp+32], eax
	jle	$LN55@GetTracks2
	mov	ebx, DWORD PTR _pSpace$[esp+32]
	mov	esi, ebp
	shl	esi, 4
	sub	esi, ebp
	add	esi, esi
...
; 1786 : 	int TimeLimit = GetTickCount() + T.MaxTrackingTime;
	...
	mov	ebp, DWORD PTR _maxtracksperthread$[esp+36]
$LN32@GetTracks2:

; 1788 : 	{
; 1789 : 		ThreadInfo[p].MaxTracks = maxtracksperthread;

	mov	eax, DWORD PTR [edi+1140]
	mov	DWORD PTR [ecx+eax+12], ebp

; 1790 : 		ThreadInfo[p].pSpace = pSpace + p * maxtracksperthread;

	mov	eax, DWORD PTR [edi+1140]
	mov	DWORD PTR [ecx+eax+8], ebx

; 1791 : 		HEvs[p] = ThreadInfo[p].HFinished;

	mov	eax, DWORD PTR [edi+1140]
	mov	eax, DWORD PTR [ecx+eax+20]
	mov	ebp, DWORD PTR [edi+1144]
	mov	DWORD PTR [ebp+edx*4], eax

; 1792 : 		ThreadInfo[p].StartLayer = StartLayer;

	mov	eax, DWORD PTR [edi+1140]
	mov	ebp, DWORD PTR _StartLayer$[esp+32]
	mov	DWORD PTR [ecx+eax+28], ebp

; 1793 : 		ThreadInfo[p].EndLayer = EndLayer;

	mov	eax, DWORD PTR [edi+1140]
	mov	ebp, DWORD PTR _EndLayer$[esp+32]
	mov	DWORD PTR [ecx+eax+32], ebp

; 1794 : 		ThreadInfo[p].TimeLimit = TimeLimit;

	mov	eax, DWORD PTR [edi+1140]
	mov	ebp, DWORD PTR _TimeLimit$[esp+32]
	mov	DWORD PTR [ecx+eax+36], ebp
	add	edx, 1
	add	ebx, esi
	add	ecx, 40					; 00000028H
	cmp	edx, DWORD PTR [edi+900]
	jl	SHORT $LL57@GetTracks2
$LN55@GetTracks2:

; 1795 : 		}
; 1796 : 	ResetEvent(HReset);

	mov	ecx, DWORD PTR [edi+1128]
	mov	esi, DWORD PTR __imp__ResetEvent@4
	push	ecx
	call	esi

; 1797 : 	SetEvent(HStart);

	mov	edx, DWORD PTR [edi+1120]
	mov	ebp, DWORD PTR __imp__SetEvent@4
	push	edx
	call	ebp

; 1798 : 	PartialGetTracks2(ThreadInfo[0]);
...
; 1799 : 
; 1800 : 	if (T.Processors > 1) WaitForMultipleObjects(T.Processors - 1, HEvs + 1, TRUE, INFINITE);

	mov	eax, DWORD PTR [edi+900]
	cmp	eax, 1
	mov	ebx, DWORD PTR __imp__WaitForMultipleObjects@16
	jle	SHORT $LN29@GetTracks2
	mov	ecx, DWORD PTR [edi+1144]
	push	-1
	push	1
	add	ecx, 4
	push	ecx
...
; 1801 : 	ResetEvent(HStart);

	mov	edx, DWORD PTR [edi+1120]
	push	edx
	call	esi

; 1802 : 	SetEvent(HReset);

	mov	eax, DWORD PTR [edi+1128]
	push	eax
	call	ebp

; 1803 : 	if (T.Processors > 1) WaitForMultipleObjects(T.Processors - 1, HEvs + 1, TRUE, INFINITE);
...
; 1804 : 
; 1805 : 	int endtime = GetTickCount();

	call	DWORD PTR __imp__GetTickCount@0

; 1806 : /*	if (endtime - starttime > T.MaxTrackingTime * 2)
; 1807 : 	{
; 1808 : 		sprintf(fdumpname, "c:\\acq\\smt8a_%08X.txt", starttime);
; 1809 : 		FILE *f = fopen(fdumpname, "wt");
; 1810 : 		fprintf(f, "Time: %d", endtime - starttime);
; 1811 : 		fprintf(f, "StartLayer: %d EndLayer: %d", StartLayer, EndLayer);
; 1812 : 		fprintf(f, "\nLayers: %d", T.Layer);
; 1813 : 		fprintf(f, "\nGrains: %d", T.NumGrains);
; 1814 : 		fprintf(f, "\nCells:");				
; 1815 : 		int layer, icell, igrain;
; 1816 : 		for (layer = 0; layer < T.Layer; layer++)
; 1817 : 			for (icell = 0; icell < T.CellsInLayer; icell++)
; 1818 : 				fprintf(f, "\n%d\t%d\t%f\t%d", layer, icell, T.ZLayer[layer], T.CellSpace[layer * T.CellsInLayer + icell].Free);
; 1819 : 		for (layer = 0; layer < T.Layer; layer++)
; 1820 : 			for (icell = 0; icell < T.CellsInLayer; icell++)
; 1821 : 				for (igrain = 0; igrain < T.CellSpace[layer * T.CellsInLayer + icell].Free; igrain++)
...
; 1825 : */
; 1826 : 
; 1827 : 	for (p = 0; p < T.Processors; p++)

	xor	ebx, ebx
	cmp	DWORD PTR [edi+900], ebx
	mov	DWORD PTR _p$[esp+32], ebx
	jle	$LN25@GetTracks2
	xor	edx, edx
	mov	DWORD PTR tv902[esp+36], edx
	npad	10
$LL27@GetTracks2:

; 1828 : 		for (i = 0; i < ThreadInfo[p].Found; i++)

	mov	eax, DWORD PTR [edi+1140]
	cmp	DWORD PTR [edx+eax+16], ebx
	mov	DWORD PTR _i$[esp+32], ebx
	jle	$LN26@GetTracks2
	mov	DWORD PTR tv892[esp+36], ebx
	npad	8
$LL24@GetTracks2:

; 1829 : 		{
; 1830 : 			Track2 &K = ThreadInfo[p].pSpace[i];

	mov	ecx, DWORD PTR [edi+1140]
	mov	ebx, DWORD PTR [edx+ecx+8]
	add	ebx, DWORD PTR tv892[esp+36]

; 1831 : 			seqlength = K.Grains;
; 1832 : 			if (!T.AllowOverlap)

	cmp	DWORD PTR [edi+940], 0
	mov	esi, DWORD PTR [ebx+4]
	mov	DWORD PTR _seqlength$[esp+36], esi
	jne	$LN7@GetTracks2

; 1833 : 			{
; 1834 : 				for (j = 0; (j < seqlength) && ((IntTrackGrain *)K.pGrains)[j].T.pG->TrackLength < seqlength; j++);
...
; 1841 : 					}
; 1842 : 				for (j = 0; j < seqlength; j++)

	xor	edx, edx
	mov	DWORD PTR tv864[esp+32], edx
	mov	DWORD PTR tv394[esp+36], esi
	npad	1
$LL16@GetTracks2:
	mov	eax, DWORD PTR [ebx+12]
	add	eax, DWORD PTR tv864[esp+32]

; 1843 : 				{
; 1844 : 					IntTrackGrain *pIG = ((IntTrackGrain *)K.pGrains) + j;
; 1845 : 					if (pIG->T.pG->pTrack2)
...
; 1848 : 						for (k = 0; k < N.Grains; k++)

	cmp	DWORD PTR [ecx+4], edx
	jbe	SHORT $LN59@GetTracks2

; 1846 : 					{
; 1847 : 						Track2 &N = *pIG->T.pG->pTrack2;
...
; 1849 : 						{
; 1850 : 							IntTrackGrain *pIJ = ((IntTrackGrain *)N.pGrains) + k;
; 1851 : 							pIJ->T.pG->pTrack2 = 0;

	mov	ebp, DWORD PTR [eax+esi]
	add	eax, esi
	mov	DWORD PTR [ebp+16], 0

; 1852 : 							pIJ->T.pG->TrackLength = 0;
...
$LN15@GetTracks2:
	add	DWORD PTR tv864[esp+32], 16		; 00000010H
	sub	DWORD PTR tv394[esp+36], 1
	jne	SHORT $LL16@GetTracks2

; 1856 : 						}
; 1857 : 					}
; 1858 : 
; 1859 : 				for (j = 0; j < seqlength; j++)
...
; 1860 : 				{
; 1861 : 					IntTrackGrain *pIG = ((IntTrackGrain *)K.pGrains) + j;
; 1862 : 					pIG->T.pG->pTrack2 = &K;

	mov	ebp, DWORD PTR [eax+ecx]
	add	eax, ecx
	mov	DWORD PTR [ebp+16], ebx

; 1863 : 					pIG->T.pG->TrackLength = seqlength;
...
; 1859 : 				for (j = 0; j < seqlength; j++)
	...
	mov	edx, DWORD PTR tv902[esp+36]
$LN7@GetTracks2:
...
; 1828 : 		for (i = 0; i < ThreadInfo[p].Found; i++)
	...
	mov	ecx, DWORD PTR [edi+1140]
	add	DWORD PTR tv892[esp+36], 60		; 0000003cH
	add	eax, 1
...
; 1827 : 	for (p = 0; p < T.Processors; p++)
	...
	cmp	eax, DWORD PTR [edi+900]
	mov	DWORD PTR _p$[esp+32], eax
	mov	DWORD PTR tv902[esp+36], edx
	jl	$LL27@GetTracks2
$LN25@GetTracks2:

; 1878 : 	pTemp = (Grain *)malloc(sizeof(Grain) * T.LayerNum * T.InitialMultiplicity);

	mov	eax, DWORD PTR [edi+932]
	imul	eax, DWORD PTR [edi+144]
	mov	edx, DWORD PTR [edi+1140]
...
; 1879 : 	for (p = 1; p < T.Processors; p++)

	cmp	DWORD PTR [edi+900], 1
...
; 1867 : 			}
; 1868 : /*
; 1869 : 	if ((endtime = GetTickCount()) > TimeLimit) 
; 1870 : 	{
; 1871 : 		sprintf(fdumpname, "c:\\acq\\smt8b_%08X.txt", starttime);
; 1872 : 		FILE *f = fopen(fdumpname, "wt");
; 1873 : 		fprintf(f, "Time: %d TimeLimit: %d", endtime - starttime, TimeLimit);
; 1874 : 		fclose(f);
; 1875 : 		}
; 1876 : */
; 1877 : 	found = ThreadInfo[0].Found;

	mov	DWORD PTR tv1013[esp+36], 40		; 00000028H
	npad	1
$LL6@GetTracks2:

; 1880 : 		for (i = 0; i < ThreadInfo[p].Found; i++)

	mov	ecx, DWORD PTR [edi+1140]
	mov	edx, DWORD PTR tv1013[esp+36]
	cmp	DWORD PTR [edx+ecx+16], ebx
	mov	DWORD PTR _i$[esp+32], ebx
	jle	$LN5@GetTracks2
	...
	shl	eax, 4
	sub	eax, esi
	mov	DWORD PTR tv919[esp+36], ecx
...
; 1880 : 		for (i = 0; i < ThreadInfo[p].Found; i++)
	...
	mov	ecx, DWORD PTR tv919[esp+36]
$LN3@GetTracks2:

; 1881 : 		{
; 1882 : 			TempF = ThreadInfo[p].pSpace[i].Field;
; 1883 : 			TempG = ThreadInfo[p].pSpace[i].Grains;
...
; 1884 : 			//if (TempV = ThreadInfo[p].pSpace[i].Valid)
; 1885 : 			TempV = ThreadInfo[p].pSpace[i].Valid;

	cmp	BYTE PTR [ecx+edx+56], 0
	lea	ebx, DWORD PTR [ecx+edx]
	setne	BYTE PTR _TempV$[esp+32]

; 1886 : 			memcpy(pTemp, ThreadInfo[p].pSpace[i].pGrains, sizeof(Grain) * TempG);

	mov	eax, edx
	mov	ecx, DWORD PTR [ecx+eax+12]
	mov	edx, DWORD PTR _pTemp$[esp+36]
	mov	DWORD PTR _TempG$[esp+36], ebp
	shl	ebp, 4
	push	ebp
	push	ecx
	push	edx
...
; 1887 : /* THESE LINES DISABLE TRACK ORDERING */
; 1888 : #if 1
; 1889 : 			j = found;
; 1890 : #else
; 1891 : 			for (j = 0; (j < found) && (pSpace[j].Field < TempF); j++);
; 1892 : 			for (k = found; k > j; k--)
; 1893 : 			{
; 1894 : 				pSpace[k].Field = pSpace[k - 1].Field;
; 1895 : 				pSpace[k].Grains = pSpace[k - 1].Grains;
; 1896 : 				//if (pSpace[k].Valid = pSpace[k - 1].Valid)
; 1897 : 				pSpace[k].Valid = pSpace[k - 1].Valid;
; 1898 : 				memcpy(pSpace[k].pGrains, pSpace[k - 1].pGrains, sizeof(Grain) * pSpace[k].Grains);
; 1899 : 				}
; 1900 : #endif
; 1901 : /* END OF TRACK ORDERING DISABLE */
; 1902 : 			pSpace[j].Field = TempF;

	mov	eax, DWORD PTR [ebx]

; 1903 : 			pSpace[j].Grains = TempG;

	mov	ecx, DWORD PTR _TempG$[esp+48]

; 1904 : 			//if (pSpace[j].Valid = TempV)
; 1905 : 			pSpace[j].Valid = TempV;

	mov	dl, BYTE PTR _TempV$[esp+44]
	mov	DWORD PTR [esi-56], eax

; 1906 : 			memcpy(pSpace[j].pGrains, pTemp, sizeof(Grain) * TempG);
	...
	mov	edx, DWORD PTR [edi+1140]
	mov	ecx, DWORD PTR tv1013[esp+60]

; 1907 : 			found++;

	add	DWORD PTR _found$[esp+60], 1
	add	DWORD PTR tv919[esp+60], 60		; 0000003cH
	add	eax, 1
	add	esp, 24					; 00000018H
	add	esi, 60					; 0000003cH
...
$LN5@GetTracks2:
	mov	eax, DWORD PTR _p$[esp+32]
	add	DWORD PTR tv1013[esp+36], 40		; 00000028H
	add	eax, 1
	cmp	eax, DWORD PTR [edi+900]
	mov	DWORD PTR _p$[esp+32], eax
	jl	$LL6@GetTracks2
...
; 1910 : 
; 1911 : /*
; 1912 : 	if ((endtime = GetTickCount()) > TimeLimit) 
; 1913 : 	{
; 1914 : 		sprintf(fdumpname, "c:\\acq\\smt8c_%08X.txt", starttime);
; 1915 : 		FILE *f = fopen(fdumpname, "wt");
; 1916 : 		fprintf(f, "Time: %d TimeLimit: %d", endtime - starttime, TimeLimit);
; 1917 : 		for (p = 0; p < T.Processors; p++)
; 1918 : 			fprintf(f, "\nThread: %d Found: %d", p, ThreadInfo[p].Found);
; 1919 : 
; 1920 : 		fclose(f);
; 1921 : 		}
; 1922 : */
; 1923 : 	*pMaxNumber = FinalizeTracks(found, pSpace);
...
; 1924 : /*
; 1925 : 	if ((endtime = GetTickCount()) > TimeLimit) 
; 1926 : 	{
; 1927 : 		sprintf(fdumpname, "c:\\acq\\smt8d_%08X.txt", starttime);
; 1928 : 		FILE *f = fopen(fdumpname, "wt");
; 1929 : 		fprintf(f, "Time: %d TimeLimit: %d", endtime - starttime, TimeLimit);
; 1930 : 		fclose(f);
; 1931 : 		}
; 1932 : */
; 1933 : 	return S_OK;
...
_TEXT	SEGMENT
_dummy$130660 = 8					; size = 4
_this$ = 8						; size = 4
_pConfig$ = 12						; size = 4
?SetConfig@CSmartTrackerClass@@UAGJPAUSySalConfig@@@Z PROC ; CSmartTrackerClass::SetConfig, COMDAT

; 258  : 	// TODO: Add your implementation code here
; 259  : 	OkToRun = false;
; 260  : 	if (GetData(*pConfig, ConfigDataN, ConfigDataQDI, &T, false) != ConfigDataN) return S_FALSE;
...
; 261  : 
; 262  : 	if (T.GrainSpace) CoTaskMemFree(T.GrainSpace);

	mov	eax, DWORD PTR [esi+960]
	test	eax, eax
	push	ebp
	mov	ebp, DWORD PTR __imp__CoTaskMemFree@4
	je	SHORT $LN21@SetConfig
	push	eax
	call	ebp
$LN21@SetConfig:

; 263  : 	if (!(T.GrainSpace = (IntGrain *)CoTaskMemAlloc( sizeof(IntGrain) * T.MaxGrains)))

	mov	eax, DWORD PTR [ebx]
	lea	ecx, DWORD PTR [eax+eax*8]
	add	ecx, ecx
	push	edi
	mov	edi, DWORD PTR __imp__CoTaskMemAlloc@4
	add	ecx, ecx
	push	ecx
	call	edi
	test	eax, eax
...
; 265  : 	if (T.ZLayer) CoTaskMemFree(T.ZLayer);
...
; 266  : 	if (!(T.ZLayer = (float *)CoTaskMemAlloc( sizeof(float) * T.LayerNum)))
...
; 268  : 	if (T.LayerGrains) CoTaskMemFree(T.LayerGrains);
...
; 269  : 	if (!(T.LayerGrains = (IntGrain **)CoTaskMemAlloc( sizeof(IntGrain *) * T.LayerNum)))
...
; 271  : 	T.CellsInLayer = T.CellNumX * T.CellNumY;

	mov	ecx, DWORD PTR [esi+152]
	imul	ecx, DWORD PTR [esi+148]

; 272  : 	if (T.CellSpace) CoTaskMemFree(T.CellSpace);

	mov	eax, DWORD PTR [esi+972]
	test	eax, eax
	mov	DWORD PTR [esi+976], ecx
	je	SHORT $LN15@SetConfig
	push	eax
	call	ebp
$LN15@SetConfig:

; 273  : 	if (!(T.CellSpace = (Cell *)CoTaskMemAlloc( sizeof(Cell) * (T.CellsInLayer)*(T.LayerNum))))
...
; 275  : 	if (T.pDeltaData) CoTaskMemFree(T.pDeltaData);
...
; 276  : 	if (!(T.pDeltaData = (float *)CoTaskMemAlloc( (4 * sizeof(float) + sizeof(IntCluster **)) * T.MaxGrains)))
...
; 278  : 	else
; 279  : 	{
; 280  : 		T.pX = T.pDeltaData;
; 281  : 		T.pY = T.pX + T.MaxGrains;
...
; 282  : 		T.pDX = T.pY + T.MaxGrains;

	add	eax, ecx
	mov	DWORD PTR [esi+1080], eax

; 283  : 		T.pDY = T.pDX + T.MaxGrains;

	add	eax, ecx
	mov	DWORD PTR [esi+1084], eax

; 284  : 		T.pReplicas = (IntCluster **)(void *)(T.pDY + T.MaxGrains);

	add	eax, ecx

; 285  : 		}
; 286  : 
; 287  : 	if (!ResetDeltaHisto()) return S_FALSE;
...
; 289  : 	int i;
; 290  : 	for (i = 1; i < MaxProcessors; i++)

	mov	ebp, 1
	cmp	DWORD PTR [esi+1128], ebp
...
; 291  : 		if (ThreadInfo[i].HThread)

	mov	edx, DWORD PTR [esi+1136]
	mov	eax, DWORD PTR [edi+edx+24]
	test	eax, eax
	je	SHORT $LN8@SetConfig

; 292  : 		{
; 293  : 			WaitForSingleObject(ThreadInfo[i].HThread, INFINITE);

	push	-1
	push	eax
	call	DWORD PTR __imp__WaitForSingleObject@8

; 294  : 			CloseHandle(ThreadInfo[i].HThread);
...
; 295  : 			CloseHandle(ThreadInfo[i].HFinished);
...
; 296  : 			ThreadInfo[i].HThread = 0;

	mov	ecx, DWORD PTR [esi+1136]
	xor	eax, eax
	mov	DWORD PTR [edi+ecx+24], eax

; 297  : 			ThreadInfo[i].HFinished = 0;
...
$LN8@SetConfig:
	add	ebp, 1
	add	edi, 40					; 00000028H
	cmp	ebp, DWORD PTR [esi+1128]
	jl	SHORT $LL9@SetConfig
$LN29@SetConfig:

; 298  : 			};
; 299  : 	ResetEvent(HTerminate);
...
; 300  : 	ResetEvent(HStart);

	mov	ecx, DWORD PTR [esi+1116]
	push	ecx
	call	edi

; 301  : 	ResetEvent(HReset);

	mov	edx, DWORD PTR [esi+1124]
	push	edx
	call	edi

; 302  : 	ThreadInfo[0].ThreadIndex = 0;

	mov	eax, DWORD PTR [esi+1136]
	mov	DWORD PTR [eax+4], 0

; 303  : 	ConfigMaxProcessors_backup = T.Processors;

	mov	eax, DWORD PTR [esi+896]

; 304  : 	if (T.Processors == 0 || T.Processors > MaxProcessors) T.Processors = MaxProcessors;

	test	eax, eax
	mov	DWORD PTR [esi+1132], eax
	je	SHORT $LN4@SetConfig
	cmp	eax, DWORD PTR [esi+1128]
...
; 306  : 	{
; 307  : 		unsigned dummy;
; 308  : 		ThreadInfo[i].HFinished = CreateEvent(NULL, FALSE, FALSE, NULL);
...
; 309  : 		ThreadInfo[i].pThis = this;

	mov	ecx, DWORD PTR [esi+1136]
	lea	eax, DWORD PTR [esi-4]
	mov	DWORD PTR [edi+ecx], eax

; 310  : 		ThreadInfo[i].ThreadIndex = i;

	mov	edx, DWORD PTR [esi+1136]

; 311  : 		ThreadInfo[i].HThread = (HANDLE)_beginthreadex(NULL, 0, TrackerThreadHook, ThreadInfo + i, 0, &dummy);

	lea	eax, DWORD PTR _dummy$130660[esp+12]
	push	eax
...
tv1560 = -320						; size = 4
tv1549 = -320						; size = 4
_slope2$134249 = -320					; size = 4
_slope2$134243 = -320					; size = 4
_ExpX$ = -320						; size = 4
tv1683 = -316						; size = 4
tv1682 = -316						; size = 4
_dz$131117 = -316					; size = 4
tv1672 = -312						; size = 4
tv1565 = -312						; size = 4
_pTrg$131114 = -312					; size = 4
_ExpY$ = -312						; size = 4
_cdz$131111 = -312					; size = 4
_ldz$131110 = -312					; size = 4
_SlopeY$ = -308						; size = 4
_SlopeX$ = -304						; size = 4
_DirX$ = -300						; size = 4
_seqlength$131118 = -296				; size = 4
_dirtol$ = -292						; size = 4
_DirY$ = -288						; size = 4
_ZLayer$ = -284						; size = 4
_pTempGrains$ = -280					; size = 4
_CellSpace$ = -276					; size = 4
_topv$131127 = -272					; size = 12
_pT$131086 = -260					; size = 4
_slope2$134231 = -256					; size = 4
_ir$ = -256						; size = 4
_pB$131099 = -252					; size = 4
_tz$ = -248						; size = 4
_idz$ = -244						; size = 4
_miniy$ = -240						; size = 4
_ny$ = -236						; size = 4
...
tv1772 = -232						; size = 4
tv171 = -228						; size = 4
_tp$131073 = -228					; size = 4
_maxix$ = -224						; size = 4
_nx$ = -220						; size = 4
_NTracks$ = -216					; size = 4
_bottomv$131128 = -212					; size = 12
_avgdz$ = -200						; size = 4
_minix$ = -196						; size = 4
_maxiy$ = -192						; size = 4
tv1944 = -188						; size = 4
...
_pTE$131087 = -144					; size = 4
_bp$131074 = -140					; size = 4
_tsl$ = -136						; size = 4
_CellsInLayer$ = -132					; size = 4
_pBE$131100 = -128					; size = 4
_td$ = -124						; size = 4
_tinf$ = -120						; size = 4
_tr$131070 = -116					; size = 44
_gt$131091 = -72					; size = 36
_gb$131104 = -36					; size = 36
_this$ = 8						; size = 4
_pSpace$ = 12						; size = 4
_pMaxNumber$ = 16					; size = 4
_StartLayer$ = 20					; size = 4
...
; 946  : 
; 947  : 	// TODO: Add your implementation code here
; 948  : 
; 949  : 	int nx, ny;
; 950  : 	int lay;
; 951  : 	int itr, ibr;
; 952  : 	int NTracks = 0;
; 953  : 	float *ZLayer = T.ZLayer;

	mov	ebx, DWORD PTR _this$[ebp]

; 954  : 	float tz;
; 955  : 	int CellsInLayer = T.CellsInLayer;

	mov	eax, DWORD PTR [ebx+980]

; 956  : 	Cell *CellSpace = T.CellSpace;
; 957  : 	float MaxSlope = T.MaxSlope;

	fld	DWORD PTR [ebx+896]
	mov	ecx, DWORD PTR [ebx+976]
	fstp	DWORD PTR _MaxSlope$[esp+376]

; 958  : 	float MinSlope = T.MinSlope;
; 959  : 
; 960  : 	int ix, iy, iix, iiy, eix, eiy;
; 961  : 	int minix, maxix, miniy, maxiy;
; 962  : 	float Slope2;
; 963  : 	float SlopeX, SlopeY, ExpX, ExpY, DirX, DirY;
; 964  : 	float dirtol;
; 965  : 	int it, ib, ir;
; 966  : 	float idz;
; 967  : 
...
; 975  : 		}
; 976  : 
; 977  : 	if (EndLayer >= T.Layer) EndLayer = T.Layer - 1;

	mov	eax, DWORD PTR [ebx+1020]
...
; 978  : 
; 979  : 	IntGrain **pTempGrains = (IntGrain **)malloc(sizeof(IntGrain *) * (EndLayer + 1));
...
; 980  : 
; 981  : 	float avgdz = (ZLayer[StartLayer] - ZLayer[EndLayer]) / (EndLayer - StartLayer);
...
; 982  : 			
; 983  : 	float tsl = 10.0f * (T.NptMinV - T.NptMin01) / (T.NptMin01 - T.NptMinH);
; 984  : 	float tinf = (float)(T.NptMinH);
; 985  : 	float td = (float)(T.NptMinV - T.NptMinH);
; 986  : 
; 987  : 	for (itr = 0; itr < T.TrialCount; itr++)
...
; 988  : 	{
; 989  : 		Trial tr = T.Trials[itr];

	mov	ecx, 11					; 0000000bH
	lea	edi, DWORD PTR _tr$131070[esp+384]
	rep movsd

; 990  : 		if (tr.TopLayer < StartLayer || tr.BottomLayer > EndLayer) continue;

	mov	eax, DWORD PTR _tr$131070[esp+384]
	cmp	eax, edx
	jl	$LN49@GetTracks
	mov	ecx, DWORD PTR _tr$131070[esp+388]
	cmp	ecx, DWORD PTR _EndLayer$[ebp]
	jg	$LN49@GetTracks

; 991  : 		Cell *tp = CellsInLayer * tr.TopLayer + CellSpace;
	...
	mov	DWORD PTR _tp$131073[esp+384], edi

; 992  : 		Cell *bp = CellsInLayer * tr.BottomLayer + CellSpace;

	mov	edi, ecx
	imul	edi, edx
	lea	edx, DWORD PTR [esi+edi*8]
	mov	DWORD PTR _bp$131074[esp+384], edx

; 993  : 		tz = ZLayer[tr.TopLayer];

	mov	edx, DWORD PTR _ZLayer$[esp+384]
	fld	DWORD PTR [edx+eax*4]
	fstp	DWORD PTR _tz$[esp+384]

; 994  : 		idz = 1.0f / (tz - ZLayer[tr.BottomLayer]);

	fld	DWORD PTR _tz$[esp+384]
	fsub	DWORD PTR [edx+ecx*4]

; 995  : 
; 996  : 		for (ix = 0; ix < nx; ix++)
	...
	jle	$LN49@GetTracks
	mov	edi, DWORD PTR _tp$131073[esp+384]
...
; 997  : 		{
; 998  : 			minix = ix - 1; if (minix < 0) minix = 0;
...
; 999  : 			maxix = ix + 1; if (maxix >= nx) maxix = nx - 1;
...
; 1001 : 			{
; 1002 : 				miniy = iy - 1; if (miniy < 0) miniy = 0;
...
; 1003 : 				maxiy = iy + 1; if (maxiy >= ny) maxiy = ny - 1;
...
; 1004 : 				Cell &ct = tp[iy * nx + ix];
; 1005 : 				IntGrain *pT = ct.FirstG;

	mov	esi, DWORD PTR [edi]

; 1006 : 				IntGrain *pTE = ct.FirstG + ct.Free;
...
; 1007 : 				for (;pT < pTE; pT++)
	...
	cmp	esi, edi
	mov	DWORD PTR _pT$131086[esp+384], esi
	mov	DWORD PTR _pTE$131087[esp+384], edi
	jae	$LN114@GetTracks
	jmp	SHORT $LN35@GetTracks
$LN113@GetTracks:
	mov	esi, DWORD PTR _pT$131086[esp+384]
$LN35@GetTracks:
...
; 1009 : 					IntGrain gt = *pT;
	...
	mov	ecx, 9
	lea	edi, DWORD PTR _gt$131091[esp+384]
	rep movsd

; 1010 : 					for (iix = minix; iix <= maxix; iix++)
...
; 1011 : 						for (iiy = miniy; iiy <= maxiy; iiy++)
	...
	imul	eax, edx
	add	eax, ecx
	mov	ecx, DWORD PTR _bp$131074[esp+384]
	lea	ecx, DWORD PTR [ecx+eax*8]
	mov	eax, esi
...
; 1012 : 						{
; 1013 : 							Cell &cb = bp[iiy * nx + iix];
; 1014 : 							IntGrain *pB = cb.FirstG;

	mov	esi, DWORD PTR [ecx]

; 1015 : 							IntGrain *pBE = cb.FirstG + cb.Free;
...
; 1016 : 							for (;pB < pBE; pB++)
	...
	cmp	esi, edi
	mov	DWORD PTR _pB$131099[esp+384], esi
	mov	DWORD PTR _pBE$131100[esp+384], edi
	jae	$LN28@GetTracks
	jmp	SHORT $LN26@GetTracks
	npad	7
$LL97@GetTracks:
	mov	esi, DWORD PTR _pB$131099[esp+384]
$LN26@GetTracks:

; 1017 : 							{
; 1018 : 								IntGrain gb = *pB;
; 1019 : 								SlopeX = idz * (gt.Xcm - gb.Xcm);

	fld	DWORD PTR _gt$131091[esp+384]
	mov	ecx, 9
	lea	edi, DWORD PTR _gb$131104[esp+384]
	rep movsd
	fsub	DWORD PTR _gb$131104[esp+384]
	fmul	ST(0), ST(1)
	fstp	DWORD PTR _SlopeX$[esp+384]

; 1020 : 								SlopeY = idz * (gt.Ycm - gb.Ycm);

	fld	DWORD PTR _gt$131091[esp+388]
	fsub	DWORD PTR _gb$131104[esp+388]
	fmulp	ST(1), ST(0)

; 1021 : 								Slope2 = hypot(SlopeX, SlopeY);
...
; 1023 : 								{
; 1024 : 									GetDirAndTol(SlopeX, SlopeY, avgdz, &DirX, &DirY, &dirtol);
	...
	fstp	QWORD PTR [esp]
	call	DWORD PTR __imp__hypot
	fstp	DWORD PTR _slope2$134231[esp+400]
	add	esp, 16					; 00000010H
	fldz
	fld	DWORD PTR _slope2$134231[esp+384]
	fcom	ST(1)
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 1025 : 									for (ir = 0; ir < tr.TriggerCount; ir++)

	cmp	DWORD PTR _tr$131070[esp+392], 0
...
; 1026 : 									{
; 1027 : 										int TriggerLayer = tr.Triggers[ir];

	mov	edx, DWORD PTR _ir$[esp+384]

; 1028 : 										float ldz = (tz - ZLayer[TriggerLayer]) * idz;

	fld	DWORD PTR _tz$[esp+384]
	mov	edi, DWORD PTR _tr$131070[esp+edx*4+396]
	mov	eax, DWORD PTR _ZLayer$[esp+384]
	fsub	DWORD PTR [eax+edi*4]

; 1029 : 										float cdz = 1.0f - ldz;
; 1030 : 										ExpX = ldz * gb.Xcm + cdz * gt.Xcm;
; 1031 : 										ExpY = ldz * gb.Ycm + cdz * gt.Ycm;
; 1032 : 										eix = (int)((ExpX - T.Win.Xmin) / T.DxCell);
; 1033 : 										eiy = (int)((ExpY - T.Win.Ymin) / T.DyCell);
; 1034 : 										IntGrain *pTrg = CellSpace[(TriggerLayer * ny + eiy) * nx + eix].FindGrain(ExpX, ExpY, DirX, DirY, dirtol, T.AlignTol);

	sub	esp, 24					; 00000018H
	fmul	DWORD PTR _idz$[esp+408]
	fstp	DWORD PTR _ldz$131110[esp+408]
	fld	DWORD PTR _ldz$131110[esp+408]
	fld	ST(0)
	fld1
	fsubrp	ST(1), ST(0)
	fstp	DWORD PTR _cdz$131111[esp+408]
	fld	ST(0)
	fmul	DWORD PTR _gb$131104[esp+408]
	fld	DWORD PTR _cdz$131111[esp+408]
	fld	ST(0)
	fmul	DWORD PTR _gt$131091[esp+408]
	faddp	ST(2), ST(0)
	fxch	ST(1)
	fstp	DWORD PTR _ExpX$[esp+408]
	fld	DWORD PTR _gb$131104[esp+412]
	fmulp	ST(2), ST(0)
	fmul	DWORD PTR _gt$131091[esp+412]
	faddp	ST(1), ST(0)
	...
	fst	DWORD PTR [esp]
	fld	DWORD PTR [ebx+992]
	fsubp	ST(2), ST(0)
	fld	DWORD PTR [ebx+1004]
	fdivp	ST(2), ST(0)
	fxch	ST(1)
	call	__ftol2_sse
	fsub	DWORD PTR [ebx+984]
	mov	ecx, edi
	imul	ecx, DWORD PTR _ny$[esp+408]
	fdiv	DWORD PTR [ebx+1000]
	mov	esi, eax
	add	esi, ecx
...
; 1035 : 										if (pTrg)
	...
	test	eax, eax
	mov	DWORD PTR _pTrg$131114[esp+384], eax
	je	$LN21@GetTracks

; 1036 : 										{
; 1037 : 											memset(pTempGrains, 0, T.Layer * sizeof(Grain *));
...
; 1038 : 											float dz;
; 1039 : 											int seqlength = 3;
; 1040 : 
; 1041 : 											pTempGrains[tr.TopLayer] = pT;

	mov	eax, DWORD PTR _tr$131070[esp+396]
	mov	ecx, DWORD PTR _pT$131086[esp+396]

; 1042 : 											pTempGrains[tr.BottomLayer] = pB;

	mov	edx, DWORD PTR _tr$131070[esp+400]
	mov	DWORD PTR [esi+eax*4], ecx
	mov	ecx, DWORD PTR _pB$131099[esp+396]
	mov	DWORD PTR [esi+edx*4], ecx

; 1043 : 											pTempGrains[TriggerLayer] = pTrg;

	mov	edx, DWORD PTR _pTrg$131114[esp+396]
	mov	DWORD PTR [esi+edi*4], edx

; 1044 : 
; 1045 : 											for (lay = tr.TopLayer + 1; lay < TriggerLayer; lay++)

	lea	esi, DWORD PTR [eax+1]
	add	esp, 12					; 0000000cH
	cmp	esi, edi
	mov	DWORD PTR _seqlength$131118[esp+384], 3
	jge	$LN16@GetTracks
...
; 1046 : 											{
; 1047 : 												dz = ZLayer[lay] - tz;

	mov	ecx, DWORD PTR tv1549[esp+384]
	fld	DWORD PTR [eax+ecx]

; 1048 : 												ExpX = dz * SlopeX + gt.Xcm;
; 1049 : 												ExpY = dz * SlopeY + gt.Ycm;
; 1050 : 												if (pTempGrains[lay] = FindGrain(ExpX, ExpY, CellSpace + lay * T.CellsInLayer, DirX, DirY, dirtol)) seqlength++;

	mov	edx, DWORD PTR [ebx+980]
	fsub	DWORD PTR _tz$[esp+384]
	mov	eax, DWORD PTR _CellSpace$[esp+384]
	imul	edx, esi
	fstp	DWORD PTR _dz$131117[esp+384]
	fldz
	sub	esp, 8
	lea	ecx, DWORD PTR [eax+edx*8]
	fst	DWORD PTR [esp+4]
	...
	add	DWORD PTR _seqlength$131118[esp+384], 1
$LN17@GetTracks:
...
; 1052 : 											for (lay = TriggerLayer + 1; lay < tr.BottomLayer; lay++)
	...
	add	edi, 1
	cmp	edi, DWORD PTR _tr$131070[esp+388]
	jge	$LN12@GetTracks
	mov	ecx, DWORD PTR _pTempGrains$[esp+384]
	mov	eax, DWORD PTR _ZLayer$[esp+384]
	sub	eax, ecx
...
; 1058 : 												};
; 1059 : 											Vector topv, bottomv;
; 1060 : 											topv.X = pT->Xcm;

	mov	eax, DWORD PTR _pT$131086[esp+384]
	fld	DWORD PTR [eax]

; 1061 : 											topv.Y = pT->Ycm;
; 1062 : 											topv.Z = tz;
; 1063 : 											bottomv.X = pB->Xcm;
; 1064 : 											bottomv.Y = pB->Ycm;
; 1065 : 											bottomv.Z = ZLayer[tr.BottomLayer];

	mov	esi, DWORD PTR _ZLayer$[esp+384]

; 1066 : 											for (lay = (int)tr.TopLayer - 1; lay >= 0; lay--)

	mov	edi, DWORD PTR _tr$131070[esp+384]
	fstp	DWORD PTR _topv$131127[esp+384]
	add	edi, -1
	fld	DWORD PTR [eax+4]
	mov	eax, DWORD PTR _pB$131099[esp+384]
	fstp	DWORD PTR _topv$131127[esp+388]
	fld	DWORD PTR _tz$[esp+384]
	fstp	DWORD PTR _topv$131127[esp+392]
	fld	DWORD PTR [eax]
	fstp	DWORD PTR _bottomv$131128[esp+384]
	fld	DWORD PTR [eax+4]
	mov	eax, DWORD PTR _tr$131070[esp+388]
	fstp	DWORD PTR _bottomv$131128[esp+388]
	fld	DWORD PTR [esi+eax*4]
	fstp	DWORD PTR _bottomv$131128[esp+392]
	js	$LN8@GetTracks
...
; 1067 : 											{
; 1068 : 												dz = (bottomv.Z - topv.Z);

	fld	DWORD PTR _bottomv$131128[esp+392]

; 1069 : 												SlopeX = (bottomv.X - topv.X) / dz;
; 1070 : 												SlopeY = (bottomv.Y - topv.Y) / dz;
; 1071 : 												GetDirAndTol(SlopeX, SlopeY, avgdz, &DirX, &DirY, &dirtol);

	sub	esp, 16					; 00000010H
	fsub	DWORD PTR _topv$131127[esp+408]
	fstp	DWORD PTR _dz$131117[esp+400]
	fld	DWORD PTR _bottomv$131128[esp+400]
	fsub	DWORD PTR _topv$131127[esp+400]
	fld	DWORD PTR _dz$131117[esp+400]
	fld	ST(0)
	fdivp	ST(2), ST(0)
	fxch	ST(1)
	fstp	DWORD PTR _SlopeX$[esp+400]
	fld	DWORD PTR _bottomv$131128[esp+404]
	fsub	DWORD PTR _topv$131127[esp+404]
	fdivrp	ST(1), ST(0)
	fstp	DWORD PTR _SlopeY$[esp+400]
	fld	DWORD PTR _SlopeY$[esp+400]
	fstp	QWORD PTR [esp+8]
	...
	fstp	QWORD PTR [esp]
	call	DWORD PTR __imp__hypot
	fstp	DWORD PTR _slope2$134243[esp+400]
	fldz
	add	esp, 16					; 00000010H
	fld	DWORD PTR _slope2$134243[esp+384]
	fcom	ST(1)
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 1072 : 												dz = ZLayer[lay] - topv.Z;
; 1073 : 												ExpX = dz * SlopeX + topv.X;
; 1074 : 												ExpY = dz * SlopeY + topv.Y;
; 1075 : 												if (pTempGrains[lay] = FindGrain(ExpX, ExpY, CellSpace + lay * T.CellsInLayer, DirX, DirY, dirtol))

	mov	ecx, DWORD PTR [ebx+980]
	fld	DWORD PTR [esi]
	mov	edx, DWORD PTR _CellSpace$[esp+384]
	imul	ecx, edi
	fsub	DWORD PTR _topv$131127[esp+392]
	fstp	DWORD PTR _dz$131117[esp+384]
	sub	esp, 8
	lea	eax, DWORD PTR [edx+ecx*8]
	mov	ecx, ebx
	...
	fld	ST(0)
	fmul	DWORD PTR _SlopeY$[esp+424]
	fadd	DWORD PTR _topv$131127[esp+428]
	fstp	DWORD PTR tv1610[esp+424]
	fld	DWORD PTR tv1610[esp+424]
	fstp	DWORD PTR [esp+4]
	fmul	DWORD PTR _SlopeX$[esp+424]
	fadd	DWORD PTR _topv$131127[esp+424]
...
; 1076 : 												{
; 1077 : 													topv.X = pTempGrains[lay]->Xcm;

	fld	DWORD PTR [eax]

; 1078 : 													topv.Y = pTempGrains[lay]->Ycm;
; 1079 : 													topv.Z = ZLayer[lay];
; 1080 : 													seqlength++;
...
; 1081 : 													}
; 1082 : 												};
; 1083 : 											for (lay = (int)tr.BottomLayer + 1; lay <= EndLayer; lay++)

	mov	edi, DWORD PTR _tr$131070[esp+388]
	add	edi, 1
...
; 1084 : 											{
; 1085 : 												dz = (bottomv.Z - topv.Z);

	fld	DWORD PTR _bottomv$131128[esp+392]

; 1086 : 												SlopeX = (bottomv.X - topv.X) / dz;
; 1087 : 												SlopeY = (bottomv.Y - topv.Y) / dz;
; 1088 : 												GetDirAndTol(SlopeX, SlopeY, avgdz, &DirX, &DirY, &dirtol);
	...
	fstp	QWORD PTR [esp]
	call	DWORD PTR __imp__hypot
	fstp	DWORD PTR _slope2$134249[esp+400]
	fldz
	add	esp, 16					; 00000010H
	fld	DWORD PTR _slope2$134249[esp+384]
	fcom	ST(1)
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 1089 : 												dz = ZLayer[lay] - topv.Z;
; 1090 : 												ExpX = dz * SlopeX + topv.X;
; 1091 : 												ExpY = dz * SlopeY + topv.Y;
; 1092 : 												if (pTempGrains[lay] = FindGrain(ExpX, ExpY, CellSpace + lay * T.CellsInLayer, DirX, DirY, dirtol))
...
; 1093 : 												{
; 1094 : 													bottomv.X = pTempGrains[lay]->Xcm;

	fld	DWORD PTR [eax]

; 1095 : 													bottomv.Y = pTempGrains[lay]->Ycm;
; 1096 : 													bottomv.Z = ZLayer[lay];
; 1097 : 													seqlength++;
...
; 1098 : 													}
; 1099 : 												};
; 1100 : 											if ((float)seqlength > (tinf + td / (1.0f + tsl * Slope2)))

	fild	DWORD PTR _seqlength$131118[esp+384]
...
; 1025 : 									for (ir = 0; ir < tr.TriggerCount; ir++)
	...
	add	eax, 1
	cmp	eax, DWORD PTR _tr$131070[esp+392]
...
; 1101 : 											{
; 1102 : 												InsertNewTrack(pTempGrains, EndLayer + 1, seqlength, pSpace, NTracks);

	mov	edi, DWORD PTR _pSpace$[ebp]
	mov	ecx, DWORD PTR _seqlength$131118[esp+384]
...
; 1104 : 												{
; 1105 : 													*pMaxNumber = FinalizeTracks(NTracks, pSpace);
...
$LN25@GetTracks:
	...
	fld	DWORD PTR _idz$[esp+384]
	add	eax, 36					; 00000024H
	cmp	eax, DWORD PTR _pBE$131100[esp+384]
	mov	DWORD PTR _pB$131099[esp+384], eax
	jb	$LL97@GetTracks
...
; 1007 : 				for (;pT < pTE; pT++)
	...
	mov	ecx, DWORD PTR _pT$131086[esp+384]
	add	ecx, 36					; 00000024H
	cmp	ecx, DWORD PTR _pTE$131087[esp+384]
	mov	DWORD PTR _pT$131086[esp+384], ecx
	jb	$LN113@GetTracks
...
; 1118 : 		}
; 1119 : 
; 1120 : 	*pMaxNumber = FinalizeTracks(NTracks, pSpace);
