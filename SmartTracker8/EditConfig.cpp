...
void CEditConfig::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EC_LONGITTOLMULTIPLIER, C.LongitTolMultiplier);
	DDV_MinMaxFloat(pDX, C.LongitTolMultiplier, 0.5f, 5.f);
	...
	DDV_MinMaxUInt(pDX, C.Processors, 1, MAX_PROCESSORS);
	DDX_Text(pDX, IDC_EC_MAXTRACKINGTIME, C.MaxTrackingTime);
	DDV_MinMaxUInt(pDX, C.MaxTrackingTime, 20, 1000);
