	TITLE	D:\SySal2\SmartTracker8\TestDlg.cpp
	.386P
include listing.inc
if @Version gt 510
.model FLAT
...
;	COMDAT ??_C@_00A@?$AA@
; File D:\SySal2\SmartTracker8\TestDlg.cpp
_BSS	SEGMENT
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T76239	DD	019930520H
	DD	02H
	DD	FLAT:$T76241
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T76241	DD	0ffffffffH
	DD	FLAT:$L76235
	DD	00H
	DD	FLAT:$L76236
xdata$x	ENDS
...
; 89   : 	while (fscanf(f, "%d %d %d %f %d %d %f %f %d", &nextfield, &nextside, &nextlayer, &Z, &count, &nextid, &C.X, &C.Y, &C.Area) == 9)
	...
	push	eax
	lea	edx, DWORD PTR _nextid$[esp+148]
	push	ecx
	lea	eax, DWORD PTR _count$[esp+152]
	push	edx
	lea	ecx, DWORD PTR _Z$[esp+156]
	push	eax
	lea	edx, DWORD PTR _nextlayer$[esp+160]
	push	ecx
	lea	eax, DWORD PTR _nextside$[esp+164]
	push	edx
	mov	edx, DWORD PTR _f$[esp+168]
	lea	ecx, DWORD PTR _nextfield$[esp+168]
	push	eax
	push	ecx
	push	OFFSET FLAT:??_C@_0BL@HKHL@?$CFd?5?$CFd?5?$CFd?5?$CFf?5?$CFd?5?$CFd?5?$CFf?5?$CFf?5?$CFd?$AA@ ; `string'
	push	edx
	mov	DWORD PTR _pC$[esp+184], esi
	call	DWORD PTR __imp__fscanf
...
;	COMDAT ??_C@_0DA@BBBG@Text?5files?5?$CI?$CK?4txt?$CJ?$HM?$CK?4txt?$HMAll?5fil@
; File C:\Program Files\Microsoft Visual Studio\VC98\MFC\INCLUDE\afxdlgs.inl
_DATA	SEGMENT
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T76303	DD	019930520H
	DD	03H
	DD	FLAT:$T76305
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T76305	DD	0ffffffffH
	DD	FLAT:$L76285
	DD	00H
	DD	FLAT:$L76286
	DD	0ffffffffH
...
; 121  : 		m_DataFile = MyDlg.GetPathName();
	...
	lea	eax, DWORD PTR $T76284[esp+532]
	lea	ecx, DWORD PTR _MyDlg$[esp+532]
	push	eax
	...
	lea	ecx, DWORD PTR $T76284[esp+532]
...
$L76286:
	lea	ecx, DWORD PTR $T76284[ebp]
	jmp	??1CString@@QAE@XZ			; CString::~CString
$L76292:
	lea	ecx, DWORD PTR _MyDlg$[ebp]
	jmp	??1CCommonDialog@@UAE@XZ		; CCommonDialog::~CCommonDialog
$L76304:
	mov	eax, OFFSET FLAT:$T76303
	jmp	___CxxFrameHandler
text$x	ENDS
