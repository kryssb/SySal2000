...
/* at Wed Sep 27 13:40:10 2006
 */
/* Compiler settings for D:\SySal2\SmartTracker8\SmartTracker8.idl:
...
#define PROC_FORMAT_STRING_SIZE   1017                              
...
CINTERFACE_PROXY_VTABLE(16) _ITracker4ProxyVtbl = 
{
    &ITracker4_ProxyInfo,
    &IID_ITracker4,
    IUnknown_QueryInterface_Proxy,
    ...
    (void *)-1 /* ITracker2::GetFlatStrips */ ,
    (void *)-1 /* ITracker3::GetTracks2 */ ,
    (void *)-1 /* ITracker4::GetMaxGrainsPerTrack */
};
...
/* 1004 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
int __stdcall _SmartTracker8_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( _SmartTracker8, 5, 4 )
    IID_BS_LOOKUP_NEXT_TEST( _SmartTracker8, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _SmartTracker8, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _SmartTracker8, 5, *pIndex )
