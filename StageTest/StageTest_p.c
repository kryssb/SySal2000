...
const CInterfaceProxyVtbl * _StageTest_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _StageTest_StubVtblList[] = 
{
...
PCInterfaceName const _StageTest_InterfaceNamesList[] = 
{
    "ISySalObject",
    "ISySalObject2",
    0
...
#define _StageTest_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _StageTest, pIID, n)

int __stdcall _StageTest_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _StageTest, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _StageTest, 2, *pIndex )
    
}

const ExtendedProxyFileInfo StageTest_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _StageTest_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _StageTest_StubVtblList,
    (const PCInterfaceName * ) & _StageTest_InterfaceNamesList,
    0, // no delegation
    & _StageTest_IID_Lookup, 
    2,
    2,
