...
#ifndef __StageTest_FWD_DEFINED__
#define __StageTest_FWD_DEFINED__

#ifdef __cplusplus
typedef class StageTest StageTest;
#else
typedef struct StageTest StageTest;
#endif /* __cplusplus */

#endif 	/* __StageTest_FWD_DEFINED__ */
...
#ifndef __STAGETESTLib_LIBRARY_DEFINED__
#define __STAGETESTLib_LIBRARY_DEFINED__

/* library STAGETESTLib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_STAGETESTLib;

EXTERN_C const CLSID CLSID_StageTest;

#ifdef __cplusplus

class DECLSPEC_UUID("CF858251-D5A2-4373-8A24-71960407B0BC")
StageTest;
#endif
#endif /* __STAGETESTLib_LIBRARY_DEFINED__ */
