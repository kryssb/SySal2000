...
/* at Thu Oct 14 13:14:47 2004
 */
/* Compiler settings for C:\Documents and Settings\Kryss\Desktop\SySal2\SySalDataIO\SySalDataIO.idl:
...
CINTERFACE_PROXY_VTABLE(8) _ISySalDataIO2ProxyVtbl = 
{
    ...
    (void *)-1 /* ISySalDataIO::Read */ ,
    (void *)-1 /* ISySalDataIO::GetStatus */ ,
    (void *)-1 /* ISySalDataIO2::Write2 */ ,
    (void *)-1 /* ISySalDataIO2::Read2 */
};
...
#ifndef _ALPHA_
/* 660 */	NdrFcShort( 0x18 ),	/* x86, MIPS, PPC Stack size/offset = 24 */
#else
			NdrFcShort( 0x30 ),	/* Alpha Stack size/offset = 48 */
#endif
/* 662 */	NdrFcShort( 0x1a ),	/* 26 */
...
/* 674 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
/* 680 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
#ifndef _ALPHA_
/* 694 */	NdrFcShort( 0x14 ),	/* x86, MIPS, PPC Stack size/offset = 20 */
#else
			NdrFcShort( 0x28 ),	/* Alpha Stack size/offset = 40 */
#endif
/* 696 */	0x8,		/* FC_LONG */
...
#ifndef _ALPHA_
/* 706 */	NdrFcShort( 0x18 ),	/* x86, MIPS, PPC Stack size/offset = 24 */
#else
			NdrFcShort( 0x30 ),	/* Alpha Stack size/offset = 48 */
#endif
...
/* 732 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
