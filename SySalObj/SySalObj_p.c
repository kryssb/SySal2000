...
/* at Sun Apr 15 20:20:37 2001
 */
/* Compiler settings for K:\SySal2\SySalObj\SySalObj.idl:
...
const CInterfaceProxyVtbl * _SySalObj_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISySalObjectProxyVtbl,
    0
};

const CInterfaceStubVtbl * _SySalObj_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ISySalObjectStubVtbl,
    0
};

PCInterfaceName const _SySalObj_InterfaceNamesList[] = 
{
    "ISySalObject",
    0
};
...
#define _SySalObj_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SySalObj, pIID, n)

int __stdcall _SySalObj_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_SySalObj_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo SySalObj_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SySalObj_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SySalObj_StubVtblList,
    (const PCInterfaceName * ) & _SySalObj_InterfaceNamesList,
    0, // no delegation
    & _SySalObj_IID_Lookup, 
    1,
    2,
