...
QueryDataInfo TSReconDataName[TSReconDataN] =
{
	...
	{"LowestPrescanPeak",		"%f",   STRUCT_OFFSET(TSReconData, LowestPrescanPeak),		"0.5"},	
	{"InPlateDPos",				"%f",   STRUCT_OFFSET(TSReconData, InPlate_D_Pos),			"10.0"},
	{"InPlateDSlope",			"%f",   STRUCT_OFFSET(TSReconData, InPlate_D_Slope),		"0.015"},
	{"InPlateGrossDPos",		"%f",	STRUCT_OFFSET(TSReconData, InPlate_Gross_D_Pos),	"10.0"},
	{"InPlateGrossDSlope",		"%f",	STRUCT_OFFSET(TSReconData, InPlate_Gross_D_Slope),	"0.03"},
	{"InPlatePosPrescan",		"%f",	STRUCT_OFFSET(TSReconData, InPlate_Pos_Prescan),	"40."},
	{"InPlateMaxIters",			"%d",	STRUCT_OFFSET(TSReconData, InPlate_MaxIters),		"5"},
	{"OffPlateDPos",			"%f",	STRUCT_OFFSET(TSReconData, OffPlate_D_Pos),			"10.0"},
	{"OffPlateDSlope",			"%f",   STRUCT_OFFSET(TSReconData, OffPlate_D_Slope),		"0.015"},
	{"OffPlateGrossDPos",		"%f",   STRUCT_OFFSET(TSReconData, OffPlate_Gross_D_Pos),	"20.0"},
	{"OffPlateGrossDSlope",		"%f",	STRUCT_OFFSET(TSReconData, OffPlate_Gross_D_Slope),	"0.03"},
	{"OffPlatePosPrescan",		"%f",	STRUCT_OFFSET(TSReconData, OffPlate_Pos_Prescan),	"100."},
	{"OffPlateMaxIters",		"%d",   STRUCT_OFFSET(TSReconData, OffPlate_MaxIters),		"7"},	
	...
	{"RequireOffPlateLinking",	"%d",   STRUCT_OFFSET(TSReconData, RequireOffPlateLinking),	"0"},
