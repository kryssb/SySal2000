...
const CInterfaceProxyVtbl * _TSReconstruct_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _TSReconstruct_StubVtblList[] = 
{
...
PCInterfaceName const _TSReconstruct_InterfaceNamesList[] = 
{
    "ISySalObject",
    "ISySalObject2",
    0
...
#define _TSReconstruct_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _TSReconstruct, pIID, n)

int __stdcall _TSReconstruct_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _TSReconstruct, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _TSReconstruct, 2, *pIndex )
    
}

const ExtendedProxyFileInfo TSReconstruct_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _TSReconstruct_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _TSReconstruct_StubVtblList,
    (const PCInterfaceName * ) & _TSReconstruct_InterfaceNamesList,
    0, // no delegation
    & _TSReconstruct_IID_Lookup, 
    2,
    2,
