...
/* Object interface: IPlateChanger, ver. 0.0,
   GUID={0x11c61d6e,0x34b8,0x4562,{0xb7,0xf5,0xd1,0x7f,0xf6,0x4d,0x85,0x6b}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IPlateChanger_ServerInfo;
...
static const unsigned short IPlateChanger_FormatStringOffsetTable[] = 
    {
    532,
    566,
    588,
...
static const MIDL_SERVER_INFO IPlateChanger_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IPlateChanger_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IPlateChanger_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IPlateChanger_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(7) _IPlateChangerProxyVtbl = 
{
    &IPlateChanger_ProxyInfo,
    &IID_IPlateChanger,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *)-1 /* IPlateChanger::LoadPlate */ ,
    (void *)-1 /* IPlateChanger::UnloadPlate */ ,
    (void *)-1 /* IPlateChanger::EnableManualControl */ ,
    (void *)-1 /* IPlateChanger::IsManualControlEnabled */
};

const CInterfaceStubVtbl _IPlateChangerStubVtbl =
{
    &IID_IPlateChanger,
    &IPlateChanger_ServerInfo,
    7,
    0, /* pure interpreted */
    CStdStubBuffer_METHODS
};
...
#ifndef _ALPHA_
/* 540 */	NdrFcShort( 0x1c ),	/* x86, MIPS, PPC Stack size/offset = 28 */
#else
			NdrFcShort( 0x28 ),	/* Alpha Stack size/offset = 40 */
#endif
/* 542 */	NdrFcShort( 0x25 ),	/* 37 */
...
/* 550 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 552 */	NdrFcShort( 0x56 ),	/* Type Offset=86 */
...
#ifndef _ALPHA_
/* 562 */	NdrFcShort( 0x18 ),	/* x86, MIPS, PPC Stack size/offset = 24 */
#else
			NdrFcShort( 0x20 ),	/* Alpha Stack size/offset = 32 */
#endif
/* 564 */	0x8,		/* FC_LONG */
...
const CInterfaceProxyVtbl * _TecnoCutPlateChanger_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IPlateChangerProxyVtbl,
    ( CInterfaceProxyVtbl *) &_ISySalObjectProxyVtbl,
    0
};

const CInterfaceStubVtbl * _TecnoCutPlateChanger_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IPlateChangerStubVtbl,
    ( CInterfaceStubVtbl *) &_ISySalObjectStubVtbl,
    0
};

PCInterfaceName const _TecnoCutPlateChanger_InterfaceNamesList[] = 
{
    "IPlateChanger",
    "ISySalObject",
    0
...
#define _TecnoCutPlateChanger_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _TecnoCutPlateChanger, pIID, n)

int __stdcall _TecnoCutPlateChanger_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _TecnoCutPlateChanger, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _TecnoCutPlateChanger, 2, *pIndex )
    
}

const ExtendedProxyFileInfo TecnoCutPlateChanger_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _TecnoCutPlateChanger_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _TecnoCutPlateChanger_StubVtblList,
    (const PCInterfaceName * ) & _TecnoCutPlateChanger_InterfaceNamesList,
    0, // no delegation
    & _TecnoCutPlateChanger_IID_Lookup, 
    2,
    2,
