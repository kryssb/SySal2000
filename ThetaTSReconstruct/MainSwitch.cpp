...
BEGIN_MESSAGE_MAP(CMainSwitch, CDialog)
	...
	ON_BN_CLICKED(IDC_MS_INTERACTIVE, OnInteractive)
	ON_BN_CLICKED(IDC_MS_BATCH, OnBatch)
...
void CMainSwitch::OnInteractive() 
{
	// TODO: Add your control notification handler code here
	m_Selection = MS_SEL_INTERACTIVE;
	OnCancel();	
}

void CMainSwitch::OnBatch() 
{
	// TODO: Add your control notification handler code here
	m_Selection = MS_SEL_BATCH;
	OnCancel();	
}
