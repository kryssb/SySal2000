...
/* at Tue Jun 18 10:22:52 2002
 */
/* Compiler settings for D:\SySal2\Thick3DTracker\Thick3DTracker.idl:
...
const CInterfaceProxyVtbl * _Thick3DTracker_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _Thick3DTracker_StubVtblList[] = 
{
...
PCInterfaceName const _Thick3DTracker_InterfaceNamesList[] = 
{
    "ITracker2",
    "ITracker",
    "ISySalObject",
...
#define _Thick3DTracker_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Thick3DTracker, pIID, n)

int __stdcall _Thick3DTracker_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _Thick3DTracker, 3, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _Thick3DTracker, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _Thick3DTracker, 3, *pIndex )
    
}

const ExtendedProxyFileInfo Thick3DTracker_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Thick3DTracker_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Thick3DTracker_StubVtblList,
    (const PCInterfaceName * ) & _Thick3DTracker_InterfaceNamesList,
    0, // no delegation
    & _Thick3DTracker_IID_Lookup, 
    3,
    2,
