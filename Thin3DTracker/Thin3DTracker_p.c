...
int __stdcall _Thin3DTracker_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( _Thin3DTracker, 4, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _Thin3DTracker, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _Thin3DTracker, 4, *pIndex )
