...
CINTERFACE_PROXY_VTABLE(13) _ITrackFitter3ProxyVtbl = 
{
    ...
    (void *)-1 /* ITrackFitter2::Fit2 */ ,
    (void *)-1 /* ITrackFitter2::Correct2 */ ,
    (void *)-1 /* ITrackFitter3::Fit3 */ ,
    (void *)-1 /* ITrackFitter3::Correct3 */
};
...
/* 840 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 842 */	NdrFcShort( 0xde ),	/* Type Offset=222 */

	/* Parameter pMaxNumber */

/* 844 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
...
#ifndef _ALPHA_
/* 858 */	NdrFcShort( 0x10 ),	/* x86, MIPS, PPC Stack size/offset = 16 */
#else
			NdrFcShort( 0x20 ),	/* Alpha Stack size/offset = 32 */
#endif
/* 860 */	0xa,		/* FC_FLOAT */
...
#ifndef _ALPHA_
/* 864 */	NdrFcShort( 0x14 ),	/* x86, MIPS, PPC Stack size/offset = 20 */
#else
			NdrFcShort( 0x28 ),	/* Alpha Stack size/offset = 40 */
#endif
/* 866 */	0x8,		/* FC_LONG */
...
/* 882 */	0x6,		/* Oi2 Flags:  clt must size, has return, */
			0x2,		/* 2 */
...
/* 886 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 888 */	NdrFcShort( 0xde ),	/* Type Offset=222 */
...
/* 208 */	
			0x11, 0x0,	/* FC_RP */
/* 210 */	NdrFcShort( 0xc ),	/* Offset= 12 (222) */
/* 212 */	
			0x15,		/* FC_STRUCT */
			0x3,		/* 3 */
...
/* 222 */	
			0x1a,		/* FC_BOGUS_STRUCT */
			0x3,		/* 3 */
/* 224 */	NdrFcShort( 0x3c ),	/* 60 */
/* 226 */	NdrFcShort( 0x0 ),	/* 0 */
/* 228 */	NdrFcShort( 0x16 ),	/* Offset= 22 (250) */
/* 230 */	0x8,		/* FC_LONG */
			0x8,		/* FC_LONG */
/* 232 */	0x8,		/* FC_LONG */
			0x36,		/* FC_POINTER */
/* 234 */	0x36,		/* FC_POINTER */
			0x4c,		/* FC_EMBEDDED_COMPLEX */
/* 236 */	0x0,		/* 0 */
			NdrFcShort( 0xffffff67 ),	/* Offset= -153 (84) */
			0x4c,		/* FC_EMBEDDED_COMPLEX */
/* 240 */	0x0,		/* 0 */
			NdrFcShort( 0xffffff63 ),	/* Offset= -157 (84) */
			0xa,		/* FC_FLOAT */
/* 244 */	0xa,		/* FC_FLOAT */
			0xa,		/* FC_FLOAT */
/* 246 */	0x3,		/* FC_SMALL */
...
/* 250 */	
			0x12, 0x0,	/* FC_UP */
/* 252 */	NdrFcShort( 0xffffffd8 ),	/* Offset= -40 (212) */
/* 254 */	
			0x12, 0x8,	/* FC_UP [simple_pointer] */
/* 256 */	0x2,		/* FC_CHAR */
			0x5c,		/* FC_PAD */
...
const CInterfaceProxyVtbl * _TrackFitter2_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _TrackFitter2_StubVtblList[] = 
{
...
PCInterfaceName const _TrackFitter2_InterfaceNamesList[] = 
{
    "ITrackFitter2",
    "ITrackFitter",
    "ISySalObject",
...
#define _TrackFitter2_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _TrackFitter2, pIID, n)

int __stdcall _TrackFitter2_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _TrackFitter2, 4, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _TrackFitter2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _TrackFitter2, 4, *pIndex )
    
}

const ExtendedProxyFileInfo TrackFitter2_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _TrackFitter2_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _TrackFitter2_StubVtblList,
    (const PCInterfaceName * ) & _TrackFitter2_InterfaceNamesList,
    0, // no delegation
    & _TrackFitter2_IID_Lookup, 
    4,
    2,
