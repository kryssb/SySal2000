...
/* at Wed Apr 09 10:51:44 2003
 */
/* Compiler settings for D:\SySal2\SmartTracker4\SmartTracker.idl:
...
const CInterfaceProxyVtbl * _SmartTracker_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _SmartTracker_StubVtblList[] = 
{
...
PCInterfaceName const _SmartTracker_InterfaceNamesList[] = 
{
    "ITracker2",
    "ITracker",
    "ITracker3",
...
#define _SmartTracker_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SmartTracker, pIID, n)

int __stdcall _SmartTracker_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _SmartTracker, 4, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _SmartTracker, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _SmartTracker, 4, *pIndex )
    
}

const ExtendedProxyFileInfo SmartTracker_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SmartTracker_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SmartTracker_StubVtblList,
    (const PCInterfaceName * ) & _SmartTracker_InterfaceNamesList,
    0, // no delegation
    & _SmartTracker_IID_Lookup, 
    4,
    2,
