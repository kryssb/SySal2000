...
extern const MIDL_SERVER_INFO IDAQSynchronize_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IDAQSynchronize_ProxyInfo;
...
/* 826 */	NdrFcShort( 0x5a ),	/* Type Offset=90 */
...
/* 862 */	NdrFcShort( 0x6e ),	/* Type Offset=110 */
...
/* 894 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
...
/* Object interface: IDAQSynchronize, ver. 0.0,
   GUID={0xb1785d91,0x3ecf,0x403b,{0xbb,0xe9,0x3b,0x14,0xcb,0x80,0x66,0x17}} */

#pragma code_seg(".orpc")
static const unsigned short IDAQSynchronize_FormatStringOffsetTable[] =
    {
    870
    };

static const MIDL_STUBLESS_PROXY_INFO IDAQSynchronize_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IDAQSynchronize_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IDAQSynchronize_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(4) _IDAQSynchronizeProxyVtbl = 
{
    &IDAQSynchronize_ProxyInfo,
    &IID_IDAQSynchronize,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* IDAQSynchronize::IsSyncEnabled */
};

const CInterfaceStubVtbl _IDAQSynchronizeStubVtbl =
{
    &IID_IDAQSynchronize,
    &IDAQSynchronize_ServerInfo,
    4,
    0, /* pure interpreted */
    CStdStubBuffer_METHODS
};
...
#define _VertigoScan7_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _VertigoScan7, pIID, n)

int __stdcall _VertigoScan7_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _VertigoScan7, 4, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _VertigoScan7, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _VertigoScan7, 4, *pIndex )
    
}

const ExtendedProxyFileInfo VertigoScan7_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _VertigoScan7_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _VertigoScan7_StubVtblList,
    (const PCInterfaceName * ) & _VertigoScan7_InterfaceNamesList,
    0, // no delegation
    & _VertigoScan7_IID_Lookup, 
    4,
    2,
