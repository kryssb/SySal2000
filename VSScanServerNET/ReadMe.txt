========================================================================
    ACTIVE TEMPLATE LIBRARY : VSScanServer Project Overview
========================================================================

AppWizard has created this VSScanServer project for you to use as the starting point for
...
_VSScanServer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_VSScanServer.h)
        GUID definitions                                (_VSScanServer_i.c)
        A type library                                  (_VSScanServer.tlb)
        Marshaling code                                 (_VSScanServer_p.c and dlldata.c)
VSScanServer.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named VSScanServer.pch and a precompiled types file named StdAfx.obj.
...
VSScanServerps.vcproj
	...
	dlldata.c, VSScanServer_i.c and VSScanServer_p.c which are required
