...
/* at Sun Sep 29 15:41:38 2002
 */
/* Compiler settings for VSScanServer.idl:
...
const CInterfaceProxyVtbl * _VSScanServer_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _VSScanServer_StubVtblList[] = 
{
...
PCInterfaceName const _VSScanServer_InterfaceNamesList[] = 
{
    "ISySalObject",
    "IScanServer",
    0
...
#define _VSScanServer_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _VSScanServer, pIID, n)

int __stdcall _VSScanServer_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _VSScanServer, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _VSScanServer, 2, *pIndex )
    
}

const ExtendedProxyFileInfo VSScanServer_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _VSScanServer_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _VSScanServer_StubVtblList,
    (const PCInterfaceName * ) & _VSScanServer_InterfaceNamesList,
    0, // no delegation
    & _VSScanServer_IID_Lookup, 
    2,
    2,
