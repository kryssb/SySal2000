...
// Construction
public:
	CScan(HWND *phwnd, ISySalObject *iself, ISySalDataIO2 *iio, IStage *ist,
		...
		bool *pFragmentResumeList = 0, char *forcedname = 0, bool remotescan = false, float autozreset = 0.0f);   // standard constructor
...
private:
	...
	struct t_FocusData
	{
		VS_View2::t_RelevantZs2 RelevantZs;
