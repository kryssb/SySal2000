// VertigoScan2Class.cpp : Implementation of CVertigoScan2Class
...
/////////////////////////////////////////////////////////////////////////////
// CVertigoScan2Class
CVertigoScan2Class::CVertigoScan2Class()
{
	CMI.Context = 0;
	CMI.pSaveConfig = 0;
	CMI.pLoadConfig = 0;
...
STDMETHODIMP CVertigoScan2Class::SetName(ConnectionName name)
{
...
STDMETHODIMP CVertigoScan2Class::GetName(ConnectionName name)
{
	// TODO: Add your implementation code here
	strncpy(name, Name, SYSAL_MAX_CONN_NAME_LEN);
	return S_OK;
...
STDMETHODIMP CVertigoScan2Class::SetConfig(SySalConfig *pConfig)
{
	// TODO: Add your implementation code here
	int i;
...
STDMETHODIMP CVertigoScan2Class::GetConfig(SySalConfig *pConfig)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::EditConfig(SySalConfig *pConfig, HSySalHANDLE hWnd)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::EnableMonitor(boolean bEnable)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::GetNumberOfConnections(int *pNumber)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::SetConnection(int n, SySalConnection connection)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::GetConnection(int n, SySalConnection *pConnection)
{
	// TODO: Add your implementation code here
	if (n < 0 || n >= NUMBER_OF_SLOTS) return E_INVALIDARG;
	*pConnection = Slots[n];	
...
STDMETHODIMP CVertigoScan2Class::GetIcon(int n, HSySalHICON *pHICON)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::GetClassName(ConnectionName name)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::SyncExec()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::AsyncExec(HSySalHANDLE HNotifyStatusChangeEvent)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::AsyncCheckStatus(long *pStatus)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::AsyncWait()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::AsyncPause()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::AsyncStop()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::AsyncResume()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan2Class::IsReady(long *pWrongConn, long *pRetCode)
{
	// TODO: Add your implementation code here
	...
	try
	{
		...
		{
			ITrackFitter3 *iFt1;
			if (Slots[3].pUnknown->QueryInterface(IID_ITrackFitter2, (void **)&iFt1) == S_OK) iFt1->Release();
			else throw 3;
			}
		else throw 3;
		if (Slots[4].pUnknown)
		{
			ITracker3 *iTk2;
			if (Slots[4].pUnknown->QueryInterface(IID_ITracker3, (void **)&iTk2) == S_OK) iTk2->Release();
			else throw 4;
			}
		else throw 4;
		if (Slots[5].pUnknown)
		{
			ITrackFitter3 *iFt2;
			if (Slots[5].pUnknown->QueryInterface(IID_ITrackFitter2, (void **)&iFt2) == S_OK) iFt2->Release();
			else throw 5;
			}
		else throw 5;
		if (Slots[6].pUnknown)
...
// ISySalObject2
STDMETHODIMP CVertigoScan2Class::SetConfigManagerInterface(ConfigManagerInterface *pCMI)
{
	CMI = *pCMI;
	return S_OK;
}

STDMETHODIMP CVertigoScan2Class::GetCLSID(CLSID *pCLSID)
{
	*pCLSID = CLSID_VertigoScan2;
	return S_OK;	
}

UINT WINAPI CVertigoScan2Class::AsyncExecHook(void *pOwner)
{
	return ((CVertigoScan2Class *)pOwner)->AsyncExec();
}

UINT CVertigoScan2Class::AsyncExec()
{
			...
			case MS_SEL_SCAN:		
									{
										...
										if (ScanStart.DoModal() == IDOK)
										{
											...
											else
											{
												...
												int RecCount, i;
												if (iIO->Read2(NULL, (BYTE *)(&pCat), &ExtErrInfo, (UCHAR *)ScanStart.m_Catalog.GetBuffer(1)) != S_OK)
												{
										...
										while (Continue && (CommDlg.DoModal() == IDOK))
										{
											switch (CommDlg.M.M.OpCode)
											{
												case SCANSRV_SCAN_ZONE_START:	
													{
														if (!ZSet)
														{
															...
															ExecLoadPlate(&AutoZReset, iSt, Id, 0);
															ZSet = true;
															};
												...
												case SCANSRV_LOAD_PLATE:
													{
														ZSet = ReturnValue = ExecLoadPlate(&AutoZReset, iSt, CommDlg.M.LS.Id, CommDlg.M.LS.TextId);
														};
													break;

												case SCANSRV_UNLOAD_PLATE:
													{
														ReturnValue = ExecUnloadPlate(iSt);
														};
													break;
...
bool CVertigoScan2Class::ExecLoadPlate(float *pAutoZReset, IStage *iSt, Identifier id, char *textid)
{
...
bool CVertigoScan2Class::ExecUnloadPlate(IStage *iSt)
{
	ISySalObject *iStOb = 0;
	iSt->QueryInterface(IID_ISySalObject, (void **)&iStOb);
	iSt->Stop(0);
	...
	UINT Ret = MessageBox(0, "Please unload the plate from the stage.", "Help Request", MB_ICONINFORMATION | MB_OKCANCEL);
