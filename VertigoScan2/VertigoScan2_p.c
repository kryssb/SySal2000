...
const CInterfaceProxyVtbl * _VertigoScan2_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _VertigoScan2_StubVtblList[] = 
{
...
PCInterfaceName const _VertigoScan2_InterfaceNamesList[] = 
{
    "ISySalObject",
    "ISySalObject2",
    0
...
#define _VertigoScan2_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _VertigoScan2, pIID, n)

int __stdcall _VertigoScan2_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _VertigoScan2, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _VertigoScan2, 2, *pIndex )
    
}

const ExtendedProxyFileInfo VertigoScan2_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _VertigoScan2_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _VertigoScan2_StubVtblList,
    (const PCInterfaceName * ) & _VertigoScan2_InterfaceNamesList,
    0, // no delegation
    & _VertigoScan2_IID_Lookup, 
    2,
    2,
