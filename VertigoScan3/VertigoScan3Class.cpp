// VertigoScan3Class.cpp : Implementation of CVertigoScan3Class

#define USE_MIDL_INCOMPATIBLE_STRUCTS

#include "stdafx.h"
#include "VertigoScan3.h"
#include "VertigoScan3Class.h"
#include "ums.h"
#include "Fitter.h"
...
/////////////////////////////////////////////////////////////////////////////
// CVertigoScan3Class
CVertigoScan3Class::CVertigoScan3Class()
{
	CMI.Context = 0;
	CMI.pSaveConfig = 0;
	CMI.pLoadConfig = 0;
...
STDMETHODIMP CVertigoScan3Class::SetName(ConnectionName name)
{
...
STDMETHODIMP CVertigoScan3Class::GetName(ConnectionName name)
{
	// TODO: Add your implementation code here
	strncpy(name, Name, SYSAL_MAX_CONN_NAME_LEN);
	return S_OK;
...
STDMETHODIMP CVertigoScan3Class::SetConfig(SySalConfig *pConfig)
{
	// TODO: Add your implementation code here
	int i;
...
STDMETHODIMP CVertigoScan3Class::GetConfig(SySalConfig *pConfig)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::EditConfig(SySalConfig *pConfig, HSySalHANDLE hWnd)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::EnableMonitor(boolean bEnable)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::GetNumberOfConnections(int *pNumber)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::SetConnection(int n, SySalConnection connection)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::GetConnection(int n, SySalConnection *pConnection)
{
	// TODO: Add your implementation code here
	if (n < 0 || n >= NUMBER_OF_SLOTS) return E_INVALIDARG;
	*pConnection = Slots[n];	
...
STDMETHODIMP CVertigoScan3Class::GetIcon(int n, HSySalHICON *pHICON)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::GetClassName(ConnectionName name)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::SyncExec()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::AsyncExec(HSySalHANDLE HNotifyStatusChangeEvent)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::AsyncCheckStatus(long *pStatus)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::AsyncWait()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::AsyncPause()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::AsyncStop()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::AsyncResume()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan3Class::IsReady(long *pWrongConn, long *pRetCode)
{
	// TODO: Add your implementation code here
...
// ISySalObject2
STDMETHODIMP CVertigoScan3Class::SetConfigManagerInterface(ConfigManagerInterface *pCMI)
{
	CMI = *pCMI;
	return S_OK;
}

STDMETHODIMP CVertigoScan3Class::GetCLSID(CLSID *pCLSID)
{
	*pCLSID = CLSID_VertigoScan3;
	return S_OK;	
}

UINT WINAPI CVertigoScan3Class::AsyncExecHook(void *pOwner)
{
	return ((CVertigoScan3Class *)pOwner)->AsyncExec();
}

UINT CVertigoScan3Class::AsyncExec()
{
...
bool CVertigoScan3Class::ExecLoadPlate(float *pAutoZReset, IStage *iSt, Identifier id, char *textid)
{
...
bool CVertigoScan3Class::ExecUnloadPlate(IStage *iSt)
{
	ISySalObject *iStOb = 0;
	iSt->QueryInterface(IID_ISySalObject, (void **)&iStOb);
	iSt->Stop(0);
...
bool CVertigoScan3Class::ExecSetParam(char *objname, char *paramname, char *paramvalue)
{
	int i, j;
	for (i = 0; i < NUMBER_OF_SLOTS; i++)
	{
