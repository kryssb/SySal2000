...
/* at Mon Feb 21 13:09:05 2005
 */
/* Compiler settings for C:\sysal2000\VertigoScan3_plus_singleview\VertigoScan3.idl:
...
const CInterfaceProxyVtbl * _VertigoScan3_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _VertigoScan3_StubVtblList[] = 
{
...
PCInterfaceName const _VertigoScan3_InterfaceNamesList[] = 
{
    "ISySalObject",
    "ISySalObject2",
    0
...
#define _VertigoScan3_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _VertigoScan3, pIID, n)

int __stdcall _VertigoScan3_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _VertigoScan3, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _VertigoScan3, 2, *pIndex )
    
}

const ExtendedProxyFileInfo VertigoScan3_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _VertigoScan3_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _VertigoScan3_StubVtblList,
    (const PCInterfaceName * ) & _VertigoScan3_InterfaceNamesList,
    0, // no delegation
    & _VertigoScan3_IID_Lookup, 
    2,
    2,
