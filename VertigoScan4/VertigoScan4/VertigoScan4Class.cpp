// VertigoScan4Class.cpp : Implementation of CVertigoScan4Class
...
/////////////////////////////////////////////////////////////////////////////
// CVertigoScan4Class
CVertigoScan4Class::CVertigoScan4Class()
{
	CMI.Context = 0;
	CMI.pSaveConfig = 0;
	CMI.pLoadConfig = 0;
...
STDMETHODIMP CVertigoScan4Class::SetName(ConnectionName name)
{
...
STDMETHODIMP CVertigoScan4Class::GetName(ConnectionName name)
{
	// TODO: Add your implementation code here
	strncpy(name, Name, SYSAL_MAX_CONN_NAME_LEN);
	return S_OK;
...
STDMETHODIMP CVertigoScan4Class::SetConfig(SySalConfig *pConfig)
{
	// TODO: Add your implementation code here
	int i;
...
STDMETHODIMP CVertigoScan4Class::GetConfig(SySalConfig *pConfig)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan4Class::EditConfig(SySalConfig *pConfig, HSySalHANDLE hWnd)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan4Class::EnableMonitor(boolean bEnable)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan4Class::GetNumberOfConnections(int *pNumber)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan4Class::SetConnection(int n, SySalConnection connection)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan4Class::GetConnection(int n, SySalConnection *pConnection)
{
	// TODO: Add your implementation code here
	if (n < 0 || n >= NUMBER_OF_SLOTS) return E_INVALIDARG;
	*pConnection = Slots[n];	
...
STDMETHODIMP CVertigoScan4Class::GetIcon(int n, HSySalHICON *pHICON)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan4Class::GetClassName(ConnectionName name)
{
	// TODO: Add your implementation code here
	
	strncpy(name, "Vertigo Scan 4", SYSAL_MAX_CONN_NAME_LEN);
	return S_OK;
}

STDMETHODIMP CVertigoScan4Class::SyncExec()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan4Class::AsyncExec(HSySalHANDLE HNotifyStatusChangeEvent)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan4Class::AsyncCheckStatus(long *pStatus)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan4Class::AsyncWait()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan4Class::AsyncPause()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan4Class::AsyncStop()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan4Class::AsyncResume()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan4Class::IsReady(long *pWrongConn, long *pRetCode)
{
	// TODO: Add your implementation code here
...
// ISySalObject2
STDMETHODIMP CVertigoScan4Class::SetConfigManagerInterface(ConfigManagerInterface *pCMI)
{
	CMI = *pCMI;
	return S_OK;
}

STDMETHODIMP CVertigoScan4Class::GetCLSID(CLSID *pCLSID)
{
	*pCLSID = CLSID_VertigoScan4;
	return S_OK;	
}

UINT WINAPI CVertigoScan4Class::AsyncExecHook(void *pOwner)
{
	return ((CVertigoScan4Class *)pOwner)->AsyncExec();
}

UINT CVertigoScan4Class::AsyncExec()
{
...
//								CommDlg.M.ZS.Id, CommDlg.M.ZS.MinX, CommDlg.M.ZS.MaxX, CommDlg.M.ZS.MinY, CommDlg.M.ZS.MaxY, 0, 0, CommDlg.M.ZS.OutName, true, AutoZReset, TrustZ);
					...
					case SCANSRV_LOAD_PLATE:
						{
							...
							if (ExecLoadPlate(&AutoZReset, iSt, CommDlg.M.LS.Id, CommDlg.M.LS.TextId))
							{
					...
					case SCANSRV_UNLOAD_PLATE:
						{
							if (ReturnValue = ExecUnloadPlate(iSt))
							{
							...
							case SCANSRV_SCAN_ZONE_START:	
								{
									if (!ZSet)
									{
										...
										if (ExecLoadPlate(&AutoZReset, iSt, Id, 0))
										{
											pmsg.Loaded = true;
											pmsg.PlateId = Id;
											ZSet = true;
							...
							case SCANSRV_LOAD_PLATE:
								{
									...
									if (pmsg.Loaded = ZSet = ReturnValue = ExecLoadPlate(&AutoZReset, iSt, CommDlg.M.LS.Id, CommDlg.M.LS.TextId))
										pmsg.PlateId = CommDlg.M.LS.Id;
...
bool CVertigoScan4Class::ExecLoadPlate(float *pAutoZReset, IStage *iSt, Identifier id, char *textid)
{
...
bool CVertigoScan4Class::ExecUnloadPlate(IStage *iSt)
{
	ISySalObject *iStOb = 0;
	iSt->QueryInterface(IID_ISySalObject, (void **)&iStOb);
	iSt->Stop(0);
...
bool CVertigoScan4Class::ExecSetParam(char *objname, char *paramname, char *paramvalue)
{
	int i, j;
	for (i = 0; i < NUMBER_OF_SLOTS; i++)
	{
