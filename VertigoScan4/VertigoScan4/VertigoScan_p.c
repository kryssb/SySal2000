...
const CInterfaceProxyVtbl * _VertigoScan_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _VertigoScan_StubVtblList[] = 
{
...
PCInterfaceName const _VertigoScan_InterfaceNamesList[] = 
{
    "ISySalObject",
    "ISySalObject2",
    0
...
#define _VertigoScan_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _VertigoScan, pIID, n)

int __stdcall _VertigoScan_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _VertigoScan, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _VertigoScan, 2, *pIndex )
    
}

const ExtendedProxyFileInfo VertigoScan_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _VertigoScan_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _VertigoScan_StubVtblList,
    (const PCInterfaceName * ) & _VertigoScan_InterfaceNamesList,
    0, // no delegation
    & _VertigoScan_IID_Lookup, 
    2,
    2,
