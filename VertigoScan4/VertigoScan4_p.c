...
/* at Thu Jul 21 20:34:17 2005
 */
/* Compiler settings for D:\SySal2\VertigoScan4\VertigoScan4.idl:
...
const CInterfaceProxyVtbl * _VertigoScan4_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _VertigoScan4_StubVtblList[] = 
{
...
PCInterfaceName const _VertigoScan4_InterfaceNamesList[] = 
{
    "ISySalObject",
    "ISySalObject2",
    0
...
#define _VertigoScan4_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _VertigoScan4, pIID, n)

int __stdcall _VertigoScan4_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _VertigoScan4, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _VertigoScan4, 2, *pIndex )
    
}

const ExtendedProxyFileInfo VertigoScan4_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _VertigoScan4_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _VertigoScan4_StubVtblList,
    (const PCInterfaceName * ) & _VertigoScan4_InterfaceNamesList,
    0, // no delegation
    & _VertigoScan4_IID_Lookup, 
    2,
    2,
