...
/* at Wed Oct 17 10:28:52 2007
 */
/* Compiler settings for D:\SySal2\VertigoScan5.3\VertigoScan5.idl:
...
int __stdcall _VertigoScan5_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( _VertigoScan5, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _VertigoScan5, 2, *pIndex )
