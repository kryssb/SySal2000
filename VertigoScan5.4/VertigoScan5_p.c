 ...
 */
/* Compiler settings for D:\SySal2\VertigoScan5.4\VertigoScan5.idl:
...
CINTERFACE_PROXY_VTABLE(4) _IDAQSynchronizeProxyVtbl = 
{
    ...
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *)-1 /* IDAQSynchronize::IsSyncEnabled */
};
...
const CInterfaceProxyVtbl * _VertigoScan5_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _VertigoScan5_StubVtblList[] = 
{
...
PCInterfaceName const _VertigoScan5_InterfaceNamesList[] = 
{
    "IDAQSynchronize",
    "ISySalObject",
    "ISySalObject2",
...
#define _VertigoScan5_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _VertigoScan5, pIID, n)

int __stdcall _VertigoScan5_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _VertigoScan5, 3, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _VertigoScan5, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _VertigoScan5, 3, *pIndex )
    
}

const ExtendedProxyFileInfo VertigoScan5_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _VertigoScan5_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _VertigoScan5_StubVtblList,
    (const PCInterfaceName * ) & _VertigoScan5_InterfaceNamesList,
    0, // no delegation
    & _VertigoScan5_IID_Lookup, 
    3,
    2,
