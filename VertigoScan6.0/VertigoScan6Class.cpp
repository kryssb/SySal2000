// VertigoScan6Class.cpp : Implementation of CVertigoScan6Class
...
QueryDataInfo ConfigDataName[ConfigDataN] =
{
	...
	{"EnableScanGrid",			"%d",   STRUCT_OFFSET(ConfigData, EnableScanGrid),			"1"},
	{"SaveGrains",				"%d",   STRUCT_OFFSET(ConfigData, SaveGrains),				"0"},
	{"FocusOffset",				"%f",   STRUCT_OFFSET(ConfigData, FocusOffset),				"0.0"}
	};

/////////////////////////////////////////////////////////////////////////////
// CVertigoScan6Class

CVertigoScan6Class::CVertigoScan6Class()
{
	CMI.Context = 0;
	CMI.pSaveConfig = 0;
	CMI.pLoadConfig = 0;
...
STDMETHODIMP CVertigoScan6Class::SetName(ConnectionName name)
{
...
STDMETHODIMP CVertigoScan6Class::GetName(ConnectionName name)
{
	// TODO: Add your implementation code here
	strncpy(name, Name, SYSAL_MAX_CONN_NAME_LEN);
	return S_OK;
...
STDMETHODIMP CVertigoScan6Class::SetConfig(SySalConfig *pConfig)
{
	// TODO: Add your implementation code here
	int i;
...
STDMETHODIMP CVertigoScan6Class::GetConfig(SySalConfig *pConfig)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::EditConfig(SySalConfig *pConfig, HSySalHANDLE hWnd)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::EnableMonitor(boolean bEnable)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::GetNumberOfConnections(int *pNumber)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::SetConnection(int n, SySalConnection connection)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::GetConnection(int n, SySalConnection *pConnection)
{
	// TODO: Add your implementation code here
	if (n < 0 || n >= NUMBER_OF_SLOTS) return E_INVALIDARG;
	*pConnection = Slots[n];	
...
STDMETHODIMP CVertigoScan6Class::GetIcon(int n, HSySalHICON *pHICON)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::GetClassName(ConnectionName name)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::SyncExec()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::AsyncExec(HSySalHANDLE HNotifyStatusChangeEvent)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::AsyncCheckStatus(long *pStatus)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::AsyncWait()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::AsyncPause()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::AsyncStop()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::AsyncResume()
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVertigoScan6Class::IsReady(long *pWrongConn, long *pRetCode)
{
	// TODO: Add your implementation code here
...
// ISySalObject2
STDMETHODIMP CVertigoScan6Class::SetConfigManagerInterface(ConfigManagerInterface *pCMI)
{
	CMI = *pCMI;
	return S_OK;
}

STDMETHODIMP CVertigoScan6Class::GetCLSID(CLSID *pCLSID)
{
	*pCLSID = CLSID_VertigoScan6;
	return S_OK;	
}

UINT WINAPI CVertigoScan6Class::AsyncExecHook(void *pOwner)
{
	return ((CVertigoScan6Class *)pOwner)->AsyncExec();
}

UINT CVertigoScan6Class::AsyncExec()
{
...
#endif				
				&m_hDefWnd, (ISySalObject *)this, iIO, iSt, iOb, iFG, iVP, iTk1, iFt1, iTk2, iFt2, iSM, C, 0, AutoZReset, TrustZ);
...
//								CommDlg.M.ZS.Id, CommDlg.M.ZS.MinX, CommDlg.M.ZS.MaxX, CommDlg.M.ZS.MinY, CommDlg.M.ZS.MaxY, 0, 0, CommDlg.M.ZS.OutName, true, AutoZReset, TrustZ);
							...
							else if (CommDlg.M.M.OpCode == SCANSRV_SCAN_ZONE_START_PRELOAD_NEXT_SLOPE_PRESET)
								Scan.PreloadNext(CommDlg.M.ZSPNPS.NextMinX, CommDlg.M.ZSPNPS.NextMinY, CommDlg.M.ZSPNPS.NextMaxX, CommDlg.M.ZSPNPS.NextMaxY);
							...
							switch (CommDlg.M.M.OpCode)
							{
								case SCANSRV_SCAN_ZONE_START: Ret = Scan.ResetAndScan(CommDlg.M.ZS.Id, CommDlg.M.ZS.MinX, CommDlg.M.ZS.MaxX, CommDlg.M.ZS.MinY, CommDlg.M.ZS.MaxY, 0, CommDlg.M.ZS.OutName, TrustZ); break;
								case SCANSRV_SCAN_ZONE_START_PRELOAD_NEXT: Ret = Scan.ResetAndScan(CommDlg.M.ZSPN.Id, CommDlg.M.ZSPN.MinX, CommDlg.M.ZSPN.MaxX, CommDlg.M.ZSPN.MinY, CommDlg.M.ZSPN.MaxY, 0, CommDlg.M.ZSPN.OutName, TrustZ); break;
								case SCANSRV_SCAN_ZONE_START_SLOPE_PRESET: Ret = Scan.ResetAndScan(CommDlg.M.ZSPS.Id, CommDlg.M.ZSPS.MinX, CommDlg.M.ZSPS.MaxX, CommDlg.M.ZSPS.MinY, CommDlg.M.ZSPS.MaxY, 0, CommDlg.M.ZSPS.OutName, TrustZ, true, CommDlg.M.ZSPS.SlopeX / C.Shrinkage, CommDlg.M.ZSPS.SlopeY / C.Shrinkage, CommDlg.M.ZSPS.SlopeAccX / C.Shrinkage, CommDlg.M.ZSPS.SlopeAccY / C.Shrinkage); break;
								case SCANSRV_SCAN_ZONE_START_PRELOAD_NEXT_SLOPE_PRESET: Ret = Scan.ResetAndScan(CommDlg.M.ZSPNPS.Id, CommDlg.M.ZSPNPS.MinX, CommDlg.M.ZSPNPS.MaxX, CommDlg.M.ZSPNPS.MinY, CommDlg.M.ZSPNPS.MaxY, 0, CommDlg.M.ZSPNPS.OutName, TrustZ, true, CommDlg.M.ZSPNPS.SlopeX / C.Shrinkage, CommDlg.M.ZSPNPS.SlopeY / C.Shrinkage, CommDlg.M.ZSPNPS.SlopeAccX / C.Shrinkage, CommDlg.M.ZSPNPS.SlopeAccY / C.Shrinkage); break;
								}
							DUMPTIME(-14);
				...
				case MS_SEL_SCAN:		
					{
						...
						if (ScanStart.DoModal() == IDOK)
						{
							...
							CScan Scan(
								...
								C.EnableScanGrid ? TkClient : nullptr, 
#endif								
								&m_hDefWnd, (ISySalObject *)this, iIO, iSt, iOb, iFG, iVP, iTk1, iFt1, iTk2, iFt2, iSM, C, 
								Id, ScanStart.m_MinX, ScanStart.m_MaxX, ScanStart.m_MinY, ScanStart.m_MaxY, ScanStart.m_EnableSlopePreset, 
...
bool CVertigoScan6Class::ExecLoadPlate(float *pAutoZReset, IStage *iSt, IPlateChanger *iPc, Identifier id, char *textid)
{
...
bool CVertigoScan6Class::ExecUnloadPlate(IStage *iSt, IPlateChanger *iPc)
{
	ISySalObject *iStOb = 0;
	iSt->QueryInterface(IID_ISySalObject, (void **)&iStOb);
	iSt->Stop(0);
...
bool CVertigoScan6Class::ExecSetParam(char *objname, char *paramname, char *paramvalue)
{
	int i, j;
	ISySalObject *iOb = 0;
...
STDMETHODIMP CVertigoScan6Class::IsSyncEnabled(boolean *pbIsEnabled)
{
	*pbIsEnabled = false;
	return S_OK;
}
