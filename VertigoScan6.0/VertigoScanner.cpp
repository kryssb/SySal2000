...
/*	
				if ((s == 0) && (fabs(Frag.Fragment.pViews[f].Layers[s].pLayerInfo[lastlayer].Z - Frag.Fragment.pViews[f].Layers[s].pLayerInfo[firstlayer].Z) > 80.0f))
				{
					::MessageBox(0, "mad Z found", "Debug Info", MB_OK);
					}
*/
