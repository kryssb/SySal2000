...
public:
	...
	CSelectField(void (*papply)(void *, bool), void *pcontext, IO_VS_Fragment2 *pfrag, CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	...
	int		m_XField;
	int		m_YField;
	BOOL	m_ShowMicrotrackExtrapolations;
	//}}AFX_DATA
