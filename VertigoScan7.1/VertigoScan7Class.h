...
private:
	...
	bool ExecTakeImages(IStage2 *iSt, IFrameGrabber *iFG, ISheetMap *iSM, const char *outpath, float px, float py, float sbsx, float sbsy, Identifier id);
	bool ExecGetFogThickness(IStage2 *iSt, IFrameGrabber *iFG, IPlateChanger2 *iPC2, SySal::DAQSystem::Scanning::PlateQuality::FogThicknessSet &fgthks, float &zreference);
