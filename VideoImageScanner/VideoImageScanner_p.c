...
const CInterfaceProxyVtbl * _VideoImageScanner_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISySalObjectProxyVtbl,
    0
};

const CInterfaceStubVtbl * _VideoImageScanner_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ISySalObjectStubVtbl,
    0
};

PCInterfaceName const _VideoImageScanner_InterfaceNamesList[] = 
{
    "ISySalObject",
    0
};
...
#define _VideoImageScanner_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _VideoImageScanner, pIID, n)

int __stdcall _VideoImageScanner_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_VideoImageScanner_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo VideoImageScanner_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _VideoImageScanner_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _VideoImageScanner_StubVtblList,
    (const PCInterfaceName * ) & _VideoImageScanner_InterfaceNamesList,
    0, // no delegation
    & _VideoImageScanner_IID_Lookup, 
    1,
    2,
